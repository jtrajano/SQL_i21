...
--**CHECK IF TABLE ARE EXISTING**--
IF EXISTS(select top 1 1  from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'pxcycmst')
AND EXISTS(select top 1 1  from INFORMATION_SCHEMA.TABLES where TABLE_NAME = 'pxselmst')
BEGIN
