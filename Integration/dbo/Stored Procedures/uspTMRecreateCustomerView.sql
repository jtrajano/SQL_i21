	...
	-- AG VIEW
		...
		BEGIN
			EXEC ('
				...
				,vwcus_phone   = dbo.[fnTMFormatOriginPhone](CAST(ISNULL(A.ptcus_phone,'''') AS CHAR(15)))    
				...
				,A4GLIdentity= CAST(A.A4GLIdentity as INT)  
				,vwcus_phone2   = dbo.[fnTMFormatOriginPhone](CAST(ISNULL(A.ptcus_phone2,'''') AS NVARCHAR(15)))  
