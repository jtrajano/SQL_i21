	...
	-- AG VIEW
		...
		BEGIN
			EXEC ('
					...
					AS
					SELECT
						vwlcl_tax_state	=	aglcl_tax_state COLLATE Latin1_General_CI_AS,
						vwlcl_tax_auth_id1	=	aglcl_tax_auth_id1 COLLATE Latin1_General_CI_AS,
						vwlcl_tax_auth_id2	=	aglcl_tax_auth_id2 COLLATE Latin1_General_CI_AS,
						vwlcl_auth_id1_desc	=	aglcl_auth_id1_desc COLLATE Latin1_General_CI_AS,
						vwlcl_auth_id2_desc	=	aglcl_auth_id2_desc COLLATE Latin1_General_CI_AS,
						vwlcl_fet_ivc_desc	=	aglcl_fet_ivc_desc COLLATE Latin1_General_CI_AS,
						vwlcl_set_ivc_desc	=	aglcl_set_ivc_desc COLLATE Latin1_General_CI_AS,
						vwlcl_lc1_ivc_desc	=	aglcl_lc1_ivc_desc COLLATE Latin1_General_CI_AS,
						vwlcl_lc2_ivc_desc	=	aglcl_lc2_ivc_desc COLLATE Latin1_General_CI_AS,
						vwlcl_lc3_ivc_desc	=	aglcl_lc3_ivc_desc COLLATE Latin1_General_CI_AS,
						vwlcl_lc4_ivc_desc	=	aglcl_lc4_ivc_desc COLLATE Latin1_General_CI_AS,
						vwlcl_lc5_ivc_desc	=	aglcl_lc5_ivc_desc COLLATE Latin1_General_CI_AS
						,vwlcl_lc6_ivc_desc	=	aglcl_lc6_ivc_desc  COLLATE Latin1_General_CI_AS
						,vwlcl_user_id	=	aglcl_user_id
						,vwlcl_user_rev_dt	=	aglcl_user_rev_dt
						,A4GLIdentity	=	CAST(A4GLIdentity   AS INT)
						,strTaxStateLocale = RTRIM(ISNULL(aglcl_tax_state,'''')) + ''-'' + RTRIM(ISNULL(aglcl_tax_auth_id1,'''')) + ''-'' + RTRIM(ISNULL(aglcl_tax_auth_id2,'''')) COLLATE Latin1_General_CI_AS
						,strDescription = '''' COLLATE Latin1_General_CI_AS
						,intConcurrencyId = 0 
					FROM aglclmst
		...
		BEGIN
			EXEC ('
					...
					AS
					SELECT
						vwlcl_tax_state	=	ptlcl_state  COLLATE Latin1_General_CI_AS,
						vwlcl_tax_auth_id1	=	ptlcl_local1_id COLLATE Latin1_General_CI_AS,
						vwlcl_tax_auth_id2	=	ptlcl_local2_id COLLATE Latin1_General_CI_AS,
						vwlcl_auth_id1_desc	=	ptlcl_desc COLLATE Latin1_General_CI_AS,
						vwlcl_auth_id2_desc	=	CAST(NULL AS CHAR(30)) COLLATE Latin1_General_CI_AS,
						vwlcl_fet_ivc_desc	=	CAST(NULL AS CHAR(20)) COLLATE Latin1_General_CI_AS,  
						vwlcl_set_ivc_desc	=	CAST(NULL AS CHAR(20)) COLLATE Latin1_General_CI_AS,
						vwlcl_lc1_ivc_desc	=	ptlcl_local1_desc COLLATE Latin1_General_CI_AS,
						vwlcl_lc2_ivc_desc	=	ptlcl_local2_desc COLLATE Latin1_General_CI_AS,
						vwlcl_lc3_ivc_desc	=	ptlcl_local3_desc COLLATE Latin1_General_CI_AS,
						vwlcl_lc4_ivc_desc	=	ptlcl_local4_desc COLLATE Latin1_General_CI_AS,
						vwlcl_lc5_ivc_desc	=	ptlcl_local5_desc COLLATE Latin1_General_CI_AS
						,vwlcl_lc6_ivc_desc	=	ptlcl_local6_desc COLLATE Latin1_General_CI_AS
						,vwlcl_user_id	=	CAST(NULL AS CHAR(16)) COLLATE Latin1_General_CI_AS
						,vwlcl_user_rev_dt	=	NULL
						,A4GLIdentity	=	CAST(A4GLIdentity   AS INT)
						,strTaxStateLocale = RTRIM(ISNULL(ptlcl_state,'''')) + ''-'' + RTRIM(ISNULL(ptlcl_local1_id,'''')) + ''-'' + RTRIM(ISNULL(ptlcl_local2_id,'''')) COLLATE Latin1_General_CI_AS
						,strDescription = '''' COLLATE Latin1_General_CI_AS
						,intConcurrencyId = 0 
	...
	BEGIN
		EXEC ('
			...
			SELECT
				...
				,intConcurrencyId = 0 
				,strTaxStateLocale = strTaxGroup COLLATE Latin1_General_CI_AS
