...
dtmStartDate, dtmEndDate, intItemId, dblPrice,ysnActive, intConcurrencyId)
...
6 'intPricingTypeId',
CONVERT(DATETIME, LEFT(ptcpl_start_date,8)) 'dtmStartDate', CASE WHEN ptcpl_end_date = 0 THEN getdate() ELSE   CONVERT(DATETIME, LEFT(ptcpl_end_date,8) ) END AS 'dtmEndDate',
