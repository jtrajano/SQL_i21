	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				ptcus_acct_stat_x_2 = (SELECT strAccountStatusCode FROM tblARAccountStatus WHERE intAccountStatusId = (SELECT  intAccountStatusId FROM tblARCustomerAccountStatus WHERE intEntityCustomerId = Cus.intEntityId ORDER BY intCustomerAccountStatusId OFFSET (1) ROW FETCH NEXT (1) ROW ONLY)),
