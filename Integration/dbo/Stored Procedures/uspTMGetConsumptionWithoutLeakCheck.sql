...
GO
PRINT 'START OF CREATING [uspTMGetConsumptionWithoutLeakCheck] SP'
GO
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[uspTMGetConsumptionWithoutLeakCheck]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[uspTMGetConsumptionWithoutLeakCheck]
GO



CREATE PROCEDURE [dbo].[uspTMGetConsumptionWithoutLeakCheck](
