	...
	EXEC('
		...
		BEGIN   
			...
			FROM	apeglmst gl INNER JOIN vyuCMOriginDepositEntry v  
						ON v.aptrx_cbk_no  COLLATE Latin1_General_CI_AS  = gl.apegl_cbk_no  
						AND v.aptrx_ivc_no  COLLATE Latin1_General_CI_AS = gl.apegl_ivc_no  
						AND v.aptrx_vnd_no  COLLATE Latin1_General_CI_AS = gl.apegl_vnd_no  
					INNER JOIN tblCMUndepositedFund uf   
						ON uf.strSourceTransactionId = (   
							CAST(v.aptrx_vnd_no AS NVARCHAR(10))   
							+ CAST(v.aptrx_ivc_no AS NVARCHAR(18))   
