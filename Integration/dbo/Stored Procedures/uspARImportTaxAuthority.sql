IF EXISTS(select top 1 1 from sys.procedures where name = 'uspARImportTaxAuthortity')
	DROP PROCEDURE uspARImportTaxAuthortity
GO

CREATE PROCEDURE [dbo].[uspARImportTaxAuthortity]
	@Checking BIT = 0,
	@Total INT = 0 OUTPUT
