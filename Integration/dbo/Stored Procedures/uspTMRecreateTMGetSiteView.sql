		...
		EXEC('
			ALTER VIEW [dbo].[vyuTMGetSite]
					...
					SELECT dblBurnRate = site.dblBurnRate
						...
						, strLocation = location.vwloc_name
						, strClockNumber = clock.strClockNumber
						, strDeliveryTerm = deliverTerm.vwtrm_desc
						, strPricingLevelName = pricingLevel.strPricingLevelName
						, strTaxStateLocale = taxLocale.vwlcl_tax_state
						...
						, strLocationAddress = location.vwloc_addr
						, strLocationPhone = ''
						, site.intCompanyLocationSubLocationId
						, sublocation.strSubLocationName
						, strLocationNumber = location.vwloc_loc_no
						, strLocationType = ''
						, strLocationEmail = ''
						, ysnLocationActive = ''
						, strLocationInternalNotes = ''
					...
					LEFT JOIN vwlocmst location ON site.intLocationId = location.A4GLIdentity
					...
					LEFT JOIN vwtrmmst deliverTerm ON site.intDeliveryTermID = deliverTerm.A4GLIdentity
					...
					LEFT JOIN vwlclmst taxLocale ON site.intTaxStateID = taxLocale.A4GLIdentity
