...
namespace iRely.Inventory.Model
{
    ...
    { 
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new vyuICGetCommodityGradeMap());
            ...
            modelBuilder.Configurations.Add(new vyuICGetItemStockUOMTotalsAllLocationsMap());
            modelBuilder.Configurations.Add(new vyuICGetItemStockUOMTotalsAllStorageUnitsMap());
            ...
            modelBuilder.Configurations.Add(new vyuICGetItemsWithNoLocationMap());
           ...
           // modelBuilder.Configurations.Add(new tblMFQAPropertyMap());
            ...
            modelBuilder.Configurations.Add(new vyuICGetBundleItemStockMap());
            ...
            modelBuilder.Configurations.Add(new vyuICGetShipmentChargeTaxDetailsMap());
        }
    }
}
