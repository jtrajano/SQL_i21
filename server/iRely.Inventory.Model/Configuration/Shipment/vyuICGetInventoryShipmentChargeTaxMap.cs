...
{
    public class vyuICGetInventoryShipmentChargeTaxMap : EntityTypeConfiguration<vyuICGetInventoryShipmentChargeTax>
    {
        public vyuICGetInventoryShipmentChargeTaxMap()
        {
            // Primary Key
            this.HasKey(t => t.intInventoryShipmentChargeTaxId);

            // Table & Column Mappings
            this.ToTable("vyuICGetInventoryShipmentChargeTax");
