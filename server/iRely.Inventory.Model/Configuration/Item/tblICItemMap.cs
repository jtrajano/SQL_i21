...
namespace iRely.Inventory.Model
{
    ...
    public class vyuICGetItemStockUOMTotalsAllLocationsMap : EntityTypeConfiguration<vyuICGetItemStockUOMTotalsAllLocations>
    {
        public vyuICGetItemStockUOMTotalsAllLocationsMap()
        {
            this.HasKey(p => p.intItemStockUOMId);
            // Table & Column Mappings
            this.ToTable("vyuICGetItemStockUOMTotalsAllLocations");
            this.Property(t => t.intItemStockUOMId).HasColumnName("intItemStockUOMId");
            this.Property(t => t.intItemId).HasColumnName("intItemId");
            this.Property(t => t.intItemLocationId).HasColumnName("intItemLocationId");
            this.Property(t => t.intItemUOMId).HasColumnName("intItemUOMId");
    ...
    public class vyuICGetItemStockUOMTotalsAllStorageUnitsMap : EntityTypeConfiguration<vyuICGetItemStockUOMTotalsAllStorageUnits>
    {
        public vyuICGetItemStockUOMTotalsAllStorageUnitsMap()
        {
            this.HasKey(p => p.intItemStockUOMId);
            // Table & Column Mappings
            this.ToTable("vyuICGetItemStockUOMTotalsAllStorageUnits");
            this.Property(t => t.intItemStockUOMId).HasColumnName("intItemStockUOMId");
            this.Property(t => t.intItemId).HasColumnName("intItemId");
            this.Property(t => t.intItemLocationId).HasColumnName("intItemLocationId");
            this.Property(t => t.intItemUOMId).HasColumnName("intItemUOMId");
    ...
    public class vyuICGetInventoryValuationSummaryMap : EntityTypeConfiguration<vyuICGetInventoryValuationSummary>
    {
        public vyuICGetInventoryValuationSummaryMap()
        {
            ...
            this.Property(t => t.dblQuantity).HasColumnName("dblQuantity").HasPrecision(38, 20);
            this.Property(t => t.dblRunningQuantity).HasColumnName("dblRunningQuantity");
            this.Property(t => t.dblValue).HasColumnName("dblValue").HasPrecision(38, 20);
            this.Property(t => t.dblRunningValue).HasColumnName("dblRunningValue").HasPrecision(38, 20);
            this.Property(t => t.dblLastCost).HasColumnName("dblLastCost").HasPrecision(38, 20);
            this.Property(t => t.dblRunningLastCost).HasColumnName("dblRunningLastCost").HasPrecision(38, 20);
            this.Property(t => t.dblStandardCost).HasColumnName("dblStandardCost").HasPrecision(38, 20);
            this.Property(t => t.dblRunningStandardCost).HasColumnName("dblRunningStandardCost").HasPrecision(38, 20);
            this.Property(t => t.dblAverageCost).HasColumnName("dblAverageCost").HasPrecision(38, 20);
            this.Property(t => t.dblRunningAverageCost).HasColumnName("dblRunningAverageCost").HasPrecision(38, 20);
            this.Property(t => t.strStockUOM).HasColumnName("strStockUOM");
    ...
    public class vyuICItemUOMDetailMap : EntityTypeConfiguration<vyuICItemUOMDetail>
    {
        public vyuICItemUOMDetailMap()
        {
            // Primary Key
            this.HasKey(p => p.intKey);

            // Table & Column Mappings
            this.ToTable("vyuICItemUOMDetail");
            this.Property(t => t.intKey).HasColumnName("intKey");
            this.Property(t => t.intItemId).HasColumnName("intItemId");
            this.Property(t => t.strItemNo).HasColumnName("strItemNo");
            this.Property(t => t.strType).HasColumnName("strType");
