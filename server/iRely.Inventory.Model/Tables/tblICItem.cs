...
namespace iRely.Inventory.Model
{
    public class tblICItem : BaseEntity
    {
        ...
        public int strBarCodeIndicator { get; set; }
        public bool ysnMSDSRequired { get; set; }
        public int strEPANumber { get; set; }
        ...
        public int strFeedRebateGroup { get; set; }
