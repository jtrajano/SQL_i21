...
namespace iRely.Inventory.BusinessLayer
{
    ...
    {
        #region Constructor
        public StorageLocationBl(IInventoryRepository db) : base(db)
        {
            _db = db;
        }
        #endregion
        ...
        public async Task<SearchResult> SearchSubLocationBinDetails(GetParameter param)
        {
            ...
            var data = await query.ExecuteProjection(param, "intItemLocationId").ToListAsync(param.cancellationToken);
