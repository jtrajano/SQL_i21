...
IF NOT EXISTS (SELECT TOP 1 1 FROM tblARCustomerPortalMenu WHERE intCustomerPortalMenuId = 24)
	INSERT [dbo].[tblARCustomerPortalMenu] ([intCustomerPortalMenuId], [strCustomerPortalMenuName], [intCustomerPortalParentMenuId], [strType], [strCommand]) VALUES (24, N'Customer Contact List', 4, N'Screen', N'EntityManagement.controller.CustomerContactList')
else
	Update [dbo].[tblARCustomerPortalMenu] set [strCustomerPortalMenuName] = N'Customer Contact List', [intCustomerPortalParentMenuId] = 4, [strType] = N'Screen', [strCommand] = N'EntityManagement.controller.CustomerContactList' where intCustomerPortalMenuId = 24
