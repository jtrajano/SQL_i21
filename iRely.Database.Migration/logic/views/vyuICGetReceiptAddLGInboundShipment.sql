...
-- changeset Von:vyuICGetReceiptAddLGInboundShipment.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234

CREATE OR ALTER VIEW vyuICGetReceiptAddLGInboundShipment
AS
SELECT
	...
	, strSealNumber						= LoadContainer.strSealNumber
FROM tblLGLoad Load
	...
	LEFT JOIN tblICItemLocation ItemLocation ON ItemLocation.intItemId = Item.intItemId AND ItemLocation.intLocationId = Load.intCompanyLocationId
