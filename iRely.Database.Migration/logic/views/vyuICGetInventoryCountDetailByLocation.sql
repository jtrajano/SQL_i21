...
-- changeset Von:vyuICGetInventoryCountDetailByLocation.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234

CREATE OR ALTER VIEW [dbo].[vyuICGetInventoryCountDetailByLocation]
	AS 
