...
-- changeset Von:vyuICGetInventoryCountByLocation.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234

CREATE OR ALTER VIEW [dbo].[vyuICGetInventoryCountByLocation]
	AS
...
FROM tblICInventoryCount InventoryCount
    ...
    INNER JOIN vyuICUserCompanyLocations permission ON permission.intCompanyLocationId = InventoryCount.intLocationId
