...
-- changeset Von:vyuICGetInventoryShipmentChargeTax.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234

CREATE OR ALTER VIEW [dbo].[vyuICGetInventoryShipmentChargeTax]
AS
