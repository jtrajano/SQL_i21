...
-- changeset Von:vyuICGetInventoryValuationSummary.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234

CREATE OR ALTER VIEW [dbo].[vyuICGetInventoryValuationSummary]
AS 
