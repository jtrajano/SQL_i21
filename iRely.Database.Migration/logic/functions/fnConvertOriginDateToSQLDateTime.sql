...
-- changeset Von:fnConvertOriginDateToSQLDateTime.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234
...
CREATE OR ALTER FUNCTION fnConvertOriginDateToSQLDateTime(@intDate AS INT)	
RETURNS DATETIME
AS
BEGIN 
