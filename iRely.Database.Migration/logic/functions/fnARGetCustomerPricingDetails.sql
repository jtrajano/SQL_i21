...
-- changeset Von:fnARGetCustomerPricingDetails.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234

CREATE OR ALTER FUNCTION [dbo].[fnARGetCustomerPricingDetails]
(
	 @ItemId						INT
	,@CustomerId					INT	
	,@LocationId					INT
...
BEGIN
	...
	SELECT TOP 1
		...
		,SP.strCustomerGroup
		,SP.strCostToUse
		,ISNULL(SP.dblDeviation, 0) + ISNULL(SP.dblDeviation2, 0) + ISNULL(SP.dblDeviation3, 0) + ISNULL(SP.dblDeviation4, 0)
		,SP.strLineNote
		,SP.intRackVendorId
		,SP.intRackItemId
