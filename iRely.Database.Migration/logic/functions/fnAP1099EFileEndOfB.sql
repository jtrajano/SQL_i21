...
-- changeset Von:fnAP1099EFileEndOfB.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234

CREATE OR ALTER FUNCTION [dbo].[fnAP1099EFileEndOfB]
(
	@year INT,
	@reprint BIT = 0,
	@corrected BIT = 0,
...
BEGIN
	...
	SELECT
		...
		@controlTotal4 = REPLICATE('0',18 - LEN(REPLACE(CAST(CAST(SUM(ISNULL(A.dbl1099B,0)) AS DECIMAL(18,2)) AS NVARCHAR(100)),'.','')))
						+ REPLACE(CAST(CAST(SUM(ISNULL(A.dbl1099B,0)) AS DECIMAL(18,2)) AS NVARCHAR(100)),'.',''),
