...
-- changeset Von:fnAPGetVendorPayFromBankAccount.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234

CREATE OR ALTER FUNCTION [dbo].[fnAPGetVendorPayFromBankAccount]
(
	@vendorId INT,
	@locationId INT,
	@currencyId INT
