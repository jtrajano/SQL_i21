...
-- changeset Von:fnConvertNumberToWord.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234


CREATE OR ALTER FUNCTION fnConvertNumberToWord(@dblAmount AS NUMERIC(38, 2))	
