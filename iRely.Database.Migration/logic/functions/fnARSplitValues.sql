...
-- changeset Von:fnARSplitValues.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234

CREATE OR ALTER FUNCTION dbo.fnARSplitValues(@String varchar(8000), @Delimiter char(1))       
