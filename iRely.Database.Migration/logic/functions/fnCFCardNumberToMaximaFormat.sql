...
-- changeset Von:fnCFCardNumberToMaximaFormat.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234


CREATE OR ALTER FUNCTION [dbo].[fnCFCardNumberToMaximaFormat](@cardNumber nvarchar(max),@mask bit = 0)
