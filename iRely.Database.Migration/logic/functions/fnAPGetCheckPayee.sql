...
-- changeset Von:fnAPGetCheckPayee.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234

CREATE OR ALTER FUNCTION fnAPGetCheckPayee(@strPaymentRecordNum NVARCHAR(50), @dtmDate DATETIME , @intEntityVendorId INT, @intPayToAddressId INT)
