...
-- changeset Von:fnARCashFlowTransactions.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234

CREATE OR ALTER FUNCTION [dbo].[fnARCashFlowTransactions]
(
...
BEGIN
	...
	SELECT
		...
		,ysnPosted				= 1
	FROM [dbo].[fnARCustomerAgingDetail](@dtmDateFrom, @dtmDateTo, NULL, NULL, NULL, NULL, NULL, @intEntityUserId, NULL, 0, 0, 0, 1) ARCAST
