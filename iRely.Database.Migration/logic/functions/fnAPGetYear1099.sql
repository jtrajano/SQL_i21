...
-- changeset Von:fnAPGetYear1099.sql.1 runOnChange:true splitStatements:false
-- comment: RK-1234

CREATE OR ALTER FUNCTION dbo.[fnAPGetYear1099](@type int, @vendorFrom NVARCHAR(50), @vendorTo NVARCHAR(50))
