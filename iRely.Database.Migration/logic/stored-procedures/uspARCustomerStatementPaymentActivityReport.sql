...
CREATE OR ALTER PROCEDURE [dbo].[uspARCustomerStatementPaymentActivityReport]
...
SELECT TOP 1 @strCompanyName	= strCompanyName
		   , @strCompanyAddress = ISNULL(LTRIM(RTRIM(strAddress)), '') + CHAR(13) + CHAR(10) + ISNULL(NULLIF(strCity, ''), '') + ISNULL(', ' + NULLIF(strState, ''), '') + ISNULL(', ' + NULLIF(strZip, ''), '') + ISNULL(', ' + NULLIF(strCountry, ''), '') + CHAR(13) + CHAR(10) + strPhone
