            ...
            iRely.Functions.openScreen('GlobalComponentEngine.view.FloatingSearch', {
                searchSettings: {
                    ...
                    columns: [
                            ...
                            { dataIndex: 'dtmBeginDate', text: 'Begin Date', width: 100, dataType: 'date', required: true },
                            { dataIndex: 'dtmEndDate', text: 'End Date', width: 100, dataType: 'date', required: true },
                            ...
                            { dataIndex: 'intCommodityId', text: 'Commodity Id', dataType: 'numeric', hidden: true, required: true },
                            { dataIndex: 'intContainerId', text: 'Container Id', dataType: 'numeric', hidden: true, required: true },
                            { dataIndex: 'strContainer', text: 'Container', width: 100, dataType: 'string' },
                            { dataIndex: 'intSubLocationId', text: 'Storage Location Id', dataType: 'numeric', hidden: true, required: true },
                            { dataIndex: 'strSubLocationName', text: 'Storage Location', width: 100, dataType: 'string' },
                            { dataIndex: 'intStorageLocationId', text: 'Storage Unit Id', dataType: 'numeric', hidden: true, required: true },
                            ...
                            { xtype: 'numbercolumn', dataIndex: 'dblOrderUOMConvFactor', text: 'Order UOM Conversion Factor', width: 100, dataType: 'float' },
                            { dataIndex: 'intItemUOMId', text: 'Item UOM Id', dataType: 'numeric', hidden: true, required: true },
                            { dataIndex: 'strUnitMeasure', text: 'Unit Measure', width: 100, dataType: 'string' },
                            { dataIndex: 'strOrderUOM', text: 'Order UOM', width: 100, dataType: 'string' },
                            { dataIndex: 'strReceiveUOMType', text: 'Receive UOM', width: 100, dataType: 'string' },
                            { dataIndex: 'strGrossUOM', text: 'Gross UOM', width: 100, dataType: 'string' },
                            { dataIndex: 'intGrossUOMId', text: 'Gross UOM Id', dataType: 'numeric', hidden: true, required: true },
                            { xtype: 'numbercolumn', dataIndex: 'dblItemUOMConvFactor', text: 'Item UOM Conversion Factor', width: 100, dataType: 'float' },
                            { xtype: 'numbercolumn', dataIndex: 'dblWeightUOMConvFactor', text: 'Weight UOM Conversion Factor', width: 100, dataType: 'float' },
                            ...
                            { dataIndex: 'intGradeId', text: 'Grade Id', dataType: 'numeric', hidden: true, required: true },
                    ...
                    listeners: {
                        ...
                        openselectedclick: function(button, e, result) {
                            Ext.Array.forEach(result, function(rec){
                                ...
                                var itemCost = (rec.get('dblReceiveLastCost') + markUpOrDownCost)
                                ...
                                var IRItemModel = Ext.create(itemDetailStore.role.type,{
                                        ...
                                        dblItemUOMConvFactor: selectedItem.get('dblItemUOMConvFactor'),
                                        dblWeightUOMConvFactor: selectedItem.get('dblWeightUOMConvFactor'),
                                        intCostUOMId: selectedItem.get('intCostUOMId') ? selectedItem.get('intCostUOMId') : selectedItem.get('intOrderUOMId'),
                                        strCostUOM: selectedItem.get('intCostUOMId') ? selectedItem.get('strCostUOM') : selectedItem.get('strOrderUOM') ,
                                        dblCostUOMConvFactor: selectedItem.get('intCostUOMId') ? selectedItem.get('dblCostUOMConvFactor') : selectedItem.get('dblOrderUOMConvFactor'),
                                        // dblGrossMargin: order.get('dblGrossMargin'),
                                        intGradeId: rec.get('intGradeId'),
