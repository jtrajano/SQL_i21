    ...
    searchConfigs: [
        ...
        },
        {
            ...
            columns: [
                ...
                { dataIndex: 'intFromSubLocationId', text: 'From Storage Location Id', width: 100, dataType: 'numeric', hidden: true },
                { dataIndex: 'strFromSubLocationName', text: 'From Storage Location', width: 100, dataType: 'string' },
                { dataIndex: 'intToSubLocationId', text: 'To Storage Location Id', width: 100, dataType: 'numeric', hidden: true },
                { dataIndex: 'strToSubLocationName', text: 'To Storage Location', width: 100, dataType: 'string' },
                { dataIndex: 'intFromStorageLocationId', text: 'From Storage Unit Id', width: 100, dataType: 'numeric', hidden: true },
                { dataIndex: 'strFromStorageLocationName', text: 'From Storage Unit', width: 100, dataType: 'string', drillDownText: 'View Storage Unit', drillDownClick: 'onViewStorageLocation' },
                { dataIndex: 'intToStorageLocationId', text: 'To Storage Unit Id', width: 100, dataType: 'numeric', hidden: true },
                { dataIndex: 'strToStorageLocationName', text: 'To Storage Unit', width: 100, dataType: 'string', drillDownText: 'View Storage Unit', drillDownClick: 'onViewStorageLocation' },
