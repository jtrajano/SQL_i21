    ...
    searchConfigs: [
        {
            ...
            columns: [
                ...
                { dataIndex: 'strSubLocationName', text: 'Sub Location', hidden: true, allowSort: false, flex: 1, dataType: 'string' },
                { dataIndex: 'strStorageLocationName', text: 'Storage Location', hidden: true, allowSort: false, flex: 1, dataType: 'string', drillDownText: 'View Storage Location', drillDownClick: 'onViewStorageLocation' },
