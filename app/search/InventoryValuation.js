Ext.define('Inventory.search.InventoryValuation', {
    ...
    searchConfigs: [
        ...
        },
        {
            ...
            columns: [
                { dataIndex: 'strItemNo', text: 'Item No', allowSort: true, flex: 1, dataType: 'string', key: true, drillDownText: 'View Item', drillDownClick: 'onViewItem', defaultSort: true, sortPriority: 2 },
                ...
                { dataIndex: 'strCategoryCode', text: 'Category', allowSort: true, flex: 1, dataType: 'string', drillDownText: 'View Category', drillDownClick: 'onViewSummaryCategory'  },
                ...
                { xtype: 'datecolumn', dataIndex: 'dtmDate', text: 'Date', allowSort: false, flex: 1, dataType: 'date', defaultSort: true, sortPriority: 1, sortOrder: 'DESC' },
