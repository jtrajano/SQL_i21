    ...
    searchConfigs: [
        ...
        },
        {
            ...
            columns: [
                ...
                { dataIndex: 'strMonthYear', text: 'Year & Month', flex: 1, dataType: 'string', defaultSort: true, sortOrder: 'DESC' }, 
                { xtype: 'numbercolumn', format: '#,##0.0000', summaryType: 'sum', dataIndex: 'dblRunningQuantity', text: 'Stock Quantity', allowSort: true, flex: 1, dataType: 'float' },
                { xtype: 'numbercolumn', format: '#,##0.0000', summaryType: 'sum', dataIndex: 'dblRunningValue', text: 'Value by Costing', allowSort: true, flex: 1, dataType: 'float' },
                { xtype: 'numbercolumn', format: '#,##0.0000', summaryType: 'sum', dataIndex: 'dblRunningLastCost', text: 'By Last Cost', allowSort: true, flex: 1, dataType: 'float' },
                { xtype: 'numbercolumn', format: '#,##0.0000', summaryType: 'sum', dataIndex: 'dblRunningStandardCost', text: 'By Standard Cost', allowSort: true, flex: 1, dataType: 'float' },
                { xtype: 'numbercolumn', format: '#,##0.0000', summaryType: 'sum', dataIndex: 'dblRunningAverageCost', text: 'By Average Cost', allowSort: true, flex: 1, dataType: 'float' },
