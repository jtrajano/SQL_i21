    ...
    searchConfigs: [
        ...
        },
        {
            ...
            columns: [
                ...
                { dataIndex: 'strSubLocationName', text: 'Storage Location Name', width: 100, dataType: 'string' },
                { dataIndex: 'intStorageLocationId', text: 'Storage Unit Id', width: 100, dataType: 'numeric', hidden: true },
                { dataIndex: 'strStorageLocationName', text: 'Storage Unit Name', width: 100, dataType: 'string', drillDownText: 'View Storage Unit', drillDownClick: 'onViewStorageLocation' },
                ...
                { dataIndex: 'intNewSubLocationId', text: 'New Storage Location Id', width: 100, dataType: 'numeric', hidden: true },
                { dataIndex: 'strNewSubLocationName', text: 'New Storage Location Name', width: 100, dataType: 'string' },
                { dataIndex: 'intNewStorageLocationId', text: 'New Storage Unit Id', width: 100, dataType: 'numeric', hidden: true },
