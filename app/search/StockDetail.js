    ...
    searchConfigs: [
        {
            ...
            columns: [
                ...
                { dataIndex: 'strLocationName', text: 'Location', groupBy: true, flex: 1, dataType: 'string', drillDownText: 'View Item', drillDownClick: 'onViewLocation', groupedOnLoadWithTotals: true },
