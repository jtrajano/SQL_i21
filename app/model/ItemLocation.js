...
Ext.define('Inventory.model.ItemLocation', {
    ...
    fields: [
            ...
            reference: {
                ...
                inverse: {
                    ...
                    storeConfig: {
                        remoteFilter: true,
                        proxy: {
                            extraParams: { include: 'tblSMCompanyLocation, tblSMCompanyLocationSubLocation, vyuAPVendor' },
                            type: 'rest',
                            api: {
        ...
        { name: 'intDepositPLUId', type: 'int', allowNull: true },
        { name: 'intBottleDepositNo', type: 'int', allowNull: true },
