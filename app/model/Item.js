...
Ext.define('Inventory.model.Item', {
    ...
    fields: [
        ...
        { name: 'intLifeTime', type: 'int', allowNull: true },
        { name: 'strLifeTimeType', type: 'string' },
        { name: 'intReceiveLife', type: 'int', allowNull: true },
        ...
        { name: 'intInnerUnits', type: 'int', allowNull: true },
        { name: 'intLayerPerPallet', type: 'int', allowNull: true },
        { name: 'intUnitPerLayer', type: 'int', allowNull: true },
