    ...
    config: {
        searchConfig: {
            ...
            columns: [
                ...
                { xtype: 'numbercolumn', format: '#,##0.000000', summaryType: 'sum', dataIndex: 'dblBeginningQtyBalance', text: 'Beginning Qty Balance', allowSort: false, flex: 1.25, dataType: 'float', renderer: function(value) { return Ext.util.Format.number(value, '#,##0.00'); } },
                { xtype: 'numbercolumn', format: '#,##0.000000', summaryType: 'sum', dataIndex: 'dblQuantity', text: 'Qty', allowSort: false, flex: .75, dataType: 'float', renderer: function(value) { return Ext.util.Format.number(value, '#,##0.00'); } },
                { xtype: 'numbercolumn', format: '#,##0.000000', summaryType: 'sum', dataIndex: 'dblRunningQtyBalance', text: 'Running Qty Balance', allowSort: false, flex: 1.25, dataType: 'float', renderer: function(value) { return Ext.util.Format.number(value, '#,##0.00'); } },
                { xtype: 'numbercolumn', format: '#,##0.000000', summaryType: 'sum', dataIndex: 'dblCost', text: 'Cost', allowSort: false, flex: 1, dataType: 'float', renderer: function(value) { return Ext.util.Format.number(value, '#,##0.00'); } },
                { xtype: 'numbercolumn', format: '#,##0.000000', summaryType: 'sum', dataIndex: 'dblBeginningBalance', text: 'Beginning Balance', allowSort: false, flex: 1.2, dataType: 'float', renderer: function(value) { return Ext.util.Format.number(value, '#,##0.00'); } },
                { xtype: 'numbercolumn', format: '#,##0.000000', summaryType: 'sum', dataIndex: 'dblValue', text: 'Value', allowSort: false, flex: 1, dataType: 'float', renderer: function(value) { return Ext.util.Format.number(value, '#,##0.00'); } },
                { xtype: 'numbercolumn', format: '#,##0.00', summaryType: 'sum', dataIndex: 'dblRunningBalance', text: 'Running Balance', allowSort: false, flex: 1.2, dataType: 'float', renderer: function(value) { return Ext.util.Format.number(value, '#,##0.00'); } },
