    ...
    config: {
        searchConfig: {
            ...
            columns: [
                ...
                { xtype: 'numbercolumn', format: '#,##0.000000', summaryType: 'sum', dataIndex: 'dblCost', text: 'Cost', allowSort: false, flex: 1, dataType: 'float', renderer: function(value) { return Ext.util.Format.usMoney(value); } },
                { xtype: 'numbercolumn', format: '#,##0.000000', summaryType: 'sum', dataIndex: 'dblBeginningBalance', text: 'Beginning Balance', allowSort: false, flex: 1.2, dataType: 'float', renderer: function(value) { return Ext.util.Format.usMoney(value); } },
                ...
                { xtype: 'numbercolumn', format: '#,##0.00', summaryType: 'sum', dataIndex: 'dblRunningBalance', text: 'Running Balance', allowSort: false, flex: 1.2, dataType: 'float', renderer: function(value) { return Ext.util.Format.usMoney(value); } },
