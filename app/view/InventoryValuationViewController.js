    ...
    config: {
        searchConfig: {
            ...
            columns: [
                ...
                { dataIndex: 'strCategory', text: 'Category', allowSort: false, flex: 1, dataType: 'string' },
                ...
                { dataIndex: 'strTransactionId', text: 'Transaction Id', allowSort: false, flex: 1, dataType: 'string' },
