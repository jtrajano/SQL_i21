/****** Object:  StoredProcedure [dbo].[usp_BuildMenuPermissions] ******/
IF EXISTS(SELECT * FROM sys.objects WHERE NAME = 'usp_BuildMenuPermissions')
DROP PROCEDURE usp_BuildMenuPermissions
GO
