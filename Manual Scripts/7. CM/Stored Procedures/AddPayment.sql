...
EXEC dbo.AddPayment @intBankAccountID = 2, @dtmDate = '2013-11-16T00:00:00', @intGLAccountID = 1, @dblAmount = 100, @strDescription = 'This is the description', @intUserID = 1
...
---------------------------------------------------------------------------------------------------------------------------------------
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[AddPayment]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
