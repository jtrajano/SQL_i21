...
This stored procedure will retrieve the total UNCLEARED bank deposits/credits. 
...
EXEC dbo.GetUnclearedBankCredits @intBankAccountID = 2, @dtmStatementDate = NULL
...
---------------------------------------------------------------------------------------------------------------------------------------
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[GetUnclearedBankCredits]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[GetUnclearedBankCredits]
GO
