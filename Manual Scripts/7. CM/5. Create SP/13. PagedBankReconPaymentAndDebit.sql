...
EXEC dbo.PagedBankReconPaymentAndDebit 
	@start = 1, 
	@limit = 100,
	@intBankAccountID = 23,
	@dtmDate = NULL,
...
---------------------------------------------------------------------------------------------------------------------------------------
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[PagedBankReconPaymentAndDebit]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
DROP PROCEDURE [dbo].[PagedBankReconPaymentAndDebit]
GO
