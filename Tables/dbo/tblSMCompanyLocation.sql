...
(
	...
	[intWriteOffSold] INT NULL,
	[intRevalueSold] INT NULL,
	...
	[strPurchaseCompanyName] NVARCHAR(50) COLLATE Latin1_General_CI_AS NULL, 
	[strPurchasePrintSignOff] NVARCHAR(200) COLLATE Latin1_General_CI_AS NULL, 
	[strLogisticsCompanyName] NVARCHAR(50) COLLATE Latin1_General_CI_AS NULL, 
	[strLogisticsPrintSignOff] NVARCHAR(200) COLLATE Latin1_General_CI_AS NULL, 
	[strContractCompanyName] NVARCHAR(50) COLLATE Latin1_General_CI_AS NULL, 
	[strContractPrintSignOff] NVARCHAR(200) COLLATE Latin1_General_CI_AS NULL, 
	-- Additional Field for Company Location wise Preferences
	[intAllowablePickDayRange] INT NOT NULL DEFAULT (0),
	[ysnAllowCreateSKUContainer] BIT NULL DEFAULT (0), 
	[ysnAllowMoveAssignedTask] BIT NULL DEFAULT (0), 
	[ysnAllowPutAwayUnitTypes] BIT NULL DEFAULT (0), 
	[ysnAutoCommentsUpdate] BIT NULL DEFAULT (0), 
	[ysnAutoPositiveReleaseForBlendedLot] BIT NULL DEFAULT (0), 
	[dblAverageDensity] DECIMAL (18, 6) NULL,
	[strBagMarksPattern] NVARCHAR(50) COLLATE Latin1_General_CI_AS NULL, 
	[intBlendProductionDockDoorUnitId] INT NULL,
	[intBlendProductionStagingUnitId] INT NULL,
	[ysnBlendAffordabilityCheck] BIT NULL DEFAULT (0), 
	[ysnCreateOutboundOrderOnBlendsheetRelease] BIT NULL DEFAULT (0), 
	[ysnCreateLoadTasks] BIT NULL DEFAULT (0), 
	[ysnCreatePutAwayTask] BIT NULL DEFAULT (0), 
	[intDefaultCarrierId] INT NULL,
	[strDefaultTerms] NVARCHAR(50) COLLATE Latin1_General_CI_AS NULL, 
	[intDefaultBlendProductionLocationId] INT NULL,
	[ysnDefaultPalletTagReprintonPositiveRelease] BIT NULL DEFAULT (0), 
	[intDefaultStatusForPreSanitizedLotId] INT NULL, 
	[intDefaultInboundDockDoorUnitId] INT NULL, 
	[ysnEDI944] BIT NULL DEFAULT (0), 
	[ysnEDI945] BIT NULL DEFAULT (0), 
	[ysnShiftActivityTimeDisable] BIT NULL DEFAULT (0), 
	[strFGReleaseMailCCAddress] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[strFGReleaseMailTOAddress] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[ysnGTINCaseCodeMandatory] BIT NULL DEFAULT (0), 
	[intHistoricalStagingTicketLocationId] INT NULL,
	[ysnPalletCreateDelayEnabled] BIT NULL DEFAULT (0), 
	[strLotIDPrefix] NVARCHAR(5) COLLATE Latin1_General_CI_AS NULL, 
	[strLotOrigin] NVARCHAR(50) COLLATE Latin1_General_CI_AS NULL, 
	[strMailBCCAddress] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[strMailCCAddress] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[strMailFromAddress] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[strMailServer] NVARCHAR(50) COLLATE Latin1_General_CI_AS NULL, 
	[strMailServerPassword] NVARCHAR(50) COLLATE Latin1_General_CI_AS NULL, 
	[strMailServerUserDomain] NVARCHAR(50) COLLATE Latin1_General_CI_AS NULL, 
	[strMailServerUserName] NVARCHAR(50) COLLATE Latin1_General_CI_AS NULL, 
	[strMailToAddress] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[strExternalDatabaseName] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[strExternalServerName] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[strExternalCLRSPURL] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[ysnModifyAffordability] BIT NULL DEFAULT (0), 
	[ysnModifyBudget] BIT NULL DEFAULT (0), 
	[intNoOfCopiesToPrintforPalletSlip] INT NOT NULL DEFAULT (0),
	[ysnOverrideAffordability] BIT NULL DEFAULT (0), 
	[ysnOverrideBudget] BIT NULL DEFAULT (0), 
	[strPalletSlipPrinterName] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[strPhysicalCountPattern] NVARCHAR(50) COLLATE Latin1_General_CI_AS NULL, 
	[strProductAlertMailCCAddress] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[strProductAlertMailTOAddress] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[intProductAlertOwnerId] INT NULL,
	[ysnReceiptConnToERP] BIT NULL DEFAULT (0), 
	[ysnReceiptFeedToERP] BIT NULL DEFAULT (0), 
	[ysnRestrictOrdersToOneOwner] BIT NULL DEFAULT (0), 
	[intSanitizationDockDoorUnitId] INT NULL, 
	[dblSanitizationOrderInputQtyTolerancePercentage] DECIMAL (18, 6) NULL,
	[dblSanitizationOrderOutputQtyTolerancePercentage] DECIMAL (18, 6) NULL,
	[intSanitizationStagingUnitId] INT NULL,
	[intSanitizationStorageUnitId] INT NULL,
	[ysnScanForkliftOnLogin] BIT NULL DEFAULT (0), 
	[ysnSendEmailNotificationOnReceiptOfMaterials] BIT NULL DEFAULT (0), 
	[ysnShowBlendProductionItemLineColor] BIT NULL DEFAULT (0), 
	[ysnSKUPickByUnitType] BIT NULL DEFAULT (0), 
	[strTagNoPattern] NVARCHAR(50) COLLATE Latin1_General_CI_AS NULL, 
	[strTicketLabelPrinterName] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[strWMSMobileURL] NVARCHAR(100) COLLATE Latin1_General_CI_AS NULL, 
	[ysnInventoryTransactionFeedToERP] BIT NULL DEFAULT (0), 
	...
	[intDemandNoMaxLength] INT NOT NULL DEFAULT (0),
	[intDemandNoMinLength] INT NOT NULL DEFAULT (0),
	[ysnEnableKittingProcess] BIT NULL DEFAULT (0), 
	[ysnBlendStageIntegration] BIT NULL DEFAULT (0), 
	...
	CONSTRAINT [FK_tblSMCompanyLocation_tblICStorageLocation_BlendProductionStagingUnit] FOREIGN KEY ([intBlendProductionStagingUnitId]) REFERENCES [tblICStorageLocation]([intStorageLocationId]),
	CONSTRAINT [FK_tblSMCompanyLocation_tblEMEntity_DefaultCarrier] FOREIGN KEY ([intDefaultCarrierId]) REFERENCES tblEMEntity([intEntityId]),
	CONSTRAINT [FK_tblSMCompanyLocation_tblICStorageLocation_DefaultBlendProductionLocation] FOREIGN KEY ([intDefaultBlendProductionLocationId]) REFERENCES [tblICStorageLocation]([intStorageLocationId]),
	CONSTRAINT [FK_tblSMCompanyLocation_tblICLotStatus_DefaultStatusForPreSanitizedLot] FOREIGN KEY ([intDefaultStatusForPreSanitizedLotId]) REFERENCES [tblICLotStatus]([intLotStatusId]),
	CONSTRAINT [FK_tblSMCompanyLocation_tblICStorageLocation_DefaultInboundDockDoorUnit] FOREIGN KEY ([intDefaultInboundDockDoorUnitId]) REFERENCES [tblICStorageLocation]([intStorageLocationId]),
	CONSTRAINT [FK_tblSMCompanyLocation_tblICStorageLocation_HistoricalStagingTicketLocation] FOREIGN KEY ([intHistoricalStagingTicketLocationId]) REFERENCES [tblICStorageLocation]([intStorageLocationId]),
