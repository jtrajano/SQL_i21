CREATE TABLE [dbo].[tblPREmployeeDeduction] (
    ...
    CONSTRAINT [FK_tblPREmployeeDeduction_tblGLAccount_Liability] FOREIGN KEY ([intAccountId]) REFERENCES [dbo].[tblGLAccount] ([intAccountId]),
	CONSTRAINT [FK_tblPREmployeeDeduction_tblGLAccount_Expense] FOREIGN KEY ([intExpenseAccountId]) REFERENCES [dbo].[tblGLAccount] ([intAccountId]),
