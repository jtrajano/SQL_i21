CREATE TABLE dbo.tblMFManufacturingProcessAttribute (
	...
	,CONSTRAINT FK_tblMFManufacturingProcessAttribute_tblMFManufacturingProcess_intManufacturingProcessId FOREIGN KEY (intManufacturingProcessId) REFERENCES dbo.tblMFManufacturingProcess(intManufacturingProcessId) ON DELETE CASCADE
