...
AS
SELECT   cfAccnt.intCustomerId,cfAccnt.intAccountId, cfDsd.intFromQty, cfDsd.intThruQty, cfDsd.dblRate, cfDsd.intDiscountScheduleId, cfDsd.intDiscountSchedDetailId
