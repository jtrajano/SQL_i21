CREATE VIEW [dbo].[vyuARCustomerVendorSearch]
AS
...
INNER JOIN (
	...
	FROM 
		(
			SELECT intEntityId, ysnActive = ysnActive, intSalespersonId, intCurrencyId, intTermsId, intShipToId, intBillToId,
			...
			UNION ALL
			SELECT intEntityId, ysnActive = ysnPymtCtrlActive, intSalespersonId = null, intCurrencyId, intTermsId, intShipToId=intShipFromId, intBillToId,
