...
SELECT   CP.intCompanyPreferenceId,
         ...
         CP.strRefund, 
		 strRefundDescription = CASE WHEN CP.strRefund = 'A' THEN 'All Patrons' WHEN CP.strRefund = 'S' THEN 'Stockholders' WHEN CP.strRefund = 'V' THEN 'Voting Only' END COLLATE Latin1_General_CI_AS,
         CP.dblMinimumRefund, 
         CP.dblServiceFee, 
         CP.dblCutoffAmount, 
         CP.strCutoffTo, 
