CREATE VIEW [dbo].[vyuICGetStorageMeasurementReadingConversionByLocation]
	AS 
...
INNER JOIN vyuICUserCompanyLocations permission ON permission.intCompanyLocationId = Header.intLocationId
