CREATE VIEW [dbo].[vyuICGetInventoryReceiptItemByLocation]
	AS

-- Commented out temporarily to resolve IC-7927 but will temporarily remove the optmizations in IC-7893
-- SELECT rs.*
-- FROM tblICInventoryReceiptDetailSearch rs
