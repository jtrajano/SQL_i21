CREATE FUNCTION [dbo].[fnSTGetRowsFromDelimitedValuesReturnString](@strParam NVARCHAR(MAX))
...
BEGIN
	...
	INSERT INTO @IntegerTable
		SELECT CAST([dbo].fnTrimX(Value) AS NVARCHAR(200)) FROM ValuesCTE OPTION (MAXRECURSION 0)
