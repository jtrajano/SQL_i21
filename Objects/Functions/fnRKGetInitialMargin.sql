...
BEGIN
	...
	DECLARE @result AS NUMERIC(18, 6)
		...
		SELECT @result= case when isnull(dblPerFutureContract,0)>0 then dblPerFutureContract*dblNoOfContract else 
		...
		((dblNoOfContract*isnull(dblPrice,0)*dblContractSize)*dblPercenatage)/100 as dblContractMargin,
		dblPerFutureContract,dblNoOfContract
