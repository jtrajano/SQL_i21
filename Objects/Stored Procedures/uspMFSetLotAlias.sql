CREATE PROCEDURE uspMFSetLotAlias @intLotId INT
...
BEGIN TRY
	...
	BEGIN
		UPDATE tblICLot
		SET strLotAlias = @strNewLotAlias
		WHERE intParentLotId = @intParentLotId
			AND intItemId = @intItemId
			AND intLocationId = @intLocationId
