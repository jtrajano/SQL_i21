...
*/
CREATE PROCEDURE [dbo].[uspAPRptWeightClaimJDE]
...
SET NOCOUNT ON
SET XACT_ABORT ON
SET ANSI_WARNINGS ON --ENABLE TO WORK WITH fnAPMaskBankAccountNos
...
BEGIN
	SELECT TOP 1 * FROM [vyuAPRptWeightClaimJDE]
END
