CREATE PROCEDURE testi21Database.[test fnGetCostingMethodAsTable for retrieving the costing method for serial lot items]
AS 
BEGIN
	-- Arrange
	BEGIN
	...
	BEGIN 
		...
		***************************************************************************************************************************************************************************************************************/
		...
		FROM dbo.fnGetCostingMethodAsTable(@SerialLotGrains, 1)
	END 
