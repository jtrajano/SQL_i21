...
/*
	...
	-----------------------------------------------------------------
	ActualCost Id	Date		In		Out		Cost	Inbound Transaction
	-------------	---------	------	-----	------	---------------------
	ACTUAL COST ID	1/1/2014	75		75		$2.00	InvShip-00001
	ACTUAL COST ID	1/16/2014	100		75		$2.15	InvRcpt-00001

	tblICInventoryActualCostOut
	-----------------------------------------------------------------
	Id		ActualCost Id		Inventory Transaction Id	Revalue Id	Qty
	-----	---------------		-------------------------	----------	-----
	1		ACTUAL COST ID		InvShip-00001				1			75
...
*/
---------------------------------------------------------------------------------------------------
CREATE PROCEDURE [testi21Database].[Fake posted transactions using Actual Costing, scenario 4]
AS
...
BEGIN
	...
	BEGIN 
		...
		------------------------------
		-- Can't add ActualCost out records when stock is negative. 
	...
	BEGIN 
		...
		BEGIN 
			...
			UPDATE	ActualCost
			SET		dblStockIn = 75
			FROM	dbo.tblICInventoryActualCost ActualCost
			WHERE	dblStockIn = 0
					AND dblStockOut = 75
		...
		----------------------------------------------------------------
		-- Fake data for tblICInventoryActualCostOut
		----------------------------------------------------------------
