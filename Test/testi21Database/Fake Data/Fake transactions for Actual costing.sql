CREATE PROCEDURE [testi21Database].[Fake transactions for Actual costing]
AS
BEGIN	
	...
	CREATE CLUSTERED INDEX [IDX_tblICInventoryActualCost]
		ON [dbo].[tblICInventoryActualCost]([dtmDate] ASC, [intItemId] ASC, [intItemLocationId] ASC, [intInventoryActualCostId] ASC);
	...
	BEGIN
		...
		SELECT	intItemId = @StickyGrains
				...
				, strActualCostId = 'PURCHASE-200000'
		UNION ALL 
		SELECT	intItemId = @PremiumGrains
				...
				, strActualCostId = 'PURCHASE-300000'
		UNION ALL 
		SELECT	intItemId = @ColdGrains
				...
				, strActualCostId = 'PURCHASE-400000'
		UNION ALL 
		SELECT	intItemId = @HotGrains
				...
				, strActualCostId = 'PURCHASE-500000'
