...
BEGIN
	...
	DECLARE @intLotItemUOMId AS INT = @10LbBag
			...
			,@dblCostingQty AS NUMERIC(38, 20) = 100												--	Add 100 lb more
			,@dblLotWeightPerQty AS NUMERIC(38,20) = 35.821428571428571428571428571429				-- Each bag is 35.xxxx Lb.  
			,@Expected AS NUMERIC(18,6) = 9.791600 -- 350.75 / 35.821428571428571428571428571429	-- expected result is a change in Qty to 9.7916251246261216350947158524426 bags.
