...
BEGIN
	...
	DECLARE @expected AS NUMERIC(38,20) = 28.34949254408350000000 -- 28.3494925440835 -- CAST( (CAST(@dblCost AS FLOAT) / CAST(@20KGBag_UnitQty AS FLOAT) * CAST(@50LBBag_UnitQty AS FLOAT)) AS NUMERIC(38, 14)) -- Equals 28.34949254408346. (Rounded to 14 decimal places)
