CREATE PROCEDURE [testi21Database].[test uspICCreateGLEntriesOnCostAdjustment for a GL description]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		SELECT	
			...
			,dblDebitUnit				= 0
			,dblCreditUnit				= 0
			,strDescription				= 'This is a G/L description.'
			,strCode					= 'ICA'
			,strReference				= ''
			,intCurrencyId				= @USD
			,dblExchangeRate			= 1
