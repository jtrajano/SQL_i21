CREATE PROCEDURE [testi21Database].[test uspICPostCustody for calling uspICPostLotInCustody]
AS
-- Fake data Variables
BEGIN
...
BEGIN
	...
	BEGIN 
		...
		-- Add a spy for uspICPostLotInCustody
		EXEC tSQLt.SpyProcedure 'dbo.uspICPostLotInCustody';	
	...
	-- Assert 
	BEGIN 
		EXEC tSQLt.AssertObjectExists 'uspICPostLotInCustody_SpyProcedureLog'
	END 
END 
