CREATE PROCEDURE [testi21Database].[test uspICIncreaseReservedQty and Stock UOM for increase of reserved qty]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		-----------------------------------
		DECLARE @Items AS ItemReservationTableType;
	...
	-- Act
	BEGIN 
		EXEC dbo.uspICIncreaseReservedQty @Items
