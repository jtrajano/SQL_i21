CREATE PROCEDURE [testi21Database].[test uspICCreateGLEntries for allowing a missing Contra Account on Build Assembly]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		SELECT 	intItemId = @StickyGrains
				...
				,dblExchangeRate = 1
				,intTransactionId = 1
				,strTransactionId = 'BUILD-10001'
				,strBatchId = 'BATCH-000001'
				,intTransactionTypeId = @INVENTORY_TRANSACTION_TYPE_BUILD_ASSEMBLY
				,strTransactionForm = 'Build Assembly'
				,intLotId = NULL 
				,dtmCreated = GETDATE()
				,intCreatedUserId = 1
				,intConcurrencyId = 1
