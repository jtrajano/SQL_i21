CREATE PROCEDURE [testi21Database].[test uspICInventoryAdjustment_CreatePostExpiryDateChange for invalid company location id]
AS
BEGIN 
	...
	BEGIN 
		EXEC dbo.uspICInventoryAdjustment_CreatePostExpiryDateChange	
			...
			,@dtmDate						= '01/30/2014' 
			,@intLocationId					= @NewHaven										-- Invalid location
