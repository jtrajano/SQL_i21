CREATE PROCEDURE [testi21Database].[test uspICUnpostFIFOInFromCustody for add-sell-unpost add]
AS
BEGIN 
...
BEGIN
	...
	BEGIN 
		...
		-- Add fake data for tblICInventoryFIFOInCustody
	...
	BEGIN 
		...
		EXEC dbo.uspICUnpostFIFOInFromCustody @strTransactionId, @intTransactionId
