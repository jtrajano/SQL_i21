CREATE PROCEDURE [testi21Database].[test uspICUnpostLIFOInFromCustody for add-sell-unpost add]
AS
BEGIN 
...
BEGIN
	...
	BEGIN 
		...
		-- Add fake data for tblICInventoryLIFOInCustody
		...
		-- Add fake data for tblICInventoryTransactionInCustody
