CREATE PROCEDURE [testi21Database].[test uspICPostStorage for calling uspICPostFIFOStorage]
AS
-- Fake data Variables
BEGIN
...
BEGIN
	...
	BEGIN 
		...
		-- Add a spy for uspICPostFIFOStorage
		EXEC tSQLt.SpyProcedure 'dbo.uspICPostFIFOStorage';		
	...
	-- Assert 
	BEGIN 
		EXEC tSQLt.AssertObjectExists 'uspICPostFIFOStorage_SpyProcedureLog'
	END 
END 
