CREATE PROCEDURE [testi21Database].[test uspICUnpostCosting on Actual Costing for scenario 4, unpost add stock, unpost sell stock]
AS
-- Arrange 
BEGIN 
...
BEGIN 
	...
	-- BEGIN Setup the expected ActualCost data
	UPDATE	expectedActualCost
	SET		dblStockIn = 75
			,dblStockOut = 75
	FROM	expectedActualCost
