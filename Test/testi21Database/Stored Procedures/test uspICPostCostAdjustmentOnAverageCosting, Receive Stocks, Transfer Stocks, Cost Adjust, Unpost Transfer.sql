CREATE PROCEDURE [testi21Database].[test uspICPostCostAdjustmentOnAverageCosting, Receive Stocks, Transfer Stocks, Cost Adjust, Unpost Transfer]
AS
BEGIN
	...
	BEGIN 
		...
		SELECT	[intInventoryTransactionId] = 10
				...
				,[intCostingMethod]			= @AVERAGECOST
				,[ysnIsUnposted]			= 1
		-- Unpost Inventory Transfer transactions
		UNION ALL 
		...
		SELECT	[intInventoryTransactionId] = 12
				...
				,[intCostingMethod]			= @AVERAGECOST
				,[ysnIsUnposted]			= 1
		-- Unpost the cost adjustments related to Revalue Transfer. 
		UNION ALL 
