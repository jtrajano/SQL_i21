CREATE PROCEDURE [testi21Database].[test uspICPostInventoryReceipt for multiple lot items and non-recap]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		INSERT INTO tblICInventoryReceiptItemLot(intInventoryReceiptItemId, intItemUnitMeasureId, intLotId, strLotNumber, dblQuantity) VALUES (2, @SerializedLotGrains_BushelUOMId, 2, 'SerialLot-0001', 12)
		INSERT INTO tblICInventoryReceiptItemLot(intInventoryReceiptItemId, intItemUnitMeasureId, intLotId, strLotNumber, dblQuantity) VALUES (2, @SerializedLotGrains_BushelUOMId, 3, 'SerialLot-0002', 8)
