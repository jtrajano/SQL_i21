CREATE PROCEDURE [testi21Database].[test uspICPostStorage for calling uspICPostLIFOStorage]
AS
-- Fake data Variables
BEGIN
...
BEGIN
	...
	BEGIN 
		...
		-- Add a spy for uspICPostLIFOStorage
		EXEC tSQLt.SpyProcedure 'dbo.uspICPostLIFOStorage';		
	...
	-- Assert 
	BEGIN 
		EXEC tSQLt.AssertObjectExists 'uspICPostLIFOStorage_SpyProcedureLog'
	END 
END 
