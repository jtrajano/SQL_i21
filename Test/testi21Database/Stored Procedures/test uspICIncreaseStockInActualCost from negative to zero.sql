CREATE PROCEDURE [testi21Database].[test uspICIncreaseStockInActualCost from negative to zero]
AS
BEGIN
	-- Arrange 
	BEGIN 
	...
	BEGIN 
		...
		BEGIN 		
			...
			BEGIN 
				...
				EXEC tSQLt.AssertEquals 1, @UpdatedActualCostId
			END 
		...
		-- Assert that the new ActualCost id is 4
