CREATE PROCEDURE [testi21Database].[test uspICPostInventoryAdjustment for the transaction type  - split lot]
AS
BEGIN
	...
	-- Arrange 
	BEGIN 
		DECLARE @strTransactionTypeName AS NVARCHAR(50) = 'Inventory Adjustment - Split Lot'
				,@intTransactionTypeId AS INT 
				,@ExpectedTransactionTypeId AS INT = @INVENTORY_ADJUSTMENT_SplitLot
	END 
