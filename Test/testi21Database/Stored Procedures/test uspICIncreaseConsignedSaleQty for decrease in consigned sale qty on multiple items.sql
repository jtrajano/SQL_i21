CREATE PROCEDURE [testi21Database].[test uspICIncreaseConsignedSaleQty for decrease in consigned sale qty on multiple items]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		SELECT	intItemId = @WetGrains
				...
				,dblConsignedSale = 0 -- It should never go down to -450. When it goes negative, the order qty is set to zero. 
	...
	-- Act
	BEGIN 
		EXEC dbo.uspICIncreaseConsignedSaleQty @Items
