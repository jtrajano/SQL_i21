CREATE PROCEDURE [testi21Database].[test uspICCreateGLEntries for allowing a missing Contra Account on Consume]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		SELECT 	intItemId = @StickyGrains
				...
				,dblExchangeRate = 1
				,intTransactionId = 1
				,strTransactionId = 'CONSUME-10001'
				,strBatchId = 'BATCH-000001'
				,intTransactionTypeId = @INVENTORY_TRANSACTION_TYPE_CONSUME
