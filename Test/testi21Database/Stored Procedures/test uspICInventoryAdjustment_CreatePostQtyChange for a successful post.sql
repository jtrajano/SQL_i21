CREATE PROCEDURE [testi21Database].[test uspICInventoryAdjustment_CreatePostQtyChange for a successful post]
AS
BEGIN 
	...
	BEGIN 
		...
		SELECT 
			...
			,strLotNumber		= @MG_LOT_100001
			,dblQty				= 1000.00 - 100
			,dblWeight			= 55115.50 - (55.1155 * 100)
