CREATE PROCEDURE [testi21Database].[test uspICIncreaseStockInLIFOStorage from positive to positive]
AS
BEGIN
	-- Arrange 
	BEGIN 
	...
	BEGIN 
		...
		SELECT	[intItemId] = @PremiumGrains
				...
				/***************************************************************************************************************************************************************************************************************
				The following are the expected records. Here is how it should look like: 
