CREATE PROCEDURE [testi21Database].[test uspICInventoryAdjustment_CreatePostExpiryDateChange for invalid lot id]
AS
BEGIN 
	...
	BEGIN 
		EXEC tSQLt.ExpectException 
			@ExpectedErrorNumber = 51053			
	END 

	-- Act
	BEGIN 
		EXEC dbo.uspICInventoryAdjustment_CreatePostExpiryDateChange	
			...
			,@strLotNumber					= @Invalid_Lot		-- Invalid lot id
