CREATE PROCEDURE [testi21Database].[test uspICPostStorage for non-supported costing method]
AS
...
--			@ExpectedMessage = 'Storage or storage for WET GRAINS is not yet supported. It is currently limited to lot-tracked items.'
--	END 
