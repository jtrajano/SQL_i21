CREATE PROCEDURE [testi21Database].[test uspICPostCostAdjustment, Receive Stocks, Cost Adjust]
AS
BEGIN
	...
	-- Get the actual data/result	
	BEGIN 
		-- Get the actualInventoryTransaction data 
		...
		-- Get the actual FIFO Cost Adjustment Log
	...
	BEGIN 
		...
		-- Setup the expected FIFO Cost Adjustment Log
