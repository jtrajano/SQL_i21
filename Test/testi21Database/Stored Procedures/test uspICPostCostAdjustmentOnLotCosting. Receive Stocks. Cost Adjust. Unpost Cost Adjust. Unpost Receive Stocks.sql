CREATE PROCEDURE [testi21Database].[test uspICPostCostAdjustmentOnLotCosting. Receive Stocks. Cost Adjust. Unpost Cost Adjust. Unpost Receive Stocks]
AS
BEGIN
	...
	-- Act 3: Unpost Inventory Receipt 
	BEGIN 
		-- Unpost the receipt 
