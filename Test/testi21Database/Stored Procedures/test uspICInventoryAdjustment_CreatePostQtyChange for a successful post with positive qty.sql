CREATE PROCEDURE [testi21Database].[test uspICInventoryAdjustment_CreatePostQtyChange for a successful post with positive qty]
AS
BEGIN 
	...
	BEGIN 
		...
		SELECT 
				...
				,dblQuantity					= 1000.00
				,dblNewQuantity					= 1025.00
				,dblAdjustByQuantity			= 25
				,intItemUOMId					= @ManualGrains_25KgBagUOM
				,dblWeight						= 55.1155 * 25
