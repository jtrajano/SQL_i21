CREATE PROCEDURE testi21Database.[test fnGetItemCostingOnUnpostErrors if it blocks negative stock on lot items from an empty stock uom table]
AS 
BEGIN
	-- Arrange
	BEGIN 
		...
		SELECT	intItemId = @ManualLotGrains
				...
				,strText = FORMATMESSAGE(80003, 'MANUAL LOT GRAINS')
				,intErrorCode = 80003	
