CREATE PROCEDURE [testi21Database].[test uspICIncreaseInTransitInBoundQty and Stock UOM for decrease qty]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		BEGIN 
			...
			INSERT INTO dbo.tblICItemStock (intItemId, intItemLocationId, dblInTransitInbound) VALUES (@WetGrains, @Default_Location, 100)
			INSERT INTO dbo.tblICItemStock (intItemId, intItemLocationId, dblInTransitInbound) VALUES (@StickyGrains, @Default_Location, 150)
			INSERT INTO dbo.tblICItemStock (intItemId, intItemLocationId, dblInTransitInbound) VALUES (@PremiumGrains, @Default_Location, 200)
			INSERT INTO dbo.tblICItemStock (intItemId, intItemLocationId, dblInTransitInbound) VALUES (@ColdGrains, @Default_Location, 250)
			INSERT INTO dbo.tblICItemStock (intItemId, intItemLocationId, dblInTransitInbound) VALUES (@HotGrains, @Default_Location, 300)
