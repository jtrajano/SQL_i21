CREATE PROCEDURE [testi21Database].[test uspICReduceStockInLIFOCustody is successful with positive stock]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		-- Create a fake data for tblICInventoryLIFOInCustody
			/***************************************************************************************************************************************************************************************************************
			The initial data in tblICInventoryLIFOInCustody
	...
	BEGIN 
		...
		-- Repeat call on uspICReduceStockInLIFOCustody until @dblReduceQty is completely distributed to all the available LIFO buckets
		...
		BEGIN
			...
			EXEC [dbo].[uspICReduceStockInLIFOCustody]
				...
				,@RemainingQty OUTPUT
				,@CostUsed OUTPUT 
				,@SourceInventoryLIFOInCustodyId OUTPUT 
			...
			BEGIN 
				...
				-- LIFO id is 6
				EXEC tSQLt.AssertEquals 6, @SourceInventoryLIFOInCustodyId; 
			END
			...
			BEGIN 
				...
				-- LIFO id is 5
				EXEC tSQLt.AssertEquals 5, @SourceInventoryLIFOInCustodyId; 
			END
			...
			BEGIN 
				...
				-- LIFO id is 4
				EXEC tSQLt.AssertEquals 4, @SourceInventoryLIFOInCustodyId; 
			END
			...
			BEGIN 
				...
				-- LIFO id is 3
				EXEC tSQLt.AssertEquals 3, @SourceInventoryLIFOInCustodyId; 
			END
			...
			BEGIN 
				...
				-- LIFO id is 2
				EXEC tSQLt.AssertEquals 2, @SourceInventoryLIFOInCustodyId; 
			END
			...
			BEGIN 
				...
				-- LIFO id is 1
				EXEC tSQLt.AssertEquals 1, @SourceInventoryLIFOInCustodyId;
			END
