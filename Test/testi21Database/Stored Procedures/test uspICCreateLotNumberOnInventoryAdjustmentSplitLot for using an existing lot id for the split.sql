CREATE PROCEDURE [testi21Database].[test uspICCreateLotNumberOnInventoryAdjustmentSplitLot for using an existing lot id for the split]
AS
BEGIN
	-- Item Ids
	...
	BEGIN 
		...
		DECLARE @intTransactionId AS INT = 13 -- ADJ-13
		...
		SELECT	intInventoryAdjustmentId = @intTransactionId
				,intInventoryAdjustmentDetailId = 12
				,intItemId = @ManualLotGrains
				,intLotId = @ManualLotGrains_Lot_100001
				,intNewLotId = @ManualLotGrains_Lot_100003
