CREATE PROCEDURE [testi21Database].[test uspICPostInventoryAdjustmentItemChange for validating the company location]
AS
BEGIN
	-- Item Ids
	...
	BEGIN 
		...
		SET		intAdjustmentType = @ADJUSTMENT_TYPE_ItemChange
