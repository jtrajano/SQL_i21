CREATE PROCEDURE [testi21Database].[test uspICPostCostAdjustmentOnLIFOCosting, Receive Stocks, Cost Adjust]
AS
BEGIN
	...
	BEGIN
		...
		EXEC tSQLt.AssertEqualsTable 'expectedInventoryLIFOCostAdjustmentLog', 'actualInventoryLIFOCostAdjustmentLog', 'Failed to create the expected LIFO Cost Adjustment Lot.'
	END 
