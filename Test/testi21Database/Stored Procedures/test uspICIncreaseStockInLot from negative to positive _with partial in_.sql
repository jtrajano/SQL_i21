CREATE PROCEDURE [testi21Database].[test uspICIncreaseStockInLot from negative to positive (with partial in)]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		-- Create a fake data for tblICInventoryLot
			...
			----------- ----------------- --------	--------------	--------------	-----------	---------------- ----------------
			3           3                 12345		77.000000		25.000000		13.000000	1                1
			3           3                 12345		0.000000		56.000000		14.000000	1                1
			3           3                 12345		0.000000		30.000000		15.000000	1                1
			3           3                 12345		25.000000		25.000000		14.750000	1                1
			***************************************************************************************************************************************************************************************************************/
		...
		DECLARE @intItemId AS INT					= @PremiumGrains
				...
				,@dtmDate AS DATETIME				= '01/05/2014'
				...
				,@intTransactionId AS INT			= 5
				,@intTransactionDetailId AS INT		= 5
		...
		-----	----------- ----------------- --------	--------------	--------------	-----------	---------------- ----------------
		upt		3           3                 12345		77.000000		25.000000		13.000000	1                1
		upt		3           3                 12345		56.000000		56.000000		14.000000	1                1
		upt		3           3                 12345		30.000000		30.000000		15.000000	1                1
				3           3                 12345		25.000000		25.000000		14.750000	1                1
		new		3           3                 12345		200.000000		86.000000		22.050000	1                1
		***************************************************************************************************************************************************************************************************************/								
	END 
	...
	BEGIN 
		...
		-- Repeat call on uspICReduceStockInLot until @dblQty is completely distributed to all the available Lot buckets
		...
		-- Assert the new Lot id is 5
		EXEC tSQLt.AssertEquals 5, @NewLotId
		
		-- Assert that it only takes 3 iterations to complete the job
