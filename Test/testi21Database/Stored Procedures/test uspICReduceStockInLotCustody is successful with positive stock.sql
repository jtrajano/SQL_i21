CREATE PROCEDURE [testi21Database].[test uspICReduceStockInLotCustody is successful with positive stock]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		***************************************************************************************************************************************************************************************************************/
		...
		-- Create the variables used by uspICReduceStockInLotCustody
	...
	BEGIN 
		...
		-- Repeat call on uspICReduceStockInLotCustody until @dblReduceQty is completely distributed to all the available Lot buckets
