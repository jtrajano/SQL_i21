CREATE PROCEDURE [testi21Database].[test uspICPostInventoryAdjustmentLotStatusChange on adjusting the lot status]
AS
BEGIN
	-- Item Ids
	...
	BEGIN 
		...
		DECLARE @intTransactionId AS INT = 4 -- For ADJ-4
				,@ysnPost AS BIT = 1
