CREATE PROCEDURE [testi21Database].[test uspICPostStorage for calling uspICPostLotStorage]
AS
-- Fake data Variables
BEGIN
...
BEGIN
	...
	BEGIN 
		...
		-- Add a spy for uspICPostLotStorage
		EXEC tSQLt.SpyProcedure 'dbo.uspICPostLotStorage';	
	...
	-- Assert 
	BEGIN 
		EXEC tSQLt.AssertObjectExists 'uspICPostLotStorage_SpyProcedureLog'
	END 
END 
