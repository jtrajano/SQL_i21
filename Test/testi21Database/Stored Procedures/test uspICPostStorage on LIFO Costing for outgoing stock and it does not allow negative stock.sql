CREATE PROCEDURE [testi21Database].[test uspICPostStorage on LIFO Costing for outgoing stock and it does not allow negative stock]
AS
...
BEGIN
	...
	BEGIN 
		EXEC tSQLt.ExpectException
			@ExpectedMessage = 'Negative stock quantity is not allowed for WET GRAINS in BETTER HAVEN.'
