CREATE PROCEDURE [testi21Database].[test uspICInventoryAdjustmentGetOutdatedExpiryDate for error 80028]
AS
BEGIN
	...
	-- Assert 
	BEGIN 
		EXEC tSQLt.ExpectException @ExpectedErrorNumber = 80028;
	END
