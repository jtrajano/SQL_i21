CREATE PROCEDURE [testi21Database].[test uspICAddSalesOrderToInventoryShipment on converting an SO into Inventory Shipment and it excludes non-stock types]
AS
BEGIN
	-- Arrange 
	BEGIN 
