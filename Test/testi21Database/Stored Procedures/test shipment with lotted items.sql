CREATE PROCEDURE testi21Database.[test shipment with lotted items]
AS
BEGIN
	...
	FROM tblICInventoryShipmentItem i
		INNER JOIN tblICInventoryShipmentItemLot l ON l.intInventoryShipmentItemId = i.intInventoryShipmentItemId
		INNER JOIN tblICInventoryShipment s ON s.intInventoryShipmentId = i.intInventoryShipmentId
