CREATE PROCEDURE [testi21Database].[test uspICCreateGLEntriesOnCostAdjustment for Revalue Build Assembly]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		SELECT 	intItemId = @StickyGrains
				...
				,intTransactionTypeId = @INV_TRANS_TYPE_Revalue_Build_Assembly
				,intLotId = NULL 
		...
		SELECT	
			...
			,strTransactionId			= 'BL-00001'
			,intTransactionId			= 1
			,strTransactionType			= @AccountCategory_Revalue_Build_Assembly
			,strTransactionForm			= 'Bill'
