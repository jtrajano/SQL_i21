CREATE PROCEDURE [testi21Database].[test uspICCreateGLEntries for allowing a missing Contra Account on Inventory Transfer]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		SELECT 	intItemId = @StickyGrains
				...
				,intTransactionTypeId = @INVENTORY_TRANSACTION_TYPE_INVENTORY_TRANSFER
