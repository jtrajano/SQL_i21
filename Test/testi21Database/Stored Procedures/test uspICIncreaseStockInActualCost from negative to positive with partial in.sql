CREATE PROCEDURE [testi21Database].[test uspICIncreaseStockInActualCost from negative to positive with partial in]
AS
BEGIN
	-- Arrange 
	BEGIN 
	...
	BEGIN 
		...
		-- Repeat call on uspICReduceStockInActualCost until @dblQty is completely distributed to all the available ActualCost buckets
		...
		BEGIN 		
			...
			BEGIN 
				...
				EXEC tSQLt.AssertEquals 4, @UpdatedActualCostId
			END 
		...
		-- Assert the new ActualCost id is 5
		EXEC tSQLt.AssertEquals 5, @NewActualCostId
