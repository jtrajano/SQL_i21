CREATE PROCEDURE [testi21Database].[test uspICPostInventoryReceiptOtherCharges for ysnPrice scenario 2]
AS
...
BEGIN
	...
	BEGIN 
		...
		EXEC tSQLt.ExpectException @ExpectedMessage = 'The Other Charges is shouldered by the receipt vendor and can''t be added to the item cost. Please correct the Price or Inventory Cost checkbox.'
	END 
