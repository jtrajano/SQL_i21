CREATE PROCEDURE [testi21Database].[test uspICPostCostAdjustmentOnLotCosting. Receive Stocks. Cost Adjust. Unpost Cost Adjust]
AS
BEGIN
	...
	BEGIN 
		-- After unposting the cost adjustment, it should return back to $22.00 
	...
	BEGIN
		...
		EXEC tSQLt.AssertEqualsTable 'expectedInventoryLotCostAdjustmentLog', 'actualInventoryLotCostAdjustmentLog', 'Adjustment Log '
