CREATE PROCEDURE [testi21Database].[test uspICPostInventoryAdjustment for the transaction type  - lot merge]
AS
BEGIN
	...
	-- Arrange 
	BEGIN 
		DECLARE @strTransactionTypeName AS NVARCHAR(50) = 'Inventory Adjustment - Lot Merge'
				,@intTransactionTypeId AS INT 
				,@ExpectedTransactionTypeId AS INT = @INVENTORY_ADJUSTMENT_LotMerge
	END 
