CREATE PROCEDURE [testi21Database].[test uspICReduceStockInLIFOStorage to failed for negative stock]
AS
BEGIN
	-- Arrange 
	BEGIN 
	...
	BEGIN 
		...
		BEGIN
			...
			EXEC [dbo].[uspICReduceStockInLIFOStorage]
				...
				,@RemainingQty OUTPUT
				,@CostUsed OUTPUT 
				,@SourceInventoryLIFOStorageId OUTPUT 
			...
			BEGIN 
				...
				-- LIFO id is 6
				EXEC tSQLt.AssertEquals 6, @SourceInventoryLIFOStorageId; 
			END
			...
			BEGIN 
				...
				-- LIFO id is 5
				EXEC tSQLt.AssertEquals 5, @SourceInventoryLIFOStorageId; 
			END
			...
			BEGIN 
				...
				-- LIFO id is 4
				EXEC tSQLt.AssertEquals 4, @SourceInventoryLIFOStorageId; 
			END
			...
			BEGIN 
				...
				-- LIFO id is 3
				EXEC tSQLt.AssertEquals 3, @SourceInventoryLIFOStorageId; 
			END
			...
			BEGIN 
				...
				-- LIFO id is 2
				EXEC tSQLt.AssertEquals 2, @SourceInventoryLIFOStorageId; 
			END
			...
			BEGIN 
				...
				-- LIFO id is 1
				EXEC tSQLt.AssertEquals 1, @SourceInventoryLIFOStorageId;
			END
