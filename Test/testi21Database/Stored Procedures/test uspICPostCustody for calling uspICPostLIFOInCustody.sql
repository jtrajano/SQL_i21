CREATE PROCEDURE [testi21Database].[test uspICPostCustody for calling uspICPostLIFOInCustody]
AS
-- Fake data Variables
BEGIN
...
BEGIN
	...
	BEGIN 
		...
		-- Add a spy for uspICPostLIFOInCustody
		EXEC tSQLt.SpyProcedure 'dbo.uspICPostLIFOInCustody';		
	...
	-- Assert 
	BEGIN 
		EXEC tSQLt.AssertObjectExists 'uspICPostLIFOInCustody_SpyProcedureLog'
	END 
END 
