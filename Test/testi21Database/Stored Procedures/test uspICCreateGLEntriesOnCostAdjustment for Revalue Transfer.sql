CREATE PROCEDURE [testi21Database].[test uspICCreateGLEntriesOnCostAdjustment for Revalue Transfer]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		DECLARE @AccountCategory_Inventory AS NVARCHAR(30) = 'Inventory'
				...
				,@AccountCategory_Revalue_Transfer AS NVARCHAR(30) = 'Revalue Transfer'
		...
		SELECT 	intItemId = @StickyGrains
				...
				,intTransactionTypeId = @INV_TRANS_TYPE_Revalue_Transfer
				,intLotId = NULL 
		...
		SELECT	
			...
			,strTransactionId			= 'BL-00001'
			,intTransactionId			= 1
			,strTransactionType			= @AccountCategory_Revalue_Transfer
			,strTransactionForm			= 'Bill'
