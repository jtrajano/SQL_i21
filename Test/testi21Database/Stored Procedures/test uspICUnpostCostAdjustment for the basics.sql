CREATE PROCEDURE [testi21Database].[test uspICUnpostCostAdjustment for the basics]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		-- Declare the variables used by uspICUnpostCostAdjustment
	...
	-- Act
	BEGIN 	
		-- Call uspICUnpostCostAdjustment to post the costing and generate the g/l entries 
		INSERT INTO actual 
