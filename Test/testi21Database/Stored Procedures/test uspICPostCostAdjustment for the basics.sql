CREATE PROCEDURE [testi21Database].[test uspICPostCostAdjustment for the basics]
AS
BEGIN
	-- Arrange 
	BEGIN 
	...
	-- Act
	BEGIN 	
		-- Call uspICPostCostAdjustment to post the costing and generate the g/l entries 
		INSERT INTO actual 
