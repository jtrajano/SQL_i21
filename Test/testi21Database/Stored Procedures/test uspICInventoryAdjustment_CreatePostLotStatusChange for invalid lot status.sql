CREATE PROCEDURE [testi21Database].[test uspICInventoryAdjustment_CreatePostLotStatusChange for invalid lot status]
AS
BEGIN 
	...
	-- Assert 
	BEGIN 
		EXEC tSQLt.ExpectException @ExpectedErrorNumber = 51118			
	END 
