CREATE PROCEDURE [testi21Database].[test uspICIncreaseStockInFIFOStorage from zero to positive]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		-- Create the variables used by uspICIncreaseStockInFIFOStorage
	...
	-- Assert
	BEGIN 
		-- Assert that it created the correct fifo id in Storage id. 
		EXEC tSQLt.AssertEquals 1, @NewFifoStorageId;
