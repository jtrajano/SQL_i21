CREATE PROCEDURE [testi21Database].[test uspICUnpostFIFOOutFromCustody for the basics]
AS
BEGIN 
...
BEGIN
	...
	-- Act
	BEGIN 
		-- Call the uspICUnpostFIFOOutFromCustody
		DECLARE @strTransactionId AS NVARCHAR(20) 
		DECLARE @intTransactionId AS INT 
				
		EXEC dbo.uspICUnpostFIFOOutFromCustody @strTransactionId, @intTransactionId
