CREATE PROCEDURE [testi21Database].[test uspICIncreaseReservedQty and Stock UOM for decrease of reserved qty]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		BEGIN 
			...
			INSERT INTO dbo.tblICItemStock (intItemId, intItemLocationId, dblUnitReserved) VALUES (@WetGrains, @Default_Location, 100)
			INSERT INTO dbo.tblICItemStock (intItemId, intItemLocationId, dblUnitReserved) VALUES (@StickyGrains, @Default_Location, 150)
			INSERT INTO dbo.tblICItemStock (intItemId, intItemLocationId, dblUnitReserved) VALUES (@PremiumGrains, @Default_Location, 200)
			INSERT INTO dbo.tblICItemStock (intItemId, intItemLocationId, dblUnitReserved) VALUES (@ColdGrains, @Default_Location, 250)
			INSERT INTO dbo.tblICItemStock (intItemId, intItemLocationId, dblUnitReserved) VALUES (@HotGrains, @Default_Location, 300)
