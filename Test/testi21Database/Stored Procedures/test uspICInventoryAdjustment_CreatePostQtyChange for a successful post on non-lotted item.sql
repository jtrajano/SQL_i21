CREATE PROCEDURE [testi21Database].[test uspICInventoryAdjustment_CreatePostQtyChange for a successful post on non-lotted item]
AS
BEGIN 
	...
	BEGIN 
		EXEC dbo.uspICInventoryAdjustment_CreatePostQtyChange	
			...
			,@dblAdjustByQuantity			= 10
			,@dblNewUnitCost				= 12.25
			,@intItemUOMId					= @WetGrains_10LbBagUOM
