CREATE PROCEDURE [testi21Database].[test uspICUnpostLIFOInFromStorage for sell-add-unpost add]
AS
BEGIN 
...
BEGIN
	...
	BEGIN 
		...
		INSERT INTO tblICInventoryLIFOStorageOut (
