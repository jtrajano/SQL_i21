CREATE PROCEDURE [testi21Database].[test uspICPostStorage on LIFO Costing for two incoming stock]
AS
...
BEGIN
	...
	BEGIN 
		...
		SELECT intItemId, intItemLocationId, intItemUOMId, dtmDate, dblStockIn, dblStockOut, dblCost INTO expected FROM dbo.tblICInventoryLIFOStorage WHERE 1 = 0		
		SELECT intItemId, intItemLocationId, intItemUOMId, dtmDate, dblStockIn, dblStockOut, dblCost INTO actual FROM dbo.tblICInventoryLIFOStorage WHERE 1 = 0
