CREATE PROCEDURE [testi21Database].[test uspICGetItemsFromItemShipment for getting data from the shipment]
AS
BEGIN
	-- Fake data
	BEGIN 
	...
	-- Arrange 
	BEGIN 
		DECLARE @intShipmentId AS INT = 1 -- INVRCPT-XXXXX1. It has all kinds of items on it. 
