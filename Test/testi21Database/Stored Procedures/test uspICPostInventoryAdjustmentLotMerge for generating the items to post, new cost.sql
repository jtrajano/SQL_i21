CREATE PROCEDURE [testi21Database].[test uspICPostInventoryAdjustmentLotMerge for generating the items to post, new cost]
AS
BEGIN
	-- Item Ids
	...
	BEGIN 
		...
		DECLARE @intTransactionId AS INT = 8
		...
		SELECT	
				...
				,intItemLocationId		= @ManualLotGrains_DefaultLocation
				,intItemUOMId			= @ManualGrains_PoundUOM -- Stored in LB because LB is the weight of the Lot. 
				,dtmDate				= '05/18/2015'
				,dblQty					= 500 * @25KgBagUnitQty -- bags x unit qty. 
