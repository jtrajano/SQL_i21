CREATE PROCEDURE [testi21Database].[test uspICPostCostAdjustmentOnActualCosting, Receive Stocks, Cost Adjust]
AS
BEGIN
	...
	BEGIN
		...
		EXEC tSQLt.AssertEqualsTable 'expectedInventoryActualCostAdjustmentLog', 'actualInventoryActualCostAdjustmentLog', 'Failed to create the expected Actual Cost Adjustment Lot.'
	END 
