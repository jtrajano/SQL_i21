CREATE PROCEDURE [testi21Database].[test uspICIncreaseConsignedPurchaseQty for decrease in consigned purchase qty on multiple items]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		CREATE TABLE expected (
			...
			,dblConsignedPurchase NUMERIC(18,6)
		)
		...
		SELECT	intItemId = @WetGrains
				...
				,dblConsignedPurchase = 0 -- It should never go down to -450. When it goes negative, the order qty is set to zero. 
	...
	-- Act
	BEGIN 
		EXEC dbo.uspICIncreaseConsignedPurchaseQty @Items
