CREATE PROCEDURE testi21Database.[test fnGetItemGLAccount function for getting the gl account from item level]
AS 
BEGIN
	...
	BEGIN 	
		...
		SELECT	[Inventory] = [dbo].[fnGetItemGLAccount](@WetGrains, @WetGrains_DefaultLocation, 'Inventory')
				,[ContraInventory] = [dbo].[fnGetItemGLAccount](@WetGrains, @WetGrains_DefaultLocation, 'Cost of Goods')
				,[RevalueSold] = NULL 
				,[WriteOffSold] = NULL 
				,[AutoNegative] = NULL 	
	END
