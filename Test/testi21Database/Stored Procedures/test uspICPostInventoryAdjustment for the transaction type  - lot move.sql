CREATE PROCEDURE [testi21Database].[test uspICPostInventoryAdjustment for the transaction type  - lot move]
AS
BEGIN
	...
	-- Arrange 
	BEGIN 
		DECLARE @strTransactionTypeName AS NVARCHAR(50) = 'Inventory Adjustment - Lot Move'
				,@intTransactionTypeId AS INT 
				,@ExpectedTransactionTypeId AS INT = @INVENTORY_ADJUSTMENT_LotMove
	END 
