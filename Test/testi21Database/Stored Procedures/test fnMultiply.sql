...
BEGIN
	...
	BEGIN 
		...
		SET @y = 0.00900000000000000000 
		SET @expected = -0.0056562755830 -- -0.00565627558257816300 
		SELECT @result = dbo.fnMultiply(@x, @y)
	...
	BEGIN 
		...
		SET @y = 50.00000000000000000000 
		SET @expected = 28.3494925440830 -- 28.34949254408345000000 
		SELECT @result = dbo.fnMultiply(@x, @y)
	...
	BEGIN 
		...
		SET @expected = 12564.3660714285710 -- 12564.36607142857127825000 
		SELECT @result = dbo.fnMultiply(@x, @y)
