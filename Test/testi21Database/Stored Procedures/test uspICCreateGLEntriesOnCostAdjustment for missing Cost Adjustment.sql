CREATE PROCEDURE [testi21Database].[test uspICCreateGLEntriesOnCostAdjustment for missing Cost Adjustment]
AS
BEGIN
	-- Arrange 
	BEGIN 
	...
	DECLARE @INV_TRANS_TYPE_Auto_Negative AS INT = 1
		...
		-- Delete Cost Adjustment from the G/L account setup to simulate a missing account id
		DELETE	ItemAccount
		...
		WHERE	GLAccountCategory.strAccountCategory = @AccountCategory_Cost_Adjustment
	END 
