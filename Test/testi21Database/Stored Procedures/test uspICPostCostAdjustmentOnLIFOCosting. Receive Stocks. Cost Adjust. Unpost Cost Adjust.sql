CREATE PROCEDURE [testi21Database].[test uspICPostCostAdjustmentOnLIFOCosting. Receive Stocks. Cost Adjust. Unpost Cost Adjust]
AS
BEGIN
	...
	BEGIN 
		...
		-- Do the unpost of the cost adjustment
	...
	BEGIN
		...
		EXEC tSQLt.AssertEqualsTable 'expectedInventoryLIFOCostAdjustmentLog', 'actualInventoryLIFOCostAdjustmentLog', 'Adjustment Log '
