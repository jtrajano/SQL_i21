CREATE PROCEDURE [testi21Database].[test uspICUnpostLotInFromStorage for sell-add-unpost add]
AS
BEGIN
	...
	BEGIN 
		...
		SELECT
				...
				,intTransactionDetailId			= NULL 
				,strTransactionId				= 'InvRcpt-0000001'
				,intInventoryCostBucketStorageId		= 2
	...
	BEGIN 
		...
		WHERE	intLotId = 12345

		EXEC tSQLt.AssertEqualsTable 'expectedLotStorage', 'actualLotStorage', 'Failed to generate the expected lot cost bucket.';
	END  
