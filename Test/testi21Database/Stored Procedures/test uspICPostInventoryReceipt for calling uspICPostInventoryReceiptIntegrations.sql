CREATE PROCEDURE [testi21Database].[test uspICPostInventoryReceipt for calling uspICPostInventoryReceiptIntegrations]
AS
BEGIN
	-- Arrange 
	BEGIN 
	...
	-- Assert 
	BEGIN 
		EXEC tSQLt.AssertObjectExists 'uspICPostInventoryReceiptIntegrations_SpyProcedureLog'
	END 
