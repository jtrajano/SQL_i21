CREATE PROCEDURE testi21Database.[test fnGetItemGLAccount function for getting the gl account from commodity]
AS 
BEGIN
	...
	BEGIN 	
		...
		SELECT	[Inventory] = [dbo].[fnGetItemGLAccount](@CornCommodity, @CornCommodity_DefaultLocation, 'Inventory')
				,[ContraInventory] = [dbo].[fnGetItemGLAccount](@CornCommodity, @CornCommodity_DefaultLocation, 'Cost of Goods')
				,[RevalueSold] = [dbo].[fnGetItemGLAccount](@CornCommodity, @CornCommodity_DefaultLocation, 'Revalue Sold')
				,[WriteOffSold] = NULL 
				,[AutoNegative] = NULL 			
	END 
	...
	BEGIN 
		...
		SELECT				
			...
			,[RevalueSold] = @RevalueSold_Default
			,[WriteOffSold] = NULL
			,[AutoNegative] = NULL
