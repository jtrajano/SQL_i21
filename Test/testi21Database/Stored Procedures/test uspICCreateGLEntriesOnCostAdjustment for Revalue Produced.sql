CREATE PROCEDURE [testi21Database].[test uspICCreateGLEntriesOnCostAdjustment for Revalue Produced]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		SELECT 	intItemId = @StickyGrains
				...
				,intTransactionTypeId = @INV_TRANS_TYPE_Revalue_Produced
				,intLotId = NULL 
		...
		SELECT	
			...
			,strTransactionId			= 'BL-00001'
			,intTransactionId			= 1
			,strTransactionType			= @AccountCategory_Revalue_Produced
			,strTransactionForm			= 'Bill'
