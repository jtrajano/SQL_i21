CREATE PROCEDURE [testi21Database].[test uspICIncreaseInTransitInBoundQty for the basics]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		CREATE TABLE expected (
			...
			,dblInTransitInbound NUMERIC(18,6)
		)
	...
	-- Act
	BEGIN 
		EXEC dbo.uspICIncreaseInTransitInBoundQty @Items
