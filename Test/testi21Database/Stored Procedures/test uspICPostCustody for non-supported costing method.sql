CREATE PROCEDURE [testi21Database].[test uspICPostCustody for non-supported costing method]
AS
...
BEGIN
	...
	BEGIN
		EXEC tSQLt.ExpectException
			@ExpectedMessage = 'Custody or storage for WET GRAINS is not yet supported. It is currently limited to lot-tracked items.'
	END 
