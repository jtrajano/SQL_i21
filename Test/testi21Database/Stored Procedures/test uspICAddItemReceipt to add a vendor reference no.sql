CREATE PROCEDURE [testi21Database].[test uspICAddItemReceipt to add a vendor reference no]
AS
BEGIN
	-- Fake data
	BEGIN 
	...
	BEGIN
		...
		DECLARE @strVendorRefNo AS NVARCHAR(50)
		SELECT	@strVendorRefNo = tblICInventoryReceipt.strVendorRefNo
		...
		EXEC tSQLt.AssertEquals '23', @strVendorRefNo, 'Vendor Reference No. does not match.'
	END 
