CREATE TABLE [dbo].[tblIPStockArchive]
(
	...
	ysnDeadlockError BIT CONSTRAINT [DF_tblIPStockArchive_ysnDeadlockError] DEFAULT 0
	CONSTRAINT [PK_tblIPStockArchive_intStageStockId] PRIMARY KEY ([intStageStockId]) 
)
