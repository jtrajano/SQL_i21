...
SELECT     
	...
	,[intSalesAccountId]				= ISNULL([dbo].[fnGetGLAccountIdFromProfitCenter](ISNULL(dbo.fnGetItemGLAccount(I.[intItemId], IL.[intItemLocationId], N'Sales Account'), NULLIF(dbo.fnGetItemBaseGLAccount(I.[intItemId], IL.[intItemLocationId], N'Sales Account'), 0)), SMCL.[intProfitCenter]), ISNULL(dbo.fnGetItemGLAccount(I.[intItemId], IL.[intItemLocationId], N'Sales Account'), NULLIF(dbo.fnGetItemBaseGLAccount(I.[intItemId], IL.[intItemLocationId], N'Sales Account'), 0)))
