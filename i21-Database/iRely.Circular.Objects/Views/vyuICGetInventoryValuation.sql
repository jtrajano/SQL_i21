...
FROM 	tblICItem i 
		...
		LEFT JOIN tblGRSettleStorage settleStorage2 
			ON settleStorage2.intSettleStorageId = t.intTransactionId
			AND settleStorage2.intSettleStorageId = t.intTransactionDetailId
