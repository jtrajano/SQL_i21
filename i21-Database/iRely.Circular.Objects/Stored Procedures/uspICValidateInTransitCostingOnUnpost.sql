...
CREATE PROCEDURE [dbo].[uspICValidateInTransitCostingOnUnpost]
	@ItemsInTransitToValidate UnpostItemsTableType READONLY
	,@ysnRecap BIT = 0 
...
FROM	@ItemsInTransitToValidate Item CROSS APPLY dbo.fnGetItemInTransitCostingOnUnpostErrors(
			Item.intItemId
