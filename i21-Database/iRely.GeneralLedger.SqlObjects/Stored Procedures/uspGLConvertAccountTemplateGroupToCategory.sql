CREATE PROCEDURE [dbo].[uspGLConvertAccountTemplateGroupToCategory]
AS
...
BEGIN
	...
	FROM tblGLCOATemplateDetail s join @tmpTbl1 b
	...
	WHERE s.intAccountCategoryId IS NULL AND t.strType = 'Primary'
