CREATE TABLE [dbo].[tblCCImportSiteHeader]
(
	[intImportSiteHeaderId] INT NOT NULL IDENTITY,
	...
	CONSTRAINT [PK_tblCCImportSiteHeader] PRIMARY KEY ([intImportSiteHeaderId])
