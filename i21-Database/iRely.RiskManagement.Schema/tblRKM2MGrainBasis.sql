...
(
	...
	CONSTRAINT [FK_tblRKM2MGrainBasis_tblSMCompanyLocation_intCompanyLocationId] FOREIGN KEY(intCompanyLocationId)REFERENCES [dbo].[tblSMCompanyLocation] (intCompanyLocationId)
)