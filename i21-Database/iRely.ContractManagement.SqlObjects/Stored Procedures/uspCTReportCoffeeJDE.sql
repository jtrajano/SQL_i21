CREATE PROCEDURE [dbo].[uspCTReportCoffeeJDE]
...
BEGIN TRY
	...
	SELECT @intScreenId=intScreenId FROM tblSMScreen WHERE ysnApproval=1 AND strNamespace='ContractManagement.view.Contract'
