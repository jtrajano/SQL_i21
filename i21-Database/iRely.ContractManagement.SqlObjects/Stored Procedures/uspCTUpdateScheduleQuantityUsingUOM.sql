CREATE PROCEDURE [dbo].[uspCTUpdateScheduleQuantityUsingUOM]
...
BEGIN TRY
	...
	IF NOT EXISTS(SELECT * FROM tblICItemUOM UM
					JOIN tblCTContractDetail CD ON CD.intItemId = UM.intItemId AND UM.intItemUOMId = @intSourceItemUOMId)
	BEGIN
