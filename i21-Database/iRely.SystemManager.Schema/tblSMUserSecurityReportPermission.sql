...
(
    ...
    CONSTRAINT [FK_tblSMUserSecurityReportPermission_tblSMUserSecurity] FOREIGN KEY ([intEntityUserSecurityId]) REFERENCES [tblSMUserSecurity]([intEntityId]) ON DELETE CASCADE, 
...
CREATE INDEX [IX_tblSMUserSecurityReportPermission_intUserSecurityId] ON [dbo].[tblSMUserSecurityReportPermission] ([intEntityUserSecurityId])
