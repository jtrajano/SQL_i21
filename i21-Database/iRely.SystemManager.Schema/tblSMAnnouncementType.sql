CREATE TABLE [dbo].[tblSMAnnouncementType]
(
	...
	CONSTRAINT [PK_tblSMAnnouncementType] PRIMARY KEY CLUSTERED ([intAnnouncementTypeId] ASC),
	CONSTRAINT [UNQ_tblSMAnnouncementType] UNIQUE ([strAnnouncementType])
)
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'tblSMAnnouncementType',
    @level2type = N'COLUMN',
