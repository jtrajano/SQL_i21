...
SELECT
  ...
  dblBasis			=	ROUND(CD.dblBasis,2) ,
  dblFixationPrice	=	ROUND(CD.dblFutures,2),
  ...
  dblFinalPrice		=	ROUND(CD.dblCashPrice,2) ,
  ...
  dblReceivedQty			=	ROUND(Lot.dblOrderQty,2) ,
  dblReceivedUom			=	Um.strUnitMeasure ,
  dblNet					=	ROUND(Lot.dblNet, 2),
