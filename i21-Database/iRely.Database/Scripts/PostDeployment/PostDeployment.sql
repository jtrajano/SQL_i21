...
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateAccountStatusView.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateCommentsView.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateContractView.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateOriginOptionView.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateCTLMSTView.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateItemView.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateInvoiceView.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateLocaleTaxView.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateLocationView.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateCustomerView.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateSalesPersonView.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateTermsView.sql"
:r ".\TM\Integration\dbo\Stored Procedures\TwoPartDeliveryFillReport.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMGetConsumptionWithGasCheck.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMGetConsumptionWithLeakCheck.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMGetConsumptionWithoutLeakCheck.sql"
:r ".\TM\Integration\dbo\Stored Procedures\uspTMGetConsumptionWithoutGasCheck.sql"
:r ".\TM\Integration\dbo\Views\vyuTMOriginDegreeOption.sql"
:r ".\TM\Integration\dbo\Functions\fnTMGetContractForCustomer.sql"

:r ".\TM\Integration\dbo\Stored Procedures\uspTMAlterCobolWrite.sql"
:r ".\TM\2_DataTransferAndCorrection.sql" 
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateBudgetCalculationItemPricingView.sql"
...
:r ".\TM\Integration\dbo\Stored Procedures\uspTMRecreateLeaseSearchView.sql"
:r ".\TM\Integration\dbo\Functions\fnTMGetSpecialPricing.sql"
:r ".\TM\Integration\dbo\Functions\fnTMGetSpecialPricingPrice.sql"
