CREATE PROCEDURE [dbo].[uspAPRptVoucherCheckOffCommodity]
...
BEGIN
--SET @xmlParam = NULL 
	SELECT * FROM [vyuAPRptVoucherCheckOffCommodity] WHERE strDescription = '' --RETURN NOTHING TO RETURN SCHEMA
END
...
SET @query = 'SELECT  
				...
				strDescription
				FROM 
			 [vyuAPRptVoucherCheckOffCommodity]
'
