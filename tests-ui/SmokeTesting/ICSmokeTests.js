...
StartTest(function (t) {
    ...
    engine.start(t)
        ...
        .addFunction(function (next) { commonSM.commonLogin(t, next); }).wait(2000d)
      ...
      /*.waitTillVisible('frmintegrateddashboardgridpanel','Login Successful',60000).wait(1000)*/
        ...
        .openScreen('Inventory Receipts').wait(2000)
        ...
        .checkControlVisible(['#btnNew', '#btnSave', '#btnSearch', '#btnDelete', '#btnUndo','#btnPrint','#btnPrintBOL','#btnShip',
             '#btnRecap','#btnCustomer','#btnWarehouseInstruction','#btnClose'], true).wait(500)
        .checkControlVisible(['#cboOrderType', '#cboSourceType', '#cboCustomer', '#dtmShipDate', '#txtReferenceNumber', '#dtmRequestedArrival',
             '#cboFreightTerms','#txtShipmentNo'], true).wait(500)
        ...
        .checkControlVisible(['#btnOpenActivity', '#btnNewEvent', '#btnNewTask', '#btnNewComment', '#btnLogCall', '#btnSendEmail','#btnGridLayout',
             '#btnInsertCriteria','#txtFilterGrid','#btnMaximizeGrid'], true).wait(500)
        .checkControlVisible(['#btnInsertCriteria', '#txtFilterGrid'], true).wait(500)
        .clickButton('#btnClose').wait(500)
        .checkMessageBox('iRely i21','Do you want to save the changes you made?','yesnocancel','question').wait(1000)
        .clickMessageBoxButton('no').wait(300)
        ...
        .checkControlVisible(['#txtTransferNumber', '#dtmTransferDate', '#cboTransferType', '#cboSourceType', '#cboTransferredBy', '#cboFromLocation',
             '#cboToLocation','#chkShipmentRequired','#cboStatus','#txtDescription'], true).wait(500)
        ...
        .checkControlVisible(['#txtItemNo', '#cboType', '#txtShortName', '#txtDescription', '#cboManufacturer','#cboStatus','#cboCommodity',
             '#cboLotTracking','#cboBrand','#txtModelNo','#cboCategory','#cboTracking'], true).wait(500)
        ...
        .checkControlVisible(['#btnAddLocation', '#btnAddMultipleLocation', '#btnEditLocation', '#btnDeleteLocation', '#cboCopyLocation',
                '#btnGridLayout', '#btnInsertCriteria', '#txtFilterGrid','#btnMaximizeGrid'], true).wait(500)

        .clickTab('#cfgSales').wait(500)
        .checkControlVisible(['#chkStockedItem', '#chkDyedFuel', '#cboBarcodePrint', '#chkMsdsRequired', '#txtEpaNumber',
                '#chkInboundTax', '#chkOutboundTax', '#chkRestrictedChemical','#chkFuelItem'], true).wait(500)
        .checkControlVisible(['#pnlRins', '#cboFuelInspectionFee', '#cboRinRequired', '#cboFuelCategory', '#txtPercentDenaturant'], true).wait(500)
        .checkControlVisible(['#pnlFeed', '#chkTonnageTax', '#chkLoadTracking', '#txtMixOrder', '#chkHandAddIngredients','#cboMedicationTag',
                '#cboIngredientTag','#txtVolumeRebateGroup'], true).wait(500)
        .checkControlVisible(['#cboPhysicalItem', '#chkExtendOnPickTicket', '#chkExportEdi', '#chkHazardMaterial', '#chkMaterialFee','#chkAutoBlend',
            '#txtUserGroupFee','#txtWgtTolerance','#txtOverReceiveTolerance','#txtMaintenanceCalculationMethod','#txtMaintenanceRate'], true).wait(500)
        ...
        .checkControlVisible(['#pnlCommisionDetail', '#chkCommissionable', '#chkSpecialCommission'], true).wait(500)
