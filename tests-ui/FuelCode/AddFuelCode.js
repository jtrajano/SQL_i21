...
StartTest (function (t) {
    ...
    engine.start(t)
        ...
        .checkControlVisible(['#colFuelCode', '#colDescription' ], true)
        .checkControlVisible('#btnDeleteFuelCode', true)
        ...
        .enterGridData('#grdFuelCode', 0, 'colFuelCode', 'fc01').wait(100)
        .enterGridData('#grdFuelCode', 0, 'colDescription', 'fuel code 01').wait(100)
        .enterGridData('#grdFuelCode', 1, 'colFuelCode', 'fc02').wait(100)
        .enterGridData('#grdFuelCode', 1, 'colDescription', 'fuel code 02').wait(100)
...
//        .openScreen('Fuel Code').wait(200)
//        .checkScreenShown ('fuelcode').wait(100)
//        .checkGridData('#grdFuelCode', 0, 'colFuelCode','fc01').wait(100)
//        .checkGridData('#grdFuelCode', 0, 'colDescription','fuel code 01').wait(100)
//        .checkGridData('#grdFuelCode', 1, 'colFuelCode','fc02').wait(100)
//        .checkGridData('#grdFuelCode', 1, 'colDescription','fuel code 02').wait(100)
//
        ...
        .openScreen('Fuel Code').wait(200)
        .checkScreenShown ('fuelcode').wait(100)
        .enterGridData('#grdFuelCode', 2, 'colFuelCode', 'fc03').wait(100)
        .enterGridData('#grdFuelCode', 2, 'colDescription', 'fuel code 03').wait(100)
...
//        .checkControlVisible(['#colFuelCode', '#colDescription' ], true)
        ...
        .checkIfScreenClosed('fuelcode').wait(100) /*issue - FRM-1547*/
//
...
//
        ...
        .openScreen('Fuel Code').wait(200)
        .checkScreenShown ('fuelcode').wait(100)
        .enterGridData('#grdFuelCode', 3, 'colFuelCode', 'fcc03').wait(100)
        .enterGridData('#grdFuelCode', 3, 'colDescription', 'fuel category 04').wait(100)
        ...
        .enterGridData('#grdFuelCode', 3, 'colFuelCode', 'fcc04').wait(100) /* IC-81 */
