...
StartTest (function (t) {
    ...
    engine.start(t)
        ...
        .openScreen('Fuel Tax Class').wait(200)
        .checkScreenShown ('fueltaxclass').wait(100)
        .checkScreenWindow({alias: 'fueltaxclass', title: 'Fuel Tax Class', collapse: true, maximize: true, minimize: false, restore: false, close: true }).wait(100)
        .checkToolbarButton({new: true, save: true, search: true, delete: true, undo: true, close: true}).wait(100)
        /*Control checking*/
        .checkControlVisible(['#txtTaxClassCode','#txtIrsTaxCode','#txtDescription'], true)
        .checkControlVisible(['#btnDeleteProductCode','#txtFilterGrid'],true)
