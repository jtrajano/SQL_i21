...
StartTest (function (t) {
    ...
    engine.start(t)
        ...
        .checkScreenWindow({alias: 'inventoryuom', title: 'Inventory UOM', collapse: true, maximize: true, minimize: false, restore: false, close: true }).wait(100)
        .checkToolbarButton({new: true, save: true, search: true, delete: true, undo: true, close: true}).wait(100) /*issue - IC-20*/
        /*Control checking*/
        .checkControlVisible([
            '#txtUnitMeasure',
            '#txtSymbol',
        ...
        .checkControlVisible(['#btnDeleteConversion', '#txtFilterGrid'],true) /* x button on filter does not have item id*/
