...
StartTest (function (t) {
    ...
    engine.start(t)
        ...
        .checkScreenWindow({alias: 'feedstock', title: 'Feed Stock', collapse: true, maximize: true, minimize: false, restore: false, close: true })
        ...
        .checkControlVisible('#btnDeleteFeedStock', true)
        ...
        .enterGridData('#grdFeedStock', 0, 'colCode', 'fs01').wait(100)
        .enterGridData('#grdFeedStock', 0, 'colDescription', 'feed stock 01').wait(100)
        .enterGridData('#grdFeedStock', 1, 'colCode', 'fs02').wait(100)
        .enterGridData('#grdFeedStock', 1, 'colDescription', 'feed stock 02').wait(100)
