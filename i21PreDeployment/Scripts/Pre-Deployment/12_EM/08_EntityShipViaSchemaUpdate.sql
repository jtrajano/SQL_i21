...
IF NOT EXISTS (SELECT TOP 1 1 FROM tempdb.INFORMATION_SCHEMA.COLUMNS WHERE COLUMN_NAME = ''intEntityId'' AND TABLE_NAME LIKE ''%#TmpShipVia%'')
BEGIN
...
END
	...
	IF NOT EXISTS(SELECT TOP 1 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE [TABLE_NAME] = ''tblSMShipVia'' AND [COLUMN_NAME] = ''intEntityShipViaId'')
	BEGIN
