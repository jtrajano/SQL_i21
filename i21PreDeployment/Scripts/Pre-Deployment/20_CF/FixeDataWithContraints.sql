...
BEGIN
	...
	BEGIN
		update tblCFSiteGroupPriceAdjustment set intSiteGroupId = NULL where intSiteGroupId = 0
	END
	...
	BEGIN
		update tblCFSiteGroupPriceAdjustment set intItemId = NULL where intItemId = 0
	END
