PRINT '********************** BEGIN - Refresh AR Temp Tables for Posting **********************'
GO
...
PRINT ' ********************** END - Refresh AR Temp Tables for Posting  **********************'
GO

PRINT '********************** BEGIN - Refresh AR Temp Tables for Aging Report **********************'
GO
...
PRINT '********************** END - Refresh AR Temp Tables for Aging Report **********************'
GO