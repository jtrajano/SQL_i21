...
IF EXISTS (SELECT TOP 1 1 FROM   sys.objects WHERE  object_id = OBJECT_ID(N'[dbo].[fnTMGetSpecialPricingPriceTable]') AND type IN (N'FN'))
	EXEC('DROP FUNCTION [dbo].[fnTMGetSpecialPricingPriceTable]')
GO 
