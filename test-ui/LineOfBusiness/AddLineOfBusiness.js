...
StartTest (function (t) {
    ...
    engine.start(t)
        ...
        .checkControlVisible(['#colLineOfBusiness'], true)
        ...
        .enterGridData('#grdGridTemplate', 0, 'colLineOfBusiness', 'lob01').wait(100)
        .enterGridData('#grdGridTemplate', 1, 'colLineOfBusiness', 'lob02').wait(100)
        .checkStatusMessage('Edited')
        .clickButton('#btnSave').wait(100)
        .checkStatusMessage('Saved').wait(100)
        .clickButton('#btnClose').wait(100)
        .checkIfScreenClosed('lineofbusiness').wait(100)

//        verify records added
        .openScreen('Line Of Business').wait(200)
        .checkScreenShown ('lineofbusiness').wait(100)
        .checkGridData('#grdGridTemplate', 0, 'colLineOfBusiness','lob02')
//        .checkGridData('#grdGridTemplate', 1, 'colLineOfBusiness','lob01')
        .checkStatusMessage('Ready')
        .clickButton('#btnClose').wait(100)
        .checkIfScreenClosed('lineofbusiness').wait(100)
        ...
        .openScreen('Line Of Business').wait(200)
        .checkScreenShown ('lineofbusiness').wait(100)
        .enterGridData('#grdGridTemplate', 2, 'colLineOfBusiness', 'lob03').wait(100)
         .clickButton('#btnClose').wait(100)
...
//        Verify record added
        ...
        .openScreen('Line Of Business').wait(200)
        .checkScreenShown ('lineofbusiness').wait(100)
        .enterGridData('#grdGridTemplate', 3, 'colLineOfBusiness', 'lob03').wait(100)
        .clickButton('#btnSave').wait(100)
...
//        Modify duplicate record to correct it
        ...
        .enterGridData('#grdGridTemplate', 3, 'colLineOfBusiness', 'lob04').wait(100) /*issue - IC-81 */
        .clickButton('#btnClose').wait(100)
...
//        Verify record added
        .openScreen('Line Of Business').wait(200)
        .checkScreenShown ('lineofbusiness').wait(100)
        .checkGridData('#grdGridTemplate', 0, 'colLineOfBusiness','lob04')
        .checkStatusMessage('Ready')
        .clickButton('#btnClose').wait(100)
        .checkIfScreenClosed('lineofbusiness').wait(100)
        ...
        .openScreen('Line Of Business').wait(200)
        .checkScreenShown ('lineofbusiness').wait(100)
        .enterGridData('#grdGridTemplate', 4, 'colLineOfBusiness', 'lob05').wait(100)
        .clickButton('#btnSave').wait(100)
