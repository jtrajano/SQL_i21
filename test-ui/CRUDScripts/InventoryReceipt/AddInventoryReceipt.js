...
//
//
//         //region Scenario 8. Create Purchase Contract Inventory Receipt for Lotted Item "Process Button" - (Comment this out until TF bug fix is done for scroll bars)
//        .displayText('=====  Scenario 8. Create Purchase Contract Inventory Receipt for Lotted Item "Process Button"  =====')
//        .clickMenuFolder('Contract Management','Folder')
//        .clickMenuScreen('Contracts','Screen')
//        .clickButton('New')
//        .waitUntilLoaded('ctcontract')
...
//        .waitUntilLoaded('')
//        .clickMenuFolder('Contract Management','Folder')
//        .displayText('===== 8. Create Purchase Contract Inventory Receipt for Lotted Item "Process Button" Done=====')

        //region Scenario 9. Create Purchase Contract Inventory Receipt for Non Lotted Item "Add Orders Screen"
        .displayText('=====  Scenario 9. Create Purchase Contract to IR Add Orders Screen for Non Lotted Item  =====')
        .clickMenuFolder('Contract Management','Folder')
        .clickMenuScreen('Contracts','Screen')
        .clickButton('New')
        .waitUntilLoaded('ctcontract')
        ...
        .selectComboBoxRowValue('Vendor', 'ABC Trucking', 'Vendor',1)
        .waitUntilLoaded('')
        .doubleClickSearchRowValue('NLTI - 100', 'strItemNo', 1)
//        .selectSearchRowNumber(1)
//        .clickButton('OpenSelected')
        .waitUntilLoaded('icinventoryreceipt')
        .waitUntilLoaded('')
       ...
       .addFunction(function (next){
        ...
        //region Scenario 10. Create Purchase Contract Inventory Receipt for Lotted Item "Add Orders Screen"
        .displayText('=====  Scenario 10. Create Purchase Contract to IR Add Orders Screen for Lotted Item  =====')
        .clickMenuFolder('Contract Management','Folder')
        .clickMenuScreen('Contracts','Screen')
        .clickButton('New')
        .waitUntilLoaded('ctcontract')
        ...
        .selectComboBoxRowValue('Vendor', 'ABC Trucking', 'Vendor',1)
        .waitUntilLoaded('')
        .doubleClickSearchRowValue('LTI - 100', 'strItemNo', 1)
//        .selectSearchRowNumber(1)
//        .clickButton('OpenSelected')
        .waitUntilLoaded('icinventoryreceipt')
        .waitUntilLoaded('')
...
//
//        //region Scenario 11. Create Purchase Contract Inbound Shipment Inventory Receipt for Lotted Item "Add Orders Screen"
//        .displayText('=====  Scenario 11. Create Inbound Shipment Purchase Contract Inventory Receipt for Lotted Item "Add Orders Screen"  =====')
//        .clickMenuFolder('Contract Management','Folder')
//        .clickMenuScreen('Contracts','Screen')
//        .clickButton('New')
//        .waitUntilLoaded('ctcontract')
...
//
//
//        //region Scenario 12. Create Purchase Contract Inbound Shipment Inventory Receipt for Non Lotted Item "Add Orders Screen"
//        .displayText('=====  Scenario 12. Create Inbound Shipment Purchase Contract Inventory Receipt for Non Lotted Item "Add Orders Screen"  =====')
//        .clickMenuFolder('Contract Management','Folder')
//        .clickMenuScreen('Contracts','Screen')
//        .clickButton('New')
//        .waitUntilLoaded('ctcontract')
...
//        .displayText('===== Create Purchase Contract Inventory Receipt for Non Lotted Item "Add Orders Screen" Done=====')
        ...
        //region Scenario 11. Update Inventory Receipt
