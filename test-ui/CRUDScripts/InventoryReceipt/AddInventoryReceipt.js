...
//        //endregion
		...
		.enterUOMGridData('InventoryReceipt', 1, 'colUOMQtyToReceive', 'strUnitMeasure', 100000, 'Pounds')
...
//        .selectGridComboBoxRowValue('Items',1,'strUOM','Pounds','strUOM')
...
//        .verifyUOMGridData('InventoryReceipt', 1, 'colUOMQtyToReceive', 100, 'Pounds', 'equal')
//        .verifyGridData('InventoryReceipt', 1, 'colItemSubCurrency', 'USD')
...
//        .verifyGridData('InventoryReceipt', 1, 'colOrderUOM', 'Pounds')
...
//        .verifyGridData('InventoryReceipt', 1, 'colStorageLocation', 'RM Storage')
//        .verifyUOMGridData('InventoryReceipt', 1, 'colUOMQtyToReceive', 100, 'Pounds', 'equal')
//        .selectGridComboBoxRowValue('InventoryReceipt',1,'strWeightUOM','Pounds','strWeightUOM')
...
//        .displayText('===== Create Purchase Order Inventory Receipt for Lotted Item "Process Button" Done=====')
       ...
       .addFunction(function (next){
        ...
        .selectComboBoxRowValue('CommodityUOM', 'Pounds', 'CommodityUOM',1)
        ...
        .selectComboBoxRowValue('NetWeightUOM', 'Pounds', 'NetWeightUOM',1)
        .selectComboBoxRowValue('PriceCurrency', 'USD', 'NetWeightUOM',1)
        .selectComboBoxRowValue('CashPriceUOM', 'Pounds', 'NetWeightUOM',1)
        .verifyData('Combo Box','PricingType','Cash')
        .verifyData('Combo Box','PriceCurrency','USD')
        .verifyData('Combo Box','CashPriceUOM','Pounds')
...
//        .clickButton('OpenSelected')
       ...
       .addFunction(function (next){
        ...
        .waitUntilLoaded()
        .verifyGridData('InventoryReceipt', 1, 'colItemNo', 'IR - NLTI - 01')
        .verifyUOMGridData('InventoryReceipt', 1, 'colUOMQtyToReceive', 100000, 'Pounds', 'equal')
        .verifyGridData('InventoryReceipt', 1, 'colItemSubCurrency', 'USD')
        .verifyGridData('InventoryReceipt', 1, 'colUnitCost', '10')
        .verifyGridData('InventoryReceipt', 1, 'colCostUOM', 'Pounds')
        .verifyGridData('InventoryReceipt', 1, 'colLineTotal', '1000000')
