StartTest (function (t) {
    ...
    new iRely.FunctionalTest().start(t)
        ...
        .addFunction(function(next){
            commonIC.addDirectIRLotted (t,next, 'ABC Trucking', 1, 'ALTI - 109','Test_Pounds', 1000, 10, 'Raw Station', 'RM Storage', 'LOT-01', 'Test_Pounds')
        })
        ...
        .selectGridComboBoxRowValue('InventoryAdjustment',1,'strNewItemUOM','Test_Pounds','strNewSubLocation')
