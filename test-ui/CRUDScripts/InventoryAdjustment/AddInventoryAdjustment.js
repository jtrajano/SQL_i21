StartTest (function (t) {
    ...
    new iRely.FunctionalTest().start(t)
        ...
        .filterGridRecords('Search', 'FilterGrid', 'IA - LTI - 02')
        .waitUntilLoaded()
        .continueIf({
            expected: true,
            actual: function (win,next) {
        ...
        /*====================================== Add Non Lotted Item ======================================*/
        .clickMenuScreen('Items','Screen')
        .filterGridRecords('Search', 'FilterGrid', 'IA - NLTI - 02')
        .waitUntilLoaded()
        .continueIf({
            expected: true,
            actual: function (win,next) {
        ...
        .addFunction(function(next){
            commonIC.addDirectIRNonLotted (t,next, 'ABC Trucking', 1, 'IA - NLTI - 02','Test_Pounds', 1000, 10)
        })

        .addFunction(function(next){
            commonIC.addDirectIRLotted (t,next, 'ABC Trucking', 1, 'IA - LTI - 02','Test_Pounds', 1000, 10, 'Raw Station', 'RM Storage', 'LOT-01', 'Test_Pounds')
        })
        ...
        .selectGridComboBoxRowValue('InventoryAdjustment',1,'strItemNo','IA - NLTI - 02','strItemNo')
        ...
        .selectGridComboBoxRowValue('InventoryAdjustment',1,'strItemNo','IA - LTI - 02','strItemNo')
