StartTest (function (t) {
    ...
    new iRely.FunctionalTest().start(t)
        ...
        .addFunction(function(next){
            commonIC.addDirectIRNonLotted (t,next, 'ABC Trucking', 1, 'DISNLTI - 02','Test_Pounds', 1000, 10)
        })

        .addFunction(function(next){
            commonIC.addDirectIRLotted (t,next, 'ABC Trucking', 1, 'DISLTI - 02','Test_Pounds', 1000, 10, 'Raw Station', 'RM Storage', 'LOT-01', 'Test_Pounds')
        })
        .waitUntilLoaded()
        ...
        .waitUntilLoaded('')
        .enterUOMGridData('InventoryShipment', 1, 'colGumQuantity', 'strUnitMeasure', 100, 'Test_Pounds')
