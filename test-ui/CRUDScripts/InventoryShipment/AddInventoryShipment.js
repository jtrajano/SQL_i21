StartTest (function (t) {
    ...
    new iRely.FunctionalTest().start(t)
        ...
        .filterGridRecords('Search', 'FilterGrid', 'ISLTI - 02')
        .waitUntilLoaded()
        .continueIf({
            expected: true,
            actual: function (win,next) {
        ...
        /*====================================== Add Non Lotted Item ======================================*/
        .clickMenuScreen('Items','Screen')
        .filterGridRecords('Search', 'FilterGrid', 'ISNLTI - 02')
        .waitUntilLoaded()
        .continueIf({
            expected: true,
            actual: function (win,next) {
        ...
        .addFunction(function(next){
            commonIC.addDirectIRNonLotted (t,next, 'ABC Trucking', 1, 'ISNLTI - 02','Test_Pounds', 10000, 10)
        })

        .addFunction(function(next){
            commonIC.addDirectIRLotted (t,next, 'ABC Trucking', 1, 'ISLTI - 02','Test_Pounds', 10000, 10, 'Raw Station', 'RM Storage', 'LOT-01', 'Test_Pounds')
        })
        ...
        .selectGridComboBoxRowValue('InventoryShipment',1,'strItemNo','ISNLTI - 02','strItemNo')
        .waitUntilLoaded('')
        ...
        .selectGridComboBoxRowValue('InventoryShipment',1,'strItemNo','ISLTI - 02','strItemNo')
        .waitUntilLoaded('')
        .enterUOMGridData('InventoryShipment', 1, 'colGumQuantity', 'strUnitMeasure', 100, 'Test_Pounds')
        .verifyGridData('InventoryShipment', 1, 'colUnitPrice', '14')
        .verifyGridData('InventoryShipment', 1, 'colOwnershipType', 'Own')
        ...
        .selectGridComboBoxRowValue('SalesOrder',1,'strItemNo','ISNLTI - 02','strItemNo')
...
//        .clickMessageBoxButton('ok')
        ...
        .verifyGridData('InventoryShipment', 1, 'colItemNumber', 'ISNLTI - 02')
        .verifyGridData('InventoryShipment', 1, 'colUnitPrice', '14')
        .verifyGridData('InventoryShipment', 1, 'colOwnershipType', 'Own')
        .verifyGridData('InventoryShipment', 1, 'colLineTotal', '1400')
        ...
        .enterData('Text Field','BOLNo','Test BOL - 01')
        .selectComboBoxRowValue('FreightTerm', 'Truck', 'FreightTerm',1)
        .selectGridComboBoxRowValue('SalesOrder',1,'strItemNo','ISLTI - 02','strItemNo')
        .addResult('Item Selected',1500)
        .enterGridData('SalesOrder', 1, 'colOrdered', '100')
        .verifyGridData('SalesOrder', 1, 'colPrice', '14')
        //.verifyGridData('SalesOrder', 1, 'colTotal', '1400')
...
//        .clickMessageBoxButton('ok')
        ...
        .verifyData('Combo Box','FreightTerms','Truck')
        .selectComboBoxRowValue('Currency', 'USD', 'Currency',1)
        .verifyGridData('InventoryShipment', 1, 'colItemNumber', 'ISLTI - 02')
        .verifyGridData('InventoryShipment', 1, 'colUnitPrice', '14')
        .verifyGridData('InventoryShipment', 1, 'colOwnershipType', 'Own')
        .verifyGridData('InventoryShipment', 1, 'colLineTotal', '1400')
        .selectGridComboBoxRowValue('InventoryShipment',1,'strSubLocationName','Raw Station','strSubLocationName')
