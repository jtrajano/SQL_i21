StartTest (function (t) {
    ...
    new iRely.FunctionalTest().start(t)
        ...
        .filterGridRecords('Search', 'FilterGrid', 'ITLTI - 03')
        .waitUntilLoaded()
        .continueIf({
            expected: true,
            actual: function (win,next) {
        ...
        .addFunction(function(next){
            commonIC.addDirectIRNonLotted (t,next, 'ABC Trucking', 1, 'ITNLTI - 03','Test_Pounds', 10000, 10)
        })

        .addFunction(function(next){
            commonIC.addDirectIRLotted (t,next, 'ABC Trucking', 1, 'ITLTI - 03','Test_Pounds', 10000, 10, 'Raw Station', 'RM Storage', 'LOT-01', 'Test_Pounds')
        })
        .waitUntilLoaded('')
        ...
        .selectGridComboBoxRowValue('InventoryTransfer',1,'strItemNo','ITLTI - 03','strItemNo')
        .selectGridComboBoxRowValue('InventoryTransfer',1,'strFromSubLocationName','Raw Station','strFromSubLocationName')
        .selectGridComboBoxRowValue('InventoryTransfer',1,'strFromStorageLocationName','RM Storage','strFromStorageLocationName')
        .verifyGridData('InventoryTransfer', 1, 'colOwnershipType', 'Own')
        .verifyGridData('InventoryTransfer', 1, 'colAvailableUOM', 'Test_Pounds')
        ...
        .clickTab('Post Preview')
        .waitUntilLoaded()
//        .verifyMessageBox('iRely i21','Negative stock quantity is not allowed for ITNLTI - 03 on 0001 - Fort Wayne, Raw Station, and RM Storage.','ok','error')
        ...
        .doubleClickSearchRowValue('ITNLTI - 03', 'strItemNo', 1)
        ...
        .selectComboBoxRowNumber('ReceiptType',3,0)
        .selectComboBoxRowValue('Transferor', '0001 - Fort Wayne', 'Transferor',0)
        .doubleClickSearchRowValue('ITLTI - 03', 'strItemNo', 1)
        .waitUntilLoaded('icinventoryreceipt')
        .verifyData('Combo Box','ReceiptType','Transfer Order')
        .verifyData('Combo Box','Transferor','0001 - Fort Wayne')
        .verifyData('Combo Box','Location','0002 - Indianapolis')
        .verifyData('Combo Box','Currency','USD')
        .verifyGridData('InventoryReceipt', 1, 'colItemNo', 'ITLTI - 03')
        .verifyGridData('InventoryReceipt', 1, 'colUnitCost', '10')
        .verifyGridData('InventoryReceipt', 1, 'colCostUOM', 'Test_Pounds')
        .verifyGridData('InventoryReceipt', 1, 'colLineTotal', '1000')
        .verifyGridData('InventoryReceipt', 1, 'colSubLocation', 'Indy')
        ...
        .clickMenuScreen('Inventory Transfers','Screen')
        .waitUntilLoaded()
        .doubleClickSearchRowValue('Location to Location', 'strTransferType', 4)
        .waitUntilLoaded('')
        .addResult('Successfully Opened',2000)
        .clickButton('Unpost')
        .waitUntilLoaded('')
        ...
        .clickButton('Close')
        .waitUntilLoaded('')
        .doubleClickSearchRowValue('Location to Location', 'strTransferType', 1)
        .waitUntilLoaded('')
        .verifyData('Combo Box','FromLocation','0001 - Fort Wayne')
        .verifyData('Combo Box','ToLocation ','0002 - Indianapolis')
        .verifyData('Text Field','Description','Test Transfer Updated')
        .verifyGridData('InventoryTransfer', 1, 'colItemNumber', 'ITNLTI - 03')
