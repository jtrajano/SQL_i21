...
//            .selectComboBoxRowNumber('StorageLocation',1,0)
    ...
    addDirectIRNonLotted: function (t,next, vendor, location,itemno,receiptuom, qtytoreceive,cost ) {
        ...
        new iRely.FunctionalTest().start(t, next)
            ...
            .verifyGridData('VoucherDetails', 1, 'colItemNo', itemno)
            .verifyGridData('VoucherDetails', 1, 'colUOM', receiptuom)
            .verifyGridData('VoucherDetails', 1, 'colQtyOrdered', qtytoreceive)
            .verifyGridData('VoucherDetails', 1, 'colCost', '10')
            .verifyGridData('VoucherDetails', 1, 'colCostUOM', receiptuom)
            .verifyGridData('VoucherDetails', 1, 'colGrossUOM', receiptuom)
            .verifyGridData('VoucherDetails', 1, 'colNetWeight', qtytoreceive)
            .verifyGridData('VoucherDetails', 1, 'colTotal', linetotal)
    ...
    addPOtoIRAddOrdersButtonNonLotted: function (t,next, vendor, location,itemno,receiptuom, qtytoreceive,cost ) {
        ...
        new iRely.FunctionalTest().start(t, next)
            ...
            .verifyGridData('VoucherDetails', 1, 'colUOM', receiptuom)
            .verifyGridData('VoucherDetails', 1, 'colQtyOrdered', qtytoreceive)
            .verifyGridData('VoucherDetails', 1, 'colCost', cost)
            .verifyGridData('VoucherDetails', 1, 'colCostUOM', receiptuom)
            .verifyGridData('VoucherDetails', 1, 'colGrossUOM', receiptuom)
            .verifyGridData('VoucherDetails', 1, 'colNetWeight', qtytoreceive)
            .verifyGridData('VoucherDetails', 1, 'colTotal', linetotal)
