...
// //            //Removed this code since this is not anymore available on 17.11.1018.50 onwards
...
//            .clickButton('Close')
            ...
            .verifyGridColumnNames('Search', [
                ...
                { dataIndex: 'strItemUOM', text: 'Quantity UOM'},
                { dataIndex: 'dblWeight', text: 'Weight'},
                { dataIndex: 'strWeightUOM', text: 'Weight UOM'},
                { dataIndex: 'dblWeightPerQty', text: 'Weight Per Qty'},
                { dataIndex: 'dblLastCost', text: 'Last Cost'},
                { dataIndex: 'strCostUOM', text: 'Cost UOM'}
