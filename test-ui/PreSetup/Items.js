StartTest (function (t) {
    ...
    new iRely.FunctionalTest().start(t)
        ...
        .selectGridComboBoxRowValue('Conversion',1,'colOtherUOM','Test_KG','strUnitMeasure',1)
        ...
        .displayText('===== Create Lotted Item Stock Unit Test KG =====')
        .clickMenuFolder('Inventory','Folder')
        ...
        .displayText('===== Add Commodity Quantity Stock Unit =====')
        .clickMenuFolder('Inventory','Folder')
        .clickMenuScreen('Commodities','Screen')
        .clickButton('New')
        .waitUntilLoaded('iccommodity')
        .enterData('Text Field','CommodityCode','DIR - Commodity - 03')
        .enterData('Text Field','Description','Test Corn Commodity')
        .enterData('Text Field','DecimalsOnDpr','6.00')

        .selectGridComboBoxRowValue('Uom',1,'strUnitMeasure','Unit','strUnitMeasure')
        .clickGridCheckBox('Uom', 1,'strUnitMeasure', 'Unit', 'ysnStockUnit', true)
        .clickButton('Save')
        .waitUntilLoaded()
        .verifyStatusMessage('Saved')
        .clickButton('Close')
        ...
        .displayText('===== Create Lotted Item Stock Unit Quantity =====')
        .clickMenuFolder('Inventory','Folder')
        .clickMenuScreen('Items','Screen')
        .clickButton('New')
        .waitUntilLoaded('icitem')
        .enterData('Text Field','ItemNo','Direct - LTI - 03')
        .enterData('Text Field','Description','Test Lotted Item Direct - LTI - 03')
        .selectComboBoxRowValue('Category', 'DIR - Category', 'Category',0)
        .selectComboBoxRowValue('Commodity', 'DIR - Commodity - 03', 'Commodity',0)
        .selectComboBoxRowNumber('LotTracking',3,0)
        .verifyData('Combo Box','Tracking','Lot Level')
        ...
        .selectComboBoxRowValue('SubLocation', 'Raw Station', 'SubLocation',0)
        .selectComboBoxRowValue('StorageLocation', 'RM Storage', 'StorageLocation',0)
        .selectComboBoxRowValue('IssueUom', 'Unit', 'IssueUom',0)
        .selectComboBoxRowValue('ReceiveUom', 'Unit', 'ReceiveUom',0)
        .clickButton('Save')
        .clickButton('Close')
