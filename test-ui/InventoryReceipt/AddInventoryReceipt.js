StartTest (function (t) {
    new iRely.FunctionalTest().start(t)
        ...
        .selectGridComboBoxRowValue('InventoryReceipt',1,'strItemNo','001 - CNLTI','strItemNo')
       ...
       .addFunction(function (next){
        ...
        .selectComboBoxRowValue('Vendor', 'ABC Trucking', 'Vendor',1)
        .selectComboBoxRowValue('Location', '0001 - Fort Wayne', 'Location',0)
        .selectGridComboBoxRowValue('InventoryReceipt',1,'strItemNo','002 - CLTI','strItemNo')
        .selectGridComboBoxRowValue('InventoryReceipt',1,'strUnitMeasure','LB','strUnitMeasure')
        .enterGridData('InventoryReceipt', 1, 'colQtyToReceive', '100')
        .verifyGridData('InventoryReceipt', 1, 'colItemSubCurrency', 'USD')
        .enterGridData('InventoryReceipt', 1, 'colUnitCost', '10')
        ...
        .waitUntilLoaded('')
        .selectGridComboBoxRowValue('Items',1,'strItemNo','001 - CNLTI','strItemNo')
        ...
        .displayText('=====  Scenario 4. Create Create PO to IR "Add Orders Screen" for Lotted Item  =====')
        .clickMenuFolder('Purchasing','Folder')
        .clickMenuScreen('Purchase Orders','Screen')
        .clickButton('New')
        .waitUntilLoaded('appurchaseorder')
        .selectComboBoxRowValue('VendorId', 'ABC Trucking', 'VendorId',1)
        .waitUntilLoaded('')
        .selectGridComboBoxRowValue('Items',1,'strItemNo','002 - CLTI','strItemNo')
        .selectGridComboBoxRowValue('Items',1,'strUOM','LB','strUOM')
        .enterGridData('Items', 1, 'colQtyOrdered', '100')
        .verifyGridData('Items', 1, 'colTotal', '1000')
        .clickButton('Save')
        ...
        .enterData('Date Field','EndDate','11/06/2018')
        .selectComboBoxRowValue('Location', '0001 - Fort Wayne', 'Location',1)
        .selectComboBoxRowValue('Item', '001 - CNLTI', 'Item',1)
     ...
     /*  //region Scenario 9. Create Purchase Contract Inventory Receipt for Lotted Item "Process Button" - (Comment this out until TF bug fix is done for scroll bars)
        ...
        .enterData('Date Field','EndDate','11/06/2018')
        .selectComboBoxRowValue('Location', '0001 - Fort Wayne', 'Location',1)
        .selectComboBoxRowValue('Item', '002 - CLTI', 'Item',1)
        .selectComboBoxRowValue('NetWeightUOM', 'LB', 'NetWeightUOM',1)
        .verifyData('Text Field','NetWeight','100.0000')
        .verifyData('Combo Box','PricingType','Cash')
        .verifyData('Combo Box','PriceCurrency','USD')
...
/*        //region Scenario 11. Create Purchase Contract Inbound Shipment Inventory Receipt for Non Lotted Item "Add Orders Screen"
        .displayText('=====  Scenario 11. Create Inbound Shipment Purchase Contract Inventory Receipt for Non Lotted Item "Add Orders Screen"  =====')
        .clickMenuFolder('Contract Management','Folder')
        .clickMenuScreen('Contracts','Screen')
        .clickButton('New')
        .waitUntilLoaded('ctcontract')
        ...
        .clickMenuScreen('Load//Shipment Schedules','Screen')
        .clickButton('New')
        ...
        .selectGridComboBoxRowValue('LoadSchedule',1,'strVendor','ABC Trucking','strVendor')
        .selectGridComboBoxRowValue('LoadSchedule',1,'strPContractNumber','001 - CNLTI','strPContractNumber')
        ...
        //region Scenario 12. Update Inventory Receipt
