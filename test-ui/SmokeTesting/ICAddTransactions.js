...
//        })
        ...
        .displayText('===== Scenario 1: Create Direct IS for Non Lotted Item =====')
        .addFunction(function(next){
...
//        //region Scenario 1: Add Direct IR for Non Lotted Item
//        .displayText('=====  Scenario 1: Add Direct IR for Non Lotted Item =====')
...
//
//
//        //region Scenario 3. Create Direct Inventory Shipment for Non Lotted Item
//        .displayText('=====  Scenario 3. Create Direct Inventory Shipment for Non Lotted Item  =====')
...
//        //endregion
//
//        //region Scenario 4. Create Direct Inventory Shipment for Lotted Item
//        .displayText('=====  Scenario 4. Create Direct Inventory Shipment for Lotted Item  =====')
//        .clickButton('New')
//        .waitUntilLoaded('icinventoryshipment')
//        .selectComboBoxRowNumber('OrderType',4,0)
//        .selectComboBoxRowValue('Customer', 'ABC Trucking', 'Customer',1)
...
//
//
//        //region Scenario 5. Create Inventory Transfer for Non Lotted Item Shipment Not Required Location to Location
//        .displayText('===== Scenario 5. Create Inventory Transfer for Non Lotted Item Shipment Not Required Location to Location =====')
...
//
//
////        //region Scenario 6. Create Inventory Transfer for Lotted Item Shipment Not Required Location to Location
////        .displayText('===== Scenario 6. Create Inventory Transfer for Lotted Item Shipment Not Required Location to Location=====')
////        .clickMenuScreen('Inventory Transfers','Screen')
////        .waitUntilLoaded()
////        .clickButton('New')
////        .waitUntilLoaded('icinventorytransfer')
...
//
//
//        //region Scenario 7. Inventory Adjustment Quantity Change Non Lotted Item
//        .displayText('===== Scenario 7. Inventory Adjustment Quantity Change Non Lotted Item=====')
...
//        //endregion
//
//        //region Scenario 8. Inventory Adjustment Quantity Change Lotted Item
//        .displayText('===== Scenario 8. Inventory Adjustment Quantity Change Lotted Item=====')
//        .clickMenuScreen('Inventory Adjustments','Screen')
//        .waitUntilLoaded()
//        .clickButton('New')
//        .waitUntilLoaded('icinventoryadjustment')
