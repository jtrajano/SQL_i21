StartTest (function (t) {
    ...
    .continueIf({
     ...
     .clickButton('Close')
    .addScenario('1','Inventory Return',1000)
    ...
    .selectGridComboBoxRowValue('Items',1,'strItemNo', productID2 ,'strItemNo') 
    ...
    .addFunction(function (next) {
       ...
       .clickButton('Close')
        ...
        .waitUntilLoaded()
        .waitUntilLoaded()
        .addScenario('1','Inventory Receipts',1000)
        .clickMenuFolder('Inventory')
        .waitUntilLoaded()
        ...
        .waitUntilLoaded().clickButton('InsertInventoryReceipt')
        .verifyGridData ('InventoryReceipt', 1 ,'strItemNo' , productID2)
       ...
       .selectGridRowNumber('LotTracking', 1)
        ...
        .addFunction(function (next) {
            ...
            .addFunction(function (next) {
                ...
                .waitUntilLoaded()
                .waitUntilLoaded()
                .addScenario('2','Inventory Receipts',1000)
                .clickMenuFolder('Inventory')
                .waitUntilLoaded()
                .clickMenuScreen('Inventory Receipts')
                .waitUntilLoaded()
                ...
                .addFunction(function (next) {
                    ...
                    .waitUntilLoaded()
                    .waitUntilLoaded()
                    .addScenario('2','Inventory Return',1000)
                    .clickMenuScreen('Inventory Receipts')
                    .waitUntilLoaded()
                    .waitUntilLoaded()
                    .addFunction(function (next) {
                        t.chain(
                            { click : "#floatingPnlIntegratedDashboard #searchTabPanel panel[title=Inventory Receipt]#mainTab #grdSearch #pnlFilter #con0 #cboColumns => .x-form-text" }
                        )
                        next();
                    })
                    .waitUntilLoaded()
                    ...
                    .clickButton('Close')
                    .waitUntilLoaded()
                    .addScenario('2','Inventory Return 2',1000)
                    .clickMenuScreen('Inventory Receipts')
                    .waitUntilLoaded().waitUntilLoaded().waitUntilLoaded()
                    .addFunction(function (next) {
                        t.chain(
