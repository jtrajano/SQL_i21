...
//    var commonGL = Ext.create('GeneralLedger.commonGL');
    ...
    new iRely.FunctionalTest().start(t)
        ...
        //Add Item
        .displayText('===== Scenario 1: Direct Inventory Receipt - Saved =====')
        ...
        .enterData('Text Field','ItemNo','Item StockCheckIR-1')
        .selectComboBoxRowNumber('Type',2,0)
        .enterData('Text Field','Description','Item StockCheckIR-1 desc')
        ...
        .selectGridComboBoxRowValue('InventoryReceipt',1,'colItemNo','Item StockCheckIR-1','strItemNo',1)
        .waitUntilLoaded('',3000)
        .waitUntilLoaded('',3000)

        .displayText('===== Inventory Receipt - Item grid =====')
        ...
        //.enterUOMGridData('InventoryReceipt', 1, 'dblOpenReceive', 100, 'lb1')
        .waitUntilLoaded('')
        ...
        .selectSearchRowValue('Item StockCheckIR-1','strItemNo',1,2)
        .waitUntilLoaded('',3000)
...
//        .verifyGridData('Search', 1, 'strItemNo', 'Item StockCheckIR-1')
//
//        .verifyGridColumnNames ('Search', [{ dataIndex: 'strItemDescription',text: 'Description'}])
//        .verifyGridData('Search', 1, 'strItemDescription', 'Item StockCheckIR-1 desc')
//
//        .verifyGridColumnNames ('Search', [{ dataIndex: 'strProductType',text: 'Product Type'}])
//        .verifyGridData('Search', 1, 'strProductType', '')
//
...
//        .verifyGridData('Search', 1, 'strLotNumber', '')
//
...
//        .verifyGridData('Search', 1, 'dblQty', 'lb1')
//
...
//        .verifyGridData('Search', 1, 'strCostUOM', 'lb1')
        ...
        .verifyGridData('Search', 1, 'strDescription', 'Item StockCheckIR-1 desc')
        ...
        .verifyGridData('Search', 1, 'dblAverageCost', '0.00')
        ...
        .verifyGridColumnNames ('Search', [{ dataIndex: 'strItemNo',text: 'Item No'}])
        .verifyGridData('Search', 2, 'strItemNo', 'Item StockCheckIR-1')

        .verifyGridColumnNames ('Search', [{ dataIndex: 'strDescription',text: 'Description'}])
        .verifyGridData('Search', 2, 'strDescription', 'Item StockCheckIR-1 desc')
        ...
        .clickMenuFolder('Inventory','Folder')
        .clickMenuScreen('Items','Screen')
        .doubleClickSearchRowValue('Item StockCheckIR-1', 1)
        .waitUntilLoaded('icitem',3000)
        .clickTab('Stock')

        .displayText('This counts the number of records in the Stock grid.')
        .verifyGridRecordCount('Stock', 0)
        .waitTillLoaded('',3000)
...
//        .verifyGridData('Stock', 1, 'dblAvailable', '0.00')
        ...
        .selectSearchRowValue('Item StockCheckIR-1','strItemNo',1,0)
        .waitUntilLoaded('',3000)
        .displayText('This counts the number of records in the search grid.')
        ...
        .verifyGridColumnNames ('Search', [{dataIndex: 'strLocationName',text: 'Location'}])
        .verifyGridData('Search', 1, 'strLocationName', null)
        ...
        .verifyGridColumnNames ('Search', [{dataIndex: 'strLotNumber',text: 'Lot Number'}])
        .verifyGridData('Search', 1, 'strLotNumber', null)
        ...
        .verifyGridData('Search', 1, 'dblQuantityInStockUOM', '0.00')

        .verifyGridColumnNames ('Search', [{dataIndex: 'dblRunningQtyBalance',text: 'Running Qty'}])
        .verifyGridData('Search', 1, 'dblRunningQtyBalance', '0.00')

        .verifyGridColumnNames ('Search', [{dataIndex: 'dblCostInStockUOM',text: 'Cost'}])
        .verifyGridData('Search', 1, 'dblCostInStockUOM', '0.00')
        ...
        .verifyGridData('Search', 1, 'dblValue', '0.00')

        .verifyGridColumnNames ('Search', [{dataIndex: 'dblRunningBalance',text: 'Running Value'}])
        .verifyGridData('Search', 1, 'dblRunningBalance', '0.00')
        ...
        .verifyGridColumnNames ('Search', [{dataIndex: 'strSubLocationName',text: 'Sub Location'}])
        .verifyGridData('Search', 1, 'strSubLocationName', null)
        ...
        .verifyGridColumnNames ('Search', [{dataIndex: 'strStockUOM',text: 'Stock UOM'}])
        .verifyGridData('Search', 1, 'strStockUOM', null)

        .verifyGridColumnNames ('Search', [{dataIndex: 'dblQuantityInStockUOM',text: 'Stock Quantity'}])
        .verifyGridData('Search', 1, 'dblQuantityInStockUOM', null)

        .verifyGridColumnNames ('Search', [{dataIndex: 'dblValue',text: 'Value'}])
        .verifyGridData('Search', 1, 'dblValue', '0.00')

        .verifyGridColumnNames ('Search', [{dataIndex: 'dblLastCost',text: 'Last Cost'}])
        .verifyGridData('Search', 1, 'dblLastCost', '0.00')

        .verifyGridColumnNames ('Search', [{dataIndex: 'dblStandardCost',text: 'Standard Cost'}])
        .verifyGridData('Search', 1, 'dblStandardCost', '0.00')
