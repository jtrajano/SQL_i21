Ext.define('iRely.FunctionalTest', {
     ...
     * @returns {iRely.TestEngine}
     */
    clickMenu: function(folderName, type) {
        var me = this,
            t = me.t,
            chain = me.chain;
     ...
     * @returns {iRely.TestEngine}
     */
    collapseMenu_tobedeleted: function(folderName, type) {
        var me = this,
            t = me.t,
            chain = me.chain,
            timeout = 30000;
     ...
     * @returns {iRely.TestEngine}
     */
    clickScreenMenu: function(screenName, type) {
        var me = this,
            t = me.t,
            chain = me.chain,
            timeout = 30000;
     ...
     *
     * @param {Integer} interval Interval of ".waitUntilLoaded()" function to execute. Optional.
     *
     * @returns {iRely.TestEngine}
     */
    ...
    /**
     * Clicks an ellipse button in the combo box.
     *
     ...
     * @returns {iRely.TestEngine}
     */
    clickEllipseButton: function(item, tab) {
        var me = this,
            chain = me.chain;
    ...
    doubleClickSearchRowValue: function(filter, gridColumn, index, tab, interval){
        var me = this,
            chain = this.chain;
     ...
     * @returns {iRely.TestEngine}
     */
    selectSearchRowValue: function(filter, delay, gridColumn, tab) {
        var me = this,
            chain = this.chain;
     ...
     * @returns {iRely.TestEngine}
     */
    selectComboBoxRowValue: function(item, filter, comboColumn, index) {
        var me = this,
            chain = this.chain;
     ...
     * @returns {iRely.TestEngine}
     */
    selectGridComboBoxRowValue: function(item, row, column, filter, delay, comboColumn, index) {
        var me = this,
            chain = me.chain;
     ...
     * @returns {iRely.TestEngine}
     */
    isControlReadOnly: function(items, readOnly) {
        var me = this,
            chain = me.chain;
     ...
     * @returns {iRely.TestEngine}
     */
    isControlVisible: function(items, visible, tab) {
        var me = this,
            chain = me.chain;
     ...
     * @returns {iRely.TestEngine}
     */
    isControlDisable: function(items, disabled) {
        var me = this,
            chain = me.chain;
     ...
     * @returns {iRely.TestEngine}
     */
    verifyFieldLabel: function(item) {
        var me = this,
            chain = me.chain,
     ...
     */
    isComponentShown_tobedelete: function(item) {
        var result = false;
     ...
     * @returns {iRely.TestEngine}
     */
    waitTillVisible_tobedelete : function(item, msg) {
        var me = this,
            chain = me.chain;
    ...
    /**
     * Waits until the Initializing, Loading, etc. dialog closes
     *
     * @param {String} item Item Id of the control.
     *
     * @returns {iRely.TestEngine}
