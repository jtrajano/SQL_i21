StartTest (function (t) {
    new iRely.FunctionalTest().start(t)
        ...
        .clickButton('New')
        .enterData('Text Field','ItemNo','SNLTI - 02')
        ...
        .displayText('=====  Creating Direct Inventory Receipt for SNLTI - 02 for Stock=====')
        ...
        .selectGridComboBoxRowValue('InventoryReceipt',1,'strItemNo','SNLTI - 02','strItemNo')
        ...
        .clickButton('Close')
        .waitUntilLoaded('')
        .displayText('=====  Creating Direct Inventory Receipt for SNLTI - 02 Done=====')

        //Check Stock of the Item
        .displayText('=====  Checking Item Stock =====')
        .clickMenuScreen('Items','Screen')
        .doubleClickSearchRowValue('SNLTI - 02', 'strItemNo', 1)
        ...
        .selectGridComboBoxRowValue('InventoryShipment',1,'strItemNo','SNLTI - 02','strItemNo')
        ...
        .clickMenuScreen('Items','Screen')
        .clickButton('New')
        .enterData('Text Field','ItemNo','SLTI - 02')
        ...
        //Create inventory Receipt for Stock
        .displayText('=====  Creating Direct Inventory Receipt for SLTI - 02 =====')
        .clickMenuScreen('Inventory Receipts','Screen')
        .waitUntilLoaded()
        .clickButton('New')
        .waitUntilLoaded('icinventoryreceipt')
        ...
        .selectComboBoxRowValue('Vendor', 'ABC Trucking', 'Vendor',1)
        .selectComboBoxRowValue('Location', '0001 - Fort Wayne', 'Location',0)
        .selectGridComboBoxRowValue('InventoryReceipt',1,'strItemNo','SLTI - 02','strItemNo')
        .selectGridComboBoxRowValue('InventoryReceipt',1,'strUnitMeasure','LB','strUnitMeasure')
        .enterGridData('InventoryReceipt', 1, 'colQtyToReceive', '1000')
        .verifyGridData('InventoryReceipt', 1, 'colItemSubCurrency', 'USD')
        .enterGridData('InventoryReceipt', 1, 'colUnitCost', '10')
        ...
        .displayText('=====  Checking Item Stock =====')
        .clickMenuScreen('Items','Screen')
        .doubleClickSearchRowValue('SLTI - 02', 'strItemNo', 1)
        .waitUntilLoaded('icitem')
        .clickTab('Stock')
        .waitUntilLoaded()
        .verifyGridData('Stock', 1, 'colStockLocation', '0001 - Fort Wayne')
        ...
        .selectGridComboBoxRowValue('InventoryShipment',1,'strItemNo','SLTI - 02','strItemNo')
        .selectGridComboBoxRowValue('InventoryShipment',1,'strUnitMeasure','LB','strUnitMeasure')
        .enterGridData('InventoryShipment', 1, 'colQuantity', '100')
        ...
        //region Scenario 3. Create Sales Order IR for Non Lotted Item then Delete the IR."Ship Button" then Delete IS
        ...
        .selectGridComboBoxRowValue('SalesOrder',1,'strItemNo','SNLTI - 02','strItemNo')
        ...
        .verifyGridData('InventoryShipment', 1, 'colItemNumber', '001 - CNLTI')
        ...
        .waitUntilLoaded()
        .clickMenuFolder('Inventory','Folder')
        .displayText('===== Create Sales Order IR for Non Lotted Item then Delete the IR."Ship Button" then Delete IS Done=====')
        //endregion
