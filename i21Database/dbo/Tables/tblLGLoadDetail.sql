...
(
	...
	[strTerminalReference] NVARCHAR(200) COLLATE Latin1_General_CI_AS NULL,
	...
	CONSTRAINT [FK_tblLGLoadDetail_tblCTCropYear_intCropYearId] FOREIGN KEY ([intCropYearId]) REFERENCES [tblCTCropYear]([intCropYearId]),
	...
	CONSTRAINT [FK_tblLGLoadDetail_tblEMEntity_intSellerId] FOREIGN KEY ([intSellerId]) REFERENCES tblEMEntity([intEntityId]),
	CONSTRAINT [FK_tblLGLoadDetail_tblEMEntity_intSalespersonId] FOREIGN KEY ([intSalespersonId]) REFERENCES tblEMEntity([intEntityId]),
	...
	CONSTRAINT [FK_tblLGLoadDetail_tblTMSite_intTMSiteId] FOREIGN KEY ([intTMSiteId]) REFERENCES [tblTMSite]([intSiteID]),
	--CONSTRAINT [FK_tblLGLoadDetail_tblTMDispatch_intTMDispatchId] FOREIGN KEY ([intTMDispatchId]) REFERENCES [tblTMDispatch]([intDispatchID]),
