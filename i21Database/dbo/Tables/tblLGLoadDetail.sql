...
(
	...
	CONSTRAINT [FK_tblLGLoadDetail_tblEntityLocation_intVendorEntityLocationId] FOREIGN KEY ([intVendorEntityLocationId]) REFERENCES [tblEntityLocation]([intEntityLocationId]),
	CONSTRAINT [FK_tblLGLoadDetail_tblEntity_intCustomerEntityId] FOREIGN KEY ([intCustomerEntityId]) REFERENCES [tblEntity]([intEntityId]),
	CONSTRAINT [FK_tblLGLoadDetail_tblEntityLocation_intCustomerEntityLocationId] FOREIGN KEY ([intCustomerEntityLocationId]) REFERENCES [tblEntityLocation]([intEntityLocationId]),
