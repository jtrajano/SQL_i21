...
(
	...
	CONSTRAINT [FK_tblLGLoadDetail_tblEntity_intVendorEntityId] FOREIGN KEY ([intVendorEntityId]) REFERENCES tblEMEntity([intEntityId]),
	CONSTRAINT [FK_tblLGLoadDetail_tblEntityLocation_intVendorEntityLocationId] FOREIGN KEY ([intVendorEntityLocationId]) REFERENCES [tblEMEntityLocation]([intEntityLocationId]),
	CONSTRAINT [FK_tblLGLoadDetail_tblEntity_intCustomerEntityId] FOREIGN KEY ([intCustomerEntityId]) REFERENCES tblEMEntity([intEntityId]),
	CONSTRAINT [FK_tblLGLoadDetail_tblEntityLocation_intCustomerEntityLocationId] FOREIGN KEY ([intCustomerEntityLocationId]) REFERENCES [tblEMEntityLocation]([intEntityLocationId]),
