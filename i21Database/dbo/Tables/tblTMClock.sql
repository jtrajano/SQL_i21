CREATE TABLE [dbo].[tblTMClock] (
    ...
    [dblJanuaryDailyMaximum]    NUMERIC (18, 6) DEFAULT 0 NULL,
    [dblFebruaryDailyMaximum]   NUMERIC (18, 6) DEFAULT 0 NULL,
    [dblMarchDailyMaximum]      NUMERIC (18, 6) DEFAULT 0 NULL,
    [dblAprilDailyMaximum]      NUMERIC (18, 6) DEFAULT 0 NULL,
    [dblMayDailyMaximum]        NUMERIC (18, 6) DEFAULT 0 NULL,
    [dblJuneDailyMaximum]       NUMERIC (18, 6) DEFAULT 0 NULL,
    [dblJulyDailyMaximum]       NUMERIC (18, 6) DEFAULT 0 NULL,
    [dblAugustDailyMaximum]     NUMERIC (18, 6) DEFAULT 0 NULL,
    [dblSeptemberDailyMaximum]  NUMERIC (18, 6) DEFAULT 0 NULL,
    [dblOctoberDailyMaximum]    NUMERIC (18, 6) DEFAULT 0 NULL,
    [dblNovemberDailyMaximum]   NUMERIC (18, 6) DEFAULT 0 NULL,
    [dblDecemberDailyMaximum]   NUMERIC (18, 6) DEFAULT 0 NULL,
