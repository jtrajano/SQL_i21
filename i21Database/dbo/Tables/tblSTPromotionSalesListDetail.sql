...
(
    ...
    CONSTRAINT [FK_tblSTPromotionSalesListDetail_tblSTPromotionItemList] FOREIGN KEY ([intPromoItemListId]) REFERENCES [tblSTPromotionItemList]([intPromoItemListId]) ON DELETE CASCADE,
