CREATE TABLE [dbo].[tblPRPaycheckTax](
	...
	[intBillId] INT NULL,
	[intSort] [int] NULL,
	[ysnW42020] BIT      DEFAULT ((0)) NOT NULL,
	[ysnW4Step2c] BIT      DEFAULT ((0)) NOT NULL,	
	[dblW4ClaimDependents]	NUMERIC (18, 6) DEFAULT ((0)) NULL,
	[dblW4OtherIncome]		NUMERIC (18, 6) DEFAULT ((0)) NULL,
	[dblW4Deductions]		NUMERIC (18, 6) DEFAULT ((0)) NULL,
...
CREATE NONCLUSTERED INDEX [IX_tblPRPaycheckTax_intPaycheckId]
ON [dbo].[tblPRPaycheckTax] ([intPaycheckId],[intTypeTaxId])
INCLUDE ([dblTotal])
GO
