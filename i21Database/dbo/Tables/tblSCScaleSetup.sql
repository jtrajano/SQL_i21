...
(
    ...
    [strStationDescription] NVARCHAR(60) NULL, 
    ...
    [strScaleOperator] NVARCHAR(30) NULL, 
    [intScaleProcessing] INT NULL, 
    [intTransferDelayMinutes] INT NULL, 
    [intBatchTransferInterval] INT NULL, 
    [strLocalFilePath] NVARCHAR(250) NULL, 
    [strServerPath] NVARCHAR(250) NULL, 
    [strWebServicePath] NVARCHAR(250) NULL, 
    ...
    [strWeightDescription] NVARCHAR(5) NOT NULL, 
