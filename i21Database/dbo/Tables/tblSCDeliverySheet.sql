...
(
	...
	[strDeliverySheetNumber] NVARCHAR(50) COLLATE Latin1_General_CI_AS NULL,
	...
	CONSTRAINT [FK_tblSCDeliverySheet_tblEMEntitySplit_intSplitId] FOREIGN KEY ([intSplitId]) REFERENCES [dbo].[tblEMEntitySplit] ([intSplitId])
)
GO
