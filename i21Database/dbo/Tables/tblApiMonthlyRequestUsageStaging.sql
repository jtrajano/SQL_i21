CREATE TABLE [dbo].[tblApiMonthlyRequestUsageStaging] (
	[guiApiMonthlyRequestUsageStagingId] [uniqueidentifier] NOT NULL,
	[guiStagingIdentifier] [uniqueidentifier] NOT NULL,
	...
	CONSTRAINT [PK_tblApiMonthlyRequestUsageStaging] PRIMARY KEY CLUSTERED ([guiApiMonthlyRequestUsageStagingId] ASC)
)
