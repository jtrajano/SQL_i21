...
(
	...
	CONSTRAINT [UK_tblICInventoryStockSummary] UNIQUE CLUSTERED ([intItemId], [intItemLocationId])
)
GO
...
GO
CREATE NONCLUSTERED INDEX [IX_tblICInventoryStockSummary_intItemLocationId]
    ON [dbo].[tblICInventoryStockSummary]([intItemLocationId] ASC);
