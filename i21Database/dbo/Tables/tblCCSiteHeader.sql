...
(
	...
	CONSTRAINT [FK_tblCCSiteHeader_tblSMCompanyLocation_intVendorDefaultId] FOREIGN KEY ([intCompanyLocationId]) REFERENCES [dbo].[tblSMCompanyLocation] ([intCompanyLocationId]),
