CREATE TABLE [dbo].[tblCFSiteGroupPriceAdjustment] (
    ...
    CONSTRAINT [PK_tblCFSiteGroupPriceAdjustment] PRIMARY KEY CLUSTERED ([intSiteGroupPriceAdjustmentId] ASC) WITH (FILLFACTOR = 70),
...
CREATE NONCLUSTERED INDEX [tblCFSiteGroupPriceAdjustment_intARItelId_intSiteGroupPriceAdjustmentHeaderID_intPriceGroupId_dblRate]
    ON [dbo].[tblCFSiteGroupPriceAdjustment]([intARItemId] ASC)
    INCLUDE([intSiteGroupPriceAdjustmentHeaderId], [intPriceGroupId], [dblRate]);
GO
