CREATE TABLE [dbo].[tblCMBankTransfer] (
	...
	[dblRateAmountTo]                  DECIMAL (18,7) DEFAULT 1 NULL,
	[intCurrencyExchangeRateTypeId] INT	NULL,
	[dblRateAmountFrom]        DECIMAL (18,7) DEFAULT 1 NULL,
    [intFiscalPeriodId]        INT             NULL, 
    [intTaskId]                INT             NULL,
    [intBankTransferTypeId]	   INT            NULL,
	[dtmAccrual]	       DATETIME       NULL,
    [dtmInTransit]	       DATETIME       NULL,
	[dblCrossRate]             DECIMAL(18,7)  NULL,
    [dblReverseRate]           DECIMAL(18,7)  NULL,
    ...
    [dblRateAmountSettlementTo]DECIMAL(18,7)  NULL,
    [dblAmountSettlementFrom]  DECIMAL(18,6)  NULL,
    [dblRateAmountSettlementFrom]DECIMAL(18,7)   NULL,
    [dblGainLossTo]            DECIMAL(18,6)  NULL,
    [dblGainLossFrom]          DECIMAL(18,6)  NULL,
	[dblRateFeesFrom]		   DECIMAL(18,7) NULL,
	[dblRateFeesTo]            DECIMAL(18,7) NULL,
