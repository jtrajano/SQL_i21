CREATE TABLE [dbo].[tblCMBankTransfer] (
	...
	[dblRateAmountTo]                  DECIMAL (38,20) DEFAULT 1 NULL,
	[intCurrencyExchangeRateTypeId] INT	NULL,
	[dblRateAmountFrom]        DECIMAL (38,20) DEFAULT 1 NULL,
    [intFiscalPeriodId]        INT             NULL, 
    [intTaskId]                INT             NULL,
    [intBankTransferTypeId]	   INT            NULL,
	[dtmAccrual]	       DATETIME       NULL,
    [dtmInTransit]	       DATETIME       NULL,
	[dblCrossRate]             DECIMAL(38,20)  NULL,
    [dblReverseRate]           DECIMAL(38,20)  NULL,
    ...
    [dblAmountSettlementTo]    DECIMAL(18,6)  NULL,
    [dblRateAmountSettlementTo]DECIMAL(38,20)  NULL,
    [dblAmountSettlementFrom]  DECIMAL(18,6)  NULL,
    [dblRateAmountSettlementFrom]DECIMAL(38,20)   NULL,
    [dblGainLossTo]            DECIMAL(18,6)  NULL,
    [dblGainLossFrom]          DECIMAL(18,6)  NULL,
	[dblRateFeesFrom]		   DECIMAL(38,20) NULL,
	[dblRateFeesTo]            DECIMAL(38,20) NULL,
    ...
    [dblReceivableFn]           DECIMAL(18,6) NULL,
