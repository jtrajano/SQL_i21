CREATE TABLE [dbo].[tblCMBankTransfer] (
	...
	[dblCrossRate]             DECIMAL(18,6)  DEFAULT 1 NULL,
    [dblReverseRate]           DECIMAL(18,6)  DEFAULT 1 NULL,
    ...
    [dblRateAmountSettlementTo]DECIMAL(18,6)  NULL,
    [dblAmountSettlementFrom]  DECIMAL(18,6)  NULL,
    [dblRateAmountSettlementFrom]DECIMAL(18,6)  NULL,
