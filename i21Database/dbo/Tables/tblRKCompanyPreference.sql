...
(
	...
	CONSTRAINT [FK_tblRKCompanyPreference_tblICUnitMeasure_intForecastWeeklyConsumptionUOMId] FOREIGN KEY([intForecastWeeklyConsumptionUOMId]) REFERENCES [dbo].[tblICUnitMeasure] ([intUnitMeasureId])
)