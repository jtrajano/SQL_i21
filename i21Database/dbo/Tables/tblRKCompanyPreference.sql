...
(
	...
	[ysnEvaluationByLocation] BIT NULL DEFAULT((0)),
	[ysnEvaluationByMarketZone] BIT NULL DEFAULT((0)),
	[ysnEvaluationByOriginPort] BIT NULL DEFAULT((0)),
	[ysnEvaluationByDestinationPort] BIT NULL DEFAULT((0)),
	[ysnEvaluationByCropYear] BIT NULL DEFAULT((0)),
	[ysnEvaluationByStorageLocation] BIT NULL DEFAULT((0)),
	[ysnEvaluationByStorageUnit] BIT NULL DEFAULT((0)),
	[ysnEnableAllocatedContractsGainOrLoss] BIT NULL DEFAULT((0)),
	[strTransactionShouldBeRelieved] NVARCHAR(50) COLLATE Latin1_General_CI_AS NOT NULL DEFAULT('Final Invoiced'),
	[ysnDropUninvoicedPurchaseAndInvoicedSales] BIT NULL DEFAULT((1)),
	[ysnEnableCommissionExemptAndOverride] BIT NULL DEFAULT((0)),
	[ysnEnableMatchPostToSAPStaging] BIT NULL DEFAULT((0)),
