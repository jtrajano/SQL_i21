...
(
    ...
    CONSTRAINT [FK_tblCTReassign_tblEntity_intEntityId] FOREIGN KEY (intEntityId) REFERENCES tblEMEntity(intEntityId),
    ...
    CONSTRAINT [FK_tblCTReassign_tblEntity_intCreatedById] FOREIGN KEY (intCreatedById) REFERENCES tblEMEntity(intEntityId),
