...
(
	...
	ysnEnableHTAMultiplePricing bit not null default 0,
	...
	ysnEnableFXForwardRequestOnSequence bit not null default 0,
	ysnEnableVendorCertificationProgram BIT NOT NULL DEFAULT 0,
	ysnEnableBudgetForBasisPricing bit not null default 0,
	ysnEnablePackingWeightAdjustment BIT NOT NULL DEFAULT 0,
	ysnEnableLetterOfCredit BIT NOT NULL DEFAULT 0,
	ysnEnableOutrightPricing BIT NOT NULL DEFAULT 0,
	ysnEnableDerivativeInArbitrage BIT NOT NULL DEFAULT 0,
	ysnEnableFutureMonthChange BIT NOT NULL DEFAULT 0,
	...
	ysnLocationLeadTime BIT NULL DEFAULT 0,
	ysnRestrictContractsWithLocationDifferentFromUser BIT NULL DEFAULT 0,
	ysnEnableValueBasedContract BIT NULL DEFAULT 0,
	ysnForceReasonCodeForAmendments BIT NULL DEFAULT 0,
	ysnEnableNetWeightAdjustment BIT NULL DEFAULT 0,
	ysnSequenceImportToCreateCBLogs BIT NULL DEFAULT 0,
	...
	intTransactionForexId int null default 1,
	ysnRequireStorageLocation BIT NULL DEFAULT 0,
	ysnEnableItemXrefVendorProduct BIT NOT NULL DEFAULT 0,
