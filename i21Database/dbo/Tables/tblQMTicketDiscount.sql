...
(
	...
	CONSTRAINT [UK_tblQMTicketDiscount_intTicketId_intTicketFileId_strDiscountCode_strDiscountCodeDescription] UNIQUE ([intTicketId],[intTicketFileId],[strDiscountCode],[strDiscountCodeDescription]), 
