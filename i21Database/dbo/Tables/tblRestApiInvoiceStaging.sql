CREATE TABLE tblRestApiInvoiceStaging (
	  intRestApiInvoiceStagingId            INT IDENTITY(1, 1)  NOT NULL
	...
	,[strCompanyLocation]					NVARCHAR(250)	COLLATE Latin1_General_CI_AS	NULL
