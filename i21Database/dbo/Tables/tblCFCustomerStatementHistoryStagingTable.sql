CREATE TABLE [dbo].[tblCFCustomerStatementHistoryStagingTable] (
    ...
    [strDisplayName]               NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strInvoiceNumber]             NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strReferenceNumber]           NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strBOLNumber]                 NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strRecordNumber]              NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strTransactionType]           NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strPaymentInfo]               NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strSalespersonName]           NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    ...
    [strUserId]                    NVARCHAR (150)  COLLATE Latin1_General_CI_AS NULL,
    [strStatementFormat]           NVARCHAR (150)  COLLATE Latin1_General_CI_AS NULL,
    ...
    [strCFTempInvoiceReportNumber] NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strCFEmailDistributionOption] NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strCFEmail]                   NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [ysnCFShowDiscountOnInvoice]   BIT             NULL,
    [ysnStatementCreditLimit]      BIT             NULL,
    [blbLogo]                      VARBINARY (MAX) NULL,
    [strCFTerm]                    NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strCFTermCode]                NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strComment]                   NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strCFInvoiceNumber]           NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strInvoiceNumberHistory]      NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
