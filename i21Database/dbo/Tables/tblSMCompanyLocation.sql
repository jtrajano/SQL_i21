...
(
	...
	[intAllowablePickDayRange] INT NOT NULL,
	...
	[intDefaultBlendProductionLocationId] INT NOT NULL,
	[ysnDefaultPalletTagReprintonPositiveRelease] BIT NULL DEFAULT (0), 
	[intDefaultStatusForPreSanitizedLotId] INT NOT NULL, 
	[intDefaultInboundDockDoorUnitId] INT NOT NULL, 
	...
	[intNoOfCopiesToPrintforPalletSlip] INT NOT NULL,
	...
	CONSTRAINT [FK_tblSMCompanyLocation_tblEntity_DefaultCarrier] FOREIGN KEY ([intDefaultCarrierId]) REFERENCES [tblEntity]([intEntityId]),
	...
	CONSTRAINT [FK_tblSMCompanyLocation_tblICLotStatus_DefaultBlendProductionLocation] FOREIGN KEY ([intDefaultStatusForPreSanitizedLotId]) REFERENCES [tblICLotStatus]([intLotStatusId]),
	...
	CONSTRAINT [FK_tblSMCompanyLocation_tblEntity_ProductAlertOwner] FOREIGN KEY ([intProductAlertOwnerId]) REFERENCES [tblEntity]([intEntityId]),
