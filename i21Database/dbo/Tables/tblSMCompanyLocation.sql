...
(
	...
	CONSTRAINT [FK_tblSMCompanyLocation_tblEntity_DefaultCarrier] FOREIGN KEY ([intDefaultCarrierId]) REFERENCES tblEMEntity([intEntityId]),
	...
	CONSTRAINT [FK_tblSMCompanyLocation_tblEntity_ProductAlertOwner] FOREIGN KEY ([intProductAlertOwnerId]) REFERENCES tblEMEntity([intEntityId]),
