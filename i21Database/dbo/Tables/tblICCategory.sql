...
*/
	...
	(
		...
		[imgReceiptImage] VARBINARY(MAX) NULL, 
		[imgWIPImage] VARBINARY(MAX) NULL, 
		[imgFGImage] VARBINARY(MAX) NULL, 
		[imgShipImage] VARBINARY(MAX) NULL, 
		...
		[dblEstimatedYieldRate] NUMERIC(18,6) NULL DEFAULT ((0)), 
