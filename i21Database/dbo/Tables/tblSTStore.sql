...
(
	...
	CONSTRAINT [FK_tblSTStore_tblEntity_intDefaultVendorId] FOREIGN KEY ([intDefaultVendorId]) REFERENCES [tblEntity]([intEntityId]), 
    ...
    CONSTRAINT [FK_tblSTStore_tblEntity_intBegVendorNumberId] FOREIGN KEY ([intBegVendorNumberId]) REFERENCES [tblEntity]([intEntityId]), 
