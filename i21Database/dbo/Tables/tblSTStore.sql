...
(
    ...
    [strSate] NVARCHAR(2) COLLATE Latin1_General_CI_AS NULL, 
    ...
    [stGLCoId] NVARCHAR(2) COLLATE Latin1_General_CI_AS NULL, 
    ...
    [ysnBreakoutPropCardTotal] NVARCHAR COLLATE Latin1_General_CI_AS NULL, 
    ...
    [intCashinBankGLId] INT NULL, 
    [intPettyCashGLId] INT NULL, 
    [intARGLId] INT NULL, 
    [intBadDebtGLId] INT NULL, 
    [intPedingAPGLId] INT NULL, 
    [intNsfChecksGLId] INT NULL, 
    [intCashOverShortGLId] INT NULL, 
    [intCustomerDiscountGLId] INT NULL, 
    [intFinanceChargeGLId] INT NULL, 
    [intARAdjustmentGLId] INT NULL, 
	...
	CONSTRAINT [FK_tblSTStore_tblGLAccount_intCashinBankId] FOREIGN KEY ([intCashinBankGLId]) REFERENCES [tblGLAccount]([intAccountId]), 
	CONSTRAINT [FK_tblSTStore_tblGLAccount_intPettyCashGLId] FOREIGN KEY ([intPettyCashGLId]) REFERENCES [tblGLAccount]([intAccountId]), 
    CONSTRAINT [FK_tblSTStore_tblGLAccount_intARGLId] FOREIGN KEY ([intARGLId]) REFERENCES [tblGLAccount]([intAccountId]), 
	CONSTRAINT [FK_tblSTStore_tblGLAccount_intBadDebtGLId] FOREIGN KEY ([intBadDebtGLId]) REFERENCES [tblGLAccount]([intAccountId]), 
	CONSTRAINT [FK_tblSTStore_tblGLAccount_intPedingAPGLId] FOREIGN KEY ([intPedingAPGLId]) REFERENCES [tblGLAccount]([intAccountId]), 
	CONSTRAINT [FK_tblSTStore_tblGLAccount_intNsfChecksGLId] FOREIGN KEY ([intNsfChecksGLId]) REFERENCES [tblGLAccount]([intAccountId]), 
	CONSTRAINT [FK_tblSTStore_tblGLAccount_intCashOverShortGLId] FOREIGN KEY ([intCashOverShortGLId]) REFERENCES [tblGLAccount]([intAccountId]), 
	CONSTRAINT [FK_tblSTStore_tblGLAccount_intCustomerDiscountGLId] FOREIGN KEY ([intCustomerDiscountGLId]) REFERENCES [tblGLAccount]([intAccountId]), 
	CONSTRAINT [FK_tblSTStore_tblGLAccount_intFinanceChargeGLId] FOREIGN KEY ([intFinanceChargeGLId]) REFERENCES [tblGLAccount]([intAccountId]), 
	CONSTRAINT [FK_tblSTStore_tblGLAccount_intARAdjustmentGLId] FOREIGN KEY ([intARAdjustmentGLId]) REFERENCES [tblGLAccount]([intAccountId]), 
	CONSTRAINT [FK_tblSTStore_tblAPVendor_intDefaultVendorId] FOREIGN KEY ([intDefaultVendorId]) REFERENCES [tblAPVendor]([intEntityId]), 
    ...
    CONSTRAINT [FK_tblSTStore_tblAPVendor_intBegVendorNumberId] FOREIGN KEY ([intBegVendorNumberId]) REFERENCES [tblAPVendor]([intEntityId]), 
    CONSTRAINT [FK_tblSTStore_tblAPVendor_intEndVendorNumberId] FOREIGN KEY ([intEndVendorNumberId]) REFERENCES [tblAPVendor]([intEntityId]), 
   );