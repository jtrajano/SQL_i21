...
(
	...
	CONSTRAINT [FK_tblSTStore_tblEntity_intDefaultVendorId] FOREIGN KEY ([intDefaultVendorId]) REFERENCES tblEMEntity([intEntityId]), 
    ...
    CONSTRAINT [FK_tblSTStore_tblEntity_intBegVendorNumberId] FOREIGN KEY ([intBegVendorNumberId]) REFERENCES tblEMEntity([intEntityId]), 
    CONSTRAINT [FK_tblSTStore_tblEntity_intEndVendorNumberId] FOREIGN KEY ([intEndVendorNumberId]) REFERENCES tblEMEntity([intEntityId]), 
