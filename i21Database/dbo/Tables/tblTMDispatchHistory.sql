CREATE TABLE [dbo].[tblTMDispatchHistory] (
    [intConcurrencyId]         INT             DEFAULT 1 NOT NULL,
    [intDispatchSyncId]        INT             IDENTITY (1, 1) NOT NULL,
    ...
    [strPricingMethod]			NVARCHAR(15) COLLATE Latin1_General_CI_AS NOT NULL DEFAULT ('Regular'), 
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'tblTMDispatchHistory',
    @level2type = N'COLUMN',
...
CREATE INDEX [IX_tblTMDispatchHistory_intSiteId] ON [dbo].[tblTMDispatchHistory] ([intSiteId])

GO

CREATE INDEX [IX_tblTMDispatchHistory_intDeliveryHistoryId] ON [dbo].[tblTMDispatchHistory] ([intDeliveryHistoryId])
