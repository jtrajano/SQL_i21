...
(
    ...
    CONSTRAINT [FK_tblCRMOpportunityQuote_tblCRMOpportunity_intOpportunityId] FOREIGN KEY ([intOpportunityId]) REFERENCES [dbo].[tblCRMOpportunity] ([intOpportunityId]),
    CONSTRAINT [FK_tblCRMOpportunityQuote_tblSOSalesorder_intSalesOrderId] FOREIGN KEY ([intSalesOrderId]) REFERENCES [dbo].[tblSOSalesOrder] ([intSalesOrderId])
)
