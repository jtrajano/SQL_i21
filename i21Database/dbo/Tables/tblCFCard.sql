CREATE TABLE [dbo].[tblCFCard] (
    ...
    [strCardValidationCode]      NVARCHAR (250) COLLATE Latin1_General_CI_AS NULL,
    ...
    [strCardNotation]                NVARCHAR (100) COLLATE Latin1_General_CI_AS NULL,
	[intDefaultDriverPin]        INT            NULL,
    [ysnAddToEncoding]           BIT            DEFAULT ((0)) NULL,
