CREATE TABLE [dbo].[tblTMGenerateOrder] (
   [intGenerateOrderId] [int] IDENTITY(1,1) NOT NULL,
	...
	[strPendingOption] [nvarchar](10) NOT NULL CONSTRAINT [DF_tblTMGenerateOrder_strPendingOption]  DEFAULT (N'Include'),
	[strFillMethods] [nvarchar](max) NULL,
	[strItems] [nvarchar](max) NULL,
	[strLocations] [nvarchar](max) NULL,
	[strRoutes] [nvarchar](max) NULL,
	[strDrivers] [nvarchar](max) NULL,
	[strClocks] [nvarchar](max) NULL,
	[dblPercentFull] [numeric](18, 6) NULL,
	[intNextDegreeDay] [int] NULL,
	[dtmNextJulianDate] [datetime] NULL,
	[strOnHold] [nvarchar](10) NOT NULL CONSTRAINT [DF_tblTMGenerateOrder_strOnHold]  DEFAULT (N'Exclude'),
	[strPastDue] [nvarchar](10) NOT NULL CONSTRAINT [DF_tblTMGenerateOrder_strPastDue]  DEFAULT (N'Exclude'),
	[strOverCreditLimit] [nvarchar](10) NOT NULL CONSTRAINT [DF_tblTMGenerateOrder_strOverCreditLimit]  DEFAULT (N'Include'),
	[strBudgetCustomers] [nvarchar](10) NOT NULL CONSTRAINT [DF_tblTMGenerateOrder_strBudgetCustomers]  DEFAULT (N'Include'),
