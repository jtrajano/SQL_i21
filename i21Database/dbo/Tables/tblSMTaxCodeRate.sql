...
(
    ...
    [strCalculationMethod]			NVARCHAR(100) COLLATE Latin1_General_CI_AS NOT NULL, 
	...
	CONSTRAINT [FK_tblSMTaxCodeRate_tblICCategory_intCategoryId] FOREIGN KEY ([intGasolineItemCategoryId]) REFERENCES [tblICCategory]([intCategoryId])
