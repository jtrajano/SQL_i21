...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Indicates if Accounting Period is shown in related search grids' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'tblGLCompanyPreferenceOption', @level2type=N'COLUMN',@level2name=N'ysnShowAccountingPeriod' 
GO