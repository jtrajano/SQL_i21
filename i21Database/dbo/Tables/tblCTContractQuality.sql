	...
	CREATE TABLE [dbo].[tblCTContractQuality](
		...
		[intCurrencyIdTmp] [int] NULL,
		[strCurrencyTmp] [nvarchar](100) COLLATE Latin1_General_CI_AS  NULL,
		[intUnitMeasureIdTmp] [int] NULL,
		[strUnitMeasureTmp] [nvarchar](100) COLLATE Latin1_General_CI_AS  NULL,
