...
(
	...
	CONSTRAINT [PK_tblRKAllocatedContractsPostRecap] PRIMARY KEY CLUSTERED ([intAllocatedContractsPostRecapId] ASC),
	CONSTRAINT [FK_tblRKAllocatedContractsPostRecap_tblRKAllocatedContractsGainOrLossHeader] FOREIGN KEY ([intAllocatedContractsGainOrLossHeaderId]) REFERENCES [tblRKAllocatedContractsGainOrLossHeader]([intAllocatedContractsGainOrLossHeaderId]) ON DELETE CASCADE
)