...
CONSTRAINT [FK_tblLGLoad_tblEntity_intTerminalEntityId] FOREIGN KEY ([intTerminalEntityId]) REFERENCES [tblEntity]([intEntityId]),
CONSTRAINT [FK_tblLGLoad_tblEntity_intShippingLineEntityId_intEntityId] FOREIGN KEY ([intShippingLineEntityId]) REFERENCES [tblEntity]([intEntityId]),
CONSTRAINT [FK_tblLGLoad_tblEntity_intForwardingAgentEntityId_intEntityId] FOREIGN KEY ([intForwardingAgentEntityId]) REFERENCES [tblEntity]([intEntityId]),
...
CONSTRAINT [FK_tblLGLoad_tblEntity_intInsurerEntityId_intEntityId] FOREIGN KEY ([intInsurerEntityId]) REFERENCES [tblEntity]([intEntityId]),
