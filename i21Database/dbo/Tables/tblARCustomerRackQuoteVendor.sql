...
(
	...
	CONSTRAINT [FK_tblARCustomerRackQuoteHeader_tblEntityLocation] FOREIGN KEY ([intEntityCustomerLocationId]) REFERENCES [dbo].[tblEMEntityLocation]([intEntityLocationId]),
