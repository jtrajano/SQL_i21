...
(
    ...
    CONSTRAINT [FK_tblGRDiscountLocationUse_tblGRDiscountId_intDiscountId] FOREIGN KEY ([intDiscountId]) REFERENCES [tblGRDiscountId]([intDiscountId]), 
    ...
    CONSTRAINT [AK_tblGRDiscountLocationUse_intCompanyLocationId] UNIQUE ([intCompanyLocationId])
)
