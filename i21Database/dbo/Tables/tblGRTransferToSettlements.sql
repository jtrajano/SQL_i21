...
(
	...
	,CONSTRAINT [FK_tblGRTransferToSettlements_intTransferSettlementHeaderId_intTransferSettlementHeaderId] FOREIGN KEY ([intTransferSettlementHeaderId]) REFERENCES [dbo].tblGRTransferSettlementsHeader ([intTransferSettlementHeaderId])
