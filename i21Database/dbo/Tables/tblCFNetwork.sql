CREATE TABLE [dbo].[tblCFNetwork] (
    ...
    [strKeyFilePath]                        NVARCHAR (100)  COLLATE Latin1_General_CI_AS NULL,
    [strPassphrase]                         NVARCHAR (100)  COLLATE Latin1_General_CI_AS NULL,
    [strHostKeyFingerPrint]                 NVARCHAR (100)  COLLATE Latin1_General_CI_AS NULL,
    [strBasePath]                           NVARCHAR (100)  COLLATE Latin1_General_CI_AS NULL,
    [strRemoteDownloadPath]                 NVARCHAR (100)  COLLATE Latin1_General_CI_AS NULL,
    [strRemoteUploadPath]                   NVARCHAR (100)  COLLATE Latin1_General_CI_AS NULL,
    [strDecryptKeyFilePath]                 NVARCHAR (200)  COLLATE Latin1_General_CI_AS NULL,
    [strDecryptPassphrase]                  NVARCHAR (100)  COLLATE Latin1_General_CI_AS NULL,
    [intConcurrencyId]                      INT          CONSTRAINT [DF_tblCFNetwork_intConcurrencyId] DEFAULT ((1)) NULL,
    [strDownloadFileName]                   NVARCHAR (100)  COLLATE Latin1_General_CI_AS NULL,
    [strAllowExemptionsOnExtAndRetailTrans] NVARCHAR (100)  COLLATE Latin1_General_CI_AS NULL,
    [ysnPostForeignSales]                   BIT          NULL,
    [strExportValidURL]                     NVARCHAR (250)  COLLATE Latin1_General_CI_AS  NULL,
