...
(
	...
	CONSTRAINT FK_tblMFWastage_tblICUnitMeasure_intNetWeightUnitMeasureId FOREIGN KEY (intNetWeightUnitMeasureId) REFERENCES tblICUnitMeasure(intUnitMeasureId),
