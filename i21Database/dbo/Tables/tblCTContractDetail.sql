...
CREATE NONCLUSTERED INDEX [IX_tblCTContractDetail_intContractHeaderId] ON [dbo].[tblCTContractDetail](intContractHeaderId);
GO
...
CREATE TRIGGER [dbo].[trgCTContractDetail]
	...
	begin try
		...
		set @queryResult = cursor for
			...
			where
				a.intContractDetailId = @intActiveContractDetailId
				and z.intContractHeaderId = a.intContractHeaderId
