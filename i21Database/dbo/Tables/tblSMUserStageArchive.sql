CREATE TABLE tblSMUserStageArchive
(
	intUserStageArchiveId			INT IDENTITY(1,1),
	...
	CONSTRAINT [PK_tblSMUserStageArchive_intUserStageArchiveId] PRIMARY KEY ([intUserStageArchiveId])
)