...
*/
	...
	(
		...
		[dblLastForexCost]			NUMERIC(38,20) DEFAULT ((0)) NULL,		
		...
		[intLastCostCurrencyId]		INT NULL, 
		[dblLastCostForexRate]		NUMERIC(38,20) DEFAULT ((0)) NULL,
		[intLastCostForexRateTypeId]		INT NULL, 
