...
(
	...
	[intTotalRows] INT NULL DEFAULT(0),
	[strUniqueId] UNIQUEIDENTIFIER NULL,
	[intRowsImported] INT NULL DEFAULT(0),
	[intRowsUpdated] INT NULL DEFAULT(0),
	[intRowsSkipped] INT NULL DEFAULT(0),
	[intTotalErrors] INT NULL DEFAULT(0),
	[intTotalWarnings] INT NULL DEFAULT(0),	
