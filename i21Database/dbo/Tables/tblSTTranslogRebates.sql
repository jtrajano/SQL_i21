...
CREATE NONCLUSTERED INDEX [IX_tblSTTranslogRebates_strTransRollback_strTransFuelPrepay_strTrpPaycode]
    ON [dbo].[tblSTTranslogRebates]([strTransRollback], [strTransFuelPrepay], [strTrpPaycode])
GO
