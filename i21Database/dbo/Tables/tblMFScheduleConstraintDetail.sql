CREATE TABLE tblMFScheduleConstraintDetail (
	...
	,CONSTRAINT [FK_tblMFScheduleConstraintDetail_tblMFScheduleLine_intScheduleLineId] FOREIGN KEY (intScheduleWorkOrderId) REFERENCES tblMFScheduleWorkOrder(intScheduleWorkOrderId)
