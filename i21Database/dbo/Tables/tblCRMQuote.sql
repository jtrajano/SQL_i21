...
(
	...
	CONSTRAINT [PK_tblCRMQuote_intQuoteId] PRIMARY KEY CLUSTERED ([intQuoteId] ASC),
	CONSTRAINT [UQ_tblCRMQuote_intOpportunityId_intSalesOrderId] UNIQUE ([intOpportunityId],[intSalesOrderId]),
    CONSTRAINT [FK_tblCRMQuote_tblCRMOpportunity_intOpportunityId] FOREIGN KEY ([intOpportunityId]) REFERENCES [dbo].[tblCRMOpportunity] ([intOpportunityId]),
