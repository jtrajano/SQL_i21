...
CONSTRAINT [FK_tblLGShipment_tblEntity_intVendorEntityId_intEntityId] FOREIGN KEY ([intVendorEntityId]) REFERENCES tblEMEntity([intEntityId]),
...
CONSTRAINT [FK_tblLGShipment_tblEntity_intCustomerEntityId_intEntityId] FOREIGN KEY ([intCustomerEntityId]) REFERENCES tblEMEntity([intEntityId]),
...
CONSTRAINT [FK_tblLGShipment_tblEntity_intTerminalEntityId] FOREIGN KEY ([intTerminalEntityId]) REFERENCES tblEMEntity([intEntityId]),
CONSTRAINT [FK_tblLGShipment_tblEntity_intShippingLineEntityId_intEntityId] FOREIGN KEY ([intShippingLineEntityId]) REFERENCES tblEMEntity([intEntityId]),
...
CONSTRAINT [FK_tblLGShipment_tblEntity_intForwardingAgentEntityId_intEntityId] FOREIGN KEY ([intForwardingAgentEntityId]) REFERENCES tblEMEntity([intEntityId]),
...
CONSTRAINT [FK_tblLGShipmentInStore_tblEntity_intTruckerEntityId] FOREIGN KEY ([intTruckerEntityId]) REFERENCES tblEMEntity([intEntityId]),
...
CONSTRAINT [FK_tblLGShipment_tblEntity_intInsurerEntityId_intEntityId] FOREIGN KEY ([intInsurerEntityId]) REFERENCES tblEMEntity([intEntityId])
)
