...
(
	...
	CONSTRAINT [FK_tblICInventoryShiftPhysicalCount_tblICItem] FOREIGN KEY ([intItemId]) REFERENCES [tblICItem]([intItemId]),	
...
CREATE NONCLUSTERED INDEX [IX_tblICInventoryShiftPhysicalHistory_intItemId]
	ON [dbo].[tblICInventoryShiftPhysicalHistory]([intItemId] ASC);
