...
(
    ...
    CONSTRAINT [FK_tblLGWarehouseInstructionHeader_tblLGDeliveryHeader_intDeliveryHeaderId] FOREIGN KEY ([intDeliveryHeaderId]) REFERENCES [tblLGDeliveryHeader]([intDeliveryHeaderId]),	
