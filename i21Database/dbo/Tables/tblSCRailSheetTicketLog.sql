...
(
	...
	,constraint fk_tblSCRailSheetTicketLog_tblSCRailSheetTicket_intRailSheetTicketId foreign key (intRailSheetTicketId) references tblSCRailSheetTicket(intRailSheetTicketId)  ON DELETE CASCADE
)
