...
(
	...
	[ysnShowRejectedToAllUsers]						BIT NOT NULL DEFAULT 0,
	...
	[ysnAzureSqlServerEnabled]						BIT NOT NULL DEFAULT 0,
	[strAzureSqlServerName]							NVARCHAR(250) COLLATE Latin1_General_CI_AS NULL,
	[strAzureSqlDatabase]							NVARCHAR(250) COLLATE Latin1_General_CI_AS NULL,
	[strAzureSqlUsername]							NVARCHAR(250) COLLATE Latin1_General_CI_AS NULL,
	[strAzureSqlPassword]							NVARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL,
