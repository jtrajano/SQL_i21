CREATE TABLE [dbo].[tblSOSalesOrderDetail] (
	...
	CONSTRAINT [FK_tblSOSalesOrderDetail_tblCTItemContractHeader_intItemContractHeaderId] FOREIGN KEY ([intItemContractHeaderId]) REFERENCES [dbo].[tblCTContractHeader] ([intContractHeaderId]),
	CONSTRAINT [FK_tblSOSalesOrderDetail_tblCTItemContractDetail_intItemContractDetailId] FOREIGN KEY ([intItemContractDetailId]) REFERENCES [dbo].[tblCTContractDetail] ([intContractDetailId]),
