CREATE TABLE [dbo].[tblSOSalesOrderDetail] (
	...
	CONSTRAINT [FK_tblSOSalesOrderDetail_tblCTItemContractHeader_intItemContractHeaderId] FOREIGN KEY ([intItemContractHeaderId]) REFERENCES [dbo].[tblCTItemContractHeader] ([intItemContractHeaderId]),
	CONSTRAINT [FK_tblSOSalesOrderDetail_tblCTItemContractDetail_intItemContractDetailId] FOREIGN KEY ([intItemContractDetailId]) REFERENCES [dbo].[tblCTItemContractDetail] ([intItemContractDetailId]),
