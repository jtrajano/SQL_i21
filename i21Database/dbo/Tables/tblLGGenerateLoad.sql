...
CONSTRAINT [FK_tblLGGenerateLoad_tblEntity_intPHaulerEntityId] FOREIGN KEY ([intPHaulerEntityId]) REFERENCES tblEMEntity([intEntityId]),
CONSTRAINT [FK_tblLGGenerateLoad_tblEntityLocation_intPEntityLocationId] FOREIGN KEY ([intPEntityLocationId]) REFERENCES [tblEMEntityLocation]([intEntityLocationId]),
...
CONSTRAINT [FK_tblLGGenerateLoad_tblEntity_intSHaulerEntityId] FOREIGN KEY ([intSHaulerEntityId]) REFERENCES tblEMEntity([intEntityId]),
CONSTRAINT [FK_tblLGGenerateLoad_tblEntityLocation_intSEntityLocationId] FOREIGN KEY ([intSEntityLocationId]) REFERENCES [tblEMEntityLocation]([intEntityLocationId]),
