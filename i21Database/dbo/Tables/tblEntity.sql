CREATE TABLE [dbo].[tblEntity] (
    ...
    [str1099Name]      NVARCHAR (50)  NULL,
    [str1099Form]      NVARCHAR (50)  NULL,
    [str1099Type]      NVARCHAR (50)  NULL,
    [strFederalTaxId]  NVARCHAR (50)  NULL,
    [dtmW9Signed]      DATETIME       NULL,
    [intConcurrencyId] INT            CONSTRAINT [DF_tblEntities_intConcurrencyId] DEFAULT ((0)) NOT NULL,
