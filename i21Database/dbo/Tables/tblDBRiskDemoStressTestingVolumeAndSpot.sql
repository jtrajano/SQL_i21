CREATE TABLE [dbo].[tblDBRiskDemoStressTestingVolumeAndSpot]
(
	[intRiskDemoStressTestingVolumeAndSpotId]	INT IDENTITY (1, 1) NOT NULL,
	...
	CONSTRAINT [PK_tblDBRiskDemoStressTestingVolumeAndSpot] PRIMARY KEY CLUSTERED ([intRiskDemoStressTestingVolumeAndSpotId] ASC),
)
