CREATE TABLE [dbo].[tblTRBulkPlantFreight] (
	...
	CONSTRAINT [FK_tblTRBulkPlantFreight_tblEntityTariffType_intEntityTariffTypeId] FOREIGN KEY ([intEntityTariffTypeId]) REFERENCES [dbo].[tblEntityTariffType] ([intEntityTariffTypeId])
