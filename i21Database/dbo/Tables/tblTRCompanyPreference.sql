...
(
    ...
    CONSTRAINT [FK_tblTRCompanyPreference_tblSMShipVia] FOREIGN KEY ([intShipViaId]) REFERENCES [tblSMShipVia]([intEntityShipViaId]),
	CONSTRAINT [FK_tblTRCompanyPreference_Seller] FOREIGN KEY ([intSellerId]) REFERENCES [tblSMShipVia]([intEntityShipViaId]), 
