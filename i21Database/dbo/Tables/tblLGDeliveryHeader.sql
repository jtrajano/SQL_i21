...
(
	...
	CONSTRAINT [FK_tblLGDeliveryHeader_tblEntity_intCustomerEntityId_intEntityId] FOREIGN KEY ([intCustomerEntityId]) REFERENCES tblEMEntity([intEntityId]),
	...
	CONSTRAINT [FK_tblLGDeliveryHeader_tblEntity_intTruckerEntityId] FOREIGN KEY ([intTruckerEntityId]) REFERENCES tblEMEntity([intEntityId]),
