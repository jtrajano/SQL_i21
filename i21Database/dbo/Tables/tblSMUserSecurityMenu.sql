CREATE TABLE [dbo].[tblSMUserSecurityMenu] (
    ...
    CONSTRAINT [FK_tblSMUserSecurityMenu_tblSMUserSecurity] FOREIGN KEY ([intEntityUserSecurityId]) REFERENCES [dbo].[tblSMUserSecurity] ([intEntityUserSecurityId]) ON DELETE CASCADE,
