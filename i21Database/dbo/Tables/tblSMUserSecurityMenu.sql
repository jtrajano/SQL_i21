CREATE TABLE [dbo].[tblSMUserSecurityMenu] (
    ...
    CONSTRAINT [FK_tblSMUserSecurityMenu_tblSMUserSecurity] FOREIGN KEY ([intUserSecurityId]) REFERENCES [dbo].[tblSMUserSecurity] ([intEntityUserSecurityId]) ON DELETE CASCADE,
