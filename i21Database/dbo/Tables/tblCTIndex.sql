...
(
	...
	CONSTRAINT [FK_tblCTIndex_tblEntity_intVendorId] FOREIGN KEY ([intVendorId]) REFERENCES tblEMEntity([intEntityId]),
	CONSTRAINT [FK_tblCTIndex_tblEntityLocation_intVendorLocationId] FOREIGN KEY ([intVendorLocationId]) REFERENCES [tblEMEntityLocation]([intEntityLocationId])
)
