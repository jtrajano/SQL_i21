CREATE TABLE [dbo].[tblARCustomer] (
    ...
    [ysnApplySalesTax]                BIT             DEFAULT ((1)) NOT NULL,
    [ysnApplyPrepaidTax]              BIT             DEFAULT ((1)) NOT NULL,
	...
	[strBatchInvoiceBy]						NVARCHAR (50)   COLLATE Latin1_General_CI_AS NULL,
    [dtmBatchTimeFrom]                      DATETIME NULL,
    [dtmBatchTimeTo]                        DATETIME NULL,
    ...
    [ysnAllowFleetVehiclestoChangeLocation]   BIT,    
