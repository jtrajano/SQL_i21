CREATE TABLE [dbo].[tblARCustomer] (
    ...
    CONSTRAINT [FK_tblARCustomer_tblEntityLocation] FOREIGN KEY ([intDefaultLocationId]) REFERENCES [dbo].[tblEMEntityLocation] ([intEntityLocationId]),
	...
	CONSTRAINT [FK_tblARCustomer_tblEntity] FOREIGN KEY ([intEntityCustomerId]) REFERENCES [dbo].tblEMEntity ([intEntityId]) ON DELETE CASCADE,
	...
	CONSTRAINT [FK_tblARCustomer_tblEntityTariffType_intEntityTariffTypeId] FOREIGN KEY ([intEntityTariffTypeId]) REFERENCES [dbo].[tblEMEntityTariffType] ([intEntityTariffTypeId])
