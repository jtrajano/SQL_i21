...
*/
	...
	(
		...
		CONSTRAINT [FK_tblICInventoryShipment_tblEntityLocation] FOREIGN KEY ([intShipToLocationId]) REFERENCES [tblEMEntityLocation]([intEntityLocationId]), 
		...
		CONSTRAINT [FK_tblICInventoryShipment_tblEntity] FOREIGN KEY ([intEntityId]) REFERENCES tblEMEntity([intEntityId]) 
	)
