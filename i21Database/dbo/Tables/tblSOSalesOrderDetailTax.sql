...
(
	...
	CONSTRAINT [FK_tblSOSalesOrderDetailTax_tblICUnitMeasure_intUnitMeasureId] FOREIGN KEY ([intUniteMeasureId]) REFERENCES [dbo].[tblICUnitMeasure] ([intUnitMeasureId])
)
