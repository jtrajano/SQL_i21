CREATE TABLE [dbo].[tblARInvoiceDetail] (
	...
	[dblItemPrice]							NUMERIC(18, 6)	CONSTRAINT [DF_tblARInvoiceDetail_dblItemPrice] DEFAULT ((0)) NULL,
	[dblTotalByItemPrice]					NUMERIC(18, 6)	CONSTRAINT [DF_tblARInvoiceDetail_dblTotalByItemPrice] DEFAULT ((0)) NULL,
