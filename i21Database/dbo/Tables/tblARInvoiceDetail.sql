CREATE TABLE [dbo].[tblARInvoiceDetail] (
	...
	[dblTaxedPrice]							NUMERIC(18, 6)	CONSTRAINT [DF_tblARInvoiceDetail_dblTaxedPrice] DEFAULT ((0)) NULL,	
	[dblBaseTaxedPrice]						NUMERIC(18, 6)	CONSTRAINT [DF_tblARInvoiceDetail_dblBaseTaxedPrice] DEFAULT ((0)) NULL,
	[intPriceUOMId]							INT												NULL,	
	[dblUnitQuantity]						NUMERIC(18, 6)	CONSTRAINT [DF_tblARInvoiceDetail_dblUnitQuantity] DEFAULT ((0)) NULL,
	[dblTaxedQuantity]						NUMERIC(18, 6)	CONSTRAINT [DF_tblARInvoiceDetail_dblTaxedQuantity] DEFAULT ((0)) NULL,
	...
	[dblTotalDiscountedTax]					NUMERIC(18, 6)	CONSTRAINT [DF_tblARInvoiceDetail_dblTotalDiscountedTax] DEFAULT ((0)) NULL,
	[dblBaseTotalDiscountedTax]				NUMERIC(18, 6)	CONSTRAINT [DF_tblARInvoiceDetail_dblBaseTotalDiscountedTax] DEFAULT ((0)) NULL,
