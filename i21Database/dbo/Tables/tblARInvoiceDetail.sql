CREATE TABLE [dbo].[tblARInvoiceDetail] (
	...
	[strRebateSubmitted]					NVARCHAR(1)		CONSTRAINT [DF_tblARInvoiceDetail_strRebateSubmitted] DEFAULT (N'N') COLLATE Latin1_General_CI_AS NOT NULL,
	...
	[strBuybackSubmitted]					NVARCHAR(1)		CONSTRAINT [DF_tblARInvoiceDetail_strBuybackSubmitted] DEFAULT (N'N') COLLATE Latin1_General_CI_AS NOT NULL,
