CREATE TABLE [dbo].[tblAPBill] (
    ...
    [intShipFromId] INT NOT NULL DEFAULT 0, 
    [intShipToId] INT NOT NULL DEFAULT 0, 
    [intStoreLocationId] INT NOT NULL DEFAULT 0, 
    [intContactId] INT NOT NULL DEFAULT 0, 
    [intOrderById] INT NOT NULL DEFAULT 0, 
