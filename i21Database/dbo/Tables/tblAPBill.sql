CREATE TABLE [dbo].[tblAPBill] (
	...
	CONSTRAINT [FK_dbo.tblAPBill_dbo.tblEntity_intEntityId] FOREIGN KEY (intEntityId) REFERENCES tblEMEntity(intEntityId),
	...
	CONSTRAINT [FK_dbo.tblAPBill_dbo.tblEntityLocation_intShipFromId] FOREIGN KEY (intShipFromId) REFERENCES [tblEMEntityLocation](intEntityLocationId),
