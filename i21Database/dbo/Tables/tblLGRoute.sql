...
(
	...
	CONSTRAINT [FK_tblLGRoute_tblEMEntity_intEntityShipViaId] FOREIGN KEY ([intEntityShipViaId]) REFERENCES [tblEMEntity]([intEntityId]),
	CONSTRAINT [FK_tblLGRoute_tblSMShipViaTruck_intEntityShipViaTruckId] FOREIGN KEY ([intEntityShipViaTruckId]) REFERENCES [tblSMShipViaTruck]([intEntityShipViaTruckId])
)
