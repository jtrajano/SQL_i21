...
(
	...
	[strItemDesc] NVARCHAR(500) COLLATE Latin1_General_CI_AS, 
...
CREATE NONCLUSTERED INDEX [IX_tblLGLoadDetailLSPStg_intLoadStgId]
ON [dbo].[tblLGLoadDetailLSPStg] ([intLoadStgId] ASC)
GO