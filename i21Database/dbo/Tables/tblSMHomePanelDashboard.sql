...
(
	...
	CONSTRAINT [FK_tblSMHomePanelDashboard_tblSMGridLayout_intGridLayoutId] FOREIGN KEY (intGridLayoutId) REFERENCES tblSMGridLayout([intGridLayoutId]) ON DELETE CASCADE
)
