...
(
    ...
    [strOptMonthSymbol] NVARCHAR(10) COLLATE Latin1_General_CI_AS NULL, 
	[intOptionMonthRefId] INT NULL,
    ...
    CONSTRAINT [UK_tblRKOptionsMonth_intFutureMarketId_strOptionMonth] UNIQUE (intFutureMarketId, strOptionMonth, intCommodityMarketId)
