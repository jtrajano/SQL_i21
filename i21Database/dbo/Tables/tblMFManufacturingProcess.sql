...
(
	...
	CONSTRAINT FK_tblMFManufacturingProcess_tblMFAttributeType_intAttributeTypeId FOREIGN KEY (intAttributeTypeId) REFERENCES tblMFAttributeType(intAttributeTypeId)
)
