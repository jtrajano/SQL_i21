...
( 
    ...
    [strVendorIdName]	    NVARCHAR(100) COLLATE Latin1_General_CI_AS NOT NULL,
    [dblCreditLimit]        NUMERIC(18, 6) NOT NULL DEFAULT(0),
    [strBillId]	            NVARCHAR(100) COLLATE Latin1_General_CI_AS NOT NULL,
    [strGLLocation]	        NVARCHAR(100) COLLATE Latin1_General_CI_AS NOT NULL,
    [strGLLineOfBusiness]   NVARCHAR(100) COLLATE Latin1_General_CI_AS NOT NULL,
