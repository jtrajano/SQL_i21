...
*/
	...
	(
		...
		[dblSubTotal] NUMERIC(38, 20) NOT NULL DEFAULT(0),
		[dblGrandTotal] NUMERIC(38, 20) NOT NULL DEFAULT(0),
		[dblTotalGross] NUMERIC(38, 20) NOT NULL DEFAULT(0),
		[dblTotalNet] NUMERIC(38, 20) NOT NULL DEFAULT(0),
		[dblTotalTax] NUMERIC(38, 20) NOT NULL DEFAULT(0),
		[dblTotalCharges] NUMERIC(38, 20) NOT NULL DEFAULT(0),
