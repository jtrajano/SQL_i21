CREATE TABLE [dbo].[tblSMCurrency] (
    ...
    [intSort]					INT             NULL,
	[ysnApplyRounding]			BIT			  NULL DEFAULT 0, 
	[dblRoundingPlace]          NUMERIC (18, 6) NULL,
    [strRoundingMethod]			NVARCHAR (100)  COLLATE Latin1_General_CI_AS NULL,    
    [ysnReasonableness]			BIT			  NULL DEFAULT 0, 
    [dblPercentReasonable]      NUMERIC (18, 6) NULL,
    [intReasonableRateType]		INT		NULL,
	[strReasonableRateType]		NVARCHAR (100)  COLLATE Latin1_General_CI_AS NULL,
