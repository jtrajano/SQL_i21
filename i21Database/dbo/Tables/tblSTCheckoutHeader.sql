...
(
	...
	CONSTRAINT [FK_tblSTCheckoutHeader_tblARInvoice_intCustomerChargesInvoiceId] FOREIGN KEY ([intCustomerChargesInvoiceId]) REFERENCES [tblARInvoice]([intInvoiceId]),
