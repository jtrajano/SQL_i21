CREATE TABLE [dbo].[tblIPReceiptItemContainerError]
(
	...
	CONSTRAINT [PK_tblIPReceiptItemContainerError_intStageReceiptItemContainerId] PRIMARY KEY ([intStageReceiptItemContainerId])
)
