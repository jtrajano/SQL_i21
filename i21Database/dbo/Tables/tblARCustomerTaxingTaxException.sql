...
(
	...
	CONSTRAINT FK_tblARCustomerTaxingTaxException_tblEntityLocation FOREIGN KEY ([intEntityCustomerLocationId]) REFERENCES [tblEMEntityLocation]([intEntityLocationId])
)
