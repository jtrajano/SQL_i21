CREATE TABLE tblIPSampleTestResultError
(
	...
	CONSTRAINT [PK_tblIPSampleTestResultError_intStageSampleTestResultId] PRIMARY KEY ([intStageSampleTestResultId]),
	CONSTRAINT [FK_tblIPSampleTestResultError_tblIPSampleError_intStageSampleId] FOREIGN KEY ([intStageSampleId]) REFERENCES [tblIPSampleError]([intStageSampleId]) ON DELETE CASCADE
)
