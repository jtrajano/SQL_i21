...
(
	...
	CONSTRAINT [PK_tblGLPosted] PRIMARY KEY CLUSTERED ([intAccountId] ASC,[dtmDate] ASC,[intCurrencyId] ASC,[intLedgerId] ASC,[intSubledgerId] ASC),
)
GO
CREATE NONCLUSTERED INDEX [IX_tblGLPosted_intAccountId_strCode_intCurrencyId_dtmDate]
    ON [dbo].[tblGLPosted]([intAccountId] ASC, [intCurrencyId] ASC, [dtmDate] ASC)
