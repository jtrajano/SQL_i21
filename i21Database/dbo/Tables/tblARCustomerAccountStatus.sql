...
GO
CREATE INDEX [idx_tblARCustomerAccountStatus_intEntityCustomerId] ON [dbo].[tblARCustomerAccountStatus] (intEntityCustomerId) INCLUDE (intAccountStatusId)
GO
CREATE INDEX [idx_tblARCustomerAccountStatus_intAccountStatusId] ON [dbo].[tblARCustomerAccountStatus] (intAccountStatusId) INCLUDE (intEntityCustomerId)
GO