CREATE TABLE [dbo].[tblAPBasisAdvanceFutures]
(
	...
	CONSTRAINT [FK_tblAPBasisAdvanceFutures_tblAPBasisAdvanceDummyHeader] FOREIGN KEY ([intBasisAdvanceDummyHeaderId]) REFERENCES [dbo].[tblAPBasisAdvanceDummyHeader] ([intBasisAdvanceDummyHeaderId])
)
