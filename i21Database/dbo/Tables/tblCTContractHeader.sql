CREATE TABLE [dbo].[tblCTContractHeader](
	...
	CONSTRAINT [FK_tblCTContractHeader_tblEntity_intProducerId] FOREIGN KEY ([intProducerId]) REFERENCES [tblEntity] ([intEntityId]),
	CONSTRAINT [FK_tblCTContractHeader_tblEntity_intEntityId_intEntityContactId] FOREIGN KEY ([intEntityContactId]) REFERENCES [tblEntity] ([intEntityId]),
