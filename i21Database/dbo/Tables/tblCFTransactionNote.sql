CREATE TABLE [dbo].[tblCFTransactionNote] (
    ...
    [strNote]              NVARCHAR (100) COLLATE Latin1_General_CI_AS NULL,
    [strGuid]              NVARCHAR (150) COLLATE Latin1_General_CI_AS NULL,
    ...
    [strErrorTitle]        NVARCHAR (100) CONSTRAINT [DF_tblCFTransactionNote_strErrorTitle]  DEFAULT ('Current Error') COLLATE Latin1_General_CI_AS NULL,
