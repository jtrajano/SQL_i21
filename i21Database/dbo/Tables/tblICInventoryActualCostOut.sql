...
GO
	...
	CREATE NONCLUSTERED INDEX [IX_tblICInventoryActualCostOut_Posting]
		ON [dbo].[tblICInventoryActualCostOut]([intRevalueActualCostId] ASC)
		INCLUDE ([intInventoryActualCostId], [intInventoryTransactionId], [dblQty])
GO