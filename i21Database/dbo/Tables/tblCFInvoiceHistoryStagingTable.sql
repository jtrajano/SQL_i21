CREATE TABLE [dbo].[tblCFInvoiceHistoryStagingTable] (
    ...
    [strPrintTimeStamp]						NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    ...
    [strShortName]							NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
    [strProductDescription]					NVARCHAR (250)  COLLATE Latin1_General_CI_AS NULL,
    [strItemNumber]							NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
    [strItemDescription]					NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
    [strTerm]								NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
    [strTermCode]							NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
    [strTermType]							NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
    [strCalculationType]					NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
    [strFeeDescription]						NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
    [strFee]								NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
    [strInvoiceFormat]						NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
    [strProductDescriptionForTotals]		NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
    ...
    [strDiscountSchedule]					NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
    ...
    [strInvoiceNumberHistory]				NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
	...
	[strDetailDisplayValue]					NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
	[strDetailDisplayLabel]					NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
    ...
    [strDepartmentGrouping]                 NVARCHAR (500)  COLLATE Latin1_General_CI_AS NULL,
