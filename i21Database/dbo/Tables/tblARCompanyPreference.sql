...
(
	...
	[ysnAllowContractWithoutPrepayment]			BIT NOT NULL DEFAULT 0,
	...
	[ysnRetainSplitItemContractQty]				BIT NOT NULL CONSTRAINT [DF_tblARCompanyPreference_ysnRetainSplitItemContractQty] DEFAULT((0)),
