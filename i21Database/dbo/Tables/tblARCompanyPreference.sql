...
(
	...
	[strIBMMessage]							NVARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL,
	[strICSMessage]							NVARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL,
	[strQBMMessage]							NVARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL,
	[strQCSMessage]							NVARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL,
	[strSOBMMessage]						NVARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL,
	[strSOCSMessage]						NVARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL,
