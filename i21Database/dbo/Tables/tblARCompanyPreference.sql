...
(
	...
	[strQCSMessage]							NVARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL DEFAULT '',
	[strSOBMMessage]						NVARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL DEFAULT '',
	[strSOCSMessage]						NVARCHAR(MAX) COLLATE Latin1_General_CI_AS NULL DEFAULT '',
	[intAttachmentRetention]				INT NOT NULL DEFAULT 7,
	[ysnAllowIntraCompanyEntries]			BIT NULL CONSTRAINT [DF_tblARCompanyPreference_ysnAllowIntraCompanyEntries] DEFAULT((0)),
	[ysnAllowIntraLocationEntries]			BIT NULL CONSTRAINT [DF_tblARCompanyPreference_ysnAllowIntraLocationEntries] DEFAULT((0)),
	[ysnAllowSingleLocationEntries]			BIT NULL CONSTRAINT [DF_tblARCompanyPreference_ysnAllowSingleLocationEntries] DEFAULT((0)),
	...
	[ysnOverrideTaxAccountCompany]			BIT NULL CONSTRAINT [DF_tblARCompanyPreference_ysnOverrideTaxAccountCompany] DEFAULT((1)),
	[ysnOverrideTaxAccountLocation]			BIT NULL CONSTRAINT [DF_tblARCompanyPreference_ysnOverrideTaxAccountLocation] DEFAULT((1)),
