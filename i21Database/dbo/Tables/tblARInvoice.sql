CREATE TABLE [dbo].[tblARInvoice] (
	...
	[dblDiscountedTax]				NUMERIC(18, 6)									NULL DEFAULT 0,
	[dblBaseDiscountedTax]			NUMERIC(18, 6)									NULL DEFAULT 0,
	...
	[ysnIncludeTaxOnDiscount]		BIT												NOT NULL	CONSTRAINT [DF_tblARInvoice_ysnIncludeTaxOnDiscount] DEFAULT ((0)),	
