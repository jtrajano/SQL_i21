CREATE TABLE [dbo].[tblARInvoice] (
	...
	[strTransactionNo]					NVARCHAR(50)									NULL,
	[intBankId]							INT												NULL,
	...
	CONSTRAINT [FK_tblARInvoice_tblCRMOpportunity_intOpportunityId] FOREIGN KEY (intOpportunityId) REFERENCES [tblCRMOpportunity](intOpportunityId),
);
--INDEXES
GO
...
GO
CREATE NONCLUSTERED INDEX [IX_tblARInvoice_dtmPostDate]
	ON [dbo].[tblARInvoice] ([dtmPostDate])
GO
