CREATE PROCEDURE [dbo].[uspAPRptVoucherCheckOffDetail]
...
BEGIN
--SET @xmlParam = NULL 
	SELECT * FROM vyuAPRptVoucherCheckOffDetail WHERE intBillId = 0 --RETURN NOTHING TO RETURN SCHEMA
END
