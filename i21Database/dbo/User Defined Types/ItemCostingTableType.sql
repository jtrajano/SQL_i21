...
(
	...
	,[dblSalesPrice] NUMERIC(18, 6) NULL DEFAULT 0		-- The sales price of selling an item per UOM. Sales price is always in base currency. 
	...
	,[dblUnitRetail] NUMERIC(38, 20) NULL DEFAULT 0			-- Retail Price when the stock is received. Please remember this is different from the Sales Price. 
)
