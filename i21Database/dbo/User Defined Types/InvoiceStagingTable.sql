...
(	 
	...
	,[intLicenseAccountId]					INT												NULL		-- Key Value from tblGLAccount with category = 'General'
	...
	,[intDocumentMaintenanceId]				INT												NULL		-- Key Value from tblSMDocumentMaintenanceMessage (Help Desk)
