...
(
	...
	,[intCostUOMId] INT NULL								-- The UOM id associated with the cost. Ex. $12 per Gallon, the cost is $12 and Gallon is the Cost UOM. 
	,[intWeightUOMId] INT NULL								-- The UOM id for the weight. Ex. 10kg-Bags can be received but the weight being tracked by the system is Gallons. Weight UOM is optional. 
