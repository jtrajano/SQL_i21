CREATE TYPE [dbo].[CTContractSequenceBalanceType] AS TABLE (
	...
	, dblOldQuantity NUMERIC(38, 20) NOT NULL DEFAULT((0))				--> Shipment quantity (NOTE: If reposting DWG, this should be the previous DWG quantity)
	, dblQuantity NUMERIC(38, 20) NOT NULL DEFAULT((0))					--> DWG quantity
