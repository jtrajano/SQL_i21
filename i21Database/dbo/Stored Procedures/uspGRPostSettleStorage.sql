					...
					,[dblCost]						= 
														case 
															...
															CASE
																...
																ELSE case WHEN (intItemType = 3 and ysnPercentChargeType = 1) then ROUND((a.dblCashPrice / a.dblCashPriceUsed) * dbo.fnCTConvertQtyToTargetItemUOM(SS.intItemUOMId,b.intItemUOMId, SS.dblCashPrice),6) else a.dblCashPrice end
															END
														end					
