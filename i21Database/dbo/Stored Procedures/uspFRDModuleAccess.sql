...
BEGIN              
 ...
 SET @intControlId = (SELECT TOP 1 intControlId FROM tblSMControl WHERE strControlName LIKE '%Close Year%' AND intScreenId = (SELECT TOP 1 intScreenId FROM tblSMScreen WHERE strScreenId like '%Fiscal%'))    
