...
Begin
	...
	pl.intParentLotId,pld.intSubLocationId,sbl.strSubLocationName,pld.intLocationId,i.strLotTracking,ti.dblQty AS dblItemRequiredQty
...
Begin
	...
	Begin
		...
		Begin
			...
			Select @intLotId,@intItemId,@dblRequiredQty,intItemUOMId,intLocationId,intSubLocationId,intStorageLocationId,@dblItemRequiredQty 
		...
		Begin
			INSERT INTO @tblPickedLot(intLotId,intItemId,dblQty,intItemUOMId,intLocationId,intSubLocationId,intStorageLocationId,dblItemRequiredQty)
			Select @intLotId,@intItemId,@dblAvailableQty,intItemUOMId,intLocationId,intSubLocationId,intStorageLocationId,@dblItemRequiredQty 
			From @tblLot Where intRowNo=@intMinLot
