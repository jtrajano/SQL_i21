...
SET @Savepoint = SUBSTRING(('ARProcessTaxDetailsForLineItem' + CONVERT(VARCHAR, @InitTranCount)), 1, 32)	
...
BEGIN TRY
	...
	SET
		...
		,ARIDT.[intSalesTaxExemptionAccountId] 	= SMTC.[intSalesTaxExemptionAccountId]
	FROM
