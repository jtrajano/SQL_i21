...
IF @transCount = 0 BEGIN TRANSACTION
	...
	CROSS APPLY (
		SELECT * FROM fnGetItemTaxComputationForVendor(B.intItemId, A.intEntityVendorId, A.dtmDate, B.dblCost, B.dblQtyReceived, B.intTaxGroupId, A.intShipToId, A.intShipFromId, 0, NULL, 0)
	) Taxes
