...
BEGIN
	...
	FROM (
		SELECT IR.intEntityVendorId as intEntityId
			, T.intCommodityId
			, 'Paid' COLLATE Latin1_General_CI_AS as FieldName
			, SUM(CASE WHEN Bill.dblTotal = Bill.dblAmountDue THEN BD.dblQtyReceived
						ELSE (BD.dblQtyReceived/Bill.dblTotal) * (Bill.dblTotal - Bill.dblAmountDue) END) as dblTotal
			, 0 as intSorting
		...
		UNION ALL SELECT IR.intEntityVendorId as intEntityId
			, T.intCommodityId
			, 'Purchased' COLLATE Latin1_General_CI_AS as FieldName
	...
	BEGIN
		...
		BEGIN
			...
			INSERT INTO #tmpSourcePurchase (intEntityId,intCommodityId,FieldName,dblTotal,intSorting)
			VALUES(@intEntityId,@intCommodityId,'W.A.P' COLLATE Latin1_General_CI_AS,@NetValue/@PurchasedValue,8)

			INSERT INTO #tmpSourcePurchase (intEntityId,intCommodityId,FieldName,dblTotal,intSorting)
			VALUES(@intEntityId,@intCommodityId,'Net Payables' COLLATE Latin1_General_CI_AS,@NetPayablesValue,99)
	
			INSERT INTO #tmpSourcePurchase (intEntityId,intCommodityId,FieldName,dblTotal,intSorting)
			VALUES(@intEntityId,@intCommodityId,'Unpaid Qty' COLLATE Latin1_General_CI_AS,ABS(@PurchasedValue - @PaidValue),100)
		END
...
BEGIN
	...
	FROM (
		SELECT InvShp.intEntityCustomerId as intEntityId
			, T.intCommodityId
			, 'Paid' COLLATE Latin1_General_CI_AS as FieldName
			, SUM(CASE WHEN I.dblInvoiceTotal = I.dblPayment THEN ID.dblQtyShipped
					ELSE (ID.dblQtyShipped/I.dblInvoiceTotal) *  I.dblPayment END) as dblTotal
			, 0 as intSorting
		...
		UNION ALL SELECT InvShp.intEntityCustomerId as intEntityId
			, T.intCommodityId
			, 'Sold' COLLATE Latin1_General_CI_AS as FieldName
...
BEGIN
	...
	BEGIN
		...
		INSERT INTO #tmpSourceSales (intEntityId,intCommodityId,FieldName,dblTotal,intSorting)
		VALUES(@intEntityId,@intCommodityId,'Gross Dollars' COLLATE Latin1_General_CI_AS,(SELECT SUM(dblTotal) FROM #tmpSourceSales WHERE FieldName IN  ('Net','Discounts','Tax','Storage','Fees') AND intCommodityId = @intCommodityId),2)
		...
		INSERT INTO #tmpSourceSales (intEntityId,intCommodityId,FieldName,dblTotal,intSorting)
		VALUES(@intEntityId,@intCommodityId,'W.A.P' COLLATE Latin1_General_CI_AS,@NetValue/@SoldValue,8)

		INSERT INTO #tmpSourceSales (intEntityId,intCommodityId,FieldName,dblTotal,intSorting)
		VALUES(@intEntityId,@intCommodityId,'Net Receivables' COLLATE Latin1_General_CI_AS,@NetReceivablesValue,99)
	
		INSERT INTO #tmpSourceSales (intEntityId,intCommodityId,FieldName,dblTotal,intSorting)
		VALUES(@intEntityId,@intCommodityId,'Unpaid Qty' COLLATE Latin1_General_CI_AS,ABS(@SoldValue - @PaidValue),100)
	END
