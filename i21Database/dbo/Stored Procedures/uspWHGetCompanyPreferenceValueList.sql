		...
		FROM (
			...
			FROM (
				SELECT CAST(intCompanyPreferenceId AS NVARCHAR(255)) intCompanyPreferenceId, 
					   ...
					   CAST(strHandheldType AS NVARCHAR(255)) strHandheldType, 
					   CAST(strWarehouseType AS NVARCHAR(255)) strWarehouseType, 
					   ...
					   CAST(strWebServiceServerURL AS NVARCHAR(255)) strWebServiceServerURL, 
					   CAST(strWMSStatus AS NVARCHAR(255)) strWMSStatus, 
