...
SELECT	intBankAccountId				= BankAccnt.intBankAccountId
		...
		,strGLBalanceWithCurrency		= BankAccnt.strCurrency  + ' ' + CAST( isnull( FORMAT([dbo].[fnGetBankGLBalance](BankAccnt.intBankAccountId, @dtmStatementDate), 'N', 'en-us'),0)  AS NVARCHAR(50))
