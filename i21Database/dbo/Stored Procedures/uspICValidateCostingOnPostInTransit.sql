...
BEGIN 
	DECLARE @strText_ytuf932e NVARCHAR(200)
	SET @strText_ytuf932e = (SELECT ISNULL(strItemNo, '') FROM tblICItem WHERE intItemId = @intItemId)
	EXEC uspICRaiseError 80048, @strText_ytuf932e
	RETURN -1
END 
