...
BEGIN TRY
	...
	BEGIN TRANSACTION
		...
		UPDATE tblRKAllocatedContractsPostRecap SET ysnIsUnposted=1,strBatchId=@strBatchId WHERE intAllocatedContractsGainOrLossHeaderId = @intAllocatedContractsGainOrLossHeaderId
		UPDATE tblRKAllocatedContractsGainOrLossHeader SET ysnPosted=1,dtmPostDate=getdate(),strBatchId=@batchId,dtmUnpostDate=null WHERE intAllocatedContractsGainOrLossHeaderId = @intAllocatedContractsGainOrLossHeaderId
		...
		UPDATE tblRKAllocatedContractsPostRecap SET strReversalBatchId = @strReversalBatchId WHERE intAllocatedContractsGainOrLossHeaderId = @intAllocatedContractsGainOrLossHeaderId
