CREATE PROCEDURE [dbo].[uspAPAddProvisionalDetail]
...
DECLARE @SavePoint NVARCHAR(32) = 'uspAPAddProvisionalDetail';
...
MERGE INTO tblAPProvisionalDetail AS destination
USING
(
	SELECT --TOP 100 PERCENT
		*
...
EXEC uspAPUpdateProvisionalDetailTax @idetailIds
