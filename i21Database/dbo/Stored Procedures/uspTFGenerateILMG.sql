...
BEGIN TRY
	...
	BEGIN		
		...
		SELECT 
			...
			, dblBlending_a = CASE WHEN AgentCode.strProductCode != '065' THEN NULL ELSE ROUND(Blend.dblBlendAgentQty, 0) END 
			...
			, dblBlending_b = CASE WHEN (AgentCode.strProductCode != 'E00' AND AgentCode.strProductCode != '123') THEN NULL ELSE ROUND(Blend.dblBlendAgentQty, 0) END 
