...
LEFT JOIN tblICUnitMeasure UOM ON UPPER(I.strItemUOM) = UPPER(UOM.strUnitMeasure)
LEFT JOIN tblICItemUOM IUOM ON UOM.intUnitMeasureId = IUOM.intUnitMeasureId AND ITEM.intItemId = IUOM.intItemId
