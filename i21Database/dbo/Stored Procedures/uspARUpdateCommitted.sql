...
BEGIN
	...
	FROM 
		(SELECT [intInvoiceId], [intInvoiceDetailId], [intItemId], [intSalesOrderDetailId], [dblPrice], [intInventoryShipmentItemId], [dblQtyOrdered] FROM tblARInvoiceDetail WITH(NOLOCK)) ARID
	INNER JOIN
