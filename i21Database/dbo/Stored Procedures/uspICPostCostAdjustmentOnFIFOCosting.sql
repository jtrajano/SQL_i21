...
FROM	tblICInventoryFIFO LEFT JOIN tblICItemUOM 
...
BEGIN 	
	...
	BEGIN 
		...
		FROM	tblICInventoryFIFOOut FIFOOut INNER JOIN tblICInventoryTransaction t 
		...
		BEGIN 
			...
			BEGIN 
				...
				-- Calculate the revalue amount for the fifp-out qty. 
				...
				SET		dblCostAdjustQty =	ISNULL(FIFOOut.dblCostAdjustQty, 0) + 
											...
											END 	
				FROM	tblICInventoryFIFOOut FIFOOut
