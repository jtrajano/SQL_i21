...
BEGIN TRY
	...
	--		,dblVoucherCost = NULL
	--	FROM 
	--		tblICInventoryTransaction t INNER JOIN tblMFWorkOrderProducedLot pl 
	--			On pl.intWorkOrderProducedLotId =t.intTransactionDetailId 
	--	WHERE 
	--		t.strBatchId = @strCostAdjustmentBatchId
