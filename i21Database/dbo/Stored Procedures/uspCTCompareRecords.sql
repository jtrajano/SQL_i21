...
BEGIN TRY
	...
	(
		DATA_TYPE					NVARCHAR(256) COLLATE SQL_Latin1_General_CP1_CI_AS,
		CHARACTER_MAXIMUM_LENGTH	INT,
		NUMERIC_PRECISION			TINYINT,
		NUMERIC_SCALE				INT,
		COLUMN_NAME					NVARCHAR(256) COLLATE SQL_Latin1_General_CP1_CI_AS,
		ORDINAL_POSITION			INT,
		ysnIdentity					BIT
	)
	...
	WHERE	COL.TABLE_NAME = @strTblName AND COLUMN_NAME NOT IN (SELECT Item COLLATE SQL_Latin1_General_CP1_CI_AS FROM dbo.fnSplitString(@strColumnsToIgnore,','))
