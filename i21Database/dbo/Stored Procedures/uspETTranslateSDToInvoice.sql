...
BEGIN  
 ...
 DECLARE @ResultTableLog TABLE(  
  ...
  ,strItemNumber NVARCHAR(100)  
  ,strRecordId NVARCHAR(100)
 )  
 ...
 BEGIN  
  ...
  BEGIN  
    ...
    BEGIN TRANSACTION  
     ...
     IF  LTRIM(@strErrorMessage) != ''  
      BEGIN    
       ...
       INSERT INTO @ResultTableLog ( strCustomerNumber ,strInvoiceNumber ,strSiteNumber ,dtmDate ,intLineItem ,strFileName ,strStatus ,ysnSuccessful ,intInvoiceId ,strTransactionType , strItemNumber, strRecordId )  
       SELECT strCustomerNumber = @strCustomerNumber ,strInvoiceNumber = @strInvoiceNumber ,strSiteNumber = @strSiteNumber, dtmDate = @dtmInvoiceDate ,intLineItem = @intLineItem ,strFileName = '' ,strStatus = @strErrorMessage ,ysnSuccessful = 0 ,intInvoiceId = @intNewInvoiceId       ,strTransactionType = 'Invoice'    , strItemNumber = '' , strRecordId = ''
       GOTO CONTINUELOOP  
      END  
    END  
   ELSE  
   ...
   BEGIN CATCH  
    ...
    INSERT INTO @ResultTableLog ( strCustomerNumber ,strInvoiceNumber ,strSiteNumber ,dtmDate ,intLineItem ,strFileName ,strStatus ,ysnSuccessful ,intInvoiceId ,strTransactionType , strItemNumber, strRecordId)  
      SELECT strCustomerNumber = @strCustomerNumber ,strInvoiceNumber = @strInvoiceNumber ,strSiteNumber = @strSiteNumber ,dtmDate = @dtmInvoiceDate ,intLineItem = @intLineItem ,strFileName = '' ,strStatus = ERROR_MESSAGE() ,ysnSuccessful = 0 ,intInvoiceId = @intNewInvoiceId ,strTransactionType = 'Invoice' , strItemNumber = '' , strRecordId = ''
      GOTO CONTINUELOOP  
   END CATCH  
