...
SET NOCOUNT ON               
 ...
 ---------------------------------------------------------------------------------------------------------------------------------------              
INSERT INTO tblGLPostedCompare (intAccountId,dtmDate,dblDebit,dblCredit,dblDebitForeign,dblCreditForeign,dblDebitUnit,dblCreditUnit,strCode,intConcurrencyId,intCurrencyId,dtmDateEntered,strReport)               
 SELECT  T2.intAccountId,T2.dtmDate,        
  ...
  T2.strCode,1,T2.intCurrencyID,T2.dtmDateEntered,@strReport        
  FROM (        
   ...
   T0.strCode,ISNULL(T0.intCurrencyId,T1.intCurrencyID)intCurrencyID,T0.dtmDateEntered FROM                    
   tblGLDetail T0          
  ...
  GROUP BY T2.intAccountId,T2.dtmDate,T2.strCode,T2.intCurrencyID,T2.dtmDateEntered                 
