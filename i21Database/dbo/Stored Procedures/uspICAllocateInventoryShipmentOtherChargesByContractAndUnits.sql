CREATE PROCEDURE [dbo].[uspICAllocateInventoryShipmentOtherChargesByContractAndUnits]
...
-- Allocate price by 'Unit' and by Contract where cost methods are using 'Per Unit' and 'Percentage' 
BEGIN 
	...
	USING (
		...
		FROM	dbo.tblICInventoryShipment Shipment INNER JOIN dbo.tblICInventoryShipmentItem ShipmentItem
				...
				LEFT JOIN (
					...
					AND TotalUnitsOfItemsPerContract.intLineNo = ShipmentItem.intLineNo
