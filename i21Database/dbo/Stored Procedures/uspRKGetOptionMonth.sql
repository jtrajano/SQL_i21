...
AS
SELECT LEFT(strOptionMonth,3) strOptionMonth,replace(strOptionMonth,' ','('+m.strOptSymbol+') ' ) COLLATE Latin1_General_CI_AS strOptionMonthYear, 
	   intOptionMonthId,dtmFirstNoticeDate,dtmLastTradingDate,	   
	   replace(strFutureMonth,' ','('+m.strFutSymbol+') ' ) COLLATE Latin1_General_CI_AS strFutureMonthYear,op.intFutureMonthId
