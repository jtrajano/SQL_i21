...
BEGIN
	...
	BEGIN
		...
		;WITH CTE
		AS (
			SELECT strFeedStatus,strMessage,RN = ROW_NUMBER() OVER (
		...
		Left JOIN tblCTContractHeader CH on CH.intContractHeaderId = CF.intContractHeaderId 
