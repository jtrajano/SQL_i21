...
WHERE ysnPosted = 1
	AND ysnCancelled = 0
	AND ((I.strType = 'Service Charge' AND @dtmDateToLocal < I.dtmForgiveDate) OR (I.strType = 'Service Charge' AND I.ysnForgiven = 0) OR ((I.strType <> 'Service Charge' AND I.ysnForgiven = 1) OR (I.strType <> 'Service Charge' AND I.ysnForgiven = 0)))
