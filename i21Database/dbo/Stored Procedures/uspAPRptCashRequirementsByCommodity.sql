CREATE PROCEDURE [dbo].[uspAPRptCashRequirementsByCommodity]
...
--SET @xmlParam = NULL 
	SELECT			NULL as dtmCurrentDate, 
					*
					FROM vyuAPRptCashRequirementsByCommodity WHERE strCommodityCode = '' --RETURN NOTHING TO RETURN SCHEMA
END
...
SET @query = 'SELECT 
			  ...
			  FROM [vyuAPRptCashRequirementsByCommodity]'
