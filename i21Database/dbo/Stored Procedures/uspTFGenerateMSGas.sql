...
BEGIN TRY
	...
	BEGIN 
		...
		SELECT @AutomotiveGas_6D = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '6D' AND strType = 'Automotive Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AutomotiveGas_1 = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '1' AND strType = 'Automotive Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AutomotiveGas_2 = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '2' AND strType = 'Automotive Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AutomotiveGas_2A = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '2A' AND strType = 'Automotive Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AutomotiveGas_2B = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '2B' AND strType = 'Automotive Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AutomotiveGas_2C = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '2C' AND strType = 'Automotive Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AutomotiveGas_2X = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '2X' AND strType = 'Automotive Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AutomotiveGas_5B = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '5B' AND strType = 'Automotive Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AutomotiveGas_5D = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '5D' AND strType = 'Automotive Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AutomotiveGas_7 = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '7' AND strType = 'Automotive Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AutomotiveGas_8 = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '8' AND strType = 'Automotive Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AutomotiveGas_13H = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '13H' AND strType = 'Automotive Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END

			, @AviationGas_6D = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '6D' AND strType = 'Aviation Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AviationGas_1 = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '1' AND strType = 'Aviation Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AviationGas_2 = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '2' AND strType = 'Aviation Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AviationGas_2A = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '2A' AND strType = 'Aviation Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AviationGas_2B = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '2B' AND strType = 'Aviation Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AviationGas_2C = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '2C' AND strType = 'Aviation Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AviationGas_2X = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '2X' AND strType = 'Aviation Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AviationGas_5B = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '5B' AND strType = 'Aviation Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AviationGas_5D = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '5D' AND strType = 'Aviation Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AviationGas_7 = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '7' AND strType = 'Aviation Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AviationGas_8 = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '8' AND strType = 'Aviation Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
			, @AviationGas_13H = CASE WHEN strFormCode = 'Gas' AND strScheduleCode = '13H' AND strType = 'Aviation Gas' THEN ISNULL(dblReceived, 0) ELSE 0 END
		FROM @transaction	
