CREATE PROCEDURE uspIPStageERPExchangeRate @strInfo1 NVARCHAR(MAX) = '' OUTPUT
...
BEGIN TRY
	...
	DECLARE @tblIPCurrency TABLE (strFromCurrency NVARCHAR(50))
	DECLARE @idoc INT
	...
	BEGIN
		BEGIN TRY
			...
			INSERT INTO tblIPCurrencyRateStage (
				intTrxSequenceNo
				,strCompanyLocation
				,intActionId
				,dtmCreatedDate
			...
			OUTPUT INSERTED.strFromCurrency
			INTO @tblIPCurrency
