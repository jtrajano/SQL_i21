...
BEGIN
	...
	SET dblAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory1,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory1,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory1,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory1,0.0) END)
	...
	SET dblAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory2,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory2,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory2,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory2,0.0) END)
	...
	SET dblAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory3,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory3,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory3,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory3,0.0) END)
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory4,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory4,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory4,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory4,0.0) END)
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory5,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory5,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory5,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory5,0.0) END) 
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory6,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory6,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory6,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory6,0.0) END) 
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory7,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory7,0.0) END) 
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory7,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory7,0.0) END)
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory8,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory8,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory8,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory8,0.0) END) 
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory9,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory9,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory9,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory9,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory10,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory10,0.0) END) 
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory10,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory10,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory11,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory11,0.0) END) 
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory11,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory11,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory12,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory12,0.0) END) 
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory12,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory12,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory13,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory13,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory13,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory13,0.0) END)   
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory14,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory14,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory14,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory14,0.0) END)   
	...
	SET dblAdjustedTax =  ( CASE WHEN dblTax = ISNULL(@dblTaxCategory15,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory15,0.0) END) 
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory15,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory15,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory16,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory16,0.0) END) 
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory16,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory16,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory17,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory17,0.0) END) 
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory17,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory17,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory18,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory18,0.0) END) 
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory18,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory18,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory19,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory19,0.0) END) 
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory19,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory19,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory20,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory20,0.0) END) 
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory20,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory20,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory21,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory21,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory21,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory21,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory22,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory22,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory22,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory22,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory23,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory23,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory23,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory23,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory24,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory24,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory24,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory24,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory25,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory25,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory25,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory25,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory26,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory26,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory26,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory26,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory27,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory27,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory27,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory27,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory28,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory28,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory28,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory28,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory29,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory29,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory29,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory29,0.0) END)  
	...
	SET dblAdjustedTax = ( CASE WHEN dblTax = ISNULL(@dblTaxCategory30,0.0) THEN dblTax ELSE ISNULL(@dblTaxCategory30,0.0) END)
	  , dblBaseAdjustedTax = (CASE WHEN dblTax = ISNULL(@dblTaxCategory30,0.0) THEN dblTax ELSE  ISNULL(@dblTaxCategory30,0.0) END)  
