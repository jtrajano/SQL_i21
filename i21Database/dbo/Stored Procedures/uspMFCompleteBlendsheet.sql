...
BEGIN TRY
	...
	BEGIN
		...
		@intStorageLocationId,@intBatchId,@strRetBatchId,@dtmCurrentDate,@intUserId,@dtmCurrentDate,@intUserId,ISNULL(@dtmProductionDate,@dtmCurrentDate),@strReferenceNo,1)
