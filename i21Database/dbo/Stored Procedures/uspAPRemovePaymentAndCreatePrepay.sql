...
BEGIN
	...
	UPDATE prepayDetail
		...
		,prepayDetail.strBundleDescription = NULL
		,prepayDetail.intUnitOfMeasureId = NULL
		,prepayDetail.intCostUOMId = NULL
		,prepayDetail.intWeightUOMId = NULL
		,prepayDetail.intBundletUOMId = NULL
		,prepayDetail.intInvoiceDetailRefId = NULL
		,prepayDetail.intDeferredVoucherId = NULL
		,prepayDetail.intContractCostId = NULL
		,prepayDetail.intPaycheckHeaderId = NULL
		,prepayDetail.intPriceFixationDetailId = NULL
		,prepayDetail.intCustomerStorageId = NULL
		,prepayDetail.intSettleStorageId = NULL
		,prepayDetail.intStorageLocationId = NULL
		,prepayDetail.intSubLocationId = NULL
		,prepayDetail.intLocationId = NULL
		,prepayDetail.intLoadDetailId = NULL
		,prepayDetail.intLoadShipmentCostId = NULL
		,prepayDetail.intLoadId = NULL
		,prepayDetail.intTicketId = NULL
		,prepayDetail.intCCSiteDetailId = NULL
		,prepayDetail.intPrepayTransactionId = NULL
		,prepayDetail.intReallocationId = NULL
		,prepayDetail.intItemBundleId = NULL
		,prepayDetail.dblBundleTotal = 0
		,prepayDetail.dblQtyContract = 0
		,prepayDetail.dblContractCost = 0
		,prepayDetail.dblQtyBundleReceived = 0
		,prepayDetail.dblOldCost = NULL
		,prepayDetail.dblRate = 1
		,prepayDetail.dblActual = 0
		,prepayDetail.dblBasis = 0
		,prepayDetail.dblFutures = 0
		,prepayDetail.dblDifference = 0
		,prepayDetail.dblWeightUnitQty = 0
		,prepayDetail.dblCostUnitQty = 0
		,prepayDetail.dblUnitQty = 0
		,prepayDetail.dblBundleUnitQty = 0
		,prepayDetail.dblNetWeight = 0
		,prepayDetail.dblNetShippedWeight = 0
		,prepayDetail.dblWeightLoss = 0
		,prepayDetail.dblFranchiseWeight = 0
		,prepayDetail.dblFranchiseAmount = 0
		,prepayDetail.dblClaimAmount = 0
		,prepayDetail.dbl1099 = 0
		,prepayDetail.ysn1099Printed = 0
		,prepayDetail.ysnRestricted = 0
		,prepayDetail.ysnSubCurrency = 0
		,prepayDetail.ysnStage = 0
		,prepayDetail.intFreightTermId = NULL
		,prepayDetail.intInventoryShipmentChargeId = NULL
		,prepayDetail.intCurrencyExchangeRateTypeId = NULL
		,prepayDetail.intCurrencyId = NULL
		,prepayDetail.strBillOfLading = NULL
		,prepayDetail.intContractSeq = NULL
		,prepayDetail.intInvoiceId = NULL
		,prepayDetail.intBuybackChargeId = NULL
