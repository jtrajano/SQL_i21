...
INSERT INTO @Source(
	...
	, ysnLockedInventory, ysnStorageUnitRequired, intAllowZeroCostTypeId, intSort
)
SELECT 
	intItemId
	, intLocationId
...
SET 
	  ...
	  ,[intAllowZeroCostTypeId] = s.intAllowZeroCostTypeId
      ,[intSort] = s.intSort
...
--BEGIN
	...
	SELECT
		...
		, s.ysnLockedInventory, s.strStorageUnitNo, s.ysnStorageUnitRequired, s.intAllowZeroCostTypeId, s.intSort
	FROM @Source s
...
SELECT 
	...
	, NewDetails.ysnLockedInventory, NewDetails.strStorageUnitNo, NewDetails.ysnStorageUnitRequired, NewDetails.intAllowZeroCostTypeId, NewDetails.intSort
FROM @New NewDetails
