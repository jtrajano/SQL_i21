...
BEGIN
	...
	SELECT TOP 1		 	
		...
		,@LoadId						= (CASE WHEN ISNULL([strSourceTransaction],'') IN ('Load Schedule', 'Weight Claim') OR [strTransactionType] = 'Credit Memo' THEN ISNULL([intLoadId], [intSourceId]) ELSE NULL END)
