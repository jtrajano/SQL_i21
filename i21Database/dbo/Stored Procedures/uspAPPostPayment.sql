...
BEGIN
	...
	SELECT     
	    ...
	    dblReportingRate ,
	    dblForeignRate ,
	    strRateType FROM dbo.[fnAPCreatePaymentGLEntries](@payments, @userId, @batchId)
	UNION ALL
	SELECT   
		dtmDate ,
	    strBatchId ,
	    ...
	    dblReportingRate ,
	    dblForeignRate ,
	    strRateType FROM dbo.[fnAPCreatePrepaymentGLEntries](@prepayIds, @userId, @batchId)
END
ELSE
BEGIN
	INSERT INTO @GLEntries (
	...
	SELECT     
	    ...
	    dblReportingRate ,
	    dblForeignRate ,
	    strRateType FROM dbo.fnAPReverseGLEntries(@payments, 'Payable', DEFAULT, @userId, @batchId)
	UNION ALL
	SELECT     
		dtmDate ,
	    strBatchId ,
	    ...
	    dblReportingRate ,
	    dblForeignRate ,
	    strRateType FROM dbo.fnAPReverseGLEntries(@prepayIds, 'Payable', DEFAULT, @userId, @batchId)
END
