		...
		IF(@strGuid IS NOT NULL AND @strGuid <> '')
			BEGIN
				...
				SELECT	CL.intCompanyLocationId
						...
						END
						,CASE
							WHEN [Changes].oldColumnName = 'strCategoryCode_Original' THEN 'INT'
							WHEN [Changes].oldColumnName = 'strCountCode_Original' THEN 'NVARCHAR'
							WHEN [Changes].oldColumnName = 'strDescription_Original' THEN 'NVARCHAR'
						END
				FROM 
				(
				...
				SELECT	CL.intCompanyLocationId
						...
						,CASE
							...
							WHEN [Changes].oldColumnName = 'strCounted_Original' THEN 'NVARCHAR'
							...
							WHEN [Changes].oldColumnName = 'strMinOrder_Original' THEN 'DECIMAL' 
							WHEN [Changes].oldColumnName = 'strSuggestedQty_Original' THEN 'DECIMAL' 
