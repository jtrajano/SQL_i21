  ...
  BEGIN  
   ...
   BEGIN TRY  
    ...
    SELECT TOP 1  
     ...
     @dtmBonusCommissionDate =  case when ISNULL(cfact_bonus_comm_dt,0) = 0 then NULL else 
		  (case  
     ...
     @strPrintSiteAddress = (case  
      ...
      @dtmLastBillingCycleDate = case when ISNULL(cfact_last_bill_cyc_dt,0) = 0 then NULL else 
		  (case  
