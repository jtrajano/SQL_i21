...
BEGIN TRY
	...
	SELECT MATNR
		...
		,MEINS
		,BMATN
	FROM OPENXML(@idoc, 'ZMATMAS03C/IDOC/E1MARAM', 2) WITH (
			 MATNR NVARCHAR(50)
			,ERSDA DATETIME
			,ERNAM NVARCHAR(50)
			,LAEDA DATETIME
	...
	Update @tblItem Set strShortName=x.MAKTX
		FROM OPENXML(@idoc, 'ZMATMAS03C/IDOC/E1MARAM/E1MAKTM', 2) WITH (
			 MAKTX NVARCHAR(50)
	...
	Insert Into @tblItemUOM(strUOM,dblNumerator,dblDenominator)
		...
		,UMREZ
		,UMREN
	FROM OPENXML(@idoc, 'ZMATMAS03C/IDOC/E1MARAM/E1MARMM', 2) WITH (
			 MEINH NVARCHAR(50)
			,UMREZ NUMERIC(38,20)
			,UMREN NUMERIC(38,20)
	)
