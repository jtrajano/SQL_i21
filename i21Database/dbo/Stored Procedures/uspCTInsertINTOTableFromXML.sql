...
BEGIN TRY
	...
	BEGIN
		...
		WHERE	COL.TABLE_NAME LIKE @strTblName+'%' AND COL.COLUMN_NAME <> 'intCompanyId' AND COL.COLUMN_NAME <> 'ysnCashFlowOverride'
	...
	BEGIN
		...
		WHERE	COL.TABLE_NAME = @strTblName AND COL.COLUMN_NAME <> 'intCompanyId' AND COL.COLUMN_NAME <> 'ysnCashFlowOverride'
		ORDER BY ORDINAL_POSITION
	END
