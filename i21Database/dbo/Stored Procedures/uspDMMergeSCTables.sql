...
BEGIN
    ...
    SET @SQLString = N'MERGE tblSCTicket AS Target
        ...
        WHEN NOT MATCHED BY TARGET THEN
            ...
            , ysnRailCar, dtmGrossDateTime1, dtmGrossDateTime2, ysnGross1Manual, ysnGross2Manual, dtmTareDateTime1, dtmTareDateTime2, ysnTare1Manual, ysnTare2Manual ,intDeliverySheetId , intLotId , strLotNumber, intTicketTypeId)
            ...
            , Source.ysnRailCar, Source.dtmGrossDateTime1, Source.dtmGrossDateTime2, Source.ysnGross1Manual, Source.ysnGross2Manual, Source.dtmTareDateTime1, Source.dtmTareDateTime2, Source.ysnTare1Manual, Source.ysnTare2Manual , Source.intDeliverySheetId , Source.intLotId , Source.strLotNumber, Source.intTicketTypeId)
        WHEN NOT MATCHED BY SOURCE THEN
            DELETE;';
