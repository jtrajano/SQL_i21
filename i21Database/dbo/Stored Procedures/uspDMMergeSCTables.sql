...
BEGIN
    ...
    SET @SQLString = N'MERGE tblSCTicketType AS Target
        ...
        WHEN NOT MATCHED BY TARGET THEN
            INSERT (intTicketTypeId, intTicketPoolId, intListTicketTypeId, ysnTicketAllowed, intNextTicketNumber, intDiscountSchedule, intDistributionMethod, ysnSelectByPO, intSplitInvoiceOption, intContractRequired, intOverrideTicketCopies, ysnPrintAtKiosk, ynsVerifySplitMethods, ysnOverrideSingleTicketSeries, intConcurrencyId)
            VALUES (Source.intTicketTypeId, Source.intTicketPoolId, Source.intListTicketTypeId, Source.ysnTicketAllowed, Source.intNextTicketNumber, Source.intDiscountSchedule, Source.intDistributionMethod, Source.ysnSelectByPO, Source.intSplitInvoiceOption, Source.intContractRequired, Source.intOverrideTicketCopies, Source.ysnPrintAtKiosk, Source.ynsVerifySplitMethods, Source.ysnOverrideSingleTicketSeries, Source.intConcurrencyId)
        WHEN NOT MATCHED BY SOURCE THEN
            DELETE;';
