CREATE PROCEDURE [dbo].[uspLGGetInvoiceHeaderReport]
...
BEGIN
	...
	DECLARE @strOurVatNumber NVARCHAR(100)	  
	...
	SELECT @strOurVatNumber = strStateTaxID FROM tblSMCompanySetup
	...
	SELECT Top(1)
		...
		Inv.strBillToCity,
		ISNULL(Inv.strBillToState,'') AS strBillToState,
		Inv.strBillToZipCode,
		Inv.strBillToCountry,
		Inv.strShipToAddress,
		Inv.strShipToCity,
		Inv.strShipToCountry,
		ISNULL(Inv.strShipToState,'') AS strShipToState,
		...
		@strOurVatNumber AS strOurVATNo,
