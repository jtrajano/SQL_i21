...
BEGIN TRY
	...
	SET @strColumnsList = @strColumnsList + ',strLotStatus,strPartyName,strLotAlias,strSampleNumber,strSampleRefNo,strSampleStatus,strSampleTypeName,dblLotQty,strUnitMeasure,dtmDateCreated,intSampleId'
