...
BEGIN  
 ...
 DECLARE @ysnConsolidatingCompany BIT = 0
 ...
 SELECT TOP 1 @ysnConsolidatingCompany = ysnConsolidatingParent FROM tblGLCompanyPreferenceOption
 SELECT  
  ...
  ISNULL(@ysnConsolidatingCompany,0) AS ConsolidatingCompany  
END
