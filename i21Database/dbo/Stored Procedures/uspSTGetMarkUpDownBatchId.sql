...
AS
BEGIN
		DECLARE @STARTING_NUMBER_BATCH AS INT = (SELECT intNumber FROM tblSMStartingNumber WHERE strModule = 'Store' AND strTransactionType = 'Mark Up/Down' AND strPrefix = 'MUD-')
