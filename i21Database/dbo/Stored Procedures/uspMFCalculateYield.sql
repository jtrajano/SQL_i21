		...
		BEGIN
			...
			BEGIN
				...
				SELECT TOP 1 @strLotNumber = L.strLotNumber
					...
					,@dblQty = (
						L.dblQty - ISNULL((
								SELECT SUM(dbo.fnMFConvertQuantityToTargetItemUOM(SR.intItemUOMId, L1.intItemUOMId, ISNULL(SR.dblQty, 0)))
				...
				BEGIN
					...
					--RAISERROR (
					--		'Unable to pick a lot/pallet to adjust the yield qty.'
					--		,16
					--		,1
					--		)
