...
BEGIN
	...
	(
	  ...
	  ----Inserting Combo Header From to ToStore
	   ...
	   and intPromoSalesId NOT IN(select intPromoSalesId from tblSTPromotionItemList where intStoreId = @ToStore AND strPromoType = 'C')
	  ...
	  -----Inserting Combo Details From to ToStore
	   ...
	   adj1.intPromoItemListId,adj1.intQuantity,
	  ...
	  ----Inserting MixMatch Header From to ToStore
	   ...
	   and intPromoSalesId NOT IN(select intPromoSalesId from tblSTPromotionItemList where intStoreId = @ToStore AND strPromoType = 'M')
     ...
     INSERT INTO tblSTPromotionItemList (intStoreId,intPromoItemListNo,
	  ...
	  AND intPromoItemListNo NOT IN (select intPromoItemListNo from tblSTPromotionItemList as adj11 INNER JOIN tblSTPromotionItemListDetail
