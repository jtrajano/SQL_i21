...
BEGIN TRY
	...
	DECLARE @CompanyEIN NVARCHAR(100) = NULL
	...
	BEGIN
		...
		SELECT DISTINCT intId, intInventoryReceiptItemId, dblReceived, dblBillQty FROM @tmpInventoryTransaction WHERE intInventoryReceiptItemId IN (SELECT DISTINCT intInventoryReceiptItemId FROM @tmpInventoryTransaction)	
