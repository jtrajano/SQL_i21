...
BEGIN
	...
	BEGIN
		...
		AS
		SELECT  A.dtmDate, A.dblDebit, A.dblCredit, A.dblDebitUnit, A.dblCreditUnit, A.dblCreditUnit,A.dblDebitForeig , ISNULL(A.strCode,'''') strCode, B.strDescription, C.strAccountGroup, C.strAccountType, D.*, E.strUOMCode, E.dblLbsPerUnit, B.intCurrencyID 		
