						...
						BEGIN
							...
							SELECT DISTINCT intScanTransactionId
											...
											, CASE	
												...
												WHEN TR.strTrlDeptNumber IN (SELECT strCashRegisterDepartment FROM [dbo].[fnSTRebateDepartment]((CAST(ST.intStoreId AS NVARCHAR(10)))) WHERE ysnTobacco = 1)  -- Change to strCashRegisterDepartment ST-2050
													THEN 'CANS'
											...
											-- PRICE
												...
												WHEN TR.strTrlDeptNumber IN (SELECT strCashRegisterDepartment FROM [dbo].[fnSTRebateDepartment]((CAST(1 AS NVARCHAR(10)))) WHERE ysnTobacco = 1) -- Change to strCashRegisterDepartment ST-2050
							...
							WHERE TR.intStoreId IN (SELECT [intID] FROM [dbo].[fnGetRowsFromDelimitedValues](@strStoreIdList)) 
								...
								AND TR.strTrlDeptNumber IN (SELECT DISTINCT strCashRegisterDepartment FROM fnSTRebateDepartment(CAST(ST.intStoreId AS NVARCHAR(10)))) -- ST-1358 -- Change to strCashRegisterDepartment ST-2050
					...
					BEGIN
						...
						BEGIN
							SET @Delimiter = ','
								...
								WHERE TR.strTrlDeptNumber IN (SELECT DISTINCT strCashRegisterDepartment FROM fnSTRebateDepartment(CAST(ST.intStoreId AS NVARCHAR(10)))) -- ST-1358 -- Change to strCashRegisterDepartment ST-2050
