						...
						BEGIN
							...
							SELECT DISTINCT intScanTransactionId
											...
											-- PRICE
												...
												WHEN TR.intTrlDeptNumber IN (SELECT intRegisterDepartmentId FROM [dbo].[fnSTRebateDepartment]((CAST(1 AS NVARCHAR(10)))) WHERE ysnTobacco = 1)
						...
						BEGIN
							SET @Delimiter = ','
								...
								SELECT intScanTransactionId ,(CASE WHEN ST.strDescription IS NULL THEN '' ELSE REPLACE(ST.strDescription, @Delimiter, '') END) as strOutletName
											...
											, CASE 
												WHEN CRP.strPromotionType IN ('VAPS') 
