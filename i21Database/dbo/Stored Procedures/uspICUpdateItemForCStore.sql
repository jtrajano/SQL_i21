...
BEGIN 
	...
	SELECT	intItemId
			,strDescription = 
				CASE 
					WHEN ISNULL(intCategoryId_Original, 0) <> ISNULL(intCategoryId_New, 0) THEN 
						'C-Store updates the Category'
					WHEN ISNULL(strCountCode_Original, 0) <> ISNULL(strCountCode_New, 0) THEN 
						'C-Store updates the Count Code'
					WHEN ISNULL(strDescription_Original, '') <> ISNULL(strDescription_New, '') THEN 
						'C-Store updates the Description'
				END 
			,strOld = 
				CASE 
