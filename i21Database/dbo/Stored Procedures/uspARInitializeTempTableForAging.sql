...
END
IF(OBJECT_ID('tempdb..##ADCUSTOMERS') IS NOT NULL)
BEGIN
	DROP TABLE ##ADCUSTOMERS
END
IF(OBJECT_ID('tempdb..##ADSALESPERSON') IS NOT NULL)
BEGIN
	DROP TABLE ##ADSALESPERSON
END
IF(OBJECT_ID('tempdb..##ADLOCATION') IS NOT NULL)
BEGIN
	DROP TABLE ##ADLOCATION
END
IF(OBJECT_ID('tempdb..##ADACCOUNTSTATUS') IS NOT NULL)
BEGIN
	DROP TABLE ##ADACCOUNTSTATUS
END
IF(OBJECT_ID('tempdb..##DELCUSTOMERS') IS NOT NULL)
BEGIN
	DROP TABLE ##DELCUSTOMERS
END
IF(OBJECT_ID('tempdb..##DELLOCATION') IS NOT NULL)
BEGIN
	DROP TABLE ##DELLOCATION
END
IF(OBJECT_ID('tempdb..##DELACCOUNTSTATUS') IS NOT NULL)
BEGIN
	DROP TABLE ##DELACCOUNTSTATUS
END
