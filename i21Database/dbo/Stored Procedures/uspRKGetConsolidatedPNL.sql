...
BEGIN TRY
	...
	DECLARE @tblGLSaleCogs AS TABLE (intCompanyId INT
	...
	DECLARE @tblConsolidatedPNL AS TABLE (intConsolidatedPNL INT IDENTITY(1, 1)
	...
	DECLARE @tblUnRealizedPNL AS TABLE (intUnRealizedPNL INT
		, strType NVARCHAR(200) COLLATE Latin1_General_CI_AS
	...
	DECLARE @tblRealizedPNL AS TABLE (intRealizedPNL INT
		, intContractTypeId INT
		, intContractDetailId INT	
		, intBookId INT
		, strBook NVARCHAR(200) COLLATE Latin1_General_CI_AS
	...
	INSERT INTO @tblRealizedPNL (intRealizedPNL
		, intContractTypeId
		, intContractDetailId
		, intBookId
		, strBook
	...
	INSERT INTO @tblUnRealizedPNL (intUnRealizedPNL
		, strType
		, intContractTypeId
		, intContractHeaderId
		, strContractType
		...
		, intCompanyId
		, strCompanyName)
	EXEC uspRKGetUnRealizedPNL @intFutureSettlementPriceId = NULL
	...
	INSERT INTO @tblGLSaleCogs (intCompanyId
		, strCompany
		, intBookId
		, strBook
		, dblSaleAmount
	...
	INSERT INTO @tblConsolidatedPNL (strPNL
		, strType
		, intBookId
		, strBook
		, intCompanyId
		...
		, strMarketValue
		, strTotalAmount)
	SELECT strPNL = 'P&L' COLLATE Latin1_General_CI_AS
		, strType = 'Realized' COLLATE Latin1_General_CI_AS
		, intBookId = intBookId
		, strBook = strBook
		, intCompanyId = intCompanyId
		, strCompany = strCompany
		, strPurchaseSale = 'COGS' COLLATE Latin1_General_CI_AS
		, dblBookValue = 0
		, dblMarketValue = 0
		, dblAmount = - SUM(dblCOGSOrNetSaleValue)
		, strBookValue = 'TotalBookvalue' COLLATE Latin1_General_CI_AS
		, strMarketValue = 'TotalMarketValue' COLLATE Latin1_General_CI_AS
		, strTotalAmount = 'Total' COLLATE Latin1_General_CI_AS
	FROM @tblRealizedPNL
	WHERE intContractTypeId  = 1
	GROUP BY intBookId, strBook, intCompanyId, strCompany
	
	UNION ALL SELECT strPNL = 'P&L' COLLATE Latin1_General_CI_AS
		, strType = 'Realized' COLLATE Latin1_General_CI_AS
		, intBookId = intBookId
		, strBook = strBook
		, intCompanyId = intCompanyId
		, strCompany = strCompany
		, strPurchaseSale = 'Sales' COLLATE Latin1_General_CI_AS
		, dblBookValue = 0
		, dblMarketValue = 0
		, dblAmount = -SUM(dblCOGSOrNetSaleValue)
		, strBookValue = 'TotalBookvalue' COLLATE Latin1_General_CI_AS
	...
	UNION ALL SELECT strPNL = 'P&L' COLLATE Latin1_General_CI_AS
		...
		, strPurchaseSale = 'Purchase' COLLATE Latin1_General_CI_AS
	...
	WHERE intContractTypeId = 1 AND intTransactionType = 1
	GROUP BY intBookId, strBook, intCompanyId, strCompanyName
	...
	UNION ALL SELECT strPNL = 'P&L' COLLATE Latin1_General_CI_AS
		...
		, intCompanyId = intCompanyId
		, strCompany = strCompanyName
		, strPurchaseSale = 'Sale' COLLATE Latin1_General_CI_AS
		, dblBookValue = SUM(dblCOGSOrNetSaleValue)
		, dblMarketValue = SUM(dblNetMarketValue)
		, dblAmount = SUM(dblProfitOrLossValue)
		, strBookValue = 'TotalBookvalue' COLLATE Latin1_General_CI_AS
		...
		, strTotalAmount = 'Total' COLLATE Latin1_General_CI_AS
	FROM @tblUnRealizedPNL
	WHERE intContractTypeId = 2 AND intTransactionType = 1
	GROUP BY intBookId, strBook, intCompanyId, strCompanyName
	...
	UNION ALL SELECT strPNL = 'P&L' COLLATE Latin1_General_CI_AS
		...
		, intCompanyId = intCompanyId
		, strCompany = strCompanyName
		, strPurchaseSale = 'In-transit(P)' COLLATE Latin1_General_CI_AS
		, dblBookValue = SUM(dblCOGSOrNetSaleValue)
		, dblMarketValue = SUM(dblNetMarketValue)
		, dblAmount = SUM(dblProfitOrLossValue)
		, strBookValue = 'TotalBookvalue' COLLATE Latin1_General_CI_AS
		...
		, strTotalAmount = 'Total' COLLATE Latin1_General_CI_AS
	FROM @tblUnRealizedPNL
	WHERE intContractTypeId = 1 AND intTransactionType = 2
	GROUP BY intBookId, strBook, intCompanyId, strCompanyName
	...
	UNION ALL SELECT strPNL = 'P&L' COLLATE Latin1_General_CI_AS
		...
		, intCompanyId = intCompanyId
		, strCompany = strCompanyName
		, strPurchaseSale = 'In-transit(S)' COLLATE Latin1_General_CI_AS
		, dblBookValue = SUM(dblCOGSOrNetSaleValue)
		, dblMarketValue = SUM(dblNetMarketValue)
		, dblAmount = SUM(dblProfitOrLossValue)
		, strBookValue = 'TotalBookvalue' COLLATE Latin1_General_CI_AS
		...
		, strTotalAmount = 'Total' COLLATE Latin1_General_CI_AS
	FROM @tblUnRealizedPNL
	WHERE intContractTypeId = 2 AND intTransactionType = 2
	GROUP BY intBookId, strBook, intCompanyId, strCompanyName
	...
	UNION ALL SELECT strPNL = 'P&L' COLLATE Latin1_General_CI_AS
		...
		, intCompanyId = intCompanyId
		, strCompany = strCompanyName
		, strPurchaseSale = 'Inventory (P)' COLLATE Latin1_General_CI_AS
		, dblBookValue = SUM(dblCOGSOrNetSaleValue)
		, dblMarketValue = SUM(dblNetMarketValue)
		, dblAmount = SUM(dblProfitOrLossValue)
		, strBookValue = 'TotalBookvalue' COLLATE Latin1_General_CI_AS
	...
	UNION ALL SELECT strPNL = 'P&L' COLLATE Latin1_General_CI_AS
		...
		, intCompanyId = intCompanyId
		, strCompany = strCompanyName
		, strPurchaseSale = 'Inventory (FG)' COLLATE Latin1_General_CI_AS
		, dblBookValue = SUM(dblCOGSOrNetSaleValue)
		, dblMarketValue = SUM(dblNetMarketValue)
		, dblAmount = SUM(dblProfitOrLossValue)
		, strBookValue = 'TotalBookvalue' COLLATE Latin1_General_CI_AS
	...
	IF @strType ='- All -'
	BEGIN
		SELECT intConsolidatedPNL = intConsolidatedPNL
			, strPNL = strPNL
			, strType = strType
			, intBookId = intBookId
			, strBook = strBook
