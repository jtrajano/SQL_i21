...
BEGIN TRY
	...
	BEGIN TRY
		...
		INSERT INTO @SingleAuditLogParam ([Id], [KeyValue], [Action], [Change], [From], [To], [Alias], [Field], [Hidden], [ParentId])
				...
				UNION ALL
				SELECT 2, '', '', 'tblCTSequenceAmendmentLogs', NULL, NULL, NULL, NULL, NULL, 1
				UNION ALL
				SELECT 3, '', 'Updated', 'Updated - Record: '+LTRIM(@intSequenceAmendmentLogId), NULL, NULL, NULL, NULL, NULL, 2
