CREATE PROCEDURE [dbo].[uspFRDBalanceSheetByPrimary]
	@intRowId				AS INT	= ''		
AS
...
BEGIN 
	...
	EXEC [dbo].[uspFRDCreateRowDesign] @intRowId, @intRefNo, @strAccountType_Hidden, 'Hidden', @BalanceSide_Hidden, 'Column', '', @strRowFilter_Hidden, 'CY', 0, 0, 1, 0, 3.000000, 'Arial', 'Normal', 'Black', 8, '', 0, 0, @intSort		
...
--EXEC [dbo].[uspFRDBalanceSheetByPrimary] 73
