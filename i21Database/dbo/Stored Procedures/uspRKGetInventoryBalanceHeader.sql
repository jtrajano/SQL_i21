...
INSERT INTO @tblFirstResult (dtmDate ,   tranShipQty , tranRecQty ,  dblAdjustmentQty ,dblCountQty, BalanceForward )
...
INSERT INTO @tblConsolidatedResult(dtmDate ,[Receive In],[Ship Out],[Adjustments],dblCount,BalanceForward,InventoryBalanceCarryForward ,
...
SELECT DISTINCT dtmDate,[Receive In] as [dblReceiveIn],[Ship Out] as [dblShipOut],Adjustments as dblAdjustments,dblCount,isnull([InventoryBalance],0) as [dblInventoryBalance],
...
FROM (
SELECT dtmDate ,[Receive In],[Ship Out],[Adjustments],dblCount,BalanceForward, InventoryBalanceCarryForward,
...
FROM(
SELECT DateData dtmDate ,[Receive In],[Ship Out],[Adjustments],dblCount,BalanceForward, InventoryBalanceCarryForward,
