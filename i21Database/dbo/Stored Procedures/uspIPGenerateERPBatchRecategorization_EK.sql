	...
	BEGIN
		...
		SELECT @strBatchXML = ''
			...
			SELECT @strBatchXML = @strBatchXML
				...
				+ '<EvaluatorsRemarks>' + dbo.fnEscapeXML(ISNULL(B.strEvaluatorRemarks, '')) + '</EvaluatorsRemarks>'
				...
				+ '<TasterComments>' + dbo.fnEscapeXML(ISNULL(B.strTasterComments, '')) + '</TasterComments>'
				...
				+ '<Taster>' + dbo.fnEscapeXML(ISNULL(B.strTaster, '')) + '</Taster>'
