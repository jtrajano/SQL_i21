...
SELECT 
    ...
    ,[dblBaseLineItemGLAmount]          = ISNULL(ARID.dblTotal * ARID.[dblCurrencyExchangeRate], @ZeroDecimal) + [dbo].fnRoundBanker(((ARID.dblDiscount/@OneHundredDecimal) * [dbo].fnRoundBanker((ARID.dblQtyShipped * ARID.dblPrice), @Precision)), @Precision)
...
SELECT 
    ...
    ,[dblBaseTotal]                     = ARID.[dblBaseTotal]
    ,[dblLineItemGLAmount]              = ISNULL(ARID.dblTotal, @ZeroDecimal) + [dbo].fnRoundBanker(((ARID.dblDiscount/@OneHundredDecimal) * [dbo].fnRoundBanker((ARID.dblQtyShipped * ARID.dblPrice), @Precision)), @Precision)
    ,[dblBaseLineItemGLAmount]          = ISNULL(ARID.dblTotal * ARID.[dblCurrencyExchangeRate], @ZeroDecimal) + [dbo].fnRoundBanker(((ARID.dblDiscount/@OneHundredDecimal) * [dbo].fnRoundBanker((ARID.dblQtyShipped * ARID.dblBasePrice), @Precision)), @Precision)
    ,[intCurrencyExchangeRateTypeId]    = ARID.[intCurrencyExchangeRateTypeId]
    ,[dblCurrencyExchangeRate]          = ARID.[dblCurrencyExchangeRate]
    ,[strCurrencyExchangeRateType]      = SMCERT.[strCurrencyExchangeRateType]
    ,[intLotId]                         = ARID.[intLotId]
