...
SET ANSI_WARNINGS OFF
	...
	FROM
		(select distinct b.strLineOfBusiness, strFieldName = 'str' + replace(b.strLineOfBusiness, ' ', '') + ' numeric(18,6) null', strFieldNameColumn = 'str' + replace(b.strLineOfBusiness, ' ', ''), strFieldNameColumnWithValue = 'str' + replace(b.strLineOfBusiness, ' ', '') + ' = null' from tblICCategory a, tblSMLineOfBusiness b where b.intLineOfBusinessId = a.intLineOfBusinessId) as result
