...
SET @query = '
	SELECT * FROM (
		...
		INNER JOIN tblGLCompanyDetails CD ON CD.intAccountSegmentId = A.intCompanySegmentId
		LEFT JOIN tblGLAccountSegment ASG ON ASG.intAccountSegmentId = CD.intAccountSegmentId
	) rawClearing
'
