...
SELECT
	...
	,str1099MISC = (CASE WHEN @form1099Param IS NULL OR @form1099Param = 1 THEN 'X' ELSE NULL END)
	,str1099INT = (CASE WHEN @form1099Param IS NULL OR @form1099Param = 2 THEN 'X' ELSE NULL END)
	,str1099B = (CASE WHEN @form1099Param IS NULL OR @form1099Param = 3 THEN 'X' ELSE NULL END)
FROM tblSMCompanySetup A,
(
	SELECT * FROM MISC1099 WHERE 1 = (CASE WHEN @form1099Param = 0 OR @form1099Param = 1 THEN 1 ELSE 0 END)
	UNION ALL
	SELECT * FROM INT1099 WHERE 1 = (CASE WHEN @form1099Param = 0 OR @form1099Param = 2 THEN 1 ELSE 0 END)
	UNION ALL
	SELECT * FROM B1099 WHERE 1 = (CASE WHEN @form1099Param = 0 OR @form1099Param = 3 THEN 1 ELSE 0 END)
) Data1099
GROUP BY intYear
,strEin  
,strAddress  
