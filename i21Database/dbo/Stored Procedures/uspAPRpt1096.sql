...
SELECT
	...
	,(SELECT RIGHT(@yearParam,2)) AS strYear
	,str1099MISC = CASE WHEN EXISTS(SELECT 1 FROM MISC1099 WHERE intYear = @yearParam) THEN 'X' ELSE NULL END
	,str1099INT = CASE WHEN EXISTS(SELECT 1 FROM INT1099 WHERE intYear = @yearParam) THEN 'X' ELSE NULL END
	,str1099B = CASE WHEN EXISTS(SELECT 1 FROM B1099 WHERE intYear = @yearParam) THEN 'X' ELSE NULL END
	,str1099PATR = CASE WHEN EXISTS(SELECT 1 FROM PATR1099 WHERE intYear = @yearParam) THEN 'X' ELSE NULL END   
	,str1099DIV = CASE WHEN EXISTS(SELECT 1 FROM DIV1099 WHERE intYear = @yearParam) THEN 'X' ELSE NULL END   
	,str1099K = CASE WHEN EXISTS(SELECT 1 FROM K1099 WHERE intYear = @yearParam) THEN 'X' ELSE NULL END   
	,B.strContactName
	,B.strContactPhone
	,B.strContactEmail
...
(
	SELECT 
		*
	FROM MISC1099 WHERE 1 = (CASE WHEN EXISTS(SELECT 1 FROM MISC1099 WHERE intYear = @yearParam) THEN 1 ELSE 0 END)
	UNION ALL
	SELECT 
		*
	FROM INT1099 WHERE 1 = (CASE WHEN EXISTS(SELECT 1 FROM INT1099 WHERE intYear = @yearParam) THEN 1 ELSE 0 END)
	UNION ALL
	SELECT 
		*
	FROM B1099 WHERE 1 = (CASE WHEN EXISTS(SELECT 1 FROM B1099 WHERE intYear = @yearParam) THEN 1 ELSE 0 END)
	UNION ALL
	SELECT 
		*
	FROM PATR1099 WHERE 1 = (CASE WHEN EXISTS(SELECT 1 FROM PATR1099 WHERE intYear = @yearParam) THEN 1 ELSE 0 END)
	UNION ALL
	SELECT 
		*
	FROM DIV1099 WHERE 1 = (CASE WHEN EXISTS(SELECT 1 FROM DIV1099 WHERE intYear = @yearParam) THEN 1 ELSE 0 END)
	UNION ALL
	SELECT 
		*
	FROM K1099 WHERE 1 = (CASE WHEN EXISTS(SELECT 1 FROM K1099 WHERE intYear = @yearParam) THEN 1 ELSE 0 END)
) Data1099 on 1=1
