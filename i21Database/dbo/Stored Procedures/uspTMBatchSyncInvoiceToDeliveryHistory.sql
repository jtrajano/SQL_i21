CREATE PROCEDURE uspTMSyncBatchInvoiceToDeliveryHistory 
...
BEGIN
	...
	--------------------------------------------------------------------------
				...
				------------------Invoice date is greater than the last delivery date
				...
				FROM tblTMSite A
				INNER JOIN #tmpFinalNonServiceInvoiceDetail B
				...
				OUTER APPLY (
					...
					FROM #tmpFinalNonServiceInvoiceDetail 
