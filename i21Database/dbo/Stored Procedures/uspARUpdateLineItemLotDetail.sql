...
BEGIN
	...
	SELECT 
        ...
        ,[dblQuantityShipped]       = CASE WHEN LGDL.dblNet > ARID.dblShipmentNetWt THEN ARID.dblShipmentNetWt ELSE LGDL.dblNet END
        ,[dblGrossWeight]           = CASE WHEN LGDL.dblNet > ARID.dblShipmentNetWt THEN ARID.dblShipmentGrossWt ELSE LGDL.dblGross END
        ,[dblTareWeight]            = CASE WHEN LGDL.dblNet > ARID.dblShipmentNetWt THEN ARID.dblShipmentTareWt ELSE LGDL.dblTare END
        ,[dblWeightPerQty]          = 1
