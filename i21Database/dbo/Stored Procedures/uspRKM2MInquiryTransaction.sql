...
--									dbo.fnCTConvertQuantityToTargetCommodityUOM(intPriceUOMId,case when isnull(PriceSourceUOMId,0)=0 then intPriceUOMId 
--									ELSE PriceSourceUOMId end,isnull(dblContractBasis,0))
--	ELSE
