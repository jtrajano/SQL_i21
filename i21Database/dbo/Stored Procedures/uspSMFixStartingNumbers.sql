...
-- Commented this since Batch ID generation is base on the Server DateTime float value no need to update the starting Number table.
-- Starting number for batch posting is not utilizing the starting number table
