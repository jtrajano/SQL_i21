CREATE PROCEDURE [dbo].[uspICEdiGenerateMappingObjectsRecurringJob] 
...
(
	SELECT 
		...
		, o.[RecordIndex]
		, o.[Key]		
		, NULLIF(RTRIM(LTRIM(o.[Value])), '''') [Value]
		, o.Content
	FROM 
		tblICEdiMapObject o INNER JOIN tblICEdiMap m 
			ON m.Id = o.MapId
	WHERE 
		o.Identifier = @p0
		AND m.UniqueId = @p1
