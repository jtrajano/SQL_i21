CREATE PROCEDURE [dbo].[uspSCTicketApplyUnpostForInTransit]
...
*/
	...
	BEGIN
		...
		SELECT @TICKET_APPLY_ID
			...
			, @ENTITY_USER_NAME
			, @USER_ID
		-- 3. update the ticket status to 'R'
		UPDATE tblSCTicket
	...
	DELETE FROM tblSCTicketApply WHERE intTicketApplyId = @TICKET_APPLY_ID
END