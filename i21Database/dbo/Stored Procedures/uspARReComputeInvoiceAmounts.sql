...
,[dblTotal]							    = ISNULL(IIF([dblTotal] < 0,-[dblTotal],[dblTotal]), @ZeroDecimal)
	,[dblBaseTotal]						= ISNULL(IIF([dblBaseTotal] <0,-[dblBaseTotal],[dblBaseTotal]), @ZeroDecimal)
							...
							ELSE
								(	
									...
									CASE WHEN (ISNULL(ARID.[intLoadDetailId],0) <> 0) THEN [dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblUnitPrice] / ARID.[dblSubCurrencyRate]) * ARID.[dblShipmentNetWt]), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblUnitPrice] / ARID.[dblSubCurrencyRate]) * ARID.[dblShipmentNetWt]) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]())
										 WHEN (ISNULL(intContractDetailId,0) <> 0 OR ISNULL(intContractHeaderId,0) <> 0) THEN
										  CASE WHEN ISNULL(ARID.[dblUnitPrice],0) = 0 THEN [dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblPrice] / ARID.[dblSubCurrencyRate]) * IIF(ARID.[dblQtyShipped] <0,-ARID.[dblQtyShipped],ARID.[dblQtyShipped])), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblPrice] / ARID.[dblSubCurrencyRate]) * IIF(ARID.[dblQtyShipped] <0,-ARID.[dblQtyShipped],ARID.[dblQtyShipped])) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]())
										   ELSE [dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblUnitPrice] / ARID.[dblSubCurrencyRate]) * IIF(ARID.[dblQtyShipped] <0,-ARID.[dblQtyShipped],ARID.[dblQtyShipped])), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblUnitPrice] / ARID.[dblSubCurrencyRate]) * IIF(ARID.[dblQtyShipped] <0,-ARID.[dblQtyShipped],ARID.[dblQtyShipped])) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]()) END
										ELSE
											...
											[dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblPrice] / ARID.[dblSubCurrencyRate]) * IIF(ARID.[dblQtyShipped] <0,-ARID.[dblQtyShipped],ARID.[dblQtyShipped])), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblPrice] / ARID.[dblSubCurrencyRate]) * IIF(ARID.[dblQtyShipped] <0,-ARID.[dblQtyShipped],ARID.[dblQtyShipped])) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]())											
									END							
								  )
							END)
							...
							ELSE
								(	
									CASE WHEN (ISNULL(ARID.[intLoadDetailId],0) <> 0) THEN [dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblBaseUnitPrice] / ARID.[dblSubCurrencyRate]) * ARID.[dblShipmentNetWt]), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblBaseUnitPrice] / ARID.[dblSubCurrencyRate]) * ARID.[dblShipmentNetWt]) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]())
										 ...
										 WHEN (ISNULL(intContractDetailId,0) <> 0 OR ISNULL(intContractHeaderId,0) <> 0) THEN CASE WHEN ISNULL(ARID.[dblBaseUnitPrice],0) = 0 THEN [dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblBasePrice] / ARID.[dblSubCurrencyRate]) * IIF(ARID.[dblQtyShipped] <0,-ARID.[dblQtyShipped],ARID.[dblQtyShipped])), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblBasePrice] / ARID.[dblSubCurrencyRate]) * IIF(ARID.[dblQtyShipped] <0,-ARID.[dblQtyShipped],ARID.[dblQtyShipped])) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]()) ELSE [dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblBaseUnitPrice] / ARID.[dblSubCurrencyRate]) * IIF(ARID.[dblQtyShipped] <0,-ARID.[dblQtyShipped],ARID.[dblQtyShipped])), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblBaseUnitPrice] / ARID.[dblSubCurrencyRate]) * IIF(ARID.[dblQtyShipped] <0,-ARID.[dblQtyShipped],ARID.[dblQtyShipped])) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]()) END
										ELSE
											[dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblBasePrice] / ARID.[dblSubCurrencyRate]) * IIF(ARID.[dblQtyShipped] <0,-ARID.[dblQtyShipped],ARID.[dblQtyShipped])), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblBasePrice] / ARID.[dblSubCurrencyRate]) * IIF(ARID.[dblQtyShipped] <0,-ARID.[dblQtyShipped],ARID.[dblQtyShipped])) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]())											
									END							
								  )
							END)	
FROM
