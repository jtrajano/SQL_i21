...
SET
	...
	,[dblTotal]							= ISNULL((CASE WHEN [dblTotal] < 0 THEN -[dblTotal] ELSE [dblTotal] END), @ZeroDecimal)
	,[dblBaseTotal]						= ISNULL((CASE WHEN [dblBaseTotal] < 0 THEN -[dblBaseTotal] ELSE [dblBaseTotal] END), @ZeroDecimal)
								...
								(	
									...
									CASE WHEN (ISNULL(ARID.[intLoadDetailId],0) <> 0) THEN [dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblUnitPrice] / ARID.[dblSubCurrencyRate]) * ARID.[dblShipmentNetWt]), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblUnitPrice] / ARID.[dblSubCurrencyRate]) * ARID.[dblShipmentNetWt]) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]())
										 WHEN (ISNULL(intContractDetailId,0) <> 0 OR ISNULL(intContractHeaderId,0) <> 0) THEN
										  CASE WHEN ISNULL(ARID.[dblUnitPrice],0) = 0 THEN [dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblPrice] / ARID.[dblSubCurrencyRate]) * (CASE WHEN ARID.[dblQtyShipped] < 0 THEN -ARID.[dblQtyShipped] ELSE ARID.[dblQtyShipped] END )), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblPrice] / ARID.[dblSubCurrencyRate]) * (CASE WHEN ARID.[dblQtyShipped] < 0 THEN -ARID.[dblQtyShipped] ELSE ARID.[dblQtyShipped] END )) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]())
										   ELSE [dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblUnitPrice] / ARID.[dblSubCurrencyRate]) * (CASE WHEN ARID.[dblQtyShipped] < 0 THEN -ARID.[dblQtyShipped] ELSE ARID.[dblQtyShipped] END )), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblUnitPrice] / ARID.[dblSubCurrencyRate]) * (CASE WHEN ARID.[dblQtyShipped] < 0 THEN -ARID.[dblQtyShipped] ELSE ARID.[dblQtyShipped] END )) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]()) END
										ELSE
											...
											[dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblPrice] / ARID.[dblSubCurrencyRate]) * (CASE WHEN ARID.[dblQtyShipped] < 0 THEN -ARID.[dblQtyShipped] ELSE ARID.[dblQtyShipped] END )), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblPrice] / ARID.[dblSubCurrencyRate]) * (CASE WHEN ARID.[dblQtyShipped] < 0 THEN -ARID.[dblQtyShipped] ELSE ARID.[dblQtyShipped] END )) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]())											
									END							
								  )
							END)
							...
							ELSE
								(	
									CASE WHEN (ISNULL(ARID.[intLoadDetailId],0) <> 0) THEN [dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblBaseUnitPrice] / ARID.[dblSubCurrencyRate]) * ARID.[dblShipmentNetWt]), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblBaseUnitPrice] / ARID.[dblSubCurrencyRate]) * ARID.[dblShipmentNetWt]) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]())
										 ...
										 WHEN (ISNULL(intContractDetailId,0) <> 0 OR ISNULL(intContractHeaderId,0) <> 0) THEN CASE WHEN ISNULL(ARID.[dblBaseUnitPrice],0) = 0 THEN [dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblBasePrice] / ARID.[dblSubCurrencyRate]) * (CASE WHEN ARID.[dblQtyShipped] < 0 THEN -ARID.[dblQtyShipped] ELSE ARID.[dblQtyShipped] END )), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblBasePrice] / ARID.[dblSubCurrencyRate]) * (CASE WHEN ARID.[dblQtyShipped] < 0 THEN -ARID.[dblQtyShipped] ELSE ARID.[dblQtyShipped] END )) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]()) ELSE [dbo].fnRoundBanker([dbo].fnRoundBanker(((ARID.[dblBaseUnitPrice] / ARID.[dblSubCurrencyRate]) * (CASE WHEN ARID.[dblQtyShipped] < 0 THEN -ARID.[dblQtyShipped] ELSE ARID.[dblQtyShipped] END )), [dbo].[fnARGetDefaultDecimal]()) - [dbo].fnRoundBanker((((ARID.[dblBaseUnitPrice] / ARID.[dblSubCurrencyRate]) * (CASE WHEN ARID.[dblQtyShipped] < 0 THEN -ARID.[dblQtyShipped] ELSE ARID.[dblQtyShipped] END )) * (ARID.[dblDiscount]/100.00)), [dbo].[fnARGetDefaultDecimal]()), [dbo].[fnARGetDefaultDecimal]()) END
										ELSE
