...
BEGIN
	...
	INSERT INTO tblICStagingItemLocation(intItemId, intItemLocationId, intLocationId, strLocationName, strLocationNo
		...
		, strDefaultGrossUom, strInventoryCountGroup, dblReorderPoint, dblLeadTime, intDefaultPurchaseUomId, intDefaultSaleUomId, intDefaultGrossUomId)
	SELECT i.intItemId, il.intItemLocationId, il.intLocationId, c.strLocationName, c.strLocationNumber
		...
		, il.intReceiveUOMId, il.intIssueUOMId, il.intGrossUOMId
	FROM @Items i
