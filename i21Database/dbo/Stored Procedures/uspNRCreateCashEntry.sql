...
, @intGLAccountId Int
, @strType nvarchar(3)
, @strTransactionId nvarchar(50) = ''   OUTPUT            
AS
BEGIN
      ...
      BEGIN TRY
            ...
            , @strNoteType nvarchar(50), @intTransactionId Int --, @strTransactionId nvarchar(50)
      ...
      --Bank accc - GL acc =  Cash acc from GL acc ( only 1 GL cash accpunt will be associated with Banc account GL account)
            ...
            SELECT @intCreatedUserId = [intEntityId] FROM dbo.tblSMUserSecurity Where [intEntityId] = @intEntityId
      ...
      --if @isSuccessful = 0
            ...
            EXEC dbo.uspCMPostBankDeposit @ysnPost, @ysnRecap, @strTransactionId, NULL, @intCreatedUserId, @intEntityId, @isSuccessful, @message_id
