...
BEGIN 
	...
	BEGIN 
		...
		DECLARE @strText_gtd9 NVARCHAR(200)
		SET @strText_gtd9 = (SELECT ISNULL(strItemNo, '') FROM tblICItem WHERE intItemId = @intItemId)
		EXEC uspICRaiseError 80048, @strText_gtd9
		GOTO _Exit
	END 
END 
