CREATE PROCEDURE uspIPFutureMonthPopulateStgXML @intFutureMonthId INT
	,@intToEntityId INT
...
BEGIN TRY
	...
	SELECT @strObjectName = 'vyuIPGetFutureMonth'
	...
	SET @intFutureMonthStageId = SCOPE_IDENTITY();
	...
	BEGIN
		...
		BEGIN
			SELECT @strSQL = N'INSERT INTO ' + @strServerName + '.' + @strDatabaseName + '.dbo.tblRKFuturesMonthStage (
				intFutureMonthId
				,strFutureMonth
				,strHeaderXML
				,strRowState
