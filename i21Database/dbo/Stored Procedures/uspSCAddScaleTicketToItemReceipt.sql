...
SELECT 
		...
		,dblCost					= CASE
										...
										(
											SELECT ISNULL(dbo.fnCTConvertQtyToTargetItemUOM(SC.intItemUOMIdTo,intSettlementUOMId,dblSettlementPrice + ISNULL(dbo.fnCTConvertQtyToTargetItemUOM(intSettlementUOMId,CNT.intBasisUOMId,LI.dblCost),0)),0) 
