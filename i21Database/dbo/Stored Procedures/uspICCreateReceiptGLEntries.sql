CREATE PROCEDURE [dbo].[uspICCreateReceiptGLEntries]
	...
	,
	@intRebuildCategoryId AS INT = NULL
-- This is only used when rebuilding the stocks. 
AS
...
--'Auto-Variance' -- Auto-variance will no longer be used. It will now use Inventory Adjustment. 
