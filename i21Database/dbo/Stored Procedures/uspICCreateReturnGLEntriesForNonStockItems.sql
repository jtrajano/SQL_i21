CREATE PROCEDURE [dbo].[uspICCreateReturnGLEntriesForNonStockItems]
...
SELECT	
		...
		,dblDebitUnit				= 0
		,dblCreditUnit				= 0
		,strDescription				= ISNULL(@strGLDescription, ISNULL(tblGLAccount.strDescription, '')) + ' ' + dbo.[fnICDescribeSoldStock](strItemNo, dblQty, dblCost, DEFAULT) 
		,strCode					= 'IC' 
		,strReference				= '' 
