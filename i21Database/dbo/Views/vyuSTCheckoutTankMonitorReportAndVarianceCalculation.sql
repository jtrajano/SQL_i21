...
INNER JOIN	tblTMCompanyConsumptionSite e
ON			c.intCompanyLocationId = e.intCompanyLocationId
INNER JOIN	tblTMCompanySiteDevice f
ON			f.intCompanyConsumptionSiteId = e.intCompanyConsumptionSiteId AND
