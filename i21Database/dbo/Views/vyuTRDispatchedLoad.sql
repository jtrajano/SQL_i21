...
LEFT JOIN tblEntity Seller ON Seller.intEntityId = Config.intSellerId
...
LEFT JOIN tblEntityLocation VendorLocation ON VendorLocation.intEntityLocationId = LG.intVendorEntityLocationId
