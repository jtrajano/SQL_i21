CREATE VIEW [dbo].[vyuCRMOpportunityLink]
	AS
		select
			...
			,strLOBType = (select top 1 r.strLineOfBusiness from tblSMLineOfBusiness r, tblCRMOpportunityLob s where r.strLineOfBusiness = 'Software' and r.intLineOfBusinessId = s.intLineOfBusinessId and s.intOpportunityId = a.intOpportunityId)
		from
			tblCRMOpportunity a
