...
INNER JOIN dbo.tblSTCigaretteRebatePrograms AS CRP 
	ON CRP.intCigaretteRebateProgramId = CRPD.intCigaretteRebateProgramId 
INNER JOIN dbo.tblICItemUOM AS UOM 
	ON UOM.intItemUOMId = CRPD.intItemUOMId 
INNER JOIN dbo.tblICUnitMeasure AS UM 
	ON UM.intUnitMeasureId = UOM.intUnitMeasureId 
INNER JOIN dbo.tblICItem AS IC 
