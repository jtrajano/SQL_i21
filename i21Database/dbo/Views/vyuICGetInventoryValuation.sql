...
SELECT	intInventoryValuationKeyId  = ISNULL(t.intInventoryTransactionId, 0) 
		...
		,dblCost					= COALESCE(dbo.fnICGetPromotionalCostByEffectiveDate(i.intItemId, t.intItemLocationId, GETDATE()) ,t.dblCost, 0)
		...
		,dblCostInStockUOM			= COALESCE(dbo.fnICGetPromotionalCostByEffectiveDate(i.intItemId, t.intItemLocationId, GETDATE()), dbo.fnCalculateCostBetweenUOM(t.intItemUOMId, iuStock.intItemUOMId, t.dblCost), 0)
