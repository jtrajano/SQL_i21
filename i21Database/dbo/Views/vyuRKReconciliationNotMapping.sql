...
AS
SELECT intReconciliationBrokerStatementHeaderId,strFutMarketName,strCommodityCode,strName,strAccountNumber,CONVERT(VARCHAR(11),dtmFilledDate,106) COLLATE Latin1_General_CI_AS dtmFilledDate 
