CREATE VIEW [dbo].[vyuQMCuppingReport]
AS
...
LEFT JOIN dbo.vyuQMCuppingTestResult AS Result_cup ON Result_cup.intSampleId = S.intSampleId
...
LEFT JOIN dbo.vyuQMCuppingTestResult AS Result_humidity ON Result_humidity.intSampleId = S.intSampleId
...
LEFT JOIN dbo.vyuQMCuppingTestResult AS Result_bulk ON Result_bulk.intSampleId = S.intSampleId
