...
SELECT DISTINCT intPOSEndOfDayId		= EOD.intPOSEndOfDayId
			  ...
			  , dblEndingBalance		= ISNULL(EOD.dblOpeningBalance, 0) + (ISNULL(PAYMENT.dblCashAmount, 0) + ISNULL(PAYMENT.dblCheckAmount, 0))  - ISNULL(ABS(CASHRETURN.dblReturnAmount),0)
