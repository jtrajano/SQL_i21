...
as	select tblSCTicket.intTicketId, (CASE WHEN
    ...
    strTicketStatusDescription, tblSCTicket.strTicketStatus,
    tblSCTicket.strTicketNumber, tblSCTicket.intScaleSetupId,
    tblSCTicket.intTicketPoolId, tblSCTicket.intTicketLocationId,
    tblSCTicket.intTicketType, tblSCTicket.strInOutFlag,
	...
	tblSCTicket.strPurchaseOrderNumber, tblSCTicket.strTruckName,
	tblSCTicket.strDriverName, tblSCTicket.ysnDriverOff,
	tblSCTicket.ysnSplitWeightTicket, tblSCTicket.ysnGrossManual,
	tblSCTicket.dblGrossWeight, tblSCTicket.dblGrossWeightOriginal,
	tblSCTicket.dblGrossWeightSplit1,
	tblSCTicket.dblGrossWeightSplit2, tblSCTicket.dtmGrossDateTime,
	tblSCTicket.intGrossUserId, tblSCTicket.ysnTareManual,
	tblSCTicket.dblTareWeight, tblSCTicket.dblTareWeightOriginal,
	tblSCTicket.dblTareWeightSplit1,
	tblSCTicket.dblTareWeightSplit2, tblSCTicket.dtmTareDateTime,
	tblSCTicket.intTareUserId, tblSCTicket.dblGrossUnits,
	tblSCTicket.dblNetUnits, tblSCTicket.strItemNumber,
	tblSCTicket.strItemUOM, tblSCTicket.intCustomerId,
	tblSCTicket.intSplitId, tblSCTicket.strDistributionOption,
	tblSCTicket.intDiscountSchedule,
	tblSCTicket.strDiscountLocation, tblSCTicket.dtmDeferDate,
	tblSCTicket.strContractNumber, tblSCTicket.intContractSequence,
	tblSCTicket.strContractLocation, tblSCTicket.dblUnitPrice,
	tblSCTicket.dblUnitBasis, tblSCTicket.dblTicketFees,
	tblSCTicket.intCurrencyId, tblSCTicket.dblCurrencyRate,
	...
	tblSCTicket.ysnFarmerPaysFreight, tblSCTicket.strLoadNumber,
	tblSCTicket.intLoadLocationId, tblSCTicket.intAxleCount,
	tblSCTicket.strBinNumber, tblSCTicket.strPitNumber,
	tblSCTicket.intGradingFactor, tblSCTicket.strVarietyType,
	tblSCTicket.strFarmNumber, tblSCTicket.strFieldNumber,
	tblSCTicket.strDiscountComment, tblSCTicket.strCommodityCode,
	tblSCTicket.intCommodityId, tblSCTicket.intDiscountId,
	tblSCTicket.intContractId, tblSCTicket.intDiscountLocationId,
	tblSCTicket.intItemId, tblSCTicket.intEntityId,
	tblSCTicket.intLoadId, tblSCTicket.intMatchTicketId,
	tblSCTicket.intSubLocationId, tblSCTicket.intStorageLocationId,
	tblSCTicket.intFarmFieldId, tblSCTicket.intDistributionMethod,
	tblSCTicket.intSplitInvoiceOption,
	tblSCTicket.intDriverEntityId,
	tblSCTicket.intStorageScheduleId, tblSCTicket.intConcurrencyId,
