...
SELECT 
	...
	companyLocation.strLocationName strLocation, 
	storageLocation.strName strStorageLocation, 
	...
	, CAST(dbo.fnMaxNumeric((storageLocation.dblEffectiveDepth * storageLocation.dblUnitPerFoot) - dbo.fnMaxNumeric(summary.dblStock, 0), 0) AS NUMERIC(16, 8)) dblAvailable
