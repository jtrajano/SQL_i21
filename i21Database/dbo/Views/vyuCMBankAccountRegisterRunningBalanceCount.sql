...
dblPayment = 
	...
	WHEN intBankTransactionTypeId IN ( 2, 5, 25, 26, 51 ) AND ISNULL(dblAmount,0) < 0 THEN dblAmount * -1 ELSE 0 END                        , 
dblDeposit = CASE WHEN intBankTransactionTypeId IN ( 1, 10, 11, 18, 19, 103, 116, 121, 122, 123 ) THEN dblAmount 
	WHEN intBankTransactionTypeId IN (5, 25) AND ISNULL(dblAmount,0) > 0 THEN dblAmount ELSE 0 END, 
strReferenceNo,
strTransactionId,
ysnCheckVoid,
ysnClr,
