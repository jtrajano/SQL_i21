...
SELECT CH.intContractHeaderId
	...
	,EY.strEntityCity
	,NM.strTerm
	,NM.strContractBasisDescription
	,EY.strEntityCountry
	,NM.strPosition
	,NM.strInsuranceByDescription
	,NM.strContractType
	,NM.strInsuranceBy
	,NM.strInvoiceTypeDescription
	,NM.strInvoiceType
	,NM.strCountry
	...
	,NM.strFreightTerm
	,CASE 
		WHEN NM.strINCOLocationType = 'City'
			THEN NM.strINCOLocation
		ELSE NM.strSubLocationName
		END AS strINCOLocation
	...
	1 = (
		CASE 
			WHEN CH.intContractTypeId = 1
				AND EY.strEntityType = 'Vendor'
				THEN 1
			WHEN CH.intContractTypeId <> 1
				AND EY.strEntityType = 'Customer'
				THEN 1
			ELSE 0
			END
		)
