...
INNER JOIN tblSTCheckoutPumpTotals CPT 
	ON CPT.intCheckoutId = CH.intCheckoutId 
INNER JOIN tblICItemUOM IU 
	ON IU.intItemUOMId = CPT.intPumpCardCouponId 
...
GROUP BY ST.intStoreId, ST.intStoreNo, ST.strRegion, ST.strDistrict, CL.strCity, CL.strStateProvince, CL.strZipPostalCode, ST.strDescription, CAT.intCategoryId, CAT.strDescription, IT.intItemId, IT.strItemNo, IT.strDescription, CH.dtmCheckoutDate, ISNULL(Inv.ysnPosted, 0)
