...
, * FROM (
	...
	SELECT 	
		...
		, intLineNo = PickLotDetail.intPickLotDetailId --PickLotDetail.intSContractDetailId
		, intOrderId = PickLotDetail.intPickLotHeaderId -- PickLotDetail.intSContractHeaderId
