...
INNER JOIN tblSTCheckoutDeposits D 
	ON D.intCheckoutId = CH.intCheckoutId 
WHERE D.dblTotalDeposit > 0	
GROUP BY D.intDepositId, ST.intStoreId, ST.intStoreNo, ST.strRegion, ST.strDistrict, ST.strDescription, CH.dtmCheckoutDate, ISNULL(Inv.ysnPosted, 0)
