...
UNION ALL
    ...
    , strItemNo, strLocationName = NULL, strLocationType = NULL, strLongUPCCode = NULL, strLotTracking = NULL, strName, strPricingMethod = NULL, strPricingType = NULL, strPromotionType = NULL
    , strStatus = NULL, strType = NULL, strUPC = NULL, strUnitMeasure, strUnitType = NULL, strUpcCode = NULL, strVendorId = NULL, strVendorName = NULL, ysnAllowPurchase = NULL, ysnAllowSale = NULL, ysnStockUnit = NULL
