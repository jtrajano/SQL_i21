CREATE VIEW [dbo].[vyuTRQuoteSelection]
	AS 
select QT.intCustomerRackQuoteHeaderId,QT.intSupplyPointId,QT.intItemId,QT.intCategoryId,QT.intEntityCustomerId,QT.ysnQuote from
             (select QH.intCustomerRackQuoteHeaderId, QV.intSupplyPointId,QI.intItemId,IC.intCategoryId,QH.intEntityCustomerId,QV.ysnQuote
             ...
             UNION ALL
             select  QH.intCustomerRackQuoteHeaderId,QV.intSupplyPointId,IC.intItemId,QC.intCategoryId,QH.intEntityCustomerId,QV.ysnQuote
                     from tblARCustomerRackQuoteHeader QH
...
group by QT.intCustomerRackQuoteHeaderId,QT.intSupplyPointId,QT.intItemId,QT.intCategoryId,QT.intEntityCustomerId,QT.ysnQuote
