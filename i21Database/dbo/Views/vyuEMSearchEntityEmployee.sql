...
SELECT 
		...
		a.strTitle,
		c.strPayPeriod,
		strDepartment = dbo.fnEMGetEmployeeDepartment(a.intEntityId) COLLATE Latin1_General_CI_AS,
		strSupervisor = dbo.fnEMGetEmployeeSupervisor(a.intEntityId) COLLATE Latin1_General_CI_AS,
		c.strType,
		c.intRank,
		c.dtmReviewDate,
		c.dtmNextReview,
