...
SELECT [strTransactionType]				= 'Load Schedule'
	...
	,[dblDiscount]						= 0
	,[dblPrice]							= ROUND(ARCC.[dblCashPrice], [dbo].[fnARGetDefaultDecimal]()) 
	,[dblShipmentUnitPrice]				= ROUND(ARCC.[dblCashPrice], [dbo].[fnARGetDefaultDecimal]()) 
	,[strPricing]						= ''
	,[dblTotalTax]						= 0
...
SELECT  [strTransactionType]			= 'Load Schedule'
	...
	,[dblQtyRemaining]					= 1
	,[dblDiscount]						= 0
	,[dblPrice]							=  ROUND(LWS.dblPrice, [dbo].[fnARGetDefaultDecimal]()) 
	,[dblShipmentUnitPrice]				=  ROUND(dblShipmentUnitPrice, [dbo].[fnARGetDefaultDecimal]())
	,[strPricing]						= ''
	,[dblTotalTax]						= 0
...
SELECT  [strTransactionType]			= 'Load Schedule'
	...
	,[dblQtyRemaining]					= 1
	,[dblDiscount]						= 0
	,[dblPrice]							=  ROUND(LC.dblPrice, [dbo].[fnARGetDefaultDecimal]()) 
	,[dblShipmentUnitPrice]				=  ROUND(LC.dblShipmentUnitPrice, [dbo].[fnARGetDefaultDecimal]()) 
	,[strPricing]						= ''
	,[dblTotalTax]						= 0
