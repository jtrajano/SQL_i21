...
FROM (
	...
	SELECT strTransactionType				= 'Inventory Shipment'
		 ...
		 , dblUnitPrice						= CAST((CASE WHEN ARCC.intContractDetailId IS NOT NULL THEN ISNULL(ARCC.dblUnitPrice, ARCC.dblCashPrice) ELSE ICISI.dblUnitPrice END) AS DECIMAL(18,6))
