CREATE VIEW [dbo].[vyuCTContractDetailViewZug]  
...
cross apply (  
 ...
 FROM tblSMTransaction TR WITH (NOLOCK)  
 JOIN tblSMScreen SC WITH (NOLOCK) ON SC.intScreenId = TR.intScreenId  
 WHERE SC.strNamespace IN( 'ContractManagement.view.Contract', 'ContractManagement.view.Amendments') AND TR.intRecordId = b.intContractHeaderId  
