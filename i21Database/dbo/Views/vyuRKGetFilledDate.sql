...
AS
SELECT top 100 percent CONVERT(INT,ROW_NUMBER() OVER(ORDER BY CONVERT(VARCHAR(10),dtmFilledDate,110) COLLATE Latin1_General_CI_AS)) intRowNum,CONVERT(VARCHAR(11),dtmFilledDate,106) dtmFilledDate from 
