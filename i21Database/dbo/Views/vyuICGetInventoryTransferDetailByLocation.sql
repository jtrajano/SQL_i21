CREATE VIEW [dbo].[vyuICGetInventoryTransferDetailByLocation]
AS
	...
	FROM tblICInventoryTransferDetail TransferDetail
        ...
        INNER JOIN vyuICUserCompanyLocations permission ON permission.intCompanyLocationId = Transfer.intFromLocationId