...
SELECT (convert(int,isnull((Long1-MatchLong),0)- isnull(Sell1-MatchShort,0)))*dblContractSize GrossPnL,((Long1-MatchLong)*dblPrice) LongWaitedPrice,  
isnull((Long1-MatchLong),0) as dblLong,isnull(Sell1-MatchShort,0) as dblShort, ((Sell1-MatchShort)*dblPrice) ShortWaitedPrice,  
