CREATE VIEW [dbo].[vyuGRTransferStorageReferenceSplitDetail]
AS
SELECT intTransferStorageSplitId		= TSS.intTransferStorageSplitId
    ...
    , dblSplitPercent				= TSR.dblSplitPercent
...
INNER JOIN tblGRTransferStorageSourceSplit TSPLT
	ON TSPLT.intTransferStorageId = TSS.intTransferStorageId
INNER JOIN tblGRTransferStorageReference TSR
	ON TSR.intTransferStorageSplitId = TSS.intTransferStorageSplitId and ISNULL(TSR.intTransferStorageId, TSS.intTransferStorageId) = TSS.intTransferStorageId
INNER JOIN tblGRTransferStorage TS
	ON TS.intTransferStorageId = TSPLT.intTransferStorageId
