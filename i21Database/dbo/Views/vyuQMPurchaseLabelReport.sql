...
CASE WHEN A.intContractDetailId IS NULL THEN B.strTeaGardenChopInvoiceNumber ELSE CT.strTeaGardenChopInvoiceNumber END strTeaGardenChopInvoiceNumber,  
B.strBroker,  
CASE WHEN A.intContractDetailId IS NULL THEN B.strLeafGrade ELSE CT.strLeafGrade END strLeafGrade,  
