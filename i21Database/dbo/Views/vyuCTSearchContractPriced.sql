CREATE VIEW [dbo].[vyuCTSearchContractPriced] AS with shipmentstatus as (
  select 
    * 
  from 
    (
...
select 
  ...
  dblPricedQuantity = t.dblQuantity,
  t.dtmFixationDate,
  t.dblFutures,
