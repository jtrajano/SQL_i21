...
SELECT
	...
	COALESCE(dbo.fnICGetPromotionalCostByEffectiveDate(stock.intItemId, stock.intItemLocationId, tsession.dtmTransactionDate), EffectiveCost.dblCost, stock.dblReceiveLastCost) dblReceiveLastCost,
	...
	COALESCE(dbo.fnICGetPromotionalCostByEffectiveDate(stock.intItemId, stock.intItemLocationId, tsession.dtmTransactionDate), EffectiveCost.dblCost, stock.dblIssueLastCost) dblIssueLastCost,
	...
	COALESCE(dbo.fnICGetPromotionalCostByEffectiveDate(stock.intItemId, stock.intItemLocationId, tsession.dtmTransactionDate), EffectiveCost.dblCost, stock.dblLastCost) dblLastCost,
