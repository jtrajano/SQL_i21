...
SELECT CD.intContractDetailId  
 ...
 , ISNULL(ISNULL(LG1.strDestinationPort, LG.strDestinationPort), DP.strCity)    AS strDestinationPoint  
 , DC.strCity AS strDestinationCity  
 , CD.strShippingTerm  
 , ES.strName AS strShippingLine  
 , CD.strVessel  
 , ISNULL(ISNULL(LG1.strName, LG.strName), EP.strName) AS strShipper  
 ...
 , intWeekActETD = datepart(wk, ISNULL(LG1.dtmETAPOL, LG.dtmETAPOL))  
 , dtmETAPOD = ISNULL(LG1.dtmETAPOD, LG.dtmETAPOD)  
 , intWeekActETA = datepart(wk, ISNULL(LG1.dtmETAPOD, LG.dtmETAPOD))  
