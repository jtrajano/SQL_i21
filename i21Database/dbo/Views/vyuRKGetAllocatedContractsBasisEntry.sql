CREATE VIEW [dbo].[vyuRKGetAllocatedContractsBasisEntry]

AS

SELECT be.intAllocatedContractsBasisEntryId
    , be.intAllocatedContractsGainOrLossHeaderId
    , be.intCommodityId
	, c.strCommodityCode
    , be.intItemId
	, i.strItemNo
	...
	, strMTMPoint = mtmPoint.strMTMPoint
...
FROM tblRKAllocatedContractsBasisEntry be
...
LEFT JOIN tblSMCompanyLocation loc ON loc.intCompanyLocationId = be.intCompanyLocationId
...
LEFT JOIN tblCTMTMPoint mtmPoint
	ON mtmPoint.intMTMPointId = be.intMTMPointId
