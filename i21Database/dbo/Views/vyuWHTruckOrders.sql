...
LEFT JOIN tblARCustomer cu ON cu.intEntityCustomerId = oh.intShipToAddressId
...
LEFT JOIN tblARCustomer cu1 ON cu1.intEntityCustomerId = oh.intShipFromAddressId
