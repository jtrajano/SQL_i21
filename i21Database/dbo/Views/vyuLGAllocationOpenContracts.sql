...
AS
	SELECT 	CD.intContractDetailId, 
			...
			CD.dblQuantity - IsNull(CD.dblAllocatedQty, 0) - IsNull(CD.dblReservedQty, 0) - IsNull(CD.dblAllocationAdjQty, 0) AS dblOpenQuantity,
			CD.dblQuantity - IsNull(CD.dblAllocatedQty, 0) - IsNull(CD.dblAllocationAdjQty, 0) AS dblUnAllocatedQuantity,
			CD.dblQuantity - IsNull(CD.dblReservedQty, 0) AS dblUnReservedQuantity,
