...
(SELECT cd.intContractDetailId, strContractNumber, intContractSeq as intContractSeq,
		...
		cd.strEntityName, 
		cd.intFutureMarketId,cd.intFutureMonthId, cd.strContractType, cd.intContractTypeId, cd.intContractStatusId,
...
GROUP BY strContractNumber,cd.intContractDetailId,intContractSeq,cd.intFutureMarketId,cd.intFutureMonthId,cd.strContractType, cd.intContractTypeId, cd.intContractStatusId,cd.strEntityName)t
