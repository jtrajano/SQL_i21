...
SELECT        A.intAccountId, A.intCustomerId, A.intDiscountDays, A.intDiscountScheduleId, A.intInvoiceCycle, A.intSalesPersonId, A.dtmBonusCommissionDate, A.dblBonusCommissionRate, A.dblRegularCommissionRate, 
                         ...
                         N.ysnExemptFETOnRemotes, N.ysnExemptSETOnRemotes, N.ysnExemptLCOnRemotes, N.strExemptLCCode, N.intImportMapperId, N.strLinkNetwork, N.intConcurrencyId AS EXPR9, 
                         D.intDepartmentId AS EXPR10, D.intAccountId AS EXPR11, D.strDepartment, D.strDepartmentDescription, D.intConcurrencyId AS EXPR12, Cus.intEntityId, Cus.intEntityCustomerId, Cus.strName, 
                         Cus.strCustomerNumber, Cus.strType, Cus.strPhone, Cus.strAddress, Cus.strCity, Cus.strState, Cus.strZipCode, Cus.ysnActive AS EXPR13, Cus.intSalespersonId AS EXPR14, Cus.intCurrencyId, Cus.intTermsId, 
                         Cus.intShipViaId, Cus.strShipToLocationName, Cus.strShipToAddress, Cus.strShipToCity, Cus.strShipToState, Cus.strShipToZipCode, Cus.strShipToCountry, Cus.strBillToLocationName, Cus.strBillToAddress, 
                         Cus.strBillToCity, Cus.strBillToState, Cus.strBillToZipCode, Cus.strBillToCountry, I.strInvoiceCycle
FROM            dbo.tblCFAccount AS A LEFT OUTER JOIN
                         ...
                         dbo.tblCFInvoiceCycle AS I ON I.intInvoiceCycleId = A.intInvoiceCycle
GO