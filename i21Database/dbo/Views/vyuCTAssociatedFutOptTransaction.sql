...
AS
	...
	(
		SELECT	SY.intAssignFuturesToContractSummaryId,
				...
				FS.dblGetNoOfContract			AS	dblShortGetNoOfContract,
				FS.dblContractSize				AS	dblShortContractSize,
				FS.dblOpenContract				AS	dblShortOpenContract,
				...
				FL.dblGetNoOfContract			AS	dblLongGetNoOfContract,
				FL.dblContractSize				AS	dblLongContractSize,
				FL.dblOpenContract				AS	dblLongOpenContract,
