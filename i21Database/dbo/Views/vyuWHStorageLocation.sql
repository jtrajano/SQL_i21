CREATE VIEW vyuWHStorageLocation
AS
...
INNER JOIN tblICStorageUnitType ut ON ut.intStorageUnitTypeId = sl.intStorageUnitTypeId
INNER JOIN tblICRestriction r ON r.intRestrictionId = sl.intRestrictionId