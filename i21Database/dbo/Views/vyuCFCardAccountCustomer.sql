...
SELECT cfCard.intCardId, cfCard.intNetworkId, cfCard.strCardNumber, cfCard.strCardDescription, cfCard.intAccountId, cfCard.intProductAuthId, cfCard.intEntryCode, cfCard.strCardXReference, cfCard.strCardForOwnUse, cfCard.intExpenseItemId, 
             ...
             cfAccount.strPrimarySortOptions, cfAccount.strSecondarySortOptions, cfAccount.ysnSummaryByCard,cfAccount.ysnSummaryByDepartmentProduct,  cfAccount.ysnSummaryByCardProd,cfAccount.ysnSummaryByDeptCardProd,cfAccount.ysnSummaryByVehicle, cfAccount.ysnSummaryByMiscellaneous, cfAccount.ysnSummaryByProduct, cfAccount.ysnSummaryByDepartment, 
             ...
             cfAccount.ysnPPTransferCostForNetwork,cfAccount.ysnShowSST ,cfAccount.ysnPrintMiscellaneous, cfAccount.intFeeProfileId, cfAccount.strPrintSiteAddress, cfAccount.dtmLastBillingCycleDate, cfAccount.intRemotePriceProfileId, cfAccount.intExtRemotePriceProfileId, 
             cfAccount.intLocalPriceProfileId, cfAccount.intCreatedUserId AS EXPR2, cfAccount.dtmCreated AS EXPR3, cfAccount.intLastModifiedUserId AS EXPR4, cfAccount.dtmLastModified AS EXPR5, cfAccount.intConcurrencyId AS EXPR6, emEntity.intEntityId, 
              emEntity.strName, emEntity.strCustomerNumber, emEntity.strType, emEntity.strPhone, emEntity.strAddress, emEntity.strCity, emEntity.strState, emEntity.strZipCode, emEntity.ysnActive AS EXPR7, emEntity.intSalespersonId AS EXPR8, 
