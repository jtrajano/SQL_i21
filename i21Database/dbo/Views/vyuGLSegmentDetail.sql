...
AS
SELECT        S.intAccountSegmentId, U.intSort, S.strCode, C.strAccountCategory, S.intAccountCategoryId, S.strDescription, G.strAccountType, S.intAccountStructureId
FROM            dbo.tblGLAccountSegment AS S LEFT OUTER JOIN
