...
union all
--insert the result in tblGRAPClearingStorageInventoryReceipt from the select statements below
--to improve the performance, the execution of select statements will be skipped if the tblGRStorageInventoryReceipt table does not have a data
--see GRN-3285
SELECT 
	intEntityVendorId
    ,dtmDate
    ...
    ,intAccountId
	,strAccountId
FROM tblGRAPClearingStorageInventoryReceipt
