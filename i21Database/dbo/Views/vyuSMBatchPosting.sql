...
(
	...
	UNION ALL
	SELECT 'Debit Memo', intBillId, strBillId, intEntityId, dtmDate, strComment as strReference FROM tblAPBill WHERE ysnPosted = 0 AND ysnForApproval = 0 AND intTransactionType = 3
	UNION ALL
