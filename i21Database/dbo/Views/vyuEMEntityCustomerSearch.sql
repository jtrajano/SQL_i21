...
SELECT intEntityId			= CUSTOMER.intEntityId
	...
	, strTerm				= ISNULL(ISNULL(CUSTOMERTERM.strTerm, PULLPOINT.strTerm), CUSTOMERTERM.strTerm)
	, intCurrencyId			= CUSTOMER.intCurrencyId
	, intTermsId			= ISNULL(ISNULL(CUSTOMER.intTermID, PULLPOINT.intTermId), CUSTOMERTERM.intTermID)
