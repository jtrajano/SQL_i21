...
SELECT intEntityId			= CUSTOMER.intEntityId
	...
	, strTerm				= ISNULL(ISNULL(LOCATIONTERM.strTerm, PULLPOINT.strTerm), CUSTOMERTERM.strTerm)
	, intCurrencyId			= CUSTOMER.intCurrencyId
	, intTermsId			= ISNULL(ISNULL(LOCATIONTERM.intTermID, PULLPOINT.intTermId), CUSTOMERTERM.intTermID)
...
AND CUSTOMER.intDefaultContactId = entityToContact.intEntityToContactId
