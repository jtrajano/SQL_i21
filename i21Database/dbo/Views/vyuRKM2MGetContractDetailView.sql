...
FROM   tblCTContractHeader                             CH           
       ...
       LEFT JOIN     tblCTPriceFixation                PF     ON     
	   case when isnull(PF.intContractHeaderId,0)=0  then PF.intContractDetailId else PF.intContractHeaderId end =
	   case when isnull(CD.intContractHeaderId,0)=0  then CD.intContractDetailId else CD.intContractHeaderId end 
