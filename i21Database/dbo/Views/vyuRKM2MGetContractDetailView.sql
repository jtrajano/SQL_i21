...
FROM   tblCTContractHeader                             CH     
       ...
       LEFT JOIN     tblCTPriceFixation                PF     ON     case when isnull(ysnMultiplePriceFixation,0)=1 then PF.intContractHeaderId else PF.intContractDetailId end = case when isnull(ysnMultiplePriceFixation,0)=1 then CD.intContractHeaderId else CD.intContractDetailId end     
