...
UNION ALL
SELECT 999999999 AS intStoreId
,	999999999 AS intStoreNo
, ST.strRegion
, ST.strDistrict
, 'Grand Total' AS strDescription 
, CAT.intCategoryId
, CAT.strCategoryCode
, CAT.strDescription strCategoryDescription
, CH.dtmCheckoutDate
...
INNER JOIN tblICCategory CAT ON CAT.intCategoryId = IT.intCategoryId
WHERE CDT.dblTotalSalesAmount > 0	
GROUP BY ST.strRegion, ST.strDistrict, CAT.intCategoryId, CAT.strCategoryCode, CAT.strDescription, CH.dtmCheckoutDate, CH.ysnPosted