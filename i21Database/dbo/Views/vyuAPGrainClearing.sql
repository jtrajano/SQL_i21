...
SELECT 
	...
	--,SS.dblSettleUnits AS dblSettleStorageQty
	,ROUND(CASE WHEN SS.dblUnpaidUnits != 0 THEN SS.dblUnpaidUnits ELSE SS.dblSettleUnits END, 2) AS dblSettleStorageQty
...
SELECT 
	...
	,ROUND(CASE WHEN SS.dblSettleUnits != 0 THEN  -SS.dblSettleUnits ELSE -SS.dblUnpaidUnits END, 2)
