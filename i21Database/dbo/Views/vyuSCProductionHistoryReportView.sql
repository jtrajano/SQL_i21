CREATE VIEW [dbo].[vyuSCProductionHistoryReportView]
	...
	SC.ysnGrossManual,
	CAST(SC.dblGrossWeight AS DECIMAL(18,4)) dblGrossWeight, 
	SC.dtmGrossDateTime,
	SC.ysnTareManual,
	CAST(SC.dblTareWeight AS DECIMAL(18,4)) dblTareWeight, 
	SC.dtmTareDateTime,
	CAST(SC.dblGrossUnits AS DECIMAL(18,4)) dblGrossUnits,
	CAST(SC.dblNetUnits AS DECIMAL(18,4)) dblNetUnits, 
	SC.strItemUOM, 
	SC.intSplitId, 
	...
	CAST(SC.dblTicketFees AS DECIMAL(18,4)) dblTicketFees,
	SC.intCurrencyId, 
	CAST(SC.dblCurrencyRate AS DECIMAL(18,4)) dblCurrencyRate,
	SC.intHaulerId,
	SC.intFreightCarrierId,
	CAST(SC.dblFreightRate AS DECIMAL(18,4)) dblFreightRate,
	CAST(SC.dblFreightAdjustment AS DECIMAL(18,4)) dblFreightAdjustment,
	SC.intFreightCurrencyId,
	CAST(SC.dblFreightCurrencyRate AS DECIMAL(18,4)) dblFreightCurrencyRate,
	...
	SC.intConcurrencyId,
	CAST(SC.dblNetWeightDestination AS DECIMAL(18,4)) dblNetWeightDestination,
	CAST(SC.dblShrink AS DECIMAL(18,4)) dblShrink,
	CAST(SC.dblConvertedUOMQty AS DECIMAL(18,4)) dblConvertedUOMQty,
	SC.strCostMethod,
	CAST((SC.dblUnitPrice + SC.dblUnitBasis) AS DECIMAL(18,4)) AS dblCashPrice,
	...
	QM.strDiscountCode,
	CAST(QM.dblGradeReading AS DECIMAL(18,4)) dblGradeReading,
	...
	CAST(SC.dblGrossUnits AS DECIMAL(18,4)) dblGross,
	CAST(SC.dblNetUnits AS DECIMAL(18,4)) dblNet,
	CAST((SC.dblGrossWeight + SC.dblGrossWeight1 + SC.dblGrossWeight2) AS DECIMAL(18,4)) AS dblLineGrossWeight,
	CAST((SC.dblTareWeight + SC.dblTareWeight1 + SC.dblTareWeight2) AS DECIMAL(18,4)) AS dblLineNetWeight,
