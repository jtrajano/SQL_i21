...
AS
SELECT     dbo.vyuARCustomerContacts.intCustomerId, dbo.vyuARCustomerContacts.intEntityId, dbo.vyuARCustomerContacts.intEntityContactId, dbo.vyuARCustomerContacts.strName, 
