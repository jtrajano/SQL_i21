...
WITH GetNextForDepreciate AS(  
 SELECT B.intAssetId, 
 dtmNextDepreciation = CASE WHEN dtmDepreciationToDate IS NULL 
 THEN  B.dtmDateInService ELSE  
	DATEADD(s,-1,DATEADD(mm, DATEDIFF(m,0,DATEADD(MONTH,1 , dtmDepreciationToDate))+1,0))
 END  
