...
GROUP BY strContractNumber,cd.intContractHeaderId,cd.intFutureMarketId,cd.intFutureMonthId,cd.strContractType,cd.intContractTypeId, cd.intContractStatusId,cd.strEntityName)t
