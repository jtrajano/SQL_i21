...
(SELECT cd.intContractHeaderId, strContractNumber,  
  ...
  isnull(SUM(cd.dblNoOfLots),0) as dblAvailableLot,  cd.intContractTypeId,
...
GROUP BY strContractNumber,cd.intContractHeaderId,cd.intFutureMarketId,cd.intFutureMonthId,ct.strContractType,e.strName,cd.intContractTypeId)t 