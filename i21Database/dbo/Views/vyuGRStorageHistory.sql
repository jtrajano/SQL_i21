...
SELECT DISTINCT TOP 100 PERCENT
	 intStorageHistoryId				= CASE 
											WHEN SH.intTransactionTypeId = 3 AND SH.strType = 'Transfer' THEN (SELECT intStorageHistoryId FROM tblGRStorageHistory WHERE intCustomerStorageId = TSplit.intTransferToCustomerStorageId AND strType = 'From Transfer' AND intTransferStorageId = TSR.intTransferStorageId)
