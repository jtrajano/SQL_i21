CREATE VIEW [dbo].[vyuICGetInventoryStorage]
AS

SELECT	intInventoryValuationKeyId  = ISNULL(t.intInventoryTransactionStorageId, 0) 
		,intInventoryTransactionStorageId	= ISNULL(t.intInventoryTransactionStorageId, 0) 
		,i.intItemId
		...
		,intLocationId				= il.intLocationId --ISNULL(InTransitLocation.intCompanyLocationId, [Location].intCompanyLocationId) 
		,t.intItemLocationId
...
FROM 	tblICInventoryTransactionStorage t 
		...
		LEFT JOIN tblSMCompanyLocation [location]
			ON [location].intCompanyLocationId = il.intLocationId
