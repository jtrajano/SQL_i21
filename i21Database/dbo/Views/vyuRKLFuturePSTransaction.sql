...
SELECT intSelectedInstrumentTypeId,
      ...
      ,IsNull((SELECT SUM (AD.dblMatchQty) from tblRKMatchFuturesPSDetail AD inner join tblRKMatchFuturesPSHeader A ON AD.intMatchFuturesPSHeaderId = A.intMatchFuturesPSHeaderId where A.strType = 'Realize' Group By AD.intLFutOptTransactionId 
