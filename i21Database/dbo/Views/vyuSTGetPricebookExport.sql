...
AS
SELECT CAST(ItemPricing.intItemPricingId AS NVARCHAR(1000)) + '0' + CAST(ItemUOM.intItemUOMId AS NVARCHAR(1000)) + '0' + CAST(ST.intStoreId AS NVARCHAR(1000)) AS strUniqueId
    , ST.intStoreId
	, ST.intStoreNo
	, Item.strItemNo
