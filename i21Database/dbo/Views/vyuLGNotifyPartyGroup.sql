CREATE VIEW vyuLGNotifyPartyGroup
AS
SELECT 
	NP.intNotifyPartyGroupDetailId
	,NP.intNotifyPartyGroupId
	,NP.intBankId
...
INNER JOIN tblLGNotifyPartyGroupDetail NP ON NP.intNotifyPartyGroupId = N.intNotifyPartyGroupId
