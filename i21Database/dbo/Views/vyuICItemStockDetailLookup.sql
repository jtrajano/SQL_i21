CREATE VIEW [dbo].[vyuICItemStockDetailLookup]
AS
SELECT 
	...
	dblReceiveLastCost = COALESCE(dbo.fnICGetPromotionalCostByEffectiveDate(Item.intItemId, ItemLocation.intItemLocationId, intReceiveUOMId, GETDATE()), ItemPricing.dblLastCost, 0) * COALESCE(ReceiveUOM.dblUnitQty, StockUOM.dblUnitQty, 0),
	...
	dblIssueLastCost = COALESCE(dbo.fnICGetPromotionalCostByEffectiveDate(Item.intItemId, ItemLocation.intItemLocationId, intIssueUOMId, GETDATE()), ItemPricing.dblLastCost, 0) * COALESCE(IssueUOM.dblUnitQty, StockUOM.dblUnitQty, 0),
	...
	dblGrossLastCost = COALESCE(dbo.fnICGetPromotionalCostByEffectiveDate(Item.intItemId, ItemLocation.intItemLocationId, intGrossUOMId, GETDATE()), ItemPricing.dblLastCost, 0) * GrossUOM.dblUnitQty,
	...
	dblLastCost = COALESCE(dbo.fnICGetPromotionalCostByEffectiveDate(Item.intItemId, ItemLocation.intItemLocationId, StockUOM.intItemUOMId, GETDATE()), ItemPricing.dblLastCost, 0),
