...
AS
	...
	LEFT JOIN	vyuCTContractHeaderNotMapped		NM	ON	NM.intContractHeaderId				=		CH.intContractHeaderId
	LEFT JOIN	vyuCTEntity							EY	ON	EY.intEntityId						=		CH.intEntityId			AND
	...
	LEFT JOIN	tblARSalesperson					SP	ON	SP.intEntitySalespersonId			=		CH.intSalespersonId					
