CREATE VIEW [dbo].[vyuSCRestApiTickets]
	AS select 
	SCT.intTicketId
	,SCT.strTicketStatus
	, (CASE
	...
	,	strSplitDistribution  =  CASE SCT.strDistributionOption 
	...
	,SCT.dtmDeferDate
	,strContractNumber = CASE WHEN SCT.strDistributionOption = 'CNT' THEN SCT.strContractNumber ELSE NULL END
	,intContractSequence = CASE WHEN SCT.strDistributionOption = 'CNT' THEN SCT.intContractSequence ELSE NULL END
