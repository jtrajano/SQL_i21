...
,strShipFromNoState = [dbo].[fnAPFormatAddress2](NULL, NULL, NULL, A.strShipFromAddress, A.strShipFromCity, A.strShipFromZipCode, A.strShipFromCountry, NULL) COLLATE Latin1_General_CI_AS
