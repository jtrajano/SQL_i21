...
,strShipFromNoState = [dbo].[fnAPFormatAddress2](B2.strName,NULL, A.strShipFromAttention, A.strShipFromAddress, A.strShipFromCity, A.strShipFromZipCode, A.strShipFromCountry, NULL) COLLATE Latin1_General_CI_AS
