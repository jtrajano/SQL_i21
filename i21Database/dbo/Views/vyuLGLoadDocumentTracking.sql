...
SELECT CH.strContractNumber
	...
	,L.[dtmETSPOL]  
	,L.[dtmETAPOD]  
	,intDaysToETAPOD = DATEDIFF(DAY, CONVERT(NVARCHAR(100), L.dtmETAPOD, 101), CONVERT(NVARCHAR(100), GETDATE(), 101))
	,intDaysToETAPOL = DATEDIFF(DAY, CONVERT(NVARCHAR(100), L.dtmETAPOL, 101), CONVERT(NVARCHAR(100), GETDATE(), 101))
	,intDaysToETSPOL = DATEDIFF(DAY, CONVERT(NVARCHAR(100), L.dtmETSPOL, 101), CONVERT(NVARCHAR(100), GETDATE(), 101))
	,[dtmDeadlineCargo]
	,[dtmDeadlineBL]
	,[dtmISFReceivedDate]
	,[dtmISFFiledDate]
