		...
		(
			SELECT		--DISTINCT
						...
						[dblCredit]	 					=	--CASE WHEN A.dblExchangeRate != 1 THEN 
															...
															AS DECIMAL(18,6)) 
																* (CASE WHEN paymentDetail.ysnOffset = 1 AND voucher.intTransactionType  NOT IN (3) THEN -1 ELSE 1 END),
															-- ELSE
						...
						[dblCreditForeign]				=	--CASE WHEN A.dblExchangeRate != 1 THEN 
															...
															AS DECIMAL(18,6)) * (CASE WHEN paymentDetail.ysnOffset = 1 AND voucher.intTransactionType  NOT IN (3) THEN -1 ELSE 1 END)
															-- ELSE
															-- 	CAST(A.dblAmountPaid AS DECIMAL(18,2)) END												
