...
(
	...
	-- TO DO: Dummy data only
	SELECT 'FA'		strModule,'Receivables' strType, intCashManagementUnrealizedId AccountId , OffSet = 0 FROM tblSMMultiCurrency UNION ALL
	...
	-- TO DO: Dummy data only
	SELECT 'FA'		strModule,'Receivables' strType, intCashManagementOffsetId AccountId , OffSet = 1 FROM tblSMMultiCurrency
)