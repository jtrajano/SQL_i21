...
SELECT	DISTINCT
	...
	JOIN tblCTContractDetail CD	ON CD.intContractDetailId = CC.intContractDetailId AND (CC.ysnPrice = 1 AND CD.intPricingTypeId IN (1,6) OR CC.ysnAccrue = @accrue) AND CC.intConcurrencyId <> ISNULL(CC.intPrevConcurrencyId,0)
