...
BEGIN
	...
	FROM (
		SELECT
			...
			,CASE WHEN voucherDetail.intContractDetailId > 0 AND ISNULL(voucherDetail.dblRate,1) != 1 THEN voucherDetail.dblRate ELSE ISNULL(forexRate.dblRate,1) END dblRate
