CREATE FUNCTION [dbo].[fnRKGetBucketOnHold]
(
	@dtmDate DATETIME,
	@intCommodityId INT,
	@intVendorId INT
...
BEGIN
	...
	FROM (
			SELECT 
				intRowNum = ROW_NUMBER() OVER (PARTITION BY c.intTransactionRecordId, c.strInOut ORDER BY c.intSummaryLogId DESC)
				,dtmCreatedDate
				,dtmTransactionDate
