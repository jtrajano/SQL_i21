...
(
	SELECT
		...
		,forPay.strBillId
		,CASE WHEN forPay.intTransactionType != 16 THEN forPay.dblTotal ELSE voucher.dblProvisionalTotal END dblTotal
		,forPay.dblDiscount
		...
		,dblTempInterest = CAST(CASE WHEN voucher.intTransactionType = 1 AND
								...
								ELSE 0 END AS DECIMAL(18,2))
		,CASE WHEN forPay.intTransactionType != 16 THEN forPay.dblAmountDue ELSE voucher.dblProvisionalAmountDue END dblAmountDue
		,forPay.dblPayment
