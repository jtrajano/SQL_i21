...
BEGIN
	...
	END
	ELSE IF @strPricingMethod = 'Percent of Margin (MSRP)'
	BEGIN
		...
		SET @dblRetailPrice = @dblSalesPrice * @dblQuantity
	END
	ELSE IF @strPricingMethod = 'Fixed Dollar Amount'
	BEGIN
