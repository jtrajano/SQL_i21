...
BEGIN
	INSERT @returntable
	--RECEIPT ITEM
	SELECT R.intInventoryReceiptId, R.strReceiptNumber, @intInventoryReceiptItemId, 1, RIT.intTaxAccountId, ISNULL(RIT.dblAdjustedTax, RIT.dblTax), 'Inventory Receipt', 'Inventory'
	...
	UNION ALL
	--RECEIPT CHARGE
	SELECT R.intInventoryReceiptId, R.strReceiptNumber, @intInventoryReceiptChargeId, 2, RCT.intTaxAccountId, ISNULL(RCT.dblAdjustedTax, RCT.dblTax), 'Inventory Receipt', 'Inventory'
	...
	UNION ALL
	--SHIPMENT CHARGE
	SELECT S.intInventoryShipmentId, S.strShipmentNumber, @intInventoryShipmentChargeId, 3, SCT.intTaxAccountId, ISNULL(SCT.dblAdjustedTax, SCT.dblTax), 'Inventory Shipment', 'Inventory'
