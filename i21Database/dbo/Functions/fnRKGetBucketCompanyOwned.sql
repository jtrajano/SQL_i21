...
BEGIN
	...
	FROM (
		SELECT 
			intRowNum = ROW_NUMBER() OVER (PARTITION BY c.intTransactionRecordId, c.strInOut, c.ysnNegate, c.strTransactionType, c.strTransactionNumber ORDER BY c.intSummaryLogId DESC)
			,dtmCreatedDate
			,dtmTransactionDate
