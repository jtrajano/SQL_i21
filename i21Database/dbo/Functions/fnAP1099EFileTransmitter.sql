...
BEGIN
	...
	@transmitter = 
		...
		+ LEFT(REPLACE(dbo.fnTrim(A.strCompanyName), CHAR(13) + CHAR(10), ' '), 40) + SPACE(40 - LEN(REPLACE(dbo.fnTrim(A.strCompanyName), CHAR(13) + CHAR(10), ' '))) --Position 110-149 First 40
		+ SPACE(40) --Position 150-189 Remaining 40
		+ LEFT(REPLACE(dbo.fnTrim(A.strAddress), CHAR(13) + CHAR(10), ' '), 40) + SPACE(40 - LEN(REPLACE(dbo.fnTrim(A.strAddress), CHAR(13) + CHAR(10), ' '))) --Position 190-229 Get 40 Char only
		+ LEFT(REPLACE(dbo.fnTrim(A.strCity), CHAR(13) + CHAR(10), ' '), 40) + SPACE(40 - LEN(REPLACE(dbo.fnTrim(A.strCity), CHAR(13) + CHAR(10), ' '))) --Position 230-269 Get 40 Char only
