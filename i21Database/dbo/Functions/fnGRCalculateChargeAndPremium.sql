...
BEGIN
    ...
    -- Range By Grade Reading Calculation
    OUTER APPLY (
        SELECT
            ...
            ,[dblCost]  =   CASE CAPD.strRateType
                            ...
                            END
            ,[dblRate]  =   ISNULL(CAPD_RANGE.dblRangeRate, 0)
    ...
    OUTER APPLY (
        SELECT
            ...
            ,[dblCost]  =   CASE CAPD.strRateType
                            ...
                            END
            ,[dblRate]  =   ISNULL(CAPD_LOC.dblLocationRate, ISNULL(CAPD2.dblRate, 0))
    ...
    OUTER APPLY (
        SELECT
            ...
            ,[dblCost]  =   ABS(
                            ...
                            -- The "Rate From Location" takes precedence over the default rate.
                            * (ISNULL(CAPD_LOC.dblLocationRate, ISNULL(CAPD.dblRate, 0)) / 100)
            ,[dblRate]  =   ISNULL(CAPD_LOC.dblLocationRate, ISNULL(CAPD.dblRate, 0))
        FROM @tblQMDiscountIds QM_ID
        INNER JOIN tblQMTicketDiscount QM
            ON QM.intTicketDiscountId = QM_ID.intId
        INNER JOIN tblGRDiscountScheduleCode DSC
