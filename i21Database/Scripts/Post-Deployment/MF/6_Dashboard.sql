...
--iGPS
DECLARE @strPalletItemNo NVARCHAR(50)

SELECT @strPalletItemNo = strAttributeValue
...
JOIN dbo.tblICItem AS I ON I.intItemId = L.intItemId
	AND I.intItemId = @strPalletItemNo
...
SELECT DISTINCT L.strLotNumber
	...
	,(
		CASE 
			WHEN IsNULL(OD.dtmToDate, IsNULL(GETDATE(), IT.dtmDate)) > @dtmDate2
				THEN @dtmDate2
