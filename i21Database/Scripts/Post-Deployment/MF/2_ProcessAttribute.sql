...
BEGIN
	...
	SELECT 101
		,'Prefill Counted Qty by System Qty'
		,5
		,5
		,'Select ''False'' as ValueMember,''False'' as DisplayMember UNION Select ''True'' as ValueMember,''True'' as DisplayMember'
END
...
BEGIN
	...
	SELECT 102
		,'Multiple machines share common staging location'
		,5
		,5
		,'Select ''False'' as ValueMember,''False'' as DisplayMember UNION Select ''True'' as ValueMember,''True'' as DisplayMember'
END
...
BEGIN
    ...
    SELECT 106
        ,'Restrict Pick Qty By RequiredQty'
        ,5
        ,5
        ,0
        ,'Select ''False'' as ValueMember,''False'' as DisplayMember UNION Select ''True'' as ValueMember,''True'' as DisplayMember'
...
BEGIN
    ...
    SELECT 107
        ,'Cost Distribution during close work order'
        ,5
        ,5
        ,0
        ,'Select ''False'' as ValueMember,''False'' as DisplayMember UNION Select ''True'' as ValueMember,''True'' as DisplayMember'
...
BEGIN
    ...
    SELECT 110
        ,'Produced Qty needs to match with Staged Qty'
        ,5
        ,5
        ,0
        ,'Select ''False'' as ValueMember,''False'' as DisplayMember UNION Select ''True'' as ValueMember,''True'' as DisplayMember'
...
BEGIN
    ...
    SELECT 112
        ,'Allow to Create Multiple Pick List'
        ,5
        ,5
        ,0
        ,'Select ''False'' as ValueMember,''False'' as DisplayMember UNION Select ''True'' as ValueMember,''True'' as DisplayMember'
...
BEGIN
    ...
    SELECT 113
        ,'Editable Planned Qty in Work Order Staging'
        ,5
        ,5
        ,0
        ,'Select ''False'' as ValueMember,''False'' as DisplayMember UNION Select ''True'' as ValueMember,''True'' as DisplayMember'
...
BEGIN
    ...
    SELECT 120
        ,'Manual Entry for Parent Lot Number'
        ,5
        ,1
		,0
		,'Select ''False'' as ValueMember,''False'' as DisplayMember UNION Select ''True'' as ValueMember,''True'' as DisplayMember'
...
BEGIN
    ...
    SELECT 121
        ,'Auto Cycle Count on Work Order Close'
        ,5
        ,1
		,0
		,'Select ''False'' as ValueMember,''False'' as DisplayMember UNION Select ''True'' as ValueMember,''True'' as DisplayMember'
...
BEGIN
    ...
    SELECT 122
        ,'Work Order cycle count By Original Posted Date'
        ,5
        ,1
		,0
		,'Select ''False'' as ValueMember,''False'' as DisplayMember UNION Select ''True'' as ValueMember,''True'' as DisplayMember'
...
BEGIN
    ...
    SELECT 126
        ,'Production date by current date'
        ,5
        ,1
		,0
		,'Select ''False'' as ValueMember,''False'' as DisplayMember UNION Select ''True'' as ValueMember,''True'' as DisplayMember'
...
BEGIN
    ...
    SELECT 127
        ...
        ,1
        ,1
        ,'Select CONVERT(nvarchar,intCompanyLocationSubLocationId) as ValueMember,strSubLocationName  as DisplayMember from tblSMCompanyLocationSubLocation  SL Where intCompanyLocationId=@intLocationId UNION Select NULL as ValueMember, '''' as DisplayMember Order by DisplayMember'
END
GO
IF NOT EXISTS (
        SELECT *
        FROM dbo.tblMFAttribute
        WHERE intAttributeId = 128
        )
BEGIN
    INSERT INTO tblMFAttribute (
        intAttributeId
    ...
    SELECT 128
        ,'Last Bag Adjustment during Consumption'
        ,5
        ,1
		,0
		,'Select ''False'' as ValueMember,''False'' as DisplayMember UNION Select ''True'' as ValueMember,''True'' as DisplayMember'
...
BEGIN
    ...
    SELECT 130
        ,'Release Blendsheet by No of Mixes'
        ,5
        ,2
		,0
		,'Select ''False'' as ValueMember,''False'' as DisplayMember UNION Select ''True'' as ValueMember,''True'' as DisplayMember'
