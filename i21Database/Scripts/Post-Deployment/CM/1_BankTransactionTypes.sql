...
SELECT 
	...
	,[strBankTransactionTypeName]	= 'Paycheck'
	,[intConcurrencyId]				= 1			
WHERE NOT EXISTS (SELECT TOP 1 1 FROM dbo.[tblCMBankTransactionType] WHERE [intBankTransactionTypeId] = 21)
UNION ALL
SELECT 
	[intBankTransactionTypeId]		= 22
	,[strBankTransactionTypeName]	= 'ACH'
	,[intConcurrencyId]				= 1			
...
UNION ALL
SELECT 
	[intBankTransactionTypeId]		= 24
	,[strBankTransactionTypeName]	= 'Write Off'
	,[intConcurrencyId]				= 1			
WHERE NOT EXISTS (SELECT TOP 1 1 FROM dbo.[tblCMBankTransactionType] WHERE [intBankTransactionTypeId] = 24)
UNION ALL
SELECT 
	[intBankTransactionTypeId]		= 103
	,[strBankTransactionTypeName]	= 'Void Misc Check'
	,[intConcurrencyId]				= 1
WHERE NOT EXISTS (SELECT TOP 1 1 FROM dbo.[tblCMBankTransactionType] WHERE [intBankTransactionTypeId] = 103)
UNION ALL 
SELECT 
	[intBankTransactionTypeId]		= 116
	,[strBankTransactionTypeName]	= 'Void AP Payment'
	,[intConcurrencyId]				= 1			
WHERE NOT EXISTS (SELECT TOP 1 1 FROM dbo.[tblCMBankTransactionType] WHERE [intBankTransactionTypeId] = 116)
UNION ALL 
SELECT 
	[intBankTransactionTypeId]		= 121
...
UNION ALL 
SELECT 
	[intBankTransactionTypeId]		= 122
	,[strBankTransactionTypeName]	= 'Void ACH'
	,[intConcurrencyId]				= 1			
WHERE NOT EXISTS (SELECT TOP 1 1 FROM dbo.[tblCMBankTransactionType] WHERE [intBankTransactionTypeId] = 122)
UNION ALL 
SELECT 
