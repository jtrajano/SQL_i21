...
SET  IDENTITY_INSERT tblCMCashFlowReportSummaryGroup ON
	...
	USING	(
			...
			SELECT id = 4,  summaryGroup = 'Total Sales Contracts', sort = 1003  UNION ALL
			SELECT id = 5,  summaryGroup = 'Total Purchase Contracts', sort = 1004  UNION ALL
			SELECT id = 6,  summaryGroup = 'Total Currency Contracts', sort = 1005 
...
SET  IDENTITY_INSERT tblCMCashFlowReportSummaryCode ON
	...
	USING	(
			...
			SELECT id = 8,   reportCode = 'SA-1001', report = 'Sales Contracts', reportDescription = 'Sales Contracts',									sort = 1007, operation = 'Add', groupId = 4 UNION ALL
			SELECT id = 9,	 reportCode = 'SA-1002', report = 'Sales Cost Billings', reportDescription = 'Sales Cost Billings',							sort = 1008, operation = 'Add', groupId = 4 UNION ALL
			SELECT id = 10,  reportCode = 'PU-1001', report = 'Purchase Contracts', reportDescription = 'Purchase Contracts',							sort = 1009, operation = 'Subtract', groupId = 5 UNION ALL
			SELECT id = 11,  reportCode = 'PU-1002', report = 'Purchase Cost', reportDescription = 'Purchase Cost',										sort = 1010, operation = 'Subtract', groupId = 5 UNION ALL
			SELECT id = 12,  reportCode = 'PP-1001', report = 'Physical Position', reportDescription = 'Physical Position',								sort = 1011, operation = 'Subtract', groupId = 2 UNION ALL
			SELECT id = 13,  reportCode = 'PC-1001', report = 'Purchased Currency VS Physical', reportDescription = 'Purchased Currency VS Physical',	sort = 1012, operation = 'Add', groupId = 6 UNION ALL
			SELECT id = 14,  reportCode = 'PO-1001', report = 'Purchased Currency Optimization', reportDescription = 'Purchased Currency Optimization', sort = 1013, operation = 'Add', groupId = 6 UNION ALL
			SELECT id = 15,  reportCode = 'SC-1001', report = 'Sold Currency VS Physical', reportDescription = 'Sold Currency VS Physical',				sort = 1014, operation = 'Subtract', groupId = 6 UNION ALL
