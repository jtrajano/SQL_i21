...
SET  IDENTITY_INSERT tblCMCashFlowReportSummaryGroup ON
	...
	USING	(
			...
			SELECT id = 4,  summaryGroup = 'Logistics Shipments', sort = 1003  UNION ALL
			SELECT id = 5,  summaryGroup = 'Total Sales Contracts', sort = 1003  UNION ALL
			SELECT id = 6,  summaryGroup = 'Total Purchase Contracts', sort = 1004  UNION ALL
			SELECT id = 7,  summaryGroup = 'Total Currency Contracts', sort = 1005 
