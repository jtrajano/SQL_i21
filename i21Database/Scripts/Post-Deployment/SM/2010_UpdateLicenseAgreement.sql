...
<p>&nbsp; &nbsp; &nbsp; &nbsp; THIS MASTER AGREEMENT (together with any applicable Ordering Document and all applicable Schedules, the "Agreement"), is effective as of the date (the "Effective Date") the Ordering Document(s) is executed by iRely LLC<strong>,</strong> a Delaware limited liability company with a principal place of business located at 4242 Flagstaff Cove, Ft. Wayne, Indiana, 46815 ("Provider") and the entity that has executed such Ordering Document(s) ("Customer") Provider</p>
<p><br></p>
