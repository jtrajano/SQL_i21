GO
	...
	IF NOT EXISTS(SELECT TOP 1 1 FROM tblSMMigrationLog WHERE strModule = 'System Manager' AND strEvent = 'Arrange User Role Menus - Role Menu (Patronage)')
	BEGIN
		...
		VALUES('System Manager', 'Arrange User Role Menus - Role Menu (Patronage)', 'Arrange User Role Menus - Role Menu (Patronage)', GETDATE())
	END
GO