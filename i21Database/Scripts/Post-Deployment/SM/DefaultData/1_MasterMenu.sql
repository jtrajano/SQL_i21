...
UPDATE tblSMMasterMenu SET strMenuName = N'Canadian Storage Receipt', strDescription = N'Canadian Storage Receipt' WHERE strMenuName = 'Storage Statement' AND strModuleName = 'Ticket Management' AND intParentMenuID = @TicketManagementMaintenanceParentMenuId
-- END OF RENAMING
