...
UPDATE tblSMMasterMenu SET strCommand = N'', intSort = 13 WHERE strMenuName = N'Utilities' AND strModuleName = N'System Manager' AND intParentMenuID = @SystemManagerParentMenuId
