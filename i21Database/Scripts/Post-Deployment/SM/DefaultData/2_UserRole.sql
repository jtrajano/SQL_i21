...
GO
	...
	IF NOT EXISTS (SELECT TOP 1 1 FROM tblSMUserRole WHERE strName = 'Help Desk') INSERT [dbo].[tblSMUserRole] ([strName], [strDescription], [strRoleType], [ysnAdmin]) VALUES (N'Help Desk', N'Default contract role.', 'Contact', 0)
GO
