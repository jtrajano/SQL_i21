...
INSERT INTO [dbo].[#TempHomePanels] VALUES (1, 'Comments',				'System', 1, 1, 500, 0, 0, 'Grid', '', NULL, NULL, 'commentsform',			1, 0, 1);
INSERT INTO [dbo].[#TempHomePanels] VALUES (2, 'Recently Viewed',		'System', 1, 1, 500, 1, 0, 'Grid', '', NULL, NULL, 'recentlyviewedform',	1, 0, 1);
INSERT INTO [dbo].[#TempHomePanels] VALUES (3, 'Messages',				'System', 1, 1, 500, 0, 1, 'Grid', '', NULL, NULL, 'messagesform',			1, 0, 1);
INSERT INTO [dbo].[#TempHomePanels] VALUES (4, 'Audit Log History',		'System', 1, 1, 500, 1, 1, 'Grid', '', NULL, NULL, 'auditloghistoryform',	1, 0, 1);
INSERT INTO [dbo].[#TempHomePanels] VALUES (5, 'Alerts',				'System', 1, 1, 500, 0, 2, 'Grid', '', NULL, NULL, 'alertsform',			1, 0, 1);
INSERT INTO [dbo].[#TempHomePanels] VALUES (6, 'Online Users',			'System', 1, 1, 500, 1, 2, 'Grid', '', NULL, NULL, 'onlineusersform',		1, 0, 1);
	...
	ELSE --NEW DATABASE, ADD DEFAULT
		BEGIN
			INSERT INTO [dbo].[tblSMHomePanelDashboard] 
				   ([intHomePanelDashboardId],[strPanelName],[strType],[ysnIsVisible],[ysnDefaultPanel],[intPanelHeight],[intColumnIndex],[intRowIndex],[strPanelStyle],[strChartStyle],[intColumn1Width],[intGridLayoutId],[strWidgetName], [intEntityId], [ysnIsCollapse], [intConcurrencyId]) 
			 SELECT [intHomePanelDashboardId],[strPanelName],[strType],[ysnIsVisible],[ysnDefaultPanel],[intPanelHeight],[intColumnIndex],[intRowIndex],[strPanelStyle],[strChartStyle],[intColumn1Width],[intGridLayoutId],[strWidgetName], [intEntityId], [ysnIsCollapse], [intConcurrencyId]
			 FROM #TempHomePanels 
