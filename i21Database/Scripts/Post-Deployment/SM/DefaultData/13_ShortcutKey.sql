...
INSERT [dbo].[tblSMShortcutKeys] ([intShortcutKeyId], [strModule], [strItemId], [strShortcutKey], [ctrl], [shift], [alt], [isEnabled], [intConcurrencyId]) VALUES (2, NULL, N'btnClose', N'c', 0, 0, 1, 1, 1)
...
INSERT [dbo].[tblSMShortcutKeys] ([intShortcutKeyId], [strModule], [strItemId], [strShortcutKey], [ctrl], [shift], [alt], [isEnabled], [intConcurrencyId]) VALUES (4, NULL, N'btnSave', N's', 0, 0, 1, 1, 1)
INSERT [dbo].[tblSMShortcutKeys] ([intShortcutKeyId], [strModule], [strItemId], [strShortcutKey], [ctrl], [shift], [alt], [isEnabled], [intConcurrencyId]) VALUES (6, NULL, N'btnDelete', N'd', 0, 0, 1, 1, 1)
...
INSERT [dbo].[tblSMShortcutKeys] ([intShortcutKeyId], [strModule], [strItemId], [strShortcutKey], [ctrl], [shift], [alt], [isEnabled], [intConcurrencyId]) VALUES (9, NULL, N'btnUndo', N'u', 0, 0, 1, 1, 1)
...
INSERT [dbo].[tblSMShortcutKeys] ([intShortcutKeyId], [strModule], [strItemId], [strShortcutKey], [ctrl], [shift], [alt], [isEnabled], [intConcurrencyId]) VALUES (11, NULL, N'btnEdit', N'e', 0, 0, 1, 1, 1)
...
INSERT [dbo].[tblSMShortcutKeys] ([intShortcutKeyId], [strModule], [strItemId], [strShortcutKey], [ctrl], [shift], [alt], [isEnabled], [intConcurrencyId]) VALUES (19, NULL, N'btnPrint', N'p', 0, 0, 1, 1, 1)
...
INSERT [dbo].[tblSMShortcutKeys] ([intShortcutKeyId], [strModule], [strItemId], [strShortcutKey], [ctrl], [shift], [alt], [isEnabled], [intConcurrencyId]) VALUES (22, NULL, N'btnLogOut', N'l', 0, 0, 1, 1, 1)
