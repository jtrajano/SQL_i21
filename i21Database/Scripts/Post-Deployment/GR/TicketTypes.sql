...
GO
	...
	BEGIN
		UPDATE tblSCTicket SET dtmDateModifiedUtc = GETUTCDATE(), intTicketTypeId = (select TOP 1 SCTicketType.intTicketTypeId from tblSCListTicketTypes SCTicketType where SCTicketType.strInOutIndicator = strInOutFlag and SCTicketType.intTicketType = intTicketType)
	END
