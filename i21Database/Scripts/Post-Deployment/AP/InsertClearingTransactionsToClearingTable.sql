--THIS IS TEMPORARY UNTIL ALL INTEGRATING MODULES ARE DONE
DELETE FROM tblAPClearing
...
BEGIN
    ...
    SELECT
        ...
        intItemId,
        intItemUOMId,
        CASE WHEN intBillId IS NULL OR intBillId < 0 THEN dblLoadDetailQty ELSE dblVoucherQty * -1 END,
        CASE WHEN intBillId IS NULL OR intBillId < 0 THEN dblLoadDetailTotal ELSE dblVoucherTotal * -1 END,
        intBillId,
        strBillId,
        intBillDetailId,
        NULL,
    ...
    SELECT
        ...
        intItemId,
        intItemUOMId,
        CASE WHEN intBillId IS NULL OR intBillId < 0 THEN dblLoadCostDetailQty ELSE dblVoucherQty * -1 END,
        CASE WHEN intBillId IS NULL OR intBillId < 0 THEN dblLoadCostDetailTotal ELSE dblVoucherTotal * -1 END,
        intBillId,
        strBillId,
        intBillDetailId,
        NULL,
