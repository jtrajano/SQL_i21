...
IF (@intTableCount = 3) 
	BEGIN
		...
		BEGIN
			...
			-- FGML 3.4
			BEGIN
				SET @strImportFileHeader	= N'Passport - FGML 3.4'
				SET @strFileType			= N'Inbound'
				SET @strFilePrefix			= N'FGML'
				SET @strFileNamePattern		= N'[prefix]+[MMddyyyyHHmmss]'
				SET @strStoredProcedure		= N'uspSTCheckoutPassportFGM'
			...
			-- FGMT 3.4
			BEGIN
				SET @strImportFileHeader	= N'Passport - FGMT 3.4'
				SET @strFileType			= N'Inbound'
				SET @strFilePrefix			= N'FGMT'
				SET @strFileNamePattern		= N'[prefix]+[MMddyyyyHHmmss]'
				SET @strStoredProcedure		= N'uspSTCheckoutPassportFGM'
		...
		END
			...
			-- vrubyrept-category
			BEGIN
				SET @strImportFileHeader	= N'Commander Category'
				SET @strFileType			= N'Inbound'
				SET @strFilePrefix			= N'vrubyrept-category'
				SET @strFileNamePattern		= N'[prefix]+[MMddyyyyHHmmss]'
				SET @strStoredProcedure		= N'[to be develop]'
