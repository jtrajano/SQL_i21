...
BEGIN
  ...
  VALUES 
      ('Passport Pricebook Mix Match - MMT','XML',NULL,'Outbound','<?xml version="1.0"?>',1,9)
END
--END CHECK HEADER
...
BEGIN
  ...
  VALUES 
      (@intImportFileHeaderId,NULL,1,0,'NAXML-MaintenanceRequest','tblSTstgPassportPricebookMixMatchMMT33',NULL,NULL,0,NULL,1,3)
END
