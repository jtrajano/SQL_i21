...
BEGIN
  ...
  VALUES 
      (@intImportFileHeaderId,NULL,1,0,'NAXML-MaintenanceRequest','tblSTstgPassportPricebookComboCBT33',NULL,NULL,0,NULL,1,9)
END
...
BEGIN
  ...
  VALUES 
      (@intImportFileColumnDetailId,1,'Version',NULL,NULL,'3.3',1,4)
END
