...
SET @strLayoutTitle = 'Passport - CPJR 3.4'
...
BEGIN
  ...
  VALUES 
      ('Passport - CPJR 3.4','XML',NULL,'Inbound','<?xml version="1.0" encoding="UTF-8"?>',1,1)
END
--END CHECK HEADER
...
BEGIN
  ...
  VALUES 
      (@intImportFileHeaderId,NULL,1,0,'NAXML-POSJournal',NULL,NULL,NULL,0,NULL,1,1)
END
...
SELECT @intImportFileColumnDetailId = intImportFileColumnDetailId FROM dbo.tblSMImportFileColumnDetail WHERE intImportFileHeaderId = @intImportFileHeaderId AND intLevel = 1 AND strXMLTag = 'NAXML-POSJournal'
