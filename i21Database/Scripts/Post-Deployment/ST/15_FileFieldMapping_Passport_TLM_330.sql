...
SET @strLayoutTitle = 'Passport - TLM 3.3'
...
BEGIN
  ...
  VALUES 
      ('Passport - TLM 3.3','XML',NULL,'Inbound','<?xml version="1.0" encoding="ISO-8859-1"?>',1,4)
END
--END CHECK HEADER
...
BEGIN
  ...
  VALUES 
      (@intImportFileColumnDetailId,1,'version',NULL,NULL,'3.3',1,1)
END
