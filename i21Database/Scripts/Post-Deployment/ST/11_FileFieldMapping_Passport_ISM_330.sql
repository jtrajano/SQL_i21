...
SET @strLayoutTitle = 'Passport - ISM 3.3'
...
BEGIN
  ...
  VALUES 
      ('Passport - ISM 3.3','XML',NULL,'Inbound','<?xml version="1.0" encoding="ISO-8859-1"?>',1,11)
END
--END CHECK HEADER
...
BEGIN
  ...
  VALUES 
      (@intImportFileHeaderId,NULL,1,0,'NAXML-MovementReport','tblSTPriceBookStaging',NULL,NULL,0,NULL,1,4)
END
...
BEGIN
  ...
  VALUES 
      (@intImportFileColumnDetailId,1,'version',NULL,NULL,'3.3',0,3)
END
