...
SET @strLayoutTitle = 'Commander uMaintenance Item List'
...
BEGIN
  ...
  VALUES 
      ('Commander uMaintenance Item List','XML',NULL,'Outbound',NULL,1,4)
END
--END CHECK HEADER
...
BEGIN
  ...
  VALUES 
      (@intImportFileHeaderId,NULL,1,0,'NAXML-MaintenanceRequest','tblSTCheckoutImportSapphireData',NULL,'Header',0,NULL,1,2)
END
