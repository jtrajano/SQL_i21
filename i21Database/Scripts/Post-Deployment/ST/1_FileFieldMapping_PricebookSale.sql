...
BEGIN
	...
	BEGIN	
		INSERT INTO [dbo].[tblSMXMLTagAttribute]
		SELECT @intImportFileColumnDetailId,	1,	'type',	'tblSTstgPricebookSendFile',	'TableActionType',	'', 1, 1	
	END
...
BEGIN
	...
	BEGIN	
		INSERT INTO [dbo].[tblSMXMLTagAttribute]
		SELECT @intImportFileColumnDetailId,	1,	'type',	'tblSTstgPricebookSendFile',	'RecordActionType',	'', 1, 1	
	END
...
BEGIN
	...
	BEGIN	
		INSERT INTO [dbo].[tblSMXMLTagAttribute]
		SELECT @intImportFileColumnDetailId,	1,	'type',	'tblSTstgPricebookSendFile',	'ITTDetailRecordActionType',	'', 1, 1	
	END
...
BEGIN
	...
	BEGIN	
		INSERT INTO [dbo].[tblSMXMLTagAttribute]
		SELECT @intImportFileColumnDetailId,	1,	'name',	'tblSTstgPricebookSendFile',	'PosCodeModifierName',	'', 1, 1	
	END
...
BEGIN
	...
	BEGIN	
		INSERT INTO [dbo].[tblSMXMLTagAttribute]
		SELECT @intImportFileColumnDetailId,	1,	'value',	'tblSTstgPricebookSendFile',	'ActiveFlagValue',	'', 1, 1	
	END
...
BEGIN
	...
	BEGIN	
		INSERT INTO [dbo].[tblSMXMLTagAttribute]
		SELECT @intImportFileColumnDetailId,	1,	'type',	'tblSTstgPricebookSendFile',	'ProhibitSaleLocationType',	'', 1	, 1
	END
	
	IF NOT EXISTS (SELECT 1 FROM [dbo].[tblSMXMLTagAttribute] Where intImportFileColumnDetailId = @intImportFileColumnDetailId AND strTagAttribute = 'value')
	BEGIN	
		INSERT INTO [dbo].[tblSMXMLTagAttribute]
		SELECT @intImportFileColumnDetailId,	2,	'value',	'tblSTstgPricebookSendFile',	'ProhibitSaleLocationValue',	'', 1	, 1
	END
