...
BEGIN
	...
	INSERT [dbo].[tblARLetterPlaceHolder] ([intPlaceHolderId], [strModules], [strPlaceHolder], [strSourceTable], [strSourceColumn], [strPlaceHolderName], [strPlaceHolderDescription], [intConcurrencyId], [strPlaceHolderId], [ysnTable], [strDataType]) VALUES (@intPlaceHolderId, N'Sales', N'<input type="value" name="PH-5" style="border:none;" placeholder="Total AR Amount Overdue" readonly="">', N'vyuARCollectionOverdueReport', N'dbl10DaysSum', N'dbl10DaysSum', N'Total AR amount Overdue', 0, N'PH-5', 0, N'nvarchar')
END
ELSE
BEGIN
	SELECT @intPlaceHolderId = MAX([intPlaceHolderId]) + 1 FROM tblARLetterPlaceHolder
...
BEGIN
	...
	INSERT [dbo].[tblARLetterPlaceHolder] ([intPlaceHolderId], [strModules], [strPlaceHolder], [strSourceTable], [strSourceColumn], [strPlaceHolderName], [strPlaceHolderDescription], [intConcurrencyId], [strPlaceHolderId], [ysnTable], [strDataType]) VALUES (@intPlaceHolderId, N'Sales', N'<table border="1" id="t01" style="width:100%;"><thead><tr><th><span style="font-family: Arial; font-size:9;">&nbsp;Due Date&nbsp;</span></th><th><span style="font-family: Arial; font-size:9;">&nbsp;Invoice Number&nbsp;</span></th><th style="text-align:right;"><span style="font-family: Arial; font-size:9;">&nbsp;Amount Due&nbsp;</span></th></tr></thead><tbody></tbody></table>', N'vyuARCollectionOverdueReport', N'dtmDueDate, strInvoiceNumber, dblTotalDue', N'dtmDueDate, strInvoiceNumber, dblTotalDue', N'Due Date, Invoice Number, Amount Due', 0, N'PH-6', 1, N'datetime, nvarchar, numeric')
END
ELSE
BEGIN
	SELECT @intPlaceHolderId = MAX([intPlaceHolderId]) + 1 FROM tblARLetterPlaceHolder
...
BEGIN
	...
	INSERT [dbo].[tblARLetterPlaceHolder] ([intPlaceHolderId], [strModules], [strPlaceHolder], [strSourceTable], [strSourceColumn], [strPlaceHolderName], [strPlaceHolderDescription], [intConcurrencyId], [strPlaceHolderId], [ysnTable], [strDataType]) VALUES (@intPlaceHolderId, N'Sales', N'[ARBalance]', N'vyuARCollectionCustomerReport', N'dblARBalance', N'dblARBalance', N'Customer AR Balance', 0, N'PH-28', 0, N'numeric')
END
ELSE
BEGIN
	SELECT @intPlaceHolderId = MAX([intPlaceHolderId]) + 1 FROM tblARLetterPlaceHolder
