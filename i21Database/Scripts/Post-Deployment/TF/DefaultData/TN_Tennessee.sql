...
*/
	...
	UNION ALL SELECT intReportingComponentId = 0, strFormCode = 'TN EDI', strFormName = 'Tennessee EDI File', strScheduleCode = '', strScheduleName = 'Tennessee EDI File', strType = '', strNote = 'EDI File', strTransactionType = '', intSort = 2000, strStoredProcedure = '', intMasterId = 422367, intComponentTypeId = 3
...
*/
	...
	UNION ALL SELECT intFilingPacketId = 0, strFormCode = 'TN EDI', strScheduleCode = '', strType = '', ysnStatus = 1, intFrequency = 1, intMasterId = 423468
