...
UNION ALL SELECT intReportTemplateId = 60, strFormCode = 'SF-900', strScheduleCode = '', strType = '', strTemplateItemId = 'SF-900-Summary-009', strReportSection = 'Section 2: Computation of Tax', intReportItemSequence = '9', intTemplateItemNumber = '9', strDescription = '9. Collection Allowance (Multiply Line 8 by 0.016). If return filed or tax paid after due date enter zero (0)', strScheduleList = '8', strConfiguration = '0.016', ysnConfiguration = '1', ysnDynamicConfiguration = '1', strLastIndexOf = 'by', strSegment = 'Summary', intConfigurationSequence = '70'
