...
*/
	...
	--MFT-1704
	UNION ALL SELECT intReportTemplateId = 0, strFormCode = 'KY EDI', strScheduleCode = '', strType = '', strTemplateItemId = 'KYEDI-LicNumGD', strReportSection = 'Header', intReportItemSequence = '0', intTemplateItemNumber = '29', strDescription = 'Gasoline Return License Number (GD999999999)', strScheduleList = NULL, strConfiguration = '', ysnConfiguration = '1', ysnUserDefinedValue = '1', strLastIndexOf = NULL, strSegment = NULL, intConfigurationSequence = '29', ysnOutputDesigner = 0, strInputType = NULL, intMasterId = 171248
	UNION ALL SELECT intReportTemplateId = 0, strFormCode = 'KY EDI', strScheduleCode = '', strType = '', strTemplateItemId = 'KYEDI-LicNumSF', strReportSection = 'Header', intReportItemSequence = '0', intTemplateItemNumber = '30', strDescription = 'Special Fuels Retrun License Number (SF999999999)', strScheduleList = NULL, strConfiguration = '', ysnConfiguration = '1', ysnUserDefinedValue = '1', strLastIndexOf = NULL, strSegment = NULL, intConfigurationSequence = '30', ysnOutputDesigner = 0, strInputType = NULL, intMasterId = 171249
	UNION ALL SELECT intReportTemplateId = 0, strFormCode = 'KY EDI', strScheduleCode = '', strType = '', strTemplateItemId = 'KYEDI-LicNumTR', strReportSection = 'Header', intReportItemSequence = '0', intTemplateItemNumber = '31', strDescription = 'Transporters Return License Number (TR999999999)', strScheduleList = NULL, strConfiguration = '', ysnConfiguration = '1', ysnUserDefinedValue = '1', strLastIndexOf = NULL, strSegment = NULL, intConfigurationSequence = '31', ysnOutputDesigner = 0, strInputType = NULL, intMasterId = 171250
