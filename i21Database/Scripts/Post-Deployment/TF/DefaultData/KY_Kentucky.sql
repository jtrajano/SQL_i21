...
*/
	...
	UNION ALL SELECT intReportTemplateId = 0, strFormCode = 'KY EDI', strScheduleCode = '', strType = '', strTemplateItemId = 'KYEDI-ISA12', strReportSection = 'Header', intReportItemSequence = '0', intTemplateItemNumber = '7', strDescription = 'ISA12 - Interchange Control Version Number', strScheduleList = NULL, strConfiguration = '403', ysnConfiguration = '1', ysnUserDefinedValue = '0', strLastIndexOf = NULL, strSegment = NULL, intConfigurationSequence = '7', ysnOutputDesigner = 0, intMasterId = 171226
	...
	UNION ALL SELECT intReportTemplateId = 0, strFormCode = 'KY EDI', strScheduleCode = '', strType = '', strTemplateItemId = 'KYEDI-GS08', strReportSection = 'Header', intReportItemSequence = '0', intTemplateItemNumber = '17', strDescription = 'GS08 - Version/Release/Industry ID Code', strScheduleList = NULL, strConfiguration = '4030', ysnConfiguration = '1', ysnUserDefinedValue = '0', strLastIndexOf = NULL, strSegment = NULL, intConfigurationSequence = '17', ysnOutputDesigner = 0, intMasterId = 171236
