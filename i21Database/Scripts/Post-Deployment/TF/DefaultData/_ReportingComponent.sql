...
BEGIN
	...
	BEGIN
		...
		IF (@FormCode IS NULL)
			...
			SELECT @FormCode = strFormCode FROM tblTFTaxReportTemplate WHERE strFormCode = 'SF-900'
		IF (@FormCode IS NULL)
			BEGIN
			...
			SELECT @FormCode = strFormCode FROM tblTFTaxReportTemplate WHERE strFormCode = 'GT-103'
		IF (@FormCode IS NULL)
			BEGIN
			...
			SELECT @FormCode = strFormCode FROM tblTFTaxReportTemplate WHERE strFormCode = 'EDI'
		IF (@FormCode IS NULL)
			BEGIN
