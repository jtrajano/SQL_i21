...
IF EXISTS(SELECT CONSTRAINT_NAME FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE WHERE TABLE_NAME='tblTFFilingPacket' AND CONSTRAINT_NAME = 'FK_tblTFFilingPacket_tblTFReportingComponent')
			 BEGIN 
					ALTER TABLE tblTFFilingPacket
					DROP CONSTRAINT FK_tblTFFilingPacket_tblTFReportingComponent
			END 
...
GO
	...
	ELSE
		BEGIN
			PRINT 'TABLE tblTFValidOriginDestinationState NOT EXIST!'
		END
