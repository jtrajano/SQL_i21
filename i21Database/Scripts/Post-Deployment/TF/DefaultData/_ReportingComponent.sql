	...
	BEGIN
		...
		IF (@intReportingComponentId IS NOT NULL)
			BEGIN
				...
				INSERT [dbo].[tblTFTaxReportTemplate] ([intTaxReportSummaryItems], [intReportingComponentDetailId], [intTaxReportSummaryItemId], [strSummaryFormCode], [intSummaryTaxAuthorityId], [strSummaryTaxAuthority], [strSummarySection], [intSummaryItemSequenceNumber], [intSummaryItemNumber], [strSummaryItemDescription], [strSummaryScheduleCode], [strConfiguration], [strSummaryPart], [strSummaryOperation], [strTaxType], [intConfigurationSequence], [intConcurrencyId]) VALUES (NULL, N'SF-900-Summary-032', N'SF-900', 14, N'IN', N'Section B: Disbursement', 5, 11, N'4. Gallons Delivered Via Rail, Pipeline, or Vessel to Licensed Suppliers, Tax', N'6', NULL, NULL, NULL, N'Details', NULL, 0)
				...
				INSERT [dbo].[tblTFTaxReportTemplate] ([intTaxReportSummaryItems], [intReportingComponentDetailId], [intTaxReportSummaryItemId], [strSummaryFormCode], [intSummaryTaxAuthorityId], [strSummaryTaxAuthority], [strSummarySection], [intSummaryItemSequenceNumber], [intSummaryItemNumber], [strSummaryItemDescription], [strSummaryScheduleCode], [strConfiguration], [strSummaryPart], [strSummaryOperation], [strTaxType], [intConfigurationSequence], [intConcurrencyId]) VALUES (NULL, N'SF-900-Summary-039', N'SF-900', 14, N'IN', N'Section B: Disbursement', 12, 18, N'11. Total Non-Taxable Disbursements (Add Lines 4 through 10; carry forward to', N'6,6X,7,7A,7B,8,10', NULL, NULL, NULL, N'Details', NULL, 0)
