	...
	BEGIN
		...
		IF (@intReportingComponentId IS NOT NULL)
			BEGIN
				...
				INSERT [dbo].[tblTFTaxReportTemplate] ([intReportingComponentDetailId], [intTemplateItemId], [strFormCode], [intTaxAuthorityId], [strTaxAuthority], [strReportSection], [intReportItemSequence], [intTemplateItemNumber], [strDescription], [strScheduleCode], [strConfiguration], [ysnDynamicConfiguration], [strLastIndexOf], [strSegment], [intConfigurationSequence], [intConcurrencyId]) VALUES (59, N'SF-900-Summary-009', N'SF-900', 14, N'IN', N'Section 2: Computation of Tax', 9, 9, N'9. Collection Allowance (Multiply Line 8 by .016). If return filed or tax paid after due date enter zero (0)', N'8', N'0.016', 1, 'by', N'Summary', 70, 0)
