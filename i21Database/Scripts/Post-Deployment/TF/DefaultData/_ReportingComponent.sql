	...
	BEGIN
		...
		IF (@intReportingComponentId IS NOT NULL)
			BEGIN
				...
				INSERT [dbo].[tblTFTaxReportTemplate] ([intReportingComponentDetailId], [intTaxReportSummaryItemId], [strSummaryFormCode], [intSummaryTaxAuthorityId], [strSummaryTaxAuthority], [strSummarySection], [intSummaryItemSequenceNumber], [intSummaryItemNumber], [strSummaryItemDescription], [strSummaryScheduleCode], [strConfiguration], [strSummaryPart], [strSummaryOperation], [strTaxType], [intConfigurationSequence], [intConcurrencyId]) VALUES (40, N'MF-360-Summary-008', N'MF-360', 14, N'IN', N'Section 2:    Calculation of Gasoline Taxes Due', 8, 8, N'8. Adjustments (Schedule E-1 must be attached and is subject to Department approval)', N'0', N'3333', N'', N'', N'Summary', 38, 1)
				...
				INSERT [dbo].[tblTFTaxReportTemplate] ([intReportingComponentDetailId], [intTaxReportSummaryItemId], [strSummaryFormCode], [intSummaryTaxAuthorityId], [strSummaryTaxAuthority], [strSummarySection], [intSummaryItemSequenceNumber], [intSummaryItemNumber], [strSummaryItemDescription], [strSummaryScheduleCode], [strConfiguration], [strSummaryPart], [strSummaryOperation], [strTaxType], [intConfigurationSequence], [intConcurrencyId]) VALUES (57, N'SF-900-Summary-006', N'SF-900', 14, N'IN', N'Section 2: Computation of Tax', 6, 6, N'6. Tax Due (Multiply Line 5 by $0.16)', N'5', N'0.16', NULL, NULL, N'Summary', 50, 0)
				INSERT [dbo].[tblTFTaxReportTemplate] ([intReportingComponentDetailId], [intTaxReportSummaryItemId], [strSummaryFormCode], [intSummaryTaxAuthorityId], [strSummaryTaxAuthority], [strSummarySection], [intSummaryItemSequenceNumber], [intSummaryItemNumber], [strSummaryItemDescription], [strSummaryScheduleCode], [strConfiguration], [strSummaryPart], [strSummaryOperation], [strTaxType], [intConfigurationSequence], [intConcurrencyId]) VALUES (57, N'SF-900-Summary-007', N'SF-900', 14, N'IN', N'Section 2: Computation of Tax', 7, 7, N'7. Amount of Tax Uncollectible from Eligible Purchasers - Complete Schedule 10E', N'0', N'1', N'', N'', N'Summary', 60, 7)
				...
				INSERT [dbo].[tblTFTaxReportTemplate] ([intReportingComponentDetailId], [intTaxReportSummaryItemId], [strSummaryFormCode], [intSummaryTaxAuthorityId], [strSummaryTaxAuthority], [strSummarySection], [intSummaryItemSequenceNumber], [intSummaryItemNumber], [strSummaryItemDescription], [strSummaryScheduleCode], [strConfiguration], [strSummaryPart], [strSummaryOperation], [strTaxType], [intConfigurationSequence], [intConcurrencyId]) VALUES (57, N'SF-900-Summary-009', N'SF-900', 14, N'IN', N'Section 2: Computation of Tax', 9, 9, N'9. Collection Allowance (Multiply Line 8 by .016). If return filed or tax paid after due date enter zero (0)', N'8', N'0.016', NULL, NULL, N'Summary', 70, 0)
				INSERT [dbo].[tblTFTaxReportTemplate] ([intReportingComponentDetailId], [intTaxReportSummaryItemId], [strSummaryFormCode], [intSummaryTaxAuthorityId], [strSummaryTaxAuthority], [strSummarySection], [intSummaryItemSequenceNumber], [intSummaryItemNumber], [strSummaryItemDescription], [strSummaryScheduleCode], [strConfiguration], [strSummaryPart], [strSummaryOperation], [strTaxType], [intConfigurationSequence], [intConcurrencyId]) VALUES (57, N'SF-900-Summary-010', N'SF-900', 14, N'IN', N'Section 2: Computation of Tax', 10, 10, N'10. Adjustment - Complete Schedule E-1 (Dollar amount only)', N'0', N'3', N'', N'', N'Summary', 80, 0)
				...
				INSERT [dbo].[tblTFTaxReportTemplate] ([intReportingComponentDetailId], [intTaxReportSummaryItemId], [strSummaryFormCode], [intSummaryTaxAuthorityId], [strSummaryTaxAuthority], [strSummarySection], [intSummaryItemSequenceNumber], [intSummaryItemNumber], [strSummaryItemDescription], [strSummaryScheduleCode], [strConfiguration], [strSummaryPart], [strSummaryOperation], [strTaxType], [intConfigurationSequence], [intConcurrencyId]) VALUES (57, N'SF-900-Summary-013', N'SF-900', 14, N'IN', N'Section 3:    Calculation of Oil Inspection Fees Due', 2, 13, N'2. Oil inspection fees due (Multiply Line 1 by $0.01)', N'12', N'0.01', NULL, NULL, N'Summary', 90, 0)
				INSERT [dbo].[tblTFTaxReportTemplate] ([intReportingComponentDetailId], [intTaxReportSummaryItemId], [strSummaryFormCode], [intSummaryTaxAuthorityId], [strSummaryTaxAuthority], [strSummarySection], [intSummaryItemSequenceNumber], [intSummaryItemNumber], [strSummaryItemDescription], [strSummaryScheduleCode], [strConfiguration], [strSummaryPart], [strSummaryOperation], [strTaxType], [intConfigurationSequence], [intConcurrencyId]) VALUES (57, N'SF-900-Summary-014', N'SF-900', 14, N'IN', N'Section 3:    Calculation of Oil Inspection Fees Due', 3, 14, N'3. Adjustments (Schedule E-1 must be attached and is subject to Department approval)', N'0', N'4', N'', N'', N'Summary', 100, 5)
				...
				INSERT [dbo].[tblTFTaxReportTemplate] ([intReportingComponentDetailId], [intTaxReportSummaryItemId], [strSummaryFormCode], [intSummaryTaxAuthorityId], [strSummaryTaxAuthority], [strSummarySection], [intSummaryItemSequenceNumber], [intSummaryItemNumber], [strSummaryItemDescription], [strSummaryScheduleCode], [strConfiguration], [strSummaryPart], [strSummaryOperation], [strTaxType], [intConfigurationSequence], [intConcurrencyId]) VALUES (57, N'SF-900-Summary-017', N'SF-900', 14, N'IN', N'Section 4: Calculation of Total Amount Due', 2, 17, N'2. Penalty (Penalty must be added if report is filed after the due date. 10% of tax due or $5.00, whichever is greater. Five dollars ($5.00) is due on a late report showing no tax due.)', N'0', N'5', NULL, NULL, N'Summary', 110, 0)
				INSERT [dbo].[tblTFTaxReportTemplate] ([intReportingComponentDetailId], [intTaxReportSummaryItemId], [strSummaryFormCode], [intSummaryTaxAuthorityId], [strSummaryTaxAuthority], [strSummarySection], [intSummaryItemSequenceNumber], [intSummaryItemNumber], [strSummaryItemDescription], [strSummaryScheduleCode], [strConfiguration], [strSummaryPart], [strSummaryOperation], [strTaxType], [intConfigurationSequence], [intConcurrencyId]) VALUES (57, N'SF-900-Summary-018', N'SF-900', 14, N'IN', N'Section 4: Calculation of Total Amount Due', 3, 18, N'3. (Interest must be added if report is filed after the due date. Contact the Department for daily interest rates.)', N'0', N'6', NULL, NULL, N'Summary', 120, 0)
				...
				INSERT [dbo].[tblTFTaxReportTemplate] ([intReportingComponentDetailId], [intTaxReportSummaryItemId], [strSummaryFormCode], [intSummaryTaxAuthorityId], [strSummaryTaxAuthority], [strSummarySection], [intSummaryItemSequenceNumber], [intSummaryItemNumber], [strSummaryItemDescription], [strSummaryScheduleCode], [strConfiguration], [strSummaryPart], [strSummaryOperation], [strTaxType], [intConfigurationSequence], [intConcurrencyId]) VALUES (57, N'SF-900-Summary-020', N'SF-900', 14, N'IN', N'Section 4: Calculation of Total Amount Due', 5, 20, N'5. Payment(s)', N'0', N'7', NULL, NULL, N'Summary', 130, 0)
				...
				INSERT [dbo].[tblTFTaxReportTemplate] ([intReportingComponentDetailId], [intTaxReportSummaryItemId], [strSummaryFormCode], [intSummaryTaxAuthorityId], [strSummaryTaxAuthority], [strSummarySection], [intSummaryItemSequenceNumber], [intSummaryItemNumber], [strSummaryItemDescription], [strSummaryScheduleCode], [strConfiguration], [strSummaryPart], [strSummaryOperation], [strTaxType], [intConfigurationSequence], [intConcurrencyId]) VALUES (57, N'License Number', N'SF-900', 14, N'IN', N'HEADER', 0, 0, N'License Number', NULL, N'001', NULL, NULL, N'HEADER', 10, 11)
		END
	END
END
