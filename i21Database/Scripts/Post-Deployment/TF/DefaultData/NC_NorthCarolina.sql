...
*/
	...
	SELECT intReportingComponentId = 0, strFormCode = 'Gas-1301', strFormName = 'Transporter Return', strScheduleCode = '14A', strScheduleName = 'Gallons Loaded in NC and Delivered to Another State', strType = '', strNote = '', strTransactionType = '', intSort = 10, strSPInventory = 'uspTFGetInventoryTax', strSPInvoice = 'uspTFGetInvoiceTax', strSPRunReport = NULL, intMasterId = 332690, intComponentTypeId = 1
	UNION ALL SELECT intReportingComponentId = 0, strFormCode = 'Gas-1301', strFormName = 'Transporter Return', strScheduleCode = '14B', strScheduleName = 'Gallons Loaded in Another State and Delivered to NC', strType = '', strNote = '', strTransactionType = '', intSort = 20, strSPInventory = 'uspTFGetInventoryTax', strSPInvoice = 'uspTFGetInvoiceTax', strSPRunReport = NULL, intMasterId = 332691, intComponentTypeId = 1
	UNION ALL SELECT intReportingComponentId = 0, strFormCode = 'Gas-1301', strFormName = 'Transporter Return', strScheduleCode = '14C', strScheduleName = 'Gallons Loaded in NC and Delivered to NC', strType = '', strNote = '', strTransactionType = '', intSort = 30, strSPInventory = 'uspTFGetInventoryTax', strSPInvoice = 'uspTFGetInvoiceTax', strSPRunReport = NULL, intMasterId = 332692, intComponentTypeId = 1
	UNION ALL SELECT intReportingComponentId = 0, strFormCode = 'Gas-1301', strFormName = 'Transporter Return', strScheduleCode = '', strScheduleName = 'NC Transporter Return', strType = '', strNote = 'Main Form', strTransactionType = '', intSort = 35, strSPInventory = 'uspTFGetInventoryTax', strSPInvoice = 'uspTFGetInvoiceTax', strSPRunReport = NULL, intMasterId = 332693, intComponentTypeId = 2
	UNION ALL SELECT intReportingComponentId = 0, strFormCode = 'Gas-1239', strFormName = 'Bulk Plant Exporter Return', strScheduleCode = '7F', strScheduleName = 'Bulk Plant Exporter Schedule of Tax-Paid Exports', strType = 'Gasoline', strNote = '', strTransactionType = 'Invoice', intSort = 40, strSPInventory = 'uspTFGetInventoryTax', strSPInvoice = 'uspTFGetInvoiceTax', strSPRunReport = NULL, intMasterId = 332694, intComponentTypeId = 1
	UNION ALL SELECT intReportingComponentId = 0, strFormCode = 'Gas-1239', strFormName = 'Bulk Plant Exporter Return', strScheduleCode = '7F', strScheduleName = 'Bulk Plant Exporter Schedule of Tax-Paid Exports', strType = 'Undyed Diesel', strNote = '', strTransactionType = 'Invoice', intSort = 50, strSPInventory = 'uspTFGetInventoryTax', strSPInvoice = 'uspTFGetInvoiceTax', strSPRunReport = NULL, intMasterId = 332695, intComponentTypeId = 1
	UNION ALL SELECT intReportingComponentId = 0, strFormCode = 'Gas-1239', strFormName = 'Bulk Plant Exporter Return', strScheduleCode = '7F', strScheduleName = 'Bulk Plant Exporter Schedule of Tax-Paid Exports', strType = 'Dyed Diesel', strNote = '', strTransactionType = 'Invoice', intSort = 60, strSPInventory = 'uspTFGetInventoryTax', strSPInvoice = 'uspTFGetInvoiceTax', strSPRunReport = NULL, intMasterId = 332696, intComponentTypeId = 1
	...
	UNION ALL SELECT intReportingComponentId = 0, strFormCode = 'Gas-1239', strFormName = 'Bulk Plant Exporter Return', strScheduleCode = '7F', strScheduleName = 'Bulk Plant Exporter Schedule of Tax-Paid Exports', strType = 'Jet Fuel', strNote = '', strTransactionType = 'Invoice', intSort = 90, strSPInventory = 'uspTFGetInventoryTax', strSPInvoice = 'uspTFGetInvoiceTax', strSPRunReport = NULL, intMasterId = 332699, intComponentTypeId = 1
	...
	UNION ALL SELECT intReportingComponentId = 0, strFormCode = 'Gas-1259', strFormName = 'Backup Tax Return', strScheduleCode = '5S', strScheduleName = 'Dyed Diesel or Dyed Kerosene Delivered to an Education Organization that is not a Public School', strType = 'Dyed Diesel', strNote = '', strTransactionType = 'Invoice', intSort = 270, strSPInventory = 'uspTFGetInventoryTax', strSPInvoice = 'uspTFGetInvoiceTax', strSPRunReport = NULL, intMasterId = 332717, intComponentTypeId = 1
