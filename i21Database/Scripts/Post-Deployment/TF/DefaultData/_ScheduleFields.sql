...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Product Code')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Transporter FEIN')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Mode')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Origin State')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Destination State')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Vendor Name')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Vendor FEIN')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Date Received')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Document Number')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Net Gals')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Gross Gals')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Billed Gals')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Transporter Name')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 19 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 19 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Customer FEIN')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Date')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 20 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 20 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 21 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 21 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 22 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 22 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 23 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 23 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 24 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 24 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 25 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 25 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 26 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 26 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 27 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 27 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 28 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 28 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 29 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 29 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 30 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 30 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 31 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 31 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 32 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 32 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 33 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 33 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 34 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 34 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 37 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 37 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 50 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 50 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 51 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 51 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 52 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 52 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 53 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 53 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 54 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 54 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 55 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 55 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 56 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 56 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 57 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 57 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 71 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 71 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 72 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 72 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 73 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 73 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 74 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 74 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 75 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 75 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 76 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 76 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 77 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 77 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 78 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 78 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Terminal')
IF NOT EXISTS(SELECT TOP 1 intReportingComponentId FROM tblTFScheduleFields WHERE intReportingComponentId = 79 AND strColumn = 'strTerminalControlNumber')
...
ELSE
BEGIN UPDATE tblTFScheduleFields SET strCaption = 'Terminal' WHERE intReportingComponentId = 79 AND strColumn = 'strTerminalControlNumber' END
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Sold To')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Consignor Name')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Consigner FEIN')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Seller Name')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Seller FEIN')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Customer Name')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Document Date')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Gross')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Net')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Supplier Name')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Supplier FEIN')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Indiana TID')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'Total Gals Purchased')
...
SET @ScheduleFieldTemplateId = (SELECT TOP 1 intScheduleFieldTemplateId from tblTFScheduleFieldTemplate WHERE strColumn = 'GUT Paid to Supplier')
