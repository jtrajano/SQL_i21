...
*/
	...
	UNION ALL SELECT intReportingComponentId = 0, strFormCode = '06-168GD', strFormName = 'Gasoline Distributors Return', strScheduleCode = '06-156', strScheduleName = 'Gallons Sold to Aviation Fuel Dealders, TX Tax Not Collected', strType = '', strNote = '', strTransactionType = 'Invoice', intSort = 60, strStoredProcedure = 'uspTFGetInvoiceTax', intMasterId = 432269, intComponentTypeId = 1
	...
	UNION ALL SELECT intReportingComponentId = 0, strFormCode = '06-168DD', strFormName = 'Diesel Distributors Return', strScheduleCode = '06-156', strScheduleName = 'Gallons Sold to Aviation Fuel Dealders, TX Tax Not Collected', strType = '', strNote = '', strTransactionType = 'Invoice', intSort = 290, strStoredProcedure = 'uspTFGetInvoiceTax', intMasterId = 432284, intComponentTypeId = 1
