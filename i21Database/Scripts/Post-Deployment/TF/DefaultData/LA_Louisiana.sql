...
*/
	...
	UNION ALL SELECT intReportTemplateId = 0, strFormCode = 'R-5346', strScheduleCode = '', strType = '', strTemplateItemId = 'R-5346-Penalty', strReportSection = 'Header', intReportItemSequence = '0', intTemplateItemNumber = '2', strDescription = 'Penalty Amount', strScheduleList = NULL, strConfiguration = NULL, ysnConfiguration = '1', ysnUserDefinedValue = '1', strLastIndexOf = NULL, strSegment = NULL, intConfigurationSequence = '20', ysnOutputDesigner = 0, intMasterId = 18724
