...
INSERT INTO #TampCannedPanels VALUES (13, 0, 20, 0, 0, 0, 0, 0, 0, 0, 1, 0, N'Master', N'iRely AP - Check History', N'Grid', N'', N'iRely AP - Check History', N'', N'', N'', N'i21 PT - Berry Oil ', N'All Dates', N'All Dates', N'apchk_rev_dt', N'', N'select apchkmst.apchk_cbk_no, apchkmst.apchk_rev_dt, apchkmst.apchk_vnd_no, apchkmst.apchk_name, apchkmst.apchk_chk_amt, apchkmst.apchk_disc_amt, apchkmst.apchk_gl_rev_dt, apchkmst.apchk_cleared_ind, apchkmst.apchk_clear_rev_dt, apchkmst.apchk_src_sys, apchkmst.apchk_rev_dt
From apchkmst Where @DATE@', N'', N'@DATE@', N'', N'', N'', N'iRely AP - Check History', N'', N'', N'None', N'', N'', N'', N'', NULL, NULL, NULL, 0, 0, NULL, NULL, N'14.1.1', NULL, 1, 36, NULL)
INSERT INTO #TampCannedPanels VALUES (14, 0, 20, 0, 0, 0, 0, 0, 0, 0, 1, 0, N'Master', N'iRely AP - Open Payables', N'Grid', N'', N'iRely AP - Open Payables', N'', N'', N'', N'Fort Books TE', N'None', N'', N'', N'', N'Select apivcmst.apivc_ivc_no, apivcmst.apivc_ivc_rev_dt, apivcmst.apivc_status_ind, apivcmst.apivc_vnd_no, apivcmst.apivc_due_rev_dt, Case When apivcmst.apivc_trans_type = ''C'' Or apivcmst.apivc_trans_type = ''A'' Then apivcmst.apivc_net_amt * -1 Else apivcmst.apivc_net_amt End As ''amounts'', ssvndmst.ssvnd_name From apivcmst Left Join ssvndmst On apivcmst.apivc_vnd_no = ssvndmst.ssvnd_vnd_no Where apivcmst.apivc_status_ind = ''U''', N'', N'', N'', N'', N'', N'iRely AP - Open Payables', N'', N'', N'None', N'', N'', N'', N'', NULL, NULL, NULL, 0, 0, NULL, NULL, N'14.1.1', NULL, 1, 73, NULL)
INSERT INTO #TampCannedPanels VALUES (15, 0, 20, 0, 0, 0, 0, 0, 0, 0, 1, 0, N'Master', N'iRely AP - Outstanding Checks', N'Grid', N'', N'iRely AP - Outstanding Checks sdfs', N'', N'', N'', N'i21 PT - Berry Oil ', N'This Year', N'This Year', N'apchk_rev_dt', N'', N'Select apchkmst.apchk_rev_dt, apchkmst.apchk_name, apchkmst.apchk_chk_amt, apchkmst.apchk_cleared_ind From apchkmst Where apchkmst.apchk_cleared_ind Is Null And @DATE@', N'', N'@DATE@', N'', N'', N'', N'iRely AP - Outstanding Checks', N'', N'', N'None', N'', N'', N'', N'', NULL, NULL, NULL, 0, 0, NULL, NULL, N'14.1.1', NULL, 1, 35, NULL)
INSERT INTO #TampCannedPanels VALUES (16, 0, 20, 0, 0, 0, 0, 0, 0, 0, 1, 0, N'Master', N'iRely AP - Paid Payables History', N'Grid', N'', N'iRely AP - Paid Payables History', N'', N'', N'', N'i21 PT - Berry Oil ', N'This Year', N'', N'apivc_ivc_rev_dt', N'', N'Select apivcmst.apivc_ivc_no, apivcmst.apivc_ivc_rev_dt, apivcmst.apivc_status_ind, apivcmst.apivc_vnd_no, apivcmst.apivc_due_rev_dt, Case When apivcmst.apivc_trans_type = ''C'' Or apivcmst.apivc_trans_type = ''A'' Then apivcmst.apivc_net_amt * -1 Else apivcmst.apivc_net_amt End As ''amounts'', ssvndmst.ssvnd_name From apivcmst Left Join ssvndmst On apivcmst.apivc_vnd_no = ssvndmst.ssvnd_vnd_no Where apivcmst.apivc_status_ind = ''U'' And @DATE@', N'', N'@DATE@', N'', N'', N'', N'iRely AP - Paid Payables History', N'', N'', N'None', N'', N'', N'', N'', NULL, NULL, NULL, 0, 0, NULL, NULL, N'14.1.1', NULL, 1, 38, NULL)
INSERT INTO #TampCannedPanels VALUES (17, 0, 5, 100, 400, 0, 0, 0, 0, 0, 1, 0, N'Master', N'iRely AG - Revenue vs Costs Monthly', N'Chart', N'', N'iRely AG - Revenue vs Costs Monthly', N'Column', N'outside', N'', N'i21 AG - Demo Test', N'All Dates', N'All Dates', N'agstmmst.agstm_ship_rev_dt', N'agstmmst.agstm_ship_rev_dt', N'Select Month(Convert(date,Convert(char(8),agstmmst.agstm_ship_rev_dt),112)) As ''Month'', Sum(agstmmst.agstm_sls) As ''Sales'' From agstmmst Where @DATE@
...
left join tblGLAccount on tblGLDetail.intAccountID = tblGLAccount.intAccountID
            ...
            WHERE ysnIsUnposted = 0 And @DATE@ ', N'', N'@DATE@', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', NULL, NULL, N'{"aggregate":[],"leftAxis":[],"topAxis":[]}', 0, 0, NULL, NULL, N'14.1.7', NULL, 1, 74, NULL)
INSERT INTO #TampCannedPanels VALUES (24, 0, 15, 0, 0, 0, 0, 0, 0, 0, 1, 0, N'Master', N'i21 General Ledger - GL History', N'Grid', N'', N'i21 General Ledger - GL History', N'', N'', N'', N'Fort Books TE', N'Last Month', N'This Year', N'dtmDate', N'', N'Select tblGLAccount.strAccountID,
...
, tblGLAccount.strDescription', N'', N'@DATE@', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'strAccountID', NULL, N'', 0, 0, NULL, NULL, N'14.1.9', NULL, 1, 75, NULL)
   
INSERT INTO #TampCannedPanels VALUES (25, 0, 15, 0, 0, 0, 0, 0, 0, 0, 1, 0, N'Master', N'i21 General Ledger - GL Summary', N'Grid', N'', N'i21 General Ledger - GL Summary', N'', N'', N'', N'Fort Books TE', N'Last Month', N'Last Month', N'dtmDate', N'', N'Select tblGLAccount.strAccountID
,tblGLAccount.strDescription
...
Order By 
tblGLAccount.strAccountID
, tblGLAccount.strDescription', N'', N'@DATE@', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', 0, 0, NULL, NULL, N'14.1.47', NULL, 1, 76, NULL)
   
INSERT INTO #TampCannedPanels VALUES (26, 0, 15, 0, 0, 0, 0, 0, 0, 0, 1, 0, N'Master', N'i21 General Ledger - Asset Breakdown', N'Grid', N'', N'i21 General Ledger - Asset Breakdown', N'', N'', N'', N'Fort Books TE', N'Last Month', N'Last Month', N'dtmDate', N'', N'select strAccountID, strDescription, SUM(Amount) as Amount
FROM
      (
...
', N'', N'@DATE@', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', NULL, NULL, N'', 0, 0, NULL, NULL, N'14.1.2', NULL, 1, 77, NULL)
   
INSERT INTO #TampCannedPanels VALUES (27, 0, 15, 0, 0, 0, 0, 0, 0, 0, 1, 0, N'Master', N'i21 General Ledger - Liability Breakdown', N'Grid', N'', N'i21 General Ledger - Liability Breakdown', N'', N'', N'', N'Fort Books TE', N'All Dates', N'', N'dtmDate', N'', N'select strAccountID, strDescription, SUM(Amount) as Amount
FROM
      (
            select B.strAccountID, B.strDescription, (A.dblDebit - A.dblCredit) as Amount  from tblGLDetail A
            left join tblGLAccount B on A.intAccountID = B.intAccountID
...
GROUP BY strAccountID, strDescription
', N'', N'@DATE@', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', NULL, NULL, N'', 0, 0, NULL, NULL, N'14.1.4', NULL, 1, 78, NULL)
   
INSERT INTO #TampCannedPanels VALUES (28, 0, 15, 0, 0, 0, 0, 0, 0, 0, 1, 0, N'Master', N'i21 General Ledger - Revenue Breakdown', N'Grid', N'', N'i21 General Ledger - Revenue Breakdown', N'', N'', N'', N'Fort Books TE', N'Last Month', N'Last Month', N'dtmDate', N'', N'select strAccountID, strDescription, SUM(Amount) as Amount
FROM
      (
            select B.strAccountID, B.strDescription, (A.dblDebit - A.dblCredit) as Amount  from tblGLDetail A
            left join tblGLAccount B on A.intAccountID = B.intAccountID
...
GROUP BY Period
ORDER BY Period
', N'', N'@DATE@', N'@DATE@', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', NULL, NULL, N'', 1, 0, NULL, NULL, N'14.1.16', NULL, 1, 81, NULL)
   
INSERT INTO #TampCannedPanels VALUES (35, 0, 5, 100, 400, 0, 0, 0, 0, 0, 1, 0, N'Master', N'i21 General Ledger - Liability Monthly', N'Chart', N'', N'i21 General Ledger - Liability Monthly', N'Column Stacked', N'insideEnd', N'Red', N'Fort Books TE', N'This Year', N'This Year', N'dtmDate', N'', N'SELECT 
    SUM(TotalBalance) as TotalBalance
    ,Period
FROM
    (
      ...
      tblGL 
GROUP BY Period
ORDER BY Period', N'', N'@DATE@', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', NULL, NULL, N'', 1, 0, NULL, NULL, N'14.1.5', NULL, 1, 82, NULL)
   
INSERT INTO #TampCannedPanels VALUES (36, 0, 15, 100, 400, 0, 0, 0, 0, 0, 1, 0, N'Master', N'i21 General Ledger - Revenue Monthly', N'Chart', N'', N'i21 General Ledger - Revenue Monthly', N'Column Stacked', N'insideEnd', N'Cate   ry3', N'Fort Books TE', N'This Year', N'This Year', N'dtmDate', N'', N'SELECT 
    SUM(TotalBalance) as TotalBalance
    ,Period
FROM
    (
      ...
      tblGL 
GROUP BY Period
ORDER BY Period', N'', N'@DATE@', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', N'', NULL, NULL, N'', 1, 0, NULL, NULL, N'14.1.5', NULL, 1, 83, NULL)
   
INSERT INTO #TampCannedPanels VALUES (37, 0, 10, 0, 0, 0, 0, 0, 0, 0, 1, 0, N'Master', N'iRely Grain - Open Hedges', N'Grid', N'', N'iRely Grain - Open Hedges', N'', N'', N'', N'i21 AG - Demo Test', N'All Dates', N'All Dates', N'gahdg_rev_dt', N'', N'Select gahdgmst.gahdg_com_cd, gahdgmst.gahdg_broker_no, gahdgmst.gahdg_rev_dt, gahdgmst.gahdg_ref, gahdgmst.gahdg_loc_no, gahdgmst.gahdg_bot_prc, gahdgmst.gahdg_bot_basis, gahdgmst.gahdg_bot, gahdgmst.gahdg_bot_option, gahdgmst.gahdg_long_short_ind, gahdgmst.gahdg_un_hdg_bal, gahdgmst.gahdg_offset_yn, gahdg_hedge_yyyymm From gahdgmst Where gahdgmst.gahdg_offset_yn = ''N'' and @DATE@', N'', N'@DATE@', N'', N'', N'', N'iRely Grain - Open Hedges', N'', N'', N'None', N'', N'', N'', N'', NULL, NULL, NULL, 0, 0, NULL, NULL, N'14.1', NULL, 1, 21, NULL)
   
INSERT INTO #TampCannedPanels VALUES (38, 0, 10, 0, 0, 0, 0, 0, 0, 0, 1, 0, N'Master', N'iRely Grain - Open Storage', N'Grid', N'', N'iRely Grain - Open Storage', N'', N'', N'', N'Ag SQL 13.1', N'None', N'', N'', N'', N'Select gastrmst.gastr_pur_sls_ind, gastrmst.gastr_com_cd, gastrmst.gastr_stor_type, gastrmst.gastr_cus_no, gastrmst.gastr_un_bal From gastrmst', N'', N'', N'', N'', N'', N'iRely Grain - Open Storage', N'', N'', N'None', N'', N'', N'', N'', NULL, NULL, NULL, 0, 0, NULL, NULL, N'14.1', NULL, 1, 22, NULL)
   
INSERT INTO #TampCannedPanels VALUES (39, 0, 5, 100, 400, 0, 0, 0, 0, 0, 1, 0, N'Master', N'i21 General Ledger - Expenses/COGS Monthly', N'Chart', N'', N'i21 General Ledger - Expenses/COGS Monthly', N'Column Stacked', N'insideStart', N'Purple', N'Fort Books TE', N'This Year', N'This Year', N'dtmDate', N'', N'SELECT 
    SUM(TotalBalance) as TotalBalance
    ,Period
FROM
    (
...
INSERT INTO #TampCannedPanels VALUES (51, 0, 5, 100, 400, 0, 0, 0, 0, 0, 1, 0, N'Master', N'iRely Petro - Revenue vs Costs Monthly', N'Chart', N'', N'iRely Petro - Revenue vs Costs Monthly', N'Column', N'outside', N'', N'i21 PT - Berry Oil ', N'All Dates', N'All Dates', N'ptstmmst.ptstm_rev_dt', N'ptstmmst.ptstm_rev_dt', N'Select Month(Convert(date,Convert(char(8),ptstmmst.ptstm_ship_rev_dt),112)) As ''Month'', 
