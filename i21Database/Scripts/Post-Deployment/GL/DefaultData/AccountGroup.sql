...
GO
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE strAccountGroup = N'Asset' AND intParentGroupId = 0)
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Asset', intSort = 100000, strAccountGroupNamespace = 'System' WHERE strAccountGroup = 'Asset' AND intParentGroupId = 0
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE strAccountGroup = N'Liability' AND intParentGroupId = 0)
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Liability', intSort = 200000, strAccountGroupNamespace = 'System' WHERE strAccountGroup = 'Liability' AND intParentGroupId = 0
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE strAccountGroup = N'Equity' AND intParentGroupId = 0)
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Equity', intSort = 300000, strAccountGroupNamespace = 'System' WHERE strAccountGroup = 'Equity' AND intParentGroupId = 0
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE strAccountGroup = N'Revenue' AND intParentGroupId = 0)
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Revenue', intSort = 400000, strAccountGroupNamespace = 'System' WHERE strAccountGroup = 'Revenue' AND intParentGroupId = 0
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Expense' OR strAccountGroup = N'Expenses') AND intParentGroupId = 0)
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Expense', intSort = 500000, strAccountGroupNamespace = 'System' WHERE (strAccountGroup = N'Expense' OR strAccountGroup = N'Expenses') AND intParentGroupId = 0
	END
...
GO
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Current Asset' OR strAccountGroup = N'Current Assets') AND strAccountType = N'Asset')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Current Assets'
									...
									WHERE  (strAccountGroup = N'Current Asset' OR strAccountGroup = N'Current Assets') AND strAccountType = N'Asset'
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Cash Account' OR strAccountGroup = N'Cash Accounts') AND strAccountType = N'Asset')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Cash Accounts'
									...
									WHERE  (strAccountGroup = N'Cash Account' OR strAccountGroup = N'Cash Accounts') AND strAccountType = N'Asset'
	END
...
GO		
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Undeposited Fund' OR strAccountGroup = N'Undeposited Funds') AND strAccountType = N'Asset')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Undeposited Funds'
									, intSort = 100120
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Current Assets' AND strAccountType = N'Asset') 
									WHERE  (strAccountGroup = N'Undeposited Fund' OR strAccountGroup = N'Undeposited Funds') AND strAccountType = N'Asset'
	END
...
GO			
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Receivable' OR strAccountGroup = N'Receivables') AND strAccountType = N'Asset')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Receivables'
									, intSort = 100130
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Current Assets' AND strAccountType = N'Asset') 
									WHERE  (strAccountGroup = N'Receivable' OR strAccountGroup = N'Receivables') AND strAccountType = N'Asset'
	END		
...
GO		
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Prepaid' OR strAccountGroup = N'Prepaids') AND strAccountType = N'Asset')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Prepaids'
									, intSort = 100140
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Current Assets' AND strAccountType = N'Asset') 
									WHERE  (strAccountGroup = N'Prepaid' OR strAccountGroup = N'Prepaids') AND strAccountType = N'Asset'
	END	
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Inventory' OR strAccountGroup = N'Inventories') AND strAccountType = N'Asset')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Inventories'
									, intSort = 100150
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Current Assets' AND strAccountType = N'Asset') 
									WHERE  (strAccountGroup = N'Inventory' OR strAccountGroup = N'Inventories') AND strAccountType = N'Asset'
	END		
...
GO
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Non-Current Asset' OR strAccountGroup = N'Non-Current Assets') AND strAccountType = N'Asset')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Non-Current Assets'
									, intSort = 100200
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Asset' AND strAccountType = N'Asset' AND intParentGroupId = 0) 
									WHERE  (strAccountGroup = N'Non-Current Asset' OR strAccountGroup = N'Non-Current Assets') AND strAccountType = N'Asset'
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Other Asset' OR strAccountGroup = N'Other Assets') AND strAccountType = N'Asset')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Other Assets'
									...
									WHERE  (strAccountGroup = N'Other Asset' OR strAccountGroup = N'Other Assets') AND strAccountType = N'Asset'
	END
...
GO
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Current Liability' OR strAccountGroup = N'Current Liabilities') AND strAccountType = N'Liability')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Current Liabilities'
									...
									WHERE  (strAccountGroup = N'Current Liability' OR strAccountGroup = N'Current Liabilities') AND strAccountType = N'Asset'
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Payable' OR strAccountGroup = N'Payables') AND strAccountType = N'Liability')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Payables'
									...
									WHERE  (strAccountGroup = N'Payable' OR strAccountGroup = N'Payables') AND strAccountType = N'Liability'
	END	
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Other Payable' OR strAccountGroup = N'Other Payables') AND strAccountType = N'Liability')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Other Payables'
									, intSort = 200120
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Current Liabilities' AND strAccountType = N'Liability') 
									WHERE  (strAccountGroup = N'Other Payable' OR strAccountGroup = N'Other Payables') AND strAccountType = N'Liability'
	END	
...
GO		
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Sales Tax Payable' OR strAccountGroup = N'Sales Tax Payables') AND strAccountType = N'Liability')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Sales Tax Payables'
									, intSort = 200130
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Current Liabilities' AND strAccountType = N'Liability') 
									WHERE  (strAccountGroup = N'Sales Tax Payable' OR strAccountGroup = N'Sales Tax Payables') AND strAccountType = N'Liability'
	END	
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Payroll Tax Liability' OR strAccountGroup = N'Payroll Tax Liabilities') AND strAccountType = N'Liability')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Payroll Tax Liabilities'
									, intSort = 200140
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Current Liabilities' AND strAccountType = N'Liability') 
									WHERE  (strAccountGroup = N'Payroll Tax Liability' OR strAccountGroup = N'Payroll Tax Liabilities') AND strAccountType = N'Liability'
	END
...
GO		
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Customer Deposit' OR strAccountGroup = N'Customer Deposits') AND strAccountType = N'Liability')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Customer Deposits'
									, intSort = 200150
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Current Liabilities' AND strAccountType = N'Liability') 
									WHERE  (strAccountGroup = N'Customer Deposit' OR strAccountGroup = N'Customer Deposits') AND strAccountType = N'Liability'
	END	
...
GO
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Pending Payable' OR strAccountGroup = N'Pending Payables') AND strAccountType = N'Liability')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Pending Payables'
									, intSort = 200160
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Current Liabilities' AND strAccountType = N'Liability') 
									WHERE  (strAccountGroup = N'Pending Payable' OR strAccountGroup = N'Pending Payables') AND strAccountType = N'Liability'
	END			
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Grain Payable' OR strAccountGroup = N'Grain Payables') AND strAccountType = N'Liability')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Grain Payables'
									, intSort = 200170
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Current Liabilities' AND strAccountType = N'Liability') 
									WHERE  (strAccountGroup = N'Grain Payable' OR strAccountGroup = N'Grain Payables') AND strAccountType = N'Liability'
	END		
...
GO
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Retained Earning' OR strAccountGroup = N'Retained Earnings') AND strAccountType = N'Equity')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Retained Earnings'
									...
									WHERE  (strAccountGroup = N'Retained Earning' OR strAccountGroup = N'Retained Earnings') AND strAccountType = N'Equity'
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Owners Equity' OR strAccountGroup = N'Owners Equities') AND strAccountType = N'Equity')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Owners Equities'
									, intSort = 300200
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Equity' AND strAccountType = N'Equity' AND intParentGroupId = 0) 
									WHERE  (strAccountGroup = N'Owners Equity' OR strAccountGroup = N'Owners Equities') AND strAccountType = N'Equity'
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Other Equity' OR strAccountGroup = N'Other Equities') AND strAccountType = N'Equity')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Other Equities'
									, intSort = 300300
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Equity' AND strAccountType = N'Equity' AND intParentGroupId = 0) 
									WHERE  (strAccountGroup = N'Other Equity' OR strAccountGroup = N'Other Equities') AND strAccountType = N'Equity'
	END		
...
GO
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE strAccountGroup = N'Sales' AND strAccountType = N'Revenue')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Sales'
									...
									WHERE  strAccountGroup = N'Sales' AND strAccountType = N'Revenue'
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Sales Discount' OR strAccountGroup = N'Sales Discounts') AND strAccountType = N'Revenue')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Sales Discounts'
									, intSort = 400200
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Revenue' AND strAccountType = N'Revenue' AND intParentGroupId = 0) 
									WHERE  (strAccountGroup = N'Sales Discount' OR strAccountGroup = N'Sales Discounts') AND strAccountType = N'Revenue'
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Other Incomes' OR strAccountGroup = N'Other Income') AND strAccountType = N'Revenue')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Other Income'
									, intSort = 400300
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Revenue' AND strAccountType = N'Revenue' AND intParentGroupId = 0) 
									WHERE  (strAccountGroup = N'Other Incomes' OR strAccountGroup = N'Other Income') AND strAccountType = N'Revenue'
	END		
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Other Revenue' OR strAccountGroup = N'Other Revenues') AND strAccountType = N'Revenue')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Other Revenues'
									, intSort = 400400
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Revenue' AND strAccountType = N'Revenue' AND intParentGroupId = 0) 
									WHERE  (strAccountGroup = N'Other Revenue' OR strAccountGroup = N'Other Revenues') AND strAccountType = N'Revenue'
	END		
...
GO
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Cost of Goods Solds' OR strAccountGroup = N'Cost of Goods Sold') AND strAccountType = N'Expense')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Cost of Goods Sold'
									...
									WHERE  (strAccountGroup = N'Cost of Goods Solds' OR strAccountGroup = N'Cost of Goods Sold') AND strAccountType = N'Expense'
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Purchase' OR strAccountGroup = N'Purchases') AND strAccountType = N'Expense')
	BEGIN
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Purchases Discount' OR strAccountGroup = N'Purchases Discounts') AND strAccountType = N'Expense')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Purchases Discounts'
									...
									WHERE  (strAccountGroup = N'Purchases Discount' OR strAccountGroup = N'Purchases Discounts') AND strAccountType = N'Expense'
	END	
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Other Purchase' OR strAccountGroup = N'Other Purchases') AND strAccountType = N'Expense')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Other Purchases'
									, intSort = 500130
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Cost of Goods Sold' AND strAccountType = N'Expense') 
									WHERE  (strAccountGroup = N'Other Purchase' OR strAccountGroup = N'Other Purchases') AND strAccountType = N'Expense'
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Payroll Cog' OR strAccountGroup = N'Payroll Cogs') AND strAccountType = N'Expense')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Payroll Cogs'
									, intSort = 500140
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Cost of Goods Sold' AND strAccountType = N'Expense') 
									WHERE  (strAccountGroup = N'Payroll Cog' OR strAccountGroup = N'Payroll Cogs') AND strAccountType = N'Expense'
	END
...
GO		
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Other Expense' OR strAccountGroup = N'Other Expenses') AND strAccountType = N'Expense')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Other Expenses'
									, intSort = 500200
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Expense' AND strAccountType = N'Expense' AND intParentGroupId = 0) 
									WHERE  (strAccountGroup = N'Other Expense' OR strAccountGroup = N'Other Expenses') AND strAccountType = N'Expense'
	END	
...
GO		
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Payroll Earning' OR strAccountGroup = N'Payroll Earnings') AND strAccountType = N'Expense')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Payroll Earnings'
									, intSort = 500300
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Expense' AND strAccountType = N'Expense' AND intParentGroupId = 0) 
									WHERE  (strAccountGroup = N'Payroll Earning' OR strAccountGroup = N'Payroll Earnings') AND strAccountType = N'Expense'
	END
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Payroll Tax Expense' OR strAccountGroup = N'Payroll Tax Expenses') AND strAccountType = N'Expense')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Payroll Tax Expenses'
									, intSort = 500400
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Expense' AND strAccountType = N'Expense' AND intParentGroupId = 0) 
									WHERE  (strAccountGroup = N'Payroll Tax Expense' OR strAccountGroup = N'Payroll Tax Expenses') AND strAccountType = N'Expense'
	END	
...
GO	
	IF EXISTS(SELECT TOP 1 1 FROM tblGLAccountGroup WHERE (strAccountGroup = N'Payroll Expense' OR strAccountGroup = N'Payroll Expenses') AND strAccountType = N'Expense')
	BEGIN
		UPDATE tblGLAccountGroup SET strAccountGroup = 'Payroll Expenses'
									, intSort = 500500
									, strAccountGroupNamespace = 'System'
									, intParentGroupId = (SELECT TOP 1 intAccountGroupId FROM tblGLAccountGroup WHERE strAccountGroup = N'Expense' AND strAccountType = N'Expense' AND intParentGroupId = 0) 
									WHERE  (strAccountGroup = N'Payroll Expense' OR strAccountGroup = N'Payroll Expenses') AND strAccountType = N'Expense'
	END	
