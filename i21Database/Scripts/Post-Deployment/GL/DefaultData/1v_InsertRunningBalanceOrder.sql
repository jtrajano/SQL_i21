...
GO
    IF NOT EXISTS (SELECT TOP 1 1 FROM tblGLRunningBalanceOrder)
        INSERT INTO tblGLRunningBalanceOrder(intGLDetailId,intAccountId,dtmDate,strTransactionId, rowId)
        SELECT intGLDetailId,intAccountId,dtmDate, strTransactionId, ROW_NUMBER() 
