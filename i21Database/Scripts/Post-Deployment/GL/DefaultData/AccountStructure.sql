...
GO
	...
	END
	IF NOT EXISTS(SELECT TOP 1 1 FROM tblGLAccountStructure WHERE strType = N'Segment' and (strStructureName = N'Location' OR strStructureName = N'Profit Center')) AND NOT EXISTS(SELECT TOP 1 1 FROM tblGLAccount)
	BEGIN
