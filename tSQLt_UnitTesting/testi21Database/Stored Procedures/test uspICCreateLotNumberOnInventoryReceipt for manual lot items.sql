CREATE PROCEDURE [testi21Database].[test uspICCreateLotNumberOnInventoryReceipt for manual lot items]
AS
BEGIN
	-- Arrange 
	BEGIN 
	...
	-- Act
	BEGIN 
		DECLARE @strTransactionId AS NVARCHAR(20) = 'INVRCPT-XXXXX5'
