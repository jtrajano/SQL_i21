CREATE PROCEDURE [testi21Database].[test uspICPostInventoryAdjustmentExpiryLotChange on adjusting the expiry date]
AS
BEGIN
	-- Item Ids
	...
	BEGIN 
		...
		DECLARE @intTransactionId AS INT = 6 -- For ADJ-6
				,@ysnPost AS BIT = 1
		...
		SELECT 
			...
			,dtmExpiryDate	= '05/12/2018'
	END 

	-- Act
	BEGIN 
		-- Call the sp that changes the expiry date of a lot item. 
