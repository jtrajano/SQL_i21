CREATE PROCEDURE [testi21Database].[test the uspICCreateStockReservation to insert non-lot items and replace existing data]
AS
BEGIN
	...
	BEGIN 
		...
		SELECT	intItemId = @StickyGrains
				...
				,dblQuantity = 1
				,intTransactionId = 2
				,strTransactionId = 'TRANSACTION-0000010'
				,intInventoryTransactionType = 1 
