...
CREATE PROCEDURE [testi21Database].[test uspICValidateConvertToItemReceipt as it checks for a valid item and location]
AS
BEGIN
	-- Arrange 
	BEGIN 
	...
	-- Test case 1: 
	BEGIN 
		-- Assert that no exception expected after uspICValidateCostingOnPost is called. 
