CREATE PROCEDURE [testi21Database].[test uspICUnpostLotOut for sell 1-sell 2-add stock-unpost sell 1]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		INSERT INTO dbo.tblICInventoryLotOut (intInventoryLotId, intInventoryTransactionId, dblQty) VALUES (3, 4, 100)
		INSERT INTO dbo.tblICInventoryLotOut (intInventoryLotId, intInventoryTransactionId, dblQty) VALUES (3, 6, 15)
