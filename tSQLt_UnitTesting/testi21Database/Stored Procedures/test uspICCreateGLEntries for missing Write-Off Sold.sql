CREATE PROCEDURE [testi21Database].[test uspICCreateGLEntries for missing Write-Off Sold]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		WHERE intAccountCategoryId = @AccountCategoryId_WriteOffSold
	END 
	...
	BEGIN 
		...
		EXEC tSQLt.ExpectException 
			@ExpectedMessagePattern = 'STICKY GRAINS is missing a GL account setup for Write-Off Sold account category.'
