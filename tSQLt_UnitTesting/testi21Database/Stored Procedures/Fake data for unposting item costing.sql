CREATE PROCEDURE [testi21Database].[Fake data for unposting item costing]
AS
BEGIN
	...
	DECLARE @PURCHASE_TYPE_NAME AS NVARCHAR(50) = 'Inventory Receipt'
	DECLARE @SALES_TYPE_NAME AS NVARCHAR(50) = 'Inventory Shipment'
