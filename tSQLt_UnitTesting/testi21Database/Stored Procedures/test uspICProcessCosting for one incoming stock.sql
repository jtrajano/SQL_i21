CREATE PROCEDURE testi21Database.[test uspICProcessCosting for one incoming stock]
AS
BEGIN
	-- Arrange 
	BEGIN 
	...
	-- Act
	BEGIN 	
		-- Call uspICProcessCosting to post the costing and generate the g/l entries 
		INSERT INTO actual 
