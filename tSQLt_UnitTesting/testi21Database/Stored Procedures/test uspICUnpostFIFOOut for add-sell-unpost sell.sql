CREATE PROCEDURE [testi21Database].[test uspICUnpostFIFOOut for add-sell-unpost sell]
AS
BEGIN
	-- Arrange 
	BEGIN 
		...
		INSERT INTO dbo.tblICInventoryFIFOOut (intInventoryFIFOId, intInventoryTransactionId, dblQty) VALUES (1, 2, 15)
