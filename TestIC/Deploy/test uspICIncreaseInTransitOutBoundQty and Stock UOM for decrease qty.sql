if exists (select * from sys.procedures where object_id = object_id('testIC.test uspICIncreaseInTransitOutBoundQty and Stock UOM for decrease qty'))
	drop procedure [testIC].[test uspICIncreaseInTransitOutBoundQty and Stock UOM for decrease qty];
GO
