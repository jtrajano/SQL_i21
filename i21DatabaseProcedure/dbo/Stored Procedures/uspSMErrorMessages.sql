...
SET @strmessage = 'Storage or storage for %s is not yet supported. It is currently limited to lot-tracked items.'
...
SET @strmessage = 'Transaction exists for the shift ''%s'', shift cannot be deleted.'
...
SET @strmessage = 'There is no enough shift time to schedule the Work Order ''%s'' in the selected calendar.'
...
SET @strmessage = 'There is no Pack Type conversion factor that matches the Work Order ''%s''.'
